...
import kcp.erasure.fecNative.FecDecode;
import kcp.erasure.fecNative.FecEncode;
import kcp.erasure.fecNative.ReedSolomonNative;
...
public class FecAdapt {
    ...
    public IFecEncode fecEncode(int headerOffset,int mtu){
        ...
        if(reedSolomonNative!=null){
            ...
            iFecEncode = new kcp.erasure.fec.FecEncode(headerOffset,this.reedSolomon,mtu);
        }
        return iFecEncode;
    }
    ...
    public IFecDecode fecDecode(int mtu){
        ...
        if(reedSolomonNative!=null){
            ...
            iFecDecode = new kcp.erasure.fec.FecDecode(3*this.reedSolomon.getTotalShardCount(),this.reedSolomon,mtu);
        }
        return iFecDecode;
    }
}
