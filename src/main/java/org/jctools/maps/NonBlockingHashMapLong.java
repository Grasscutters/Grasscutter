 ...
 *
 * <p> Operations (including put) generally do not block, so may
 ...
 * does <em>not</em> allow null to be used as a value.
 *
 *
 * @since 1.5
 * @author Cliff Click
...
public class NonBlockingHashMapLong<TypeV>
   ...
   *
   *  <p>The view's iterator is a "weakly consistent" iterator that
