...
public class LeyLinesManager {
    ...
    static {
        ...
        registerMonster(20020101,1); // 狂风之核
        ...
        registerMonster(24010108,2); // 遗迹守卫
        registerMonster(24010109,2); // 遗迹守卫
        ...
        registerMonster(25100201,0); // 海乱鬼·炎威
        registerMonster(25100401,0); // 落武者·祟炎
        registerMonster(25100102,0); // 海乱鬼·雷腾
        ...
        registerMonster(26080101,0); // 跋掣
        registerMonster(26090101,0); // 浮游水蕈兽
        registerMonster(20060101,0); // 水飘浮灵
        registerMonster(20060201,0); // 岩飘浮灵
        registerMonster(20060301,0); // 风飘浮灵
        registerMonster(20060401,0); // 冰飘浮灵
        registerMonster(20060501,0); // 雷飘浮灵
        registerMonster(20060601,0); // 火飘浮灵
    ...
    public EntityGadget createLeyLineGadgetEntity(Position pos, LeyLinesType leyLinesType){
        ...
        gadgetWorktop.setOnSelectWorktopOptionEvent((Player player, GadgetWorktop context, int option) -> {
            ...
            synchronized (activeLeyLines) {
                ...
                var monsters = getRandomMonstersID(0,4);
