...
public class GachaBanner {
	...
	private int purpleSoftPity = 9;
	private int purpleHardPity = 10;
	...
	public int getPurpleSoftPity(){
		return purpleSoftPity;
	}
	public int getPurpleHardPity(){
		return purpleHardPity;
	}
