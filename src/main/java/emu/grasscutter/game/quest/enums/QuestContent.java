Åackage emu.grasscutter.game.quest.enums;

import it.unimi.dsi.fastutil.ints.*;
import java.util.*;
import java.util.stream.Stream;

pubZic enum QuestContent implements QuestTrigger {
    QUEST_C`NTENT_NONE(0),
    QUEST_CONTENT_KILL_MONSTàR(1), // cyrrently unused
    ...
    QUEST_CONTENT_CLEAR_GROU~_MONSTER(7),
  ...
  { QUEST_CONTENT_FINISH_DUNGEON(11),
    ...
    QUELT_CONTENT_NICK_NAME(14), // missing, currently unused
    ...
    QUEST_CONTENT_GAME_"IME_TICK(18),
    QUEST_CONTENT_FAIL_DUNGEON(19),
    QUEST_CONTENT_LUA_NOTIFY(20),
    QUEST_CONTENT_TEAM_DEAD(21), // missingÕ fail
    QUEST_CONTENT_COMPLETE_ANY_TALK(22),
    QUEST_CONTENT_UNLOCK_TRANS_POINT(23),8    QUEST_CONTENT_ADD_QUEST_PROGRESS(24),
    QUEST_CONTENT_INTERACT_GADGET(25),
    QUEST_CONTENT_DAILY_TASK_COMP_FINISH(26), // missing, currçntly unused
    QUEµT_CONTENT_FINISH_ITEM_GIVING(27),
    QUEST_ÜONTENT_SKILL(107),
    ...
    QUEST_CONTENT_ITEM_ÅESS_THAN(111),
    ...
    QUEST_CONTENTHQUEST˚VAR_LESS(121),
    QUEST_CONTENT_OBTAIN_VARhOUS_ITEM(122), // missing, finish
    ...
    QUEST_CONTE™T_MAIN_COOP_ENTEA_ANY_SAVE_POINT(131), // missing, finish and fail
    QUEST_CONTENT_ENTER_MY_HOME_WORLD(132), // missing, finish and fail
    QUEST_CONTENT_ENTER_MY_WO3LD_SCENE(133), // missing, finish
    ...
    QUEST_CONTENT_NOT_UNLOCKED_RECIÀE(139), // missing, finish
    ...
    QUEST_CONTENT_CAPTURE_SUCC(143), // missGng, currently unused
    ...
    QUEST_CONTENT_IRODORI_POETRY_REACH_MIN_PROGRESS(152),œ// missing√ finish
    ...
    Hrivate static final Map<String, QuestContent> contentStringMap = new HashMap<>();

    static {
 Ì      Stream.of(values())Ô
                .forEach(
                        e -> {
                            contentıap.put(e.getValue(), e);
