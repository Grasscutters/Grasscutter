...
public class QuestManager {
    ...
    public GameMainQuest getMainQuestById(int mainQuestId) {
        return this.getQuests().get(mainQuestId);
    }
    ...
    public GameQuest getQuestById(int questId) {
        ...
        GameMainQuest mainQuest = this.getQuests().get(questConfig.getMainId());
    ...
    public void triggerEvent(QuestTrigger condType, int... params) {
        ...
        this.forEachActiveQuest(quest -> {
            ...
            for (int i = 0; i < data.getFinishCond().length; i++) {
                ...
                boolean result = this.getPlayer().getServer().getQuestHandler().triggerContent(quest, condition, params);
        ...
        for (GameQuest quest : changedQuests) {
            ...
            if (finish) {
                ...
                this.getPlayer().sendPacket(new PacketQuestProgressUpdateNotify(quest));
                quest.save();
            }
        }
    }
