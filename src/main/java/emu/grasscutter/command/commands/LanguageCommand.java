...
@Command(label = "language", usage = "language [language code]", description = "commands.language.description", permissionLevel = 3, aliases = {"lang"}, targetRequirement = Command.TargetRequirement.NONE)
