...
@Command(label = "changescene", usage = "changescene <sceneId>", aliases = {"scene"}, permission = "player.changescene", permissionLevel = 1,  permissionTargeted = "player.changescene.others", description = "commands.changescene.description")
