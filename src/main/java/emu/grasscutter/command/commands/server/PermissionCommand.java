...
@Command(label = "permission", usage = "permission <add|remove> <permission>", permission = "permission", description = "commands.permission.description" , category = Command.Category.PERMISSIONS)
