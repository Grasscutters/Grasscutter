...
@Command(label = "setstats", usage = "setstats|stats <stat> <value>", aliases = {"stats"}, permission = "player.setstats", permissionLevel = 2, permissionTargeted = "player.setstats.others", description = "commands.setStats.description")
