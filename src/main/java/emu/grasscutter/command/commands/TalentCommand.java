...
@Command(label = "talent", usage = "talent <talentId> <value>", permission = "player.settalent", permissionLevel = 2, permissionTargeted = "player.settalent.others", description = "commands.talent.description")
