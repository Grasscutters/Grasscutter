...
@Command(label = "permission", usage = "permission <add|remove> <permission>", permission = "server.permission" , permissionLevel = 2, description = "commands.permission.description", targetRequirement = Command.TargetRequirement.NONE)
