...
@Command(label = "sendmessage", usage = "sendmessage <message>",
        aliases = {"say", "sendservmsg", "sendservermessage"}, permission = "server.sendmessage", permissionTargeted = "server.sendmessage.others" , permissionLevel = 2, description = "commands.sendMessage.description")
