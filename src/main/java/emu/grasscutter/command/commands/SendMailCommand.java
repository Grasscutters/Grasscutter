...
@Command(label = "sendmail", usage = "sendmail <userId|all|help> [templateId]", permission = "server.sendmail", description = "commands.sendMail.description" , permissionLevel = 3, targetRequirement = Command.TargetRequirement.NONE)
