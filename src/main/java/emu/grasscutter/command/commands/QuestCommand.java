...
@Command(label = "quest", usage = "quest <add|finish> [quest id]",aliases = {"q", "misi"}, permission = "player.quest", permissionTargeted = "player.quest.others", description = "commands.quest.description")
