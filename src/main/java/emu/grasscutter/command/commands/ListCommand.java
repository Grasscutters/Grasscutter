...
@Command(label = "list", usage = "list [uid]", aliases = {"players"}, description = "commands.list.description" , permissionLevel = 3, targetRequirement = Command.TargetRequirement.NONE)
