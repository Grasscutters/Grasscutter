...
@Command(label = "coop", usage = "coop [host uid]", permission = "server.coop", permissionLevel = 1, permissionTargeted = "server.coop.others", description = "commands.coop.description")
