...
@Command(label = "tpall", usage = "tpall", permission = "player.tpall", permissionLevel = 3, permissionTargeted = "player.tpall.others", description = "commands.teleportAll.description")
