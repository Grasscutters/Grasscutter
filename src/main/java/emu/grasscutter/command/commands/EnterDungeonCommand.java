...
@Command(label = "enterdungeon", usage = "enterdungeon <dungeonId>", aliases = {"dungeon"}, permission = "player.enterdungeon", permissionLevel = 1, permissionTargeted = "player.enterdungeon.others", description = "commands.enter_dungeon.description")
