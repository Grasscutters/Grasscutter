...
@Command(label = "drop", usage = "drop <itemId|itemName> [amount]", aliases = {"d", "dropitem"}, permission = "server.drop", permissionLevel = 1, permissionTargeted = "server.drop.others", description = "commands.drop.description")
