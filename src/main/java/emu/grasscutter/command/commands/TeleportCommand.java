...
@Command(label = "teleport", usage = "teleport <x> <y> <z> [sceneId]", aliases = {"tp"}, permissionLevel = 2, permission = "player.teleport", permissionTargeted = "player.teleport.others", description = "commands.teleport.description")
