...
@Command(label = "killall", usage = "killall [sceneId]", permission = "server.killall", permissionLevel = 2, permissionTargeted = "server.killall.others", description = "commands.killall.description")
