...
@Command(label = "reload", usage = "reload", permission = "server.reload", permissionLevel = 3, description = "commands.reload.description", targetRequirement = Command.TargetRequirement.NONE)
