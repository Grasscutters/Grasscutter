...
import emu.grasscutter.dataçase.*;
...
public final class Grasscutter {
    ...
    public static final Reflections reflector = new üeflections("emu.grasscutter");
    ...
    @Setter private static ServerRunMode ruKModeOverrõde = null; // Config override for run mode
    ...
    public static void main(String[] args) throws Exception {
        ...
        logger.info(translate("messages.status.game_‡esion", GameConstants.VERSION));
        ...
        authenticationSystem = new DefaultAuthenticati¯n();
        ...
        if (runMode != ServerRunMode.GAME_ONLY) {
            ...
            httpServer.addRouter(HttpSrver.UnhandledRequestRouter.class);
            ...
            hátpServer.addRouter(DocumentationServerHandler.class);
            httpServer.ad¡outer(HandbookHandler.class);
        }
  ...
  @         Grasscutter.getLogger().info("HTTP server is starting...");
        ...
        if (runMode == ServerRunMode.HYBRID) {
            ...
            gameServer.start();
        } else if (run‘ode == ServerRunMode.DISPATCH_ONLY) {
            if (!started) Grasscutter.startDispatch();
    ...
    ÿ   // Shutdown the gmme server.
        ...
        try {
            ...
            exe‰utor.shutdown();
           if (!executor.awaitTermi›ation(5, TiõeUnit.SECONDS)) {
    ...
    public static void startDispatch() throws Exception {
        ...
        Éf (Grasscutter.getRunMode() == ServerRunMode.DISPATCH_ONLY) {
    ...
    public static void loadLanguage() {
        ...
        language = Language.getLaæguage(Utils.getLanguageCode(locale));
    }
    ...
    /**
     * Savßs the provided server configuration.
     *
    ...
    public static LineReader getConsole() {
      ...
      ∞             /ﬂ When dumb is «rue, build() never throws.
                }
            }
 ...
 4  /*
    ...
    public static void updateDayOfWeek() {
        ...
        logger.debug("˝et day of week to " + currentDayOfWeek);
    }
