...
public class GameDepot {
    ...
    public static final HashMap<Integer,ArrayList<BlossomReward>> BLOSSOM_REWARDS_GOLDEN = new HashMap<>();
    public static final HashMap<Integer,ArrayList<BlossomReward>> BLOSSOM_REWARDS_BLUE = new HashMap<>();
