...
public final class DispatchServer {
	...
	public void start() throws Exception {
		...
		httpServer.get("/", (req, res) -> {
			File welcomeFile = new File(DISPATCH_INFO.WelcomeFile);
		...
		httpServer.raw().error(404, ctx -> {
			...
			File errorFile = new File(DISPATCH_INFO.ErrorFile);
			...
			if (errorFile.exists()) {
				...
				ctx.result("<!doctype html><html><head><meta charset=\"utf8\"></head><body><img src=\"https://http.cat/404\" /></body></html>");
			}
		});
