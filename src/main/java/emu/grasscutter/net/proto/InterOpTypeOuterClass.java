...
public final class InterOpTypeOuterClass {
  ...
  public enum InterOpType
    ...
    /**
     * <code>InterOpFinish = 0;</code>
     */
    InterOpFinish(0),
    /**
     * <code>InterOpStart = 1;</code>
     */
    InterOpStart(1),
    UNRECOGNIZED(-1),
    ;
     ...
     * <code>InterOpFinish = 0;</code>
     */
    public static final int InterOpFinish_VALUE = 0;
    /**
     * <code>InterOpStart = 1;</code>
     */
    public static final int InterOpStart_VALUE = 1;
    ...
    public static InterOpType forNumber(int value) {
      switch (value) {
        case 0: return InterOpFinish;
        case 1: return InterOpStart;
        default: return null;
      }
    }
