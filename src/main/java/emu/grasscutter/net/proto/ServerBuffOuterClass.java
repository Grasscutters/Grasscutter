...
public final class ServerBuffOuterClass {
  ...
  public interface ServerBuffOrBuilder extends
    ...
    /**
     * <code>repeated uint32 doneOnaddedActionList = 5;</code>
     * @return A list containing the doneOnaddedActionList.
     */
    java.util.List<java.lang.Integer> getDoneOnaddedActionListList();
    /**
     * <code>repeated uint32 doneOnaddedActionList = 5;</code>
     * @return The count of doneOnaddedActionList.
     */
    int getDoneOnaddedActionListCount();
    /**
     * <code>repeated uint32 doneOnaddedActionList = 5;</code>
     * @param index The index of the element to return.
     * @return The doneOnaddedActionList at the given index.
     */
    int getDoneOnaddedActionList(int index);

    /**
     * <code>bool isOnaddedActionAllow = 6;</code>
     * @return The isOnaddedActionAllow.
     */
    boolean getIsOnaddedActionAllow();
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
    ...
    private ServerBuff() {
      doneOnaddedActionList_ = emptyIntList();
    }
    ...
    private ServerBuff(
      ...
      try {
          ...
          switch (tag) {
            ...
            case 40: {
              if (!((mutable_bitField0_ & 0x00000001) != 0)) {
                doneOnaddedActionList_ = newIntList();
                mutable_bitField0_ |= 0x00000001;
              }
              doneOnaddedActionList_.addInt(input.readUInt32());
              break;
            }
            case 42: {
            ...
            case 48: {
              ...
              isOnaddedActionAllow_ = input.readBool();
              break;
            }
            default: {
        ...
        if (((mutable_bitField0_ & 0x00000001) != 0)) {
          doneOnaddedActionList_.makeImmutable(); // C
        }
    ...
    public static final int DONEONADDEDACTIONLIST_FIELD_NUMBER = 5;
    private com.google.protobuf.Internal.IntList doneOnaddedActionList_;
    /**
     * <code>repeated uint32 doneOnaddedActionList = 5;</code>
     * @return A list containing the doneOnaddedActionList.
     */
    ...
    public java.util.List<java.lang.Integer>
        getDoneOnaddedActionListList() {
      return doneOnaddedActionList_;
    }
    /**
     * <code>repeated uint32 doneOnaddedActionList = 5;</code>
     * @return The count of doneOnaddedActionList.
     */
    public int getDoneOnaddedActionListCount() {
      return doneOnaddedActionList_.size();
    }
    /**
     * <code>repeated uint32 doneOnaddedActionList = 5;</code>
     * @param index The index of the element to return.
     * @return The doneOnaddedActionList at the given index.
     */
    public int getDoneOnaddedActionList(int index) {
      return doneOnaddedActionList_.getInt(index);
    }
    private int doneOnaddedActionListMemoizedSerializedSize = -1;

    public static final int ISONADDEDACTIONALLOW_FIELD_NUMBER = 6;
    private boolean isOnaddedActionAllow_;
    /**
     * <code>bool isOnaddedActionAllow = 6;</code>
     * @return The isOnaddedActionAllow.
     */
    @java.lang.Override
    public boolean getIsOnaddedActionAllow() {
      return isOnaddedActionAllow_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (getDoneOnaddedActionListList().size() > 0) {
        output.writeUInt32NoTag(42);
        output.writeUInt32NoTag(doneOnaddedActionListMemoizedSerializedSize);
      }
      for (int i = 0; i < doneOnaddedActionList_.size(); i++) {
        output.writeUInt32NoTag(doneOnaddedActionList_.getInt(i));
      }
      if (isOnaddedActionAllow_ != false) {
        output.writeBool(6, isOnaddedActionAllow_);
      }
      ...
      }
      {
        ...
        for (int i = 0; i < doneOnaddedActionList_.size(); i++) {
          dataSize += com.google.protobuf.CodedOutputStream
            .computeUInt32SizeNoTag(doneOnaddedActionList_.getInt(i));
        }
        size += dataSize;
        if (!getDoneOnaddedActionListList().isEmpty()) {
          size += 1;
          size += com.google.protobuf.CodedOutputStream
              .computeInt32SizeNoTag(dataSize);
        }
        doneOnaddedActionListMemoizedSerializedSize = dataSize;
      }
      if (isOnaddedActionAllow_ != false) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(6, isOnaddedActionAllow_);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!getDoneOnaddedActionListList()
          .equals(other.getDoneOnaddedActionListList())) return false;
      if (getIsOnaddedActionAllow()
          != other.getIsOnaddedActionAllow()) return false;
    ...
    public int hashCode() {
      ...
      if (getDoneOnaddedActionListCount() > 0) {
        hash = (37 * hash) + DONEONADDEDACTIONLIST_FIELD_NUMBER;
        hash = (53 * hash) + getDoneOnaddedActionListList().hashCode();
      }
      hash = (37 * hash) + ISONADDEDACTIONALLOW_FIELD_NUMBER;
      hash = (53 * hash) + com.google.protobuf.Internal.hashBoolean(
          getIsOnaddedActionAllow());
    ...
    public static final class Builder extends
      ...
      public emu.grasscutter.net.proto.ServerBuffOuterClass.ServerBuff buildPartial() {
        ...
        if (((bitField0_ & 0x00000001) != 0)) {
          doneOnaddedActionList_.makeImmutable();
          bitField0_ = (bitField0_ & ~0x00000001);
        }
        result.doneOnaddedActionList_ = doneOnaddedActionList_;
        result.isOnaddedActionAllow_ = isOnaddedActionAllow_;
        onBuilt();
        return result;
      }
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.ServerBuffOuterClass.ServerBuff other) {
        ...
        if (!other.doneOnaddedActionList_.isEmpty()) {
          if (doneOnaddedActionList_.isEmpty()) {
            doneOnaddedActionList_ = other.doneOnaddedActionList_;
            bitField0_ = (bitField0_ & ~0x00000001);
          } else {
            ensureDoneOnaddedActionListIsMutable();
            doneOnaddedActionList_.addAll(other.doneOnaddedActionList_);
          }
          onChanged();
        }
        if (other.getIsOnaddedActionAllow() != false) {
          setIsOnaddedActionAllow(other.getIsOnaddedActionAllow());
        }
      ...
      private com.google.protobuf.Internal.IntList doneOnaddedActionList_ = emptyIntList();
      private void ensureDoneOnaddedActionListIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          doneOnaddedActionList_ = mutableCopy(doneOnaddedActionList_);
      ...
      public java.util.List<java.lang.Integer>
        ...
        return ((bitField0_ & 0x00000001) != 0) ?
                 java.util.Collections.unmodifiableList(doneOnaddedActionList_) : doneOnaddedActionList_;
      }
      /**
       * <code>repeated uint32 doneOnaddedActionList = 5;</code>
       * @return The count of doneOnaddedActionList.
       ...
       * @param value The doneOnaddedActionList to set.
       * @return This builder for chaining.
       */
      public Builder setDoneOnaddedActionList(
          int index, int value) {
        ensureDoneOnaddedActionListIsMutable();
        doneOnaddedActionList_.setInt(index, value);
        onChanged();
        return this;
      }
      /**
       * <code>repeated uint32 doneOnaddedActionList = 5;</code>
       * @param value The doneOnaddedActionList to add.
       * @return This builder for chaining.
       */
      public Builder addDoneOnaddedActionList(int value) {
        ensureDoneOnaddedActionListIsMutable();
        doneOnaddedActionList_.addInt(value);
        onChanged();
        return this;
      }
      /**
       * <code>repeated uint32 doneOnaddedActionList = 5;</code>
       * @param values The doneOnaddedActionList to add.
       * @return This builder for chaining.
       */
      public Builder addAllDoneOnaddedActionList(
          java.lang.Iterable<? extends java.lang.Integer> values) {
        ensureDoneOnaddedActionListIsMutable();
        com.google.protobuf.AbstractMessageLite.Builder.addAll(
            values, doneOnaddedActionList_);
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearDoneOnaddedActionList() {
        doneOnaddedActionList_ = emptyIntList();
        bitField0_ = (bitField0_ & ~0x00000001);
        onChanged();
        return this;
      ...
      /**
       * <code>bool isOnaddedActionAllow = 6;</code>
       * @param value The isOnaddedActionAllow to set.
       * @return This builder for chaining.
       */
      public Builder setIsOnaddedActionAllow(boolean value) {
        
        isOnaddedActionAllow_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearIsOnaddedActionAllow() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ierId\030\004 \001(\r\022\035\n\025doneOnaddedActionList\030\005 \003" +
    ...
    internal_static_ServerBuff_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_ServerBuff_descriptor,
        new java.lang.String[] { "ServerBuffUid", "ServerBuffId", "ServerBuffType", "InstancedModifierId", "DoneOnaddedActionList", "IsOnaddedActionAllow", });
  }
