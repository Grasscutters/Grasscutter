...
public final class ChangeAvatarRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    private long currGuid_;
    /**
     * <code>uint64 currGuid = 2;</code>
     * @return The currGuid.
     */
    @java.lang.Override
    public long getCurrGuid() {
      return currGuid_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (currGuid_ != 0L) {
        output.writeUInt64(2, currGuid_);
      }
      if (skillId_ != 0) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getCurrGuid()
          != other.getCurrGuid()) return false;
      if (getSkillId()
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + CURRGUID_FIELD_NUMBER;
    ...
    public static final class Builder extends
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.ChangeAvatarRspOuterClass.ChangeAvatarRsp other) {
        ...
        if (other.getCurrGuid() != 0L) {
          setCurrGuid(other.getCurrGuid());
        }
      ...
      /**
       * <code>uint64 currGuid = 2;</code>
       * @param value The currGuid to set.
       * @return This builder for chaining.
       */
      public Builder setCurrGuid(long value) {
  ...
  static {
    ...
    internal_static_ChangeAvatarRsp_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_ChangeAvatarRsp_descriptor,
        new java.lang.String[] { "Retcode", "CurrGuid", "SkillId", });
  }
