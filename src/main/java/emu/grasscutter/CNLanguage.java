...
public final class CNLanguage {
    ...
    // Clear
    public String Clear_weapons = "已为 {name} 清理武器 。";
    public String Clear_artifacts = "已为 {name} 清理圣遗物 。";
    public String Clear_materials = "已为 {name} 清理材料。";
    public String Clear_furniture = "已为 {name} 清理摆设。";
    public String Clear_displays = "Cleared displays for {name} 。";
    public String Clear_virtuals = "已为 {name} 清理货币。";
    public String Clear_everything = "已为 {name} 清理所有物品。";
    ...
    public String GiveArtifact_given = "已给 {itemId} 到 {target}。";
    ...
    // List
    public String List_message = "这里有 {size} 个玩家在线:";
    ...
    public String SendMail_send = "已添加 {amount} 个 {item} (等级为 {lvl}) 到邮件。\n继续添加更多物品 或 使用 `/sendmail finish` 来发送邮件。";
    ...
    public String Talent_normal_attack_id = "普攻 ID为 {id}。";
    public String Talent_e_skill_id = "E 技能ID为 {id}。";
    public String Talent_q_skill_id = "Q 技能ID为 {id}。";
    ...
    public String Weather_message = "改变天气为 {weatherId} 气候为 {climateId}";
