...
public final class MarkMapReqOuterClass {
    ...
    public interface MarkMapReqOrBuilder
            extends
     ...
     */
    public static final class MarkMapReq extends com.google.protobuf.GeneratedMessageV3
            implements
            ...
            try {
                ...
                while (!done) {
                    ...
                    switch (tag) {
                        ...
                        case 90:
                            {
                                emu.grasscutter.net.proto.MapMarkPointOuterClass.MapMarkPoint.Builder subBuilder =
                                        null;
                                if (mark_ != null) {
        ...
        protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
            ...
            return emu.grasscutter.net.proto.MarkMapReqOuterClass
                    .internal_static_MarkMapReq_fieldAccessorTable
                    .ensureFieldAccessorsInitialized(
                            emu.grasscutter.net.proto.MarkMapReqOuterClass.MarkMapReq.class,
                            emu.grasscutter.net.proto.MarkMapReqOuterClass.MarkMapReq.Builder.class);
        }
        ...
        public enum Operation implements com.google.protobuf.ProtocolMessageEnum {
            ...
            public static final com.google.protobuf.Descriptors.EnumDescriptor getDescriptor() {
                return emu.grasscutter.net.proto.MarkMapReqOuterClass.MarkMapReq.getDescriptor()
                        .getEnumTypes()
                        .get(0);
            }
        ...
        public emu.grasscutter.net.proto.MarkMapReqOuterClass.MarkMapReq.Operation getOp() {
            ...
            emu.grasscutter.net.proto.MarkMapReqOuterClass.MarkMapReq.Operation result =
                    emu.grasscutter.net.proto.MarkMapReqOuterClass.MarkMapReq.Operation.valueOf(op_);
            return result == null
                    ? emu.grasscutter.net.proto.MarkMapReqOuterClass.MarkMapReq.Operation.UNRECOGNIZED
                    : result;
        }
        ...
        public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
            if (op_
                    != emu.grasscutter.net.proto.MarkMapReqOuterClass.MarkMapReq.Operation.OPERATION_ADD
                            .getNumber()) {
        ...
        public int getSerializedSize() {
            ...
            if (op_
                    != emu.grasscutter.net.proto.MarkMapReqOuterClass.MarkMapReq.Operation.OPERATION_ADD
                            .getNumber()) {
                size += com.google.protobuf.CodedOutputStream.computeEnumSize(7, op_);
            }
            if (mark_ != null) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(11, getMark());
            }
            if (old_ != null) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(15, getOld());
            }
        ...
        public boolean equals(final java.lang.Object obj) {
            ...
            emu.grasscutter.net.proto.MarkMapReqOuterClass.MarkMapReq other =
                    (emu.grasscutter.net.proto.MarkMapReqOuterClass.MarkMapReq) obj;

            if (hasOld() != other.hasOld()) return false;
            if (hasOld()) {
                if (!getOld().equals(other.getOld())) return false;
            }
            if (hasMark() != other.hasMark()) return false;
            if (hasMark()) {
                if (!getMark().equals(other.getMark())) return false;
            }
        ...
        public static Builder newBuilder(
                emu.grasscutter.net.proto.MarkMapReqOuterClass.MarkMapReq prototype) {
        ...
        public static final class Builder
            ...
            public emu.grasscutter.net.proto.MarkMapReqOuterClass.MarkMapReq buildPartial() {
                emu.grasscutter.net.proto.MarkMapReqOuterClass.MarkMapReq result =
                        new emu.grasscutter.net.proto.MarkMapReqOuterClass.MarkMapReq(this);
                if (oldBuilder_ == null) {
                    result.old_ = old_;
                } else {
            ...
            public Builder mergeFrom(emu.grasscutter.net.proto.MarkMapReqOuterClass.MarkMapReq other) {
                if (other == emu.grasscutter.net.proto.MarkMapReqOuterClass.MarkMapReq.getDefaultInstance())
                    return this;
                if (other.hasOld()) {
            ...
            public Builder mergeFrom(
                ...
                try {
                    ...
                    parsedMessage =
                            (emu.grasscutter.net.proto.MarkMapReqOuterClass.MarkMapReq) e.getUnfinishedMessage();
            ...
            public Builder mergeOld(emu.grasscutter.net.proto.MapMarkPointOuterClass.MapMarkPoint value) {
                if (oldBuilder_ == null) {
                    if (old_ != null) {
                        old_ =
                                emu.grasscutter.net.proto.MapMarkPointOuterClass.MapMarkPoint.newBuilder(old_)
                                        .mergeFrom(value)
                                        .buildPartial();
                    } else {
                        old_ = value;
                ...
                if (oldBuilder_ == null) {
                    oldBuilder_ =
                            new com.google.protobuf.SingleFieldBuilderV3<
                                    ...
                                    emu.grasscutter.net.proto.MapMarkPointOuterClass.MapMarkPoint.Builder,
                                    emu.grasscutter.net.proto.MapMarkPointOuterClass.MapMarkPointOrBuilder>(
                                    getOld(), getParentForChildren(), isClean());
                    old_ = null;
                }
                return oldBuilder_;
            }
            ...
            /** <code>.MapMarkPoint mark = 11;</code> */
            public Builder mergeMark(
                    emu.grasscutter.net.proto.MapMarkPointOuterClass.MapMarkPoint value) {
                if (markBuilder_ == null) {
                    if (mark_ != null) {
                        mark_ =
                                emu.grasscutter.net.proto.MapMarkPointOuterClass.MapMarkPoint.newBuilder(mark_)
                                        .mergeFrom(value)
                                        .buildPartial();
                    } else {
                        mark_ = value;
                ...
                if (markBuilder_ == null) {
                    markBuilder_ =
                            new com.google.protobuf.SingleFieldBuilderV3<
                                    ...
                                    emu.grasscutter.net.proto.MapMarkPointOuterClass.MapMarkPoint.Builder,
                                    emu.grasscutter.net.proto.MapMarkPointOuterClass.MapMarkPointOrBuilder>(
                                    getMark(), getParentForChildren(), isClean());
                    mark_ = null;
                }
                return markBuilder_;
            }
            ...
            public Builder setOp(
                    emu.grasscutter.net.proto.MarkMapReqOuterClass.MarkMapReq.Operation value) {
                if (value == null) {
                    throw new NullPointerException();
                }
        ...
        private static final com.google.protobuf.Parser<MarkMapReq> PARSER =
                new com.google.protobuf.AbstractParser<MarkMapReq>() {
                    @java.lang.Override
    ...
    static {
        java.lang.String[] descriptorData = {
            "\n\020MarkMapReq.proto\032\022MapMarkPoint.proto\"\301"
                    + "\001\n\nMarkMapReq\022\032\n\003old\030\017 \001(\0132\r.MapMarkPoin"
