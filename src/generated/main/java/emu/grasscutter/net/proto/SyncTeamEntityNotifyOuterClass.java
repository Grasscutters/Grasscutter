...
public final class SyncTeamEntityNotifyOuterClass {
    ...
    public interface SyncTeamEntityNotifyOrBuilder
            extends
        ...
        /** <code>repeated .TeamEntityInfo team_entity_info_list = 2;</code> */
        emu.grasscutter.net.proto.TeamEntityInfoOuterClass.TeamEntityInfo getTeamEntityInfoList(
                int index);
        /** <code>repeated .TeamEntityInfo team_entity_info_list = 2;</code> */
        int getTeamEntityInfoListCount();
        /** <code>repeated .TeamEntityInfo team_entity_info_list = 2;</code> */
        java.util.List<
                        ? extends emu.grasscutter.net.proto.TeamEntityInfoOuterClass.TeamEntityInfoOrBuilder>
     ...
     */
    public static final class SyncTeamEntityNotify extends com.google.protobuf.GeneratedMessageV3
            implements
        ...
        public static final com.google.protobuf.Descriptors.Descriptor getDescriptor() {
            return emu.grasscutter.net.proto.SyncTeamEntityNotifyOuterClass
        ...
        protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
            ...
            return emu.grasscutter.net.proto.SyncTeamEntityNotifyOuterClass
                    ...
                    .ensureFieldAccessorsInitialized(
                            emu.grasscutter.net.proto.SyncTeamEntityNotifyOuterClass.SyncTeamEntityNotify.class,
                            emu.grasscutter.net.proto.SyncTeamEntityNotifyOuterClass.SyncTeamEntityNotify.Builder
                                    .class);
        }

        public static final int TEAM_ENTITY_INFO_LIST_FIELD_NUMBER = 2;
        private java.util.List<emu.grasscutter.net.proto.TeamEntityInfoOuterClass.TeamEntityInfo>
                teamEntityInfoList_;
        /** <code>repeated .TeamEntityInfo team_entity_info_list = 2;</code> */
        @java.lang.Override
        public java.util.List<emu.grasscutter.net.proto.TeamEntityInfoOuterClass.TeamEntityInfo>
                getTeamEntityInfoListList() {
        ...
        /** <code>repeated .TeamEntityInfo team_entity_info_list = 2;</code> */
        @java.lang.Override
        public emu.grasscutter.net.proto.TeamEntityInfoOuterClass.TeamEntityInfo getTeamEntityInfoList(
                int index) {
            return teamEntityInfoList_.get(index);
        }
        /** <code>repeated .TeamEntityInfo team_entity_info_list = 2;</code> */
        @java.lang.Override
        public emu.grasscutter.net.proto.TeamEntityInfoOuterClass.TeamEntityInfoOrBuilder
                getTeamEntityInfoListOrBuilder(int index) {
            return teamEntityInfoList_.get(index);
        }
        ...
        public int getSerializedSize() {
            ...
            for (int i = 0; i < teamEntityInfoList_.size(); i++) {
                size +=
                        com.google.protobuf.CodedOutputStream.computeMessageSize(2, teamEntityInfoList_.get(i));
            }
            if (sceneId_ != 0) {
        ...
        public boolean equals(final java.lang.Object obj) {
            ...
            emu.grasscutter.net.proto.SyncTeamEntityNotifyOuterClass.SyncTeamEntityNotify other =
                    (emu.grasscutter.net.proto.SyncTeamEntityNotifyOuterClass.SyncTeamEntityNotify) obj;

            if (!getTeamEntityInfoListList().equals(other.getTeamEntityInfoListList())) return false;
        ...
        public static emu.grasscutter.net.proto.SyncTeamEntityNotifyOuterClass.SyncTeamEntityNotify
        ...
        public static Builder newBuilder(
                emu.grasscutter.net.proto.SyncTeamEntityNotifyOuterClass.SyncTeamEntityNotify prototype) {
        ...
        public static final class Builder
            ...
            // Construct using
            // emu.grasscutter.net.proto.SyncTeamEntityNotifyOuterClass.SyncTeamEntityNotify.newBuilder()
            private Builder() {
            ...
            @java.lang.Override
            public emu.grasscutter.net.proto.SyncTeamEntityNotifyOuterClass.SyncTeamEntityNotify
                    getDefaultInstanceForType() {
                return emu.grasscutter.net.proto.SyncTeamEntityNotifyOuterClass.SyncTeamEntityNotify
                        .getDefaultInstance();
            }

            @java.lang.Override
            public emu.grasscutter.net.proto.SyncTeamEntityNotifyOuterClass.SyncTeamEntityNotify build() {
                emu.grasscutter.net.proto.SyncTeamEntityNotifyOuterClass.SyncTeamEntityNotify result =
                        buildPartial();
            ...
            public emu.grasscutter.net.proto.SyncTeamEntityNotifyOuterClass.SyncTeamEntityNotify
                    buildPartial() {
                emu.grasscutter.net.proto.SyncTeamEntityNotifyOuterClass.SyncTeamEntityNotify result =
                        new emu.grasscutter.net.proto.SyncTeamEntityNotifyOuterClass.SyncTeamEntityNotify(this);
            ...
            private com.google.protobuf.RepeatedFieldBuilderV3<
                            emu.grasscutter.net.proto.TeamEntityInfoOuterClass.TeamEntityInfo,
                            emu.grasscutter.net.proto.TeamEntityInfoOuterClass.TeamEntityInfo.Builder,
                            emu.grasscutter.net.proto.TeamEntityInfoOuterClass.TeamEntityInfoOrBuilder>
                    teamEntityInfoListBuilder_;
            ...
            public emu.grasscutter.net.proto.TeamEntityInfoOuterClass.TeamEntityInfo
                    getTeamEntityInfoList(int index) {
                if (teamEntityInfoListBuilder_ == null) {
                    return teamEntityInfoList_.get(index);
                } else {
            ...
            public Builder addTeamEntityInfoList(
                    emu.grasscutter.net.proto.TeamEntityInfoOuterClass.TeamEntityInfo value) {
                if (teamEntityInfoListBuilder_ == null) {
                    if (value == null) {
                        throw new NullPointerException();
                    }
            ...
            public Builder addAllTeamEntityInfoList(
                    java.lang.Iterable<
                                    ? extends emu.grasscutter.net.proto.TeamEntityInfoOuterClass.TeamEntityInfo>
                            values) {
                if (teamEntityInfoListBuilder_ == null) {
                    ensureTeamEntityInfoListIsMutable();
                    com.google.protobuf.AbstractMessageLite.Builder.addAll(values, teamEntityInfoList_);
                    onChanged();
                } else {
            ...
            /** <code>repeated .TeamEntityInfo team_entity_info_list = 2;</code> */
            public emu.grasscutter.net.proto.TeamEntityInfoOuterClass.TeamEntityInfo.Builder
                    getTeamEntityInfoListBuilder(int index) {
            ...
            /** <code>repeated .TeamEntityInfo team_entity_info_list = 2;</code> */
            public emu.grasscutter.net.proto.TeamEntityInfoOuterClass.TeamEntityInfo.Builder
                    addTeamEntityInfoListBuilder() {
                return getTeamEntityInfoListFieldBuilder()
                        .addBuilder(
                                emu.grasscutter.net.proto.TeamEntityInfoOuterClass.TeamEntityInfo
                                        .getDefaultInstance());
            }
            /** <code>repeated .TeamEntityInfo team_entity_info_list = 2;</code> */
            public emu.grasscutter.net.proto.TeamEntityInfoOuterClass.TeamEntityInfo.Builder
                    addTeamEntityInfoListBuilder(int index) {
                return getTeamEntityInfoListFieldBuilder()
                        .addBuilder(
                                index,
                                emu.grasscutter.net.proto.TeamEntityInfoOuterClass.TeamEntityInfo
        ...
        private static final emu.grasscutter.net.proto.SyncTeamEntityNotifyOuterClass
                        .SyncTeamEntityNotify
                DEFAULT_INSTANCE;

        static {
            DEFAULT_INSTANCE =
                    new emu.grasscutter.net.proto.SyncTeamEntityNotifyOuterClass.SyncTeamEntityNotify();
        }
        ...
        private static final com.google.protobuf.Parser<SyncTeamEntityNotify> PARSER =
                new com.google.protobuf.AbstractParser<SyncTeamEntityNotify>() {
                    @java.lang.Override
