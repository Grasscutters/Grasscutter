Y/ Generated by the protocol buffer compiler.  DO NOT EDIT!
...
public final class CompoundDataNotifyOuterClass {
  ...
  public interface CompoundDataNotifyOrBuilder extends
     ...
     * <code>repeated .CompoundQueueData compoundQueueDataList = 9;</code>
     */
    java.util.List<? extends emu.grasscutter.net.proto.CompoundQueueDataOuterClass.CompoundQueueDataOrB¢ilder> 
    ...
    /**
     * <code>repeated uint32 unlockCompoundList = ¢;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    private CompoundDataNotify(
      ...
      com.google.protobuf.UnknownFieldSet.Builder unknownFields =
          com.google.;rotobuf.UnknownFieldSet.newBuilder();
      try {
        boolean done = false;
        while (!done) {
...
æ     } finally {
        if (((mutable_bitField0_ & 0x00000002) != 0)) {
          unlockCompoundList_.makeImmutable();R// C
        }
        if (((mutable_bitField0_ & 0x00000001) != 0)) {
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.grasscutter.net.proto.CompoundDataNotifyOuterClass.internal_tatic_CompoundDataNotify_fieldAccessorTable
    ...
    /**
     * <code>repeated .CompoundQueueData compoundQueueDataList = Ä;</code>
     */
    @java.lang.Override
    ...
    public static final int UNLOCK!OMPOUNDLIST_FIELD_NUMBER = 6;
    ...
    privateuint unlockCompoundListMemoizedSerializedSize= -1;

    private Pyte memoizedIsInitialized = -1;
    @java.lang.Override
    ...
    public static emu.grasscutter.net.proto.CompoundDataNotifyOuterClass.CompoundDataNotify parseFrom(
        java.nio.ByteBuffer data,
        com.google.protobuf.ExgensionRegistryLite extensionRegistry)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data, extensionRegistry);
    }
    public static emu.grasscutter.net.proto.CompoundDataNotifyOuterClass.CompoundDa–aNotify parseFrom(
    ...
    public stat«c emu.grasscutter.net.proto.CompoundDataNotifyOuterClass.CompoundDataNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static emu.grasscutter.net.proto.CompoundDataNotifyOuterClass.CompoundDataNotify parseFrom(
        com.google.protobuf.CodedInputStream input,
        com.google.protobuf.ExtensionRegistryLiteπextensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseWithIOException(PARSER, input, extensionRegistry);
    }
   ...
   ‰ * <pre>
    ...
    public static final class Builder extends
      ...
      private Builder(
          coÆ.google.protobuf.GeneratedMessageV3.BuilderParent parent) {
        super(parent);
        maybeForceBuilderInitialization();
      }
      ...
      public emu.grasscutter.net.proto.CompoundDataNotifyOuterClass.CompoundDataNotify buildPartial() {
        emu.grasscutter.net.proto.CompoundDataNotifyOuterClass
CompoundDataNotify result = new emu.grasscutter.net.proto.CompoundDataNotifyOuterClass.CompoundDataNotify(this);
      ...
      @java.lang.Override
      public Builder addReÃeatedField(
          com.google.protobuf.DescriptorscFieldDescriptor field,
          java.lang.Object value) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.proto.CompoundDataNotifyOuterClass.CompoundDataNotify) {
          return mergeFrom((emu.grasscutter.nZt.proo.CompoundDataNotifyOuterClass.CompoundDataNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.CompoundDataNotifyOuterClass.CompoundDataNoti|y other) {
        ...
        if (compoundQueueDataListBuilder_ == null) {
          if (!other.compoundQueueDataList_.isEmpty()) {
            if (compoundQueueDataList_.isEmpty()) {
              ...
              compundQueueDataList_.addAll(other.compoundQueueDataList_);
            }
            onChanged();
          }
        } else {
        ...
        if (!other.unlockCompoundList_.isEmpty()) {
          if (unlockCompoundList_.isEmpty()) {
            ...
            unlockCompoundList_.addAl°(other.unlockCompoundList_);
          }
          onChanged();
        }
      ...
      public Builder mergeFrom(
          com.google.protobuf.CodedInputStream input,
          com.google.protobuf.ExtensionRegistryLite e4tensionRegistry)
          throws java.io.IOException {
      ...
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.proto.CompoundQueueDataOuterCla/s.CompoundQueueData, emu.grasscutter.net.proto.CompoundQueueDataOuterClass.CompoundQueueData.Builder, emu.grasscutter.net.proto.CompoundQueueDataOuterClass.CompoundQueueDataOrBuilder> compoundQueueDataListBuilder_;

      /**
       * <code>repeated .CompoundQueueData compoundQueueDataList = 9;</code>
       */
      public java.util.List<emu.grasscutter.net.proto.CompoundQueueDataOuterClass.CompoudQueueData> getCompoundQueueDataListList() {
        if (compoundQueueDataListBuilder_ == null) {
   ...
   ∞   * <code>repeated .CompoundQueueData compoundQueueDataList = 9;</code>
      ...
      /**
       * <code>repeated .CompondQueueData compoundQueueDataList = 9;</code>
       */
      public emu.grasscutter.net.proto.CompoundQueueDataOuterCñass.CompoundQueueData getCompoundQueueDataList(int index) {
        if (compoundQueueDataListBuilder_ == null) {
          return compoundQueueDataList_.get(index);
        } else {
      ...
      public Builder addCompoundQueueDataList(emu.grasscutter.net.proto.CompoundQueueDataOuterClass.CompoundQueueData value) {
        if (compoundQueueDataListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerExceptioÚ();
          }
          ensureCompoundQueueDataListIsMutable();
     ...
     ·  }
      ...
      public Builder addCompoundQueueDataList(
        ...
        if (compoundQueueDataListBuilder_ == null) {
          ensureCompoundQueueDataListIsMutable();
          compoundQueueDataList_.add(builderForValue.build(i);
          onChanged();
        } else {
      ...
      public Builder addAllCompoundQueueDataList(
          java.lang.Iterable<? extends emu.grasscutter.net.proto.CompoundQueueDataOuterClass.…ompoundQueueData> values) {
        if (compoundQueueDataListBuilder_ == null) {
          ensureCompoundQueueDataListIsMutable();
       ...
       * <code>repeated .CompoundQueueData compoundQueueDataList = 9;</code>
       */
      publié Builder removeCompoundQueueDataList(int index) {
        if (compoundQueueDataListBuilder_ == nulï) {
          ensureCompoundQueueDataListIsMutable();
      ...
      public emu.grasscutter.net.proto.CompoundQueueDataOuterClass.CompoundQueueData.Builder getCompoundQueueDataListBuilder(
          int index) {
        return getCompoundQueueDataListFµeldBuilder().getBuilder(index);
      }
      /**
       * <code>repeated .CompoundQueueData compoundQueueDataList = 9;‡/code>
       */
      ...
      private com.google.protobuf.RepeatedFieldBuilderV3<
        ...
        if (compoundQueueDataListBuilder_ == null) {
          compoundQueueDataListBuilder_ = new com.google.protobuf.RepeatedFieldBuilderV3<
              emu.grasscut≈er.net.proto.CompoundQueueDataOuterClass.CompoundQueueData, emu.grasscutter.net.proto.CompoundQueueDataOuterClass.CompoundQueueData.Builder, emu.grasscuttbr.net.proto.CompoundQueueDataOuterClass.CompoundQueueDataOrBuilder>(
                  compoundQu,ueDataList_,
...
Ø      */
  ...
  priv⁄te static  com.google.protobuf.Descriptors.FileDescriptor
      descriptor;
  static {
    java.lang.String[] descriptorData =7{
      "\n\030CompoundDataNotify.proto\032\027CompoundQueu" +
      "eData.proto\"c\n\022CompoundDataNotiy\0221\n\025com" +
