...
public final class PlayerEnterSceneNotifyOuterClass {
    ...
    public interface PlayerEnterSceneNotifyOrBuilder
        ...
        /**
         * <code>uint32 enter_reason = 482;</code>
         *
        ...
        /**
         * <code>string scene_transaction = 1931;</code>
         *
        ...
        /**
         * <code>uint32 world_type = 952;</code>
         *
        ...
        /**
         * <code>bool is_skip_ui = 1748;</code>
         *
         * @return The isSkipUi.
         */
        boolean getIsSkipUi();
        ...
        /**
         * <code>bool is_first_login_enter_scene = 6;</code>
         *
        ...
        /**
         * <code>uint32 prev_scene_id = 3;</code>
         *
    ...
    public static final class PlayerEnterSceneNotify extends com.google.protobuf.GeneratedMessageV3
        ...
        public static final int ENTER_REASON_FIELD_NUMBER = 482;
        ...
        public static final int SCENE_TRANSACTION_FIELD_NUMBER = 1931;
        ...
        public static final int PREV_POS_FIELD_NUMBER = 14;
        ...
        public static final int WORLD_TYPE_FIELD_NUMBER = 952;
        ...
        public static final int IS_SKIP_UI_FIELD_NUMBER = 1748;
        ...
        public static final int IS_FIRST_LOGIN_ENTER_SCENE_FIELD_NUMBER = 6;
        ...
        public static final int PREV_SCENE_ID_FIELD_NUMBER = 3;
        ...
        public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
            ...
            if (prevSceneId_ != 0) {
                output.writeUInt32(3, prevSceneId_);
            }
            if (targetUid_ != 0) {
                output.writeUInt32(4, targetUid_);
            }
            if (isFirstLoginEnterScene_ != false) {
                output.writeBool(6, isFirstLoginEnterScene_);
            }
            ...
            if (prevPos_ != null) {
                output.writeMessage(14, getPrevPos());
            }
            if (enterReason_ != 0) {
                output.writeUInt32(482, enterReason_);
            }
            if (worldType_ != 0) {
                output.writeUInt32(952, worldType_);
            }
            if (isSkipUi_ != false) {
                output.writeBool(1748, isSkipUi_);
            }
            if (!com.google.protobuf.GeneratedMessageV3.isStringEmpty(sceneTransaction_)) {
                com.google.protobuf.GeneratedMessageV3.writeString(output, 1931, sceneTransaction_);
            }
        ...
        public int getSerializedSize() {
            ...
            if (prevSceneId_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(3, prevSceneId_);
            }
            if (targetUid_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(4, targetUid_);
            }
            if (isFirstLoginEnterScene_ != false) {
                size += com.google.protobuf.CodedOutputStream.computeBoolSize(6, isFirstLoginEnterScene_);
            }
            if (sceneBeginTime_ != 0L) {
            ...
            if (pos_ != null) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(10, getPos());
            }
            if (worldLevel_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(11, worldLevel_);
            }
            {
                int dataSize = 0;
                for (int i = 0; i < sceneTagIdList_.size(); i++) {
            ...
            if (prevPos_ != null) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(14, getPrevPos());
            }
            if (enterReason_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(482, enterReason_);
            }
            if (worldType_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(952, worldType_);
            }
            if (isSkipUi_ != false) {
                size += com.google.protobuf.CodedOutputStream.computeBoolSize(1748, isSkipUi_);
            }
            if (!com.google.protobuf.GeneratedMessageV3.isStringEmpty(sceneTransaction_)) {
                size += com.google.protobuf.GeneratedMessageV3.computeStringSize(1931, sceneTransaction_);
            }
