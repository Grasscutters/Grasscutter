          ...
          switch (tag) {
            ...
            case 42: {
              ...
              if (challengeDetailCase_ == 5) {
                subBuilder = ((emu.grasscutter.net.proto.ScoreChallengeInfoOuterClass.ScoreChallengeInfo) challengeDetail_).toBuilder();
              }
              challengeDetail_ =
                  input.readMessage(emu.grasscutter.net.proto.ScoreChallengeInfoOuterClass.ScoreChallengeInfo.parser(), extensionRegistry);
              if (subBuilder != null) {
                subBuilder.mergeFrom((emu.grasscutter.net.proto.ScoreChallengeInfoOuterClass.ScoreChallengeInfo) challengeDetail_);
            ...
            case 66: {
              ...
              if (challengeDetailCase_ == 8) {
                subBuilder = ((emu.grasscutter.net.proto.BundleInfoOuterClass.BundleInfo) challengeDetail_).toBuilder();
              }
              challengeDetail_ =
                  input.readMessage(emu.grasscutter.net.proto.BundleInfoOuterClass.BundleInfo.parser(), extensionRegistry);
              if (subBuilder != null) {
                subBuilder.mergeFrom((emu.grasscutter.net.proto.BundleInfoOuterClass.BundleInfo) challengeDetail_);
                challengeDetail_ = subBuilder.buildPartial();
              }
