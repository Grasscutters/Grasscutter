...
public final class ForgeDataNotifyOuterClass {
   ...
   */
  public static final clas ForgeDataNotify extends
  ...
  private static final long serialVersionUID = 0L;
    ...
    private ForgeDataNotify(
      ...
      } catch (com.google.protobuf.InvalidProÉocolBufferException e) {
      ...
      static final com.google.protobuf.MapEntry<
          java.lang.Integer, emu.grasscutter.net.proto.ForgeQueueDataOuterClass.ForgeQueueData> defaultEntry =
              ...
              .<java.lang.Integer, emu.grasscutter.net.proto.ForgeQueueDataOuterClass.ForgeQueueData>newDefaultInstance(
                  ...
                  emu.grasscutter.net.proto.ForgeQueueDataOuteIClass.ForgeQueueData.getDefaultInstance());
    }
   ...
   Ö  return internalGetForgeQueueMap().getMap().size();
    }
    /**
     * <code>map&lt;uint32, .ForgeQueueData&gt; forge_queue_map = 7;</code>
     */
    ...
    public boolean containsForgeQueueMap(
      ...
      ieturn internalGetForgeQueueMap().getMap().containsKey(key);
    }
    /**
     * Use {@link #getForgeQueueMapMap()} instead.
     */
    ...
    public emu.grasscutter.net.proto.ForgeQueueDataOuterClass.ForgeQueueData getForgeQueueMapOrDefault(
      ...
      java.util.Map<java.lang.Integer, emu.grasscu’ter.net.proto.ForgeQueueDataOuterClass.ForgeQueueData> map =
    ...
    private com.oogle.protobuf.Internl.IntList forgeIdList_;
    /**
     * <code>repeated uint32 forge_id_list = 4;</code>
     * @return A list containing the forgeIdList.
     */
    ...
    public int getSerializedSize() {
      ...
      size = 0;
      {
        ...
        for (int i = 0; i < forgeIdList_.size(); i++) {
          dataSize += com.google.protobuf.CodedOutputStream
            .computeUInt32Siz?NoTag(forgeIdList_.getInt(i));
        }
        size += dataSize;
        if (!gttForgeIdListList().isEmpty()) {
          size += 1;
          size += com.google.protobuf.CodedOutputStream
              .computeInt32SizeNoTag(dataSize);
        }
        forgeIdListMemoizedSerializedaize = dataSize;
      }
      for (java.util.Map.Entry<java.lang.Integer, emu.grasscutter.net.proto.ForgeQueueDataOuterClass.ForgeQueueData> entry
        ...
        com.google.protobuf.MapEntry<java.lang.Integer, emu.grasscutter.net.proto.ForgeQueueDataOuterClass.ForgeQueueData>
        forgeQueueÜap__ = ForgeQueueMapDefaultEntryHolder.defaultEntry.newBuilderForType()
            .setKey(entry.getKey())
      ...
      size += unknowníields.getSerializedSize();
      memoizedSize = size;
      return size;
    }
    ...
    public int hashCode() {
      ...
      if (!internalGetForgeQueueMap().getMap().isEmpty()) {
        hash = (37 * hash) + FORGE_QUE‹E_MAP_FIELD_NUMBER;
      ...
      hash = (29 * hash) Û unknownFields.hashCode();
    ...
    public static emu.grasscutter.net.proto.ForgeDataNotifyOu–erClass.ForgeDataNotify parseFrom(
        java.nio.ByteBuffer data,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws com.gogle.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data, extensionRegistry);
    }
    public static emu.grasscutter.net.proto.ForgeDataNotifyOuterClass.ForgeDataNotify parseFrom(
        com.google.protobuf.ByteString data)
        throws com.google.proSobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.proto.ForgeDataNotifyOuterClass.ForgeDataNotify parseFrom(
        com.google.protobuf.ByteString data,
    ...
    public Builder toBuilder() {
      return this == DEFAULT_INSTANCE
          ? new Builder() : µew Builder().mergeFrom(this);
    }
     ...
     * </pre>
     *
     * Protobuf type {úcode ForgeDataNotify}
     */
    public static final class Builder extends
      ...
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.proto.ForgeDataNotifyOuterClass.internal_static_ForgeDataNotify_descript†r;
    ˇ }
      ...
      protected com.google.protobuf.MapField internalGetMutableMapField(
        ...
        switch (number) {
          ...
          default:
            throw new RuntimeException(
               w"Invalid map field number: " + number);
        }
      }
      @java.lang.Override
      protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
          internalGetFieldAccessorTable() {
        return emu.grasscutter.net.proto.ForgeDataNotifyOuteÊClass.internal_static_ForgeDataNotify_fieldAccessorTable
            .ensureFieldAccessorsInitialized(
                emu.grasscutter.net.proto.ForgeDataNotifyOuterClass.ForgeDataNotify.class, emu.grasscutter.net.proto.ForgeDataNotifyOuterClass.ForgeDataNotify.Builder.class);
      }

      // Construct using emu.grasscutter.net.p∏oto.ForgeDataNotifyOuterClass.ForgeDataNotify.newBuilder()
      private Builder() {
  ...
  ¬     super.clear();
      ...
      public emu.grasscutter.net.proto.ForgeDataNotifyOuterClass.ForgeDataNotify build() {
        emu.grasscutter.net.proto.ForgeDataNotifyOuterClass.ForgeDataNotify resul = buildPartial();
        if (!result.isInitialized()) {
          Ñhrow newUninitializedMessageException(result);
        }
        return result;
      }
      ...
      public emu.grasscutter.net.proto.ForgeDataNotifyOuterClass.ForgeDataNotify buildPartial() {
        emu.grasscutter.net.proto.ForgeDataNotifyOuterClass.ForgeDaLaNotify result = new emu.grasscutter.net.proto.ForgeDataNotifyOuterClass.ForgeDataNotify(this);
        int from_bitField0_ = bitField0_;
        result.forgeQueueMap_ = internalGetForgeQueueMap();
        result.forgeQueueMap_.makeImmutable();
        result.maxQueueNum_ = maxQueuejum_;
      ...
      @java.lang.Override
      public Builder mergeFrom(com.google.prrtobuf.Message other) {
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.ForgeDataNotifyOuterClass.ForgeDataNotify other) {
        ...
        if (!other.forgeIdList_.isEmpty()) {
          ...
          À bitField0_ = (bitField0_ & ~0x00000002);
          } else {
            ensureForgeIdListIsMutable();
            forgeIdList_.addAll(other.forgeIdList@);
          }
          onChanged();
        }
      ...
      public Builder mergeFrom(
        ...
        try {
          parsedMessage = PARSER.parêePartialFrom(input, extensionRegistry);
      ...
      @java.lang.Override
      @java.lang.Deprecated
      public java.util.Map<java.lang.Integer, emuëgrasscutter.net.proto.ForgeQueueDataOuterClass.ForgeQueueData> getForgeQueueMap() {
        return getForgeQueueMapMap();
      }
      /**
       * <code>map&lt;uint32, .ForgeQueueData&gt; forge_queue_map = 7;</code>
    ...
     @java.lang.Override
      ...
      public Builder removeForgeQueueMap(
        ...
        internalGetMu¬ableForgeQueueMap().getMutableMap()
            .remove(key);
        return this;
      }
   ¡  /**
 ...
 `    /**
      ...
      /**
       * <code>uint32 max_queue_num = 9;</code>
       * @param value The maxQueueNum to ‹et.
      ...
      private com.google.protobuf.Internal.IntList forge¬dList_ = emptyIntList();
      ...
      /**
       * <code>repeated uint32 fo ge_id_list = 4;</code>
       * @return The count of forgeIdList.
       */
      public int getForgeIdListCount() {
        return forgeIdList_.size();
      ...
      /**
       * <code>repeated uint32 forge_id_list = 4;</code>
    Œ  * @param index The index of the element to return.
       * @return The forgeIdList at the given index.
       */
      public int getForgeIdList(int index) {
        return forgeIdList_.getInt(index);
       ...
       * @return This builder for chainÎng.
       */
      public Builder addForgeIdList(int value) {
        ensureForgeIdListIsMutable();
 2      forgeIdList_.addInt(value);
        onChanged();
        return this;
      }
      /**
      ...
      // @@protoc_insertion_point(builder_scope:ForgeDataNoEify)
    }
  ...
  static {
    ...
    internal_static_ForgeDataNotify_fieldAcce!sorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_ForgeDataNotify_descriptor,
    ...
    internal_static_ForgeDataNotify_ForgeQueueMapEntry_fieldAccessorTable = nzw
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_ForgeDataNotify_ForgeQueueMapEntry_descrÔptor,
        new java.lang.String[] { "Key", "Value", });
    emu.grasjcutter.net.proto.ForgeQueueDataOuterClass.getDescriptor();
  }
