...
public final class EffigyDailyInfoOuterClass {
    ...
    public interface EffigyDailyInfoOrBuilder
            extends
        ...
        /**
         * <code>uint32 EJIHDCNMFEE = 10;</code>
         *
         * @return The eJIHDCNMFEE.
         */
        int getEJIHDCNMFEE();
        ...
        /**
         * <code>bool is_first_pass_reward_taken = 3;</code>
         *
        ...
        /**
         * <code>uint32 BHJHCPLKIMJ = 5;</code>
         *
         * @return The bHJHCPLKIMJ.
         */
        int getBHJHCPLKIMJ();
    }
    /**
     ...
     */
    public static final class EffigyDailyInfo extends com.google.protobuf.GeneratedMessageV3
            implements
        ...
        public static final com.google.protobuf.Descriptors.Descriptor getDescriptor() {
            return emu.grasscutter.net.proto.EffigyDailyInfoOuterClass
        ...
        protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
            ...
            return emu.grasscutter.net.proto.EffigyDailyInfoOuterClass
                    ...
                    .ensureFieldAccessorsInitialized(
                            emu.grasscutter.net.proto.EffigyDailyInfoOuterClass.EffigyDailyInfo.class,
                            emu.grasscutter.net.proto.EffigyDailyInfoOuterClass.EffigyDailyInfo.Builder.class);
        }
        ...
        public static final int EJIHDCNMFEE_FIELD_NUMBER = 10;
        private int eJIHDCNMFEE_;
        /**
         * <code>uint32 EJIHDCNMFEE = 10;</code>
         *
         * @return The eJIHDCNMFEE.
        ...
        public static final int IS_FIRST_PASS_REWARD_TAKEN_FIELD_NUMBER = 3;
        ...
        public static final int BHJHCPLKIMJ_FIELD_NUMBER = 5;
        private int bHJHCPLKIMJ_;
        /**
         * <code>uint32 BHJHCPLKIMJ = 5;</code>
         *
         * @return The bHJHCPLKIMJ.
        ...
        public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
            ...
            if (isFirstPassRewardTaken_ != false) {
                output.writeBool(3, isFirstPassRewardTaken_);
            }
            if (dayIndex_ != 0) {
                output.writeUInt32(4, dayIndex_);
            }
            if (bHJHCPLKIMJ_ != 0) {
                output.writeUInt32(5, bHJHCPLKIMJ_);
            }
            if (challengeId_ != 0) {
                output.writeUInt32(9, challengeId_);
            }
            if (eJIHDCNMFEE_ != 0) {
                output.writeUInt32(10, eJIHDCNMFEE_);
            }
        ...
        public int getSerializedSize() {
            ...
            if (isFirstPassRewardTaken_ != false) {
                size += com.google.protobuf.CodedOutputStream.computeBoolSize(3, isFirstPassRewardTaken_);
            }
            if (dayIndex_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(4, dayIndex_);
            }
            if (bHJHCPLKIMJ_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(5, bHJHCPLKIMJ_);
            }
            if (challengeId_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(9, challengeId_);
            }
            if (eJIHDCNMFEE_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(10, eJIHDCNMFEE_);
            }
            if (challengeMaxScore_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(11, challengeMaxScore_);
            }
        ...
        public boolean equals(final java.lang.Object obj) {
            ...
            emu.grasscutter.net.proto.EffigyDailyInfoOuterClass.EffigyDailyInfo other =
                    (emu.grasscutter.net.proto.EffigyDailyInfoOuterClass.EffigyDailyInfo) obj;

            if (getChallengeMaxScore() != other.getChallengeMaxScore()) return false;
            if (getEJIHDCNMFEE() != other.getEJIHDCNMFEE()) return false;
            if (getBeginTime() != other.getBeginTime()) return false;
            if (getDayIndex() != other.getDayIndex()) return false;
            if (getIsFirstPassRewardTaken() != other.getIsFirstPassRewardTaken()) return false;
            if (getChallengeId() != other.getChallengeId()) return false;
            if (getBHJHCPLKIMJ() != other.getBHJHCPLKIMJ()) return false;
        ...
        public int hashCode() {
            ...
            hash = (37 * hash) + EJIHDCNMFEE_FIELD_NUMBER;
            hash = (53 * hash) + getEJIHDCNMFEE();
            ...
            hash = (53 * hash) + com.google.protobuf.Internal.hashBoolean(getIsFirstPassRewardTaken());
            hash = (37 * hash) + CHALLENGE_ID_FIELD_NUMBER;
            hash = (53 * hash) + getChallengeId();
            hash = (37 * hash) + BHJHCPLKIMJ_FIELD_NUMBER;
            hash = (53 * hash) + getBHJHCPLKIMJ();
        ...
        public static emu.grasscutter.net.proto.EffigyDailyInfoOuterClass.EffigyDailyInfo
        ...
        public static Builder newBuilder(
                emu.grasscutter.net.proto.EffigyDailyInfoOuterClass.EffigyDailyInfo prototype) {
        ...
        public static final class Builder
            ...
            // Construct using
            // emu.grasscutter.net.proto.EffigyDailyInfoOuterClass.EffigyDailyInfo.newBuilder()
            private Builder() {
            ...
            @java.lang.Override
            public emu.grasscutter.net.proto.EffigyDailyInfoOuterClass.EffigyDailyInfo
                    getDefaultInstanceForType() {
                return emu.grasscutter.net.proto.EffigyDailyInfoOuterClass.EffigyDailyInfo
                        .getDefaultInstance();
            }
            ...
            public emu.grasscutter.net.proto.EffigyDailyInfoOuterClass.EffigyDailyInfo buildPartial() {
                emu.grasscutter.net.proto.EffigyDailyInfoOuterClass.EffigyDailyInfo result =
                        new emu.grasscutter.net.proto.EffigyDailyInfoOuterClass.EffigyDailyInfo(this);
                ...
                result.bHJHCPLKIMJ_ = bHJHCPLKIMJ_;
                onBuilt();
                return result;
            }
            ...
            public Builder mergeFrom(
                    emu.grasscutter.net.proto.EffigyDailyInfoOuterClass.EffigyDailyInfo other) {
                if (other
                        == emu.grasscutter.net.proto.EffigyDailyInfoOuterClass.EffigyDailyInfo
                                .getDefaultInstance()) return this;
                if (other.getChallengeMaxScore() != 0) {
                    setChallengeMaxScore(other.getChallengeMaxScore());
                }
                if (other.getEJIHDCNMFEE() != 0) {
                    setEJIHDCNMFEE(other.getEJIHDCNMFEE());
                }
                ...
                if (other.getBHJHCPLKIMJ() != 0) {
                    setBHJHCPLKIMJ(other.getBHJHCPLKIMJ());
                }
             ...
             * <code>uint32 EJIHDCNMFEE = 10;</code>
             *
             * @param value The eJIHDCNMFEE to set.
             * @return This builder for chaining.
             */
            public Builder setEJIHDCNMFEE(int value) {
             ...
             * @return This builder for chaining.
             */
            public Builder clearEJIHDCNMFEE() {
             ...
             * <code>uint32 BHJHCPLKIMJ = 5;</code>
             *
             * @param value The bHJHCPLKIMJ to set.
             * @return This builder for chaining.
             */
            public Builder setBHJHCPLKIMJ(int value) {
             ...
             * @return This builder for chaining.
             */
            public Builder clearBHJHCPLKIMJ() {
        ...
        private static final emu.grasscutter.net.proto.EffigyDailyInfoOuterClass.EffigyDailyInfo
                DEFAULT_INSTANCE;
        ...
        private static final com.google.protobuf.Parser<EffigyDailyInfo> PARSER =
                new com.google.protobuf.AbstractParser<EffigyDailyInfo>() {
                    @java.lang.Override
    ...
    static {
        java.lang.String[] descriptorData = {
            "\n\025EffigyDailyInfo.proto\"\271\001\n\017EffigyDailyI"
                    ...
                    + "_index\030\004 \001(\r\022\"\n\032is_first_pass_reward_tak"
                    + "en\030\003 \001(\010\022\024\n\014challenge_id\030\t \001(\r\022\023\n\013BHJHCP"
                    + "LKIMJ\030\005 \001(\rB\033\n\031emu.grasscutter.net.proto"
                    + "b\006proto3"
        };
        descriptor =
                com.google.protobuf.Descriptors.FileDescriptor.internalBuildGeneratedFileFrom(
                        descriptorData, new com.google.protobuf.Descriptors.FileDescriptor[] {});
        internal_static_EffigyDailyInfo_descriptor = getDescriptor().getMessageTypes().get(0);
        internal_static_EffigyDailyInfo_fieldAccessorTable =
