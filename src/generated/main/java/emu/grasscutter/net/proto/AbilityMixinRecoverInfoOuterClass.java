...
public final class AbilityMixinRecoverInfoOuterClass {
    ...
    public interface AbilityMixinRecoverInfoOrBuilder
            extends
        ...
        /** <code>repeated .MassivePropSyncInfo massive_prop_list = 6;</code> */
        emu.grasscutter.net.proto.MassivePropSyncInfoOuterClass.MassivePropSyncInfo getMassivePropList(
                int index);
        /** <code>repeated .MassivePropSyncInfo massive_prop_list = 6;</code> */
        ...
        java.util.List<
                        ? extends
                                emu.grasscutter.net.proto.MassivePropSyncInfoOuterClass
        ...
        emu.grasscutter.net.proto.MassivePropSyncInfoOuterClass.MassivePropSyncInfoOrBuilder
                getMassivePropListOrBuilder(int index);
     ...
     */
    public static final class AbilityMixinRecoverInfo extends com.google.protobuf.GeneratedMessageV3
            implements
        ...
        public static final com.google.protobuf.Descriptors.Descriptor getDescriptor() {
            return emu.grasscutter.net.proto.AbilityMixinRecoverInfoOuterClass
         ...
         */
        @java.lang.Override
        public java.util.List<java.lang.Integer> getDataListList() {
            return dataList_;
        }
        /**
         * <code>repeated uint32 data_list = 4;</code>
        ...
        /** <code>repeated .MassivePropSyncInfo massive_prop_list = 6;</code> */
        @java.lang.Override
        public emu.grasscutter.net.proto.MassivePropSyncInfoOuterClass.MassivePropSyncInfo
                getMassivePropList(int index) {
            return massivePropList_.get(index);
        }
        /** <code>repeated .MassivePropSyncInfo massive_prop_list = 6;</code> */
        @java.lang.Override
        public emu.grasscutter.net.proto.MassivePropSyncInfoOuterClass.MassivePropSyncInfoOrBuilder
                getMassivePropListOrBuilder(int index) {
            return massivePropList_.get(index);
        }
        ...
        /** <code>.BreakoutSnapShot breakout_snap_shot = 7;</code> */
        @java.lang.Override
        public emu.grasscutter.net.proto.BreakoutSnapShotOuterClass.BreakoutSnapShotOrBuilder
                getBreakoutSnapShotOrBuilder() {
        ...
        public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
            getSerializedSize();
            if (sourceCase_ == 1) {
                output.writeUInt32(1, (int) ((java.lang.Integer) source_));
            }
            if (sourceCase_ == 2) {
                output.writeUInt32(2, (int) ((java.lang.Integer) source_));
            }
            if (localId_ != 0) {
        ...
        public int getSerializedSize() {
            ...
            if (localId_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(3, localId_);
            }
            {
                int dataSize = 0;
                for (int i = 0; i < dataList_.size(); i++) {
                    dataSize +=
                            com.google.protobuf.CodedOutputStream.computeUInt32SizeNoTag(dataList_.getInt(i));
                }
                size += dataSize;
            ...
            if (isServerbuffModifier_ != false) {
                size += com.google.protobuf.CodedOutputStream.computeBoolSize(5, isServerbuffModifier_);
            }
            for (int i = 0; i < massivePropList_.size(); i++) {
                size +=
                        com.google.protobuf.CodedOutputStream.computeMessageSize(6, massivePropList_.get(i));
            }
            if (breakoutSnapShot_ != null) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(7, getBreakoutSnapShot());
            }
        ...
        public boolean equals(final java.lang.Object obj) {
            ...
            emu.grasscutter.net.proto.AbilityMixinRecoverInfoOuterClass.AbilityMixinRecoverInfo other =
                    (emu.grasscutter.net.proto.AbilityMixinRecoverInfoOuterClass.AbilityMixinRecoverInfo) obj;

            if (getLocalId() != other.getLocalId()) return false;
            if (!getDataListList().equals(other.getDataListList())) return false;
            if (getIsServerbuffModifier() != other.getIsServerbuffModifier()) return false;
            if (!getMassivePropListList().equals(other.getMassivePropListList())) return false;
            if (hasBreakoutSnapShot() != other.hasBreakoutSnapShot()) return false;
            if (hasBreakoutSnapShot()) {
                if (!getBreakoutSnapShot().equals(other.getBreakoutSnapShot())) return false;
            }
            if (!getSourceCase().equals(other.getSourceCase())) return false;
            switch (sourceCase_) {
                case 1:
                    if (getInstancedAbilityId() != other.getInstancedAbilityId()) return false;
                    break;
                case 2:
                    if (getInstancedModifierId() != other.getInstancedModifierId()) return false;
                    break;
                case 0:
                default:
            }
        ...
        public int hashCode() {
            ...
            hash = (53 * hash) + com.google.protobuf.Internal.hashBoolean(getIsServerbuffModifier());
        ...
        public static emu.grasscutter.net.proto.AbilityMixinRecoverInfoOuterClass
        ...
        public static final class Builder
            ...
            // Construct using
            // emu.grasscutter.net.proto.AbilityMixinRecoverInfoOuterClass.AbilityMixinRecoverInfo.newBuilder()
            private Builder() {
            ...
            public emu.grasscutter.net.proto.AbilityMixinRecoverInfoOuterClass.AbilityMixinRecoverInfo
                ...
                return emu.grasscutter.net.proto.AbilityMixinRecoverInfoOuterClass.AbilityMixinRecoverInfo
                        .getDefaultInstance();
            }
            ...
            public emu.grasscutter.net.proto.AbilityMixinRecoverInfoOuterClass.AbilityMixinRecoverInfo
                    build() {
                emu.grasscutter.net.proto.AbilityMixinRecoverInfoOuterClass.AbilityMixinRecoverInfo result =
                        buildPartial();
            ...
            public emu.grasscutter.net.proto.AbilityMixinRecoverInfoOuterClass.AbilityMixinRecoverInfo
                    buildPartial() {
                emu.grasscutter.net.proto.AbilityMixinRecoverInfoOuterClass.AbilityMixinRecoverInfo result =
                        new emu.grasscutter.net.proto.AbilityMixinRecoverInfoOuterClass.AbilityMixinRecoverInfo(
                                this);
            ...
            public java.util.List<java.lang.Integer> getDataListList() {
                return ((bitField0_ & 0x00000001) != 0)
                        ? java.util.Collections.unmodifiableList(dataList_)
                        : dataList_;
            }
            /**
             * <code>repeated uint32 data_list = 4;</code>
             ...
             * @return This builder for chaining.
             */
            public Builder addAllDataList(java.lang.Iterable<? extends java.lang.Integer> values) {
                ensureDataListIsMutable();
            ...
            private com.google.protobuf.RepeatedFieldBuilderV3<
                            emu.grasscutter.net.proto.MassivePropSyncInfoOuterClass.MassivePropSyncInfo,
                            emu.grasscutter.net.proto.MassivePropSyncInfoOuterClass.MassivePropSyncInfo.Builder,
                            emu.grasscutter.net.proto.MassivePropSyncInfoOuterClass.MassivePropSyncInfoOrBuilder>
                    massivePropListBuilder_;
            ...
            public Builder setMassivePropList(
                    int index,
                    emu.grasscutter.net.proto.MassivePropSyncInfoOuterClass.MassivePropSyncInfo value) {
                if (massivePropListBuilder_ == null) {
                    if (value == null) {
            ...
            public Builder addAllMassivePropList(
                ...
                if (massivePropListBuilder_ == null) {
                    ensureMassivePropListIsMutable();
                    com.google.protobuf.AbstractMessageLite.Builder.addAll(values, massivePropList_);
                    onChanged();
                } else {
            ...
            /** <code>repeated .MassivePropSyncInfo massive_prop_list = 6;</code> */
            public emu.grasscutter.net.proto.MassivePropSyncInfoOuterClass.MassivePropSyncInfo.Builder
                    getMassivePropListBuilder(int index) {
            ...
            /** <code>repeated .MassivePropSyncInfo massive_prop_list = 6;</code> */
            public emu.grasscutter.net.proto.MassivePropSyncInfoOuterClass.MassivePropSyncInfo.Builder
                    addMassivePropListBuilder() {
                return getMassivePropListFieldBuilder()
                        .addBuilder(
                                emu.grasscutter.net.proto.MassivePropSyncInfoOuterClass.MassivePropSyncInfo
                                        .getDefaultInstance());
            }
            /** <code>repeated .MassivePropSyncInfo massive_prop_list = 6;</code> */
            public emu.grasscutter.net.proto.MassivePropSyncInfoOuterClass.MassivePropSyncInfo.Builder
                    addMassivePropListBuilder(int index) {
                return getMassivePropListFieldBuilder()
                        .addBuilder(
                                index,
                                emu.grasscutter.net.proto.MassivePropSyncInfoOuterClass.MassivePropSyncInfo
            ...
            private emu.grasscutter.net.proto.BreakoutSnapShotOuterClass.BreakoutSnapShot
                    breakoutSnapShot_;
            private com.google.protobuf.SingleFieldBuilderV3<
                            emu.grasscutter.net.proto.BreakoutSnapShotOuterClass.BreakoutSnapShot,
                            emu.grasscutter.net.proto.BreakoutSnapShotOuterClass.BreakoutSnapShot.Builder,
                            emu.grasscutter.net.proto.BreakoutSnapShotOuterClass.BreakoutSnapShotOrBuilder>
                    breakoutSnapShotBuilder_;
            /**
             * <code>.BreakoutSnapShot breakout_snap_shot = 7;</code>
             *
             * @return Whether the breakoutSnapShot field is set.
            ...
            public Builder setBreakoutSnapShot(
                    emu.grasscutter.net.proto.BreakoutSnapShotOuterClass.BreakoutSnapShot value) {
                if (breakoutSnapShotBuilder_ == null) {
                    if (value == null) {
                        throw new NullPointerException();
                    }
            ...
            /** <code>.BreakoutSnapShot breakout_snap_shot = 7;</code> */
            public Builder mergeBreakoutSnapShot(
                    emu.grasscutter.net.proto.BreakoutSnapShotOuterClass.BreakoutSnapShot value) {
                if (breakoutSnapShotBuilder_ == null) {
                    if (breakoutSnapShot_ != null) {
                        breakoutSnapShot_ =
            ...
            /** <code>.BreakoutSnapShot breakout_snap_shot = 7;</code> */
            public emu.grasscutter.net.proto.BreakoutSnapShotOuterClass.BreakoutSnapShot.Builder
                    getBreakoutSnapShotBuilder() {
                ...
                if (breakoutSnapShotBuilder_ == null) {
                    breakoutSnapShotBuilder_ =
                            new com.google.protobuf.SingleFieldBuilderV3<
                                    ...
                                    emu.grasscutter.net.proto.BreakoutSnapShotOuterClass.BreakoutSnapShot.Builder,
                                    emu.grasscutter.net.proto.BreakoutSnapShotOuterClass.BreakoutSnapShotOrBuilder>(
                                    getBreakoutSnapShot(), getParentForChildren(), isClean());
                    breakoutSnapShot_ = null;
                }
        ...
        private static final emu.grasscutter.net.proto.AbilityMixinRecoverInfoOuterClass
                        .AbilityMixinRecoverInfo
                DEFAULT_INSTANCE;
        ...
        private static final com.google.protobuf.Parser<AbilityMixinRecoverInfo> PARSER =
                new com.google.protobuf.AbstractParser<AbilityMixinRecoverInfo>() {
                    @java.lang.Override
