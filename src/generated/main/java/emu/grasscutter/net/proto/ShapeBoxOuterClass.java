...
public final class ShapeBoxOuterClass {
    ...
    public interface ShapeBoxOrBuilder
            extends
     ...
     */
    public static final class ShapeBox extends com.google.protobuf.GeneratedMessageV3
            implements
        ...
        protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
            ...
            return emu.grasscutter.net.proto.ShapeBoxOuterClass
                    .internal_static_ShapeBox_fieldAccessorTable
                    .ensureFieldAccessorsInitialized(
                            emu.grasscutter.net.proto.ShapeBoxOuterClass.ShapeBox.class,
                            emu.grasscutter.net.proto.ShapeBoxOuterClass.ShapeBox.Builder.class);
        }
        ...
        public int getSerializedSize() {
            ...
            if (axis0_ != null) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(2, getAxis0());
            }
            if (axis1_ != null) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(3, getAxis1());
            }
            if (axis2_ != null) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(4, getAxis2());
            }
            if (extents_ != null) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(5, getExtents());
            }
        ...
        public boolean equals(final java.lang.Object obj) {
            ...
            emu.grasscutter.net.proto.ShapeBoxOuterClass.ShapeBox other =
                    (emu.grasscutter.net.proto.ShapeBoxOuterClass.ShapeBox) obj;
            ...
            if (hasAxis0()) {
                if (!getAxis0().equals(other.getAxis0())) return false;
            }
            if (hasAxis1() != other.hasAxis1()) return false;
            if (hasAxis1()) {
                if (!getAxis1().equals(other.getAxis1())) return false;
            }
            if (hasAxis2() != other.hasAxis2()) return false;
            if (hasAxis2()) {
                if (!getAxis2().equals(other.getAxis2())) return false;
            }
        ...
        public static Builder newBuilder(
                emu.grasscutter.net.proto.ShapeBoxOuterClass.ShapeBox prototype) {
        ...
        public static final class Builder
            ...
            public emu.grasscutter.net.proto.ShapeBoxOuterClass.ShapeBox buildPartial() {
                emu.grasscutter.net.proto.ShapeBoxOuterClass.ShapeBox result =
                        new emu.grasscutter.net.proto.ShapeBoxOuterClass.ShapeBox(this);
                if (centerBuilder_ == null) {
            ...
            public Builder mergeFrom(emu.grasscutter.net.proto.ShapeBoxOuterClass.ShapeBox other) {
                if (other == emu.grasscutter.net.proto.ShapeBoxOuterClass.ShapeBox.getDefaultInstance())
                    return this;
                if (other.hasCenter()) {
            ...
            public Builder mergeFrom(
                ...
                try {
                    ...
                    parsedMessage =
                            (emu.grasscutter.net.proto.ShapeBoxOuterClass.ShapeBox) e.getUnfinishedMessage();
            ...
            public Builder mergeAxis0(emu.grasscutter.net.proto.VectorOuterClass.Vector value) {
                if (axis0Builder_ == null) {
                    if (axis0_ != null) {
                        axis0_ =
                                emu.grasscutter.net.proto.VectorOuterClass.Vector.newBuilder(axis0_)
                                        .mergeFrom(value)
                                        .buildPartial();
                    } else {
                        axis0_ = value;
                ...
                if (axis0Builder_ == null) {
                    axis0Builder_ =
                            new com.google.protobuf.SingleFieldBuilderV3<
                                    ...
                                    emu.grasscutter.net.proto.VectorOuterClass.Vector.Builder,
                                    emu.grasscutter.net.proto.VectorOuterClass.VectorOrBuilder>(
                                    getAxis0(), getParentForChildren(), isClean());
                    axis0_ = null;
                }
            ...
            public Builder mergeAxis1(emu.grasscutter.net.proto.VectorOuterClass.Vector value) {
                if (axis1Builder_ == null) {
                    if (axis1_ != null) {
                        axis1_ =
                                emu.grasscutter.net.proto.VectorOuterClass.Vector.newBuilder(axis1_)
                                        .mergeFrom(value)
                                        .buildPartial();
                    } else {
                        axis1_ = value;
                ...
                if (axis1Builder_ == null) {
                    axis1Builder_ =
                            new com.google.protobuf.SingleFieldBuilderV3<
                                    ...
                                    emu.grasscutter.net.proto.VectorOuterClass.Vector.Builder,
                                    emu.grasscutter.net.proto.VectorOuterClass.VectorOrBuilder>(
                                    getAxis1(), getParentForChildren(), isClean());
                    axis1_ = null;
                }
            ...
            public Builder mergeAxis2(emu.grasscutter.net.proto.VectorOuterClass.Vector value) {
                if (axis2Builder_ == null) {
                    if (axis2_ != null) {
                        axis2_ =
                                emu.grasscutter.net.proto.VectorOuterClass.Vector.newBuilder(axis2_)
                                        .mergeFrom(value)
                                        .buildPartial();
                    } else {
                        axis2_ = value;
                ...
                if (axis2Builder_ == null) {
                    axis2Builder_ =
                            new com.google.protobuf.SingleFieldBuilderV3<
                                    ...
                                    emu.grasscutter.net.proto.VectorOuterClass.Vector.Builder,
                                    emu.grasscutter.net.proto.VectorOuterClass.VectorOrBuilder>(
                                    getAxis2(), getParentForChildren(), isClean());
                    axis2_ = null;
                }
        ...
        private static final com.google.protobuf.Parser<ShapeBox> PARSER =
                new com.google.protobuf.AbstractParser<ShapeBox>() {
                    @java.lang.Override
    ...
    static {
        ...
        internal_static_ShapeBox_descriptor = getDescriptor().getMessageTypes().get(0);
        internal_static_ShapeBox_fieldAccessorTable =
                new com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
                        internal_static_ShapeBox_descriptor,
                        new java.lang.String[] {
                            "Center", "Axis0", "Axis1", "Axis2", "Extents",
                        });
        emu.grasscutter.net.proto.VectorOuterClass.getDescriptor();
    }
