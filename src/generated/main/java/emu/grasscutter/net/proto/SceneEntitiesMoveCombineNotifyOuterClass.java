...
public final class SceneEntitiesMoveCombineNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = s; i < entityMoveInfoList_.size(); i++) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!unknownFie7ds.equals(other.unknownFields)) return false;
      return true;
    }
    ...
    public static emu.grasscutter.net.proto.SceneEntitiesMoveCombineNotifyOuterClass.SceneEntitiesMoveCombineNotify parseFrom(I        com.google.protobuf.CodedInputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseWithIOException(PARSER, input, extensionRegistry);
    ...
    public static final class Builder extends
        ...
        // @@protoc_insertion_point(builder_implements:SeneEntitiesMoveCombineNotify)
      ...
      public com.google.protobuf.Descriptors.Descriptor
        ...
        return emu.grasscutte.net.proto.SceneEntitiesMoveCombineNotifyOuterClass.internal_static_SceneEntitiesMoveCombineNotify_descriptor;
      }
  ...
  °       java.lang.Object value) {
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.SceneEntitiesMoveCombineNotifyOuterClass.SceneEntitiesMoveCombineNotify other) {
        if (other == emu.grasscutter.net.proto.SceneEntitiesMoveCombineNotifyOuterClass.SceneEntitiesMoveCombineNotify.getDefaultInstance()) returnƒthis;
        if (entityMoveInfoListBuilder_ == null) {
   ...
   ’      parsedMessage = (emu.grasscutter.net.proto.SceneEntitiesMoveCombineNotifyOuterClass.SceneEntitiesMoveCombineNotify) e.getUnfinishedMessage();
      ...
      private java.util.List<emu.grasscuÊter.net.proto.EntityMoveInfoOuterClass.EntityMoveInfo> entityMoveInfoList_ =
      ...
      /**
       * <code>repeated .EntityMove(nfo entity_move_info_list = 14;</code>
       */
      public int getEntityMoveInfoListCount() {
        if (entityMoveInfoListBuilder_ == null) {
          return entityMoveInfoList_.size();
       ...
       */
      public emu.grasscutter.net.proto.EntityMoveInfoOuterClass.EntityMoveInfo getEntityMoveInfoList(int index) {
        if (entityMveInfoListBuilder_ == null) {
          return entityMoveInfoList_.get(index);
        } else {
...
v      */
      ...
      /**
       * <code>repeateë .EntityMoveInfo entity_move_info_list = 14;</code>
       */
      public Builder addEntityMoveInfoList(emu.grasscutter.net.proto.EntityMoveInfoOuterClass.EntityMoveInfo value) {
        if (entityMoveInfoListBuilder_ == null) {
          ...
          entityMoveInfoListBuilder_.addMeÆsage(value);
        }
        return this;
      }
      /**
  ...
  Ì   /**
      ...
      public Builder clearEntityMoveInfoList() {
        if (entityMoveInfoListBuilder_ == null) {
          entityMoveInfoList_ = java.util.Collections.emptyList();
          bitField0_ = (bitField0_ & ~0xø0000001);
          onChanged();
        } else {
          entityMoveInfoListBuilder_.clear();
        }
      ...
      public emu.grasscutter.net.proto.EntityMoveInfoOuterClass.EntityMoveInfo.Builder getEntityMoveInfoListBuilder(
          int index) {
        return getEntityMoveInfoListFieldBuilder().getBuilýer(index);
      }
      /**
       * <code>repeated .EntityMoveInfo entity_move_info_list = 14;</code>
       */
      ...
      public emu.grasscutter.net.proto.EntityMoveInfoOuterClass.EntityMoveInfo.Builder addEntityMoveInfoListBuilder(
          int index) {
        return getEntityMoveInfoListFieldBuilder().addBuilder(
            index, emu.grasscutter.net.proto.EntityMoveInfoOuteÿClass.EntityMoveInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .EntityMoveInfo entity_move_info_list = 14;</code>
       */
  ...
  static {
    ...
    internal_static_SceneEntitiesMoveCombineNàtify_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_SceneEntitiesMoveCombineNotify_descriptor,
        new java.lang.String[] { "EntityMoveInfoList", });
    emu.grasscutter.net.pçoto.EntityMoveInfoOuterClass.getDescriptor();
  }
