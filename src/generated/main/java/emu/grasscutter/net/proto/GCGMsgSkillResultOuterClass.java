...
public final class GCGMsgSkillResultOuterClass {
    ...
    public interface GCGMsgSkillResultOrBuilder
            extends
        ...
        /** <code>repeated .GCGDamageDetail detail_list = 2;</code> */
        java.util.List<
                        ? extends emu.grasscutter.net.proto.GCGDamageDetailOuterClass.GCGDamageDetailOrBuilder>
                getDetailListOrBuilderList();
        /** <code>repeated .GCGDamageDetail detail_list = 2;</code> */
        emu.grasscutter.net.proto.GCGDamageDetailOuterClass.GCGDamageDetailOrBuilder
                getDetailListOrBuilder(int index);
    }
    /**
     *
     *
     ...
     */
    public static final class GCGMsgSkillResult extends com.google.protobuf.GeneratedMessageV3
            implements
                                ...
                                if (!((mutable_bitField0_ & 0x00000001) != 0)) {
                                    detailList_ =
                                            new java.util.ArrayList<
                                                    emu.grasscutter.net.proto.GCGDamageDetailOuterClass.GCGDamageDetail>();
        ...
        public static final com.google.protobuf.Descriptors.Descriptor getDescriptor() {
            return emu.grasscutter.net.proto.GCGMsgSkillResultOuterClass
        ...
        protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
            ...
            return emu.grasscutter.net.proto.GCGMsgSkillResultOuterClass
                    ...
                    .ensureFieldAccessorsInitialized(
                            emu.grasscutter.net.proto.GCGMsgSkillResultOuterClass.GCGMsgSkillResult.class,
        ...
        private java.util.List<emu.grasscutter.net.proto.GCGDamageDetailOuterClass.GCGDamageDetail>
                detailList_;
        /** <code>repeated .GCGDamageDetail detail_list = 2;</code> */
        @java.lang.Override
        public java.util.List<emu.grasscutter.net.proto.GCGDamageDetailOuterClass.GCGDamageDetail>
                getDetailListList() {
            return detailList_;
        }
        /** <code>repeated .GCGDamageDetail detail_list = 2;</code> */
        ...
        /** <code>repeated .GCGDamageDetail detail_list = 2;</code> */
        @java.lang.Override
        public emu.grasscutter.net.proto.GCGDamageDetailOuterClass.GCGDamageDetail getDetailList(
                int index) {
            return detailList_.get(index);
        }
        /** <code>repeated .GCGDamageDetail detail_list = 2;</code> */
        @java.lang.Override
        public emu.grasscutter.net.proto.GCGDamageDetailOuterClass.GCGDamageDetailOrBuilder
                getDetailListOrBuilder(int index) {
            return detailList_.get(index);
        }
        ...
        public int getSerializedSize() {
            ...
            size = 0;
            for (int i = 0; i < detailList_.size(); i++) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(2, detailList_.get(i));
            }
            if (bGFONKCHPHD_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(4, bGFONKCHPHD_);
            }
            if (skillId_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(6, skillId_);
            }
            if (nEAHEJCAPAM_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(7, nEAHEJCAPAM_);
            }
            if (aOIGOAHIPIG_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(8, aOIGOAHIPIG_);
            }
            if (lDOEHIDLFKI_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(9, lDOEHIDLFKI_);
            }
            if (nDJABBCPLBB_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(10, nDJABBCPLBB_);
            }
            if (oBKMAKCCGBB_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(11, oBKMAKCCGBB_);
            }
            if (dMBDKFHNGOF_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(12, dMBDKFHNGOF_);
            }
            if (hNLABLOMGMJ_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(13, hNLABLOMGMJ_);
            }
            if (damage_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(15, damage_);
            }
        ...
        public boolean equals(final java.lang.Object obj) {
            ...
            if (!(obj
                    instanceof emu.grasscutter.net.proto.GCGMsgSkillResultOuterClass.GCGMsgSkillResult)) {
                return super.equals(obj);
            }
            emu.grasscutter.net.proto.GCGMsgSkillResultOuterClass.GCGMsgSkillResult other =
                    (emu.grasscutter.net.proto.GCGMsgSkillResultOuterClass.GCGMsgSkillResult) obj;

            if (getBGFONKCHPHD() != other.getBGFONKCHPHD()) return false;
            if (getHNLABLOMGMJ() != other.getHNLABLOMGMJ()) return false;
            if (getOBKMAKCCGBB() != other.getOBKMAKCCGBB()) return false;
            if (getDamage() != other.getDamage()) return false;
            if (getNEAHEJCAPAM() != other.getNEAHEJCAPAM()) return false;
            if (getNDJABBCPLBB() != other.getNDJABBCPLBB()) return false;
            if (getDMBDKFHNGOF() != other.getDMBDKFHNGOF()) return false;
            if (getLDOEHIDLFKI() != other.getLDOEHIDLFKI()) return false;
            if (getSkillId() != other.getSkillId()) return false;
            if (getAOIGOAHIPIG() != other.getAOIGOAHIPIG()) return false;
            if (!getDetailListList().equals(other.getDetailListList())) return false;
        ...
        public static emu.grasscutter.net.proto.GCGMsgSkillResultOuterClass.GCGMsgSkillResult
        ...
        public static Builder newBuilder(
                emu.grasscutter.net.proto.GCGMsgSkillResultOuterClass.GCGMsgSkillResult prototype) {
        ...
        public static final class Builder
            ...
            public emu.grasscutter.net.proto.GCGMsgSkillResultOuterClass.GCGMsgSkillResult build() {
                emu.grasscutter.net.proto.GCGMsgSkillResultOuterClass.GCGMsgSkillResult result =
                        buildPartial();
            ...
            public emu.grasscutter.net.proto.GCGMsgSkillResultOuterClass.GCGMsgSkillResult
                    buildPartial() {
                emu.grasscutter.net.proto.GCGMsgSkillResultOuterClass.GCGMsgSkillResult result =
                        new emu.grasscutter.net.proto.GCGMsgSkillResultOuterClass.GCGMsgSkillResult(this);
            ...
            public Builder mergeFrom(
                    ...
                    com.google.protobuf.ExtensionRegistryLite extensionRegistry)
                    throws java.io.IOException {
                emu.grasscutter.net.proto.GCGMsgSkillResultOuterClass.GCGMsgSkillResult parsedMessage =
                        null;
                try {
            ...
            private void ensureDetailListIsMutable() {
                if (!((bitField0_ & 0x00000001) != 0)) {
                    detailList_ =
                            new java.util.ArrayList<
                                    emu.grasscutter.net.proto.GCGDamageDetailOuterClass.GCGDamageDetail>(detailList_);
            ...
            private com.google.protobuf.RepeatedFieldBuilderV3<
                            emu.grasscutter.net.proto.GCGDamageDetailOuterClass.GCGDamageDetail,
                            emu.grasscutter.net.proto.GCGDamageDetailOuterClass.GCGDamageDetail.Builder,
                            emu.grasscutter.net.proto.GCGDamageDetailOuterClass.GCGDamageDetailOrBuilder>
                    detailListBuilder_;
            ...
            public Builder addDetailList(
                    emu.grasscutter.net.proto.GCGDamageDetailOuterClass.GCGDamageDetail value) {
                if (detailListBuilder_ == null) {
                    if (value == null) {
                        throw new NullPointerException();
                    }
            ...
            public Builder addAllDetailList(
                    java.lang.Iterable<
                                    ? extends emu.grasscutter.net.proto.GCGDamageDetailOuterClass.GCGDamageDetail>
                            values) {
                if (detailListBuilder_ == null) {
                    ensureDetailListIsMutable();
                    com.google.protobuf.AbstractMessageLite.Builder.addAll(values, detailList_);
                    onChanged();
                } else {
            ...
            /** <code>repeated .GCGDamageDetail detail_list = 2;</code> */
            public emu.grasscutter.net.proto.GCGDamageDetailOuterClass.GCGDamageDetail.Builder
                    getDetailListBuilder(int index) {
            ...
            /** <code>repeated .GCGDamageDetail detail_list = 2;</code> */
            public emu.grasscutter.net.proto.GCGDamageDetailOuterClass.GCGDamageDetail.Builder
                    addDetailListBuilder() {
                return getDetailListFieldBuilder()
                        .addBuilder(
                                emu.grasscutter.net.proto.GCGDamageDetailOuterClass.GCGDamageDetail
                                        .getDefaultInstance());
            }
            /** <code>repeated .GCGDamageDetail detail_list = 2;</code> */
            public emu.grasscutter.net.proto.GCGDamageDetailOuterClass.GCGDamageDetail.Builder
                    addDetailListBuilder(int index) {
                return getDetailListFieldBuilder()
                        .addBuilder(
                                index,
                                emu.grasscutter.net.proto.GCGDamageDetailOuterClass.GCGDamageDetail
                ...
                if (detailListBuilder_ == null) {
                    detailListBuilder_ =
                            new com.google.protobuf.RepeatedFieldBuilderV3<
                                    ...
                                    emu.grasscutter.net.proto.GCGDamageDetailOuterClass.GCGDamageDetail.Builder,
                                    emu.grasscutter.net.proto.GCGDamageDetailOuterClass.GCGDamageDetailOrBuilder>(
                                    detailList_, ((bitField0_ & 0x00000001) != 0), getParentForChildren(), isClean());
                    detailList_ = null;
                }
        ...
        private static final emu.grasscutter.net.proto.GCGMsgSkillResultOuterClass.GCGMsgSkillResult
                DEFAULT_INSTANCE;

        static {
            DEFAULT_INSTANCE =
                    new emu.grasscutter.net.proto.GCGMsgSkillResultOuterClass.GCGMsgSkillResult();
        }
        ...
        private static final com.google.protobuf.Parser<GCGMsgSkillResult> PARSER =
                new com.google.protobuf.AbstractParser<GCGMsgSkillResult>() {
                    @java.lang.Override
    ...
    static {
        ...
        internal_static_GCGMsgSkillResult_descriptor = getDescriptor().getMessageTypes().get(0);
        internal_static_GCGMsgSkillResult_fieldAccessorTable =
