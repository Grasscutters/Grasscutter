...
public final class DungeonCandidateTeamPlayerLeaveReasonOuterClass {
    ...
    public enum DungeonCandidateTeamPlayerLeaveReason
        ...
        public static DungeonCandidateTeamPlayerLeaveReason forNumber(int value) {
            switch (value) {
                case 0:
                    return DUNGEON_CANDIDATE_TPLR_NORMAL;
                case 1:
                    return DUNGEON_CANDIDATE_TPLR_DIE;
                case 2:
                    return DUNGEON_CANDIDATE_TPLR_BE_KICK;
                case 3:
                    return DUNGEON_CANDIDATE_DISCONNECT;
                default:
                    return null;
            }
        }
        ...
        public static final com.google.protobuf.Descriptors.EnumDescriptor getDescriptor() {
            return emu.grasscutter.net.proto.DungeonCandidateTeamPlayerLeaveReasonOuterClass
                    .getDescriptor()
                    .getEnumTypes()
                    .get(0);
        }
