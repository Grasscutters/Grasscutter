...
public final class FireWorkNotifyOuterClass {
    ...
    public interface FireWorkNotifyOrBuilder
            extends
     ...
     */
    public static final class FireWorkNotify extends com.google.protobuf.GeneratedMessageV3
            implements
                                ...
                                if (!((mutable_bitField0_ & 0x00000001) != 0)) {
                                    fireWorkData_ =
                                            new java.util.ArrayList<
                                                    emu.grasscutter.net.proto.FireWorkDataOuterClass.FireWorkData>();
        ...
        protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
            ...
            return emu.grasscutter.net.proto.FireWorkNotifyOuterClass
                    ...
                    .ensureFieldAccessorsInitialized(
                            emu.grasscutter.net.proto.FireWorkNotifyOuterClass.FireWorkNotify.class,
                            emu.grasscutter.net.proto.FireWorkNotifyOuterClass.FireWorkNotify.Builder.class);
        }

        public static final int FIREWORKDATA_FIELD_NUMBER = 1;
        private java.util.List<emu.grasscutter.net.proto.FireWorkDataOuterClass.FireWorkData>
                fireWorkData_;
        /** <code>repeated .FireWorkData fireWorkData = 1;</code> */
        @java.lang.Override
        public java.util.List<emu.grasscutter.net.proto.FireWorkDataOuterClass.FireWorkData>
                getFireWorkDataList() {
        ...
        public java.util.List<
                        ? extends emu.grasscutter.net.proto.FireWorkDataOuterClass.FireWorkDataOrBuilder>
                getFireWorkDataOrBuilderList() {
            return fireWorkData_;
        }
        /** <code>repeated .FireWorkData fireWorkData = 1;</code> */
        ...
        /** <code>repeated .FireWorkData fireWorkData = 1;</code> */
        @java.lang.Override
        public emu.grasscutter.net.proto.FireWorkDataOuterClass.FireWorkDataOrBuilder
                getFireWorkDataOrBuilder(int index) {
            return fireWorkData_.get(index);
        }
        ...
        public int getSerializedSize() {
            ...
            size = 0;
            for (int i = 0; i < fireWorkData_.size(); i++) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(1, fireWorkData_.get(i));
            }
        ...
        public boolean equals(final java.lang.Object obj) {
            ...
            emu.grasscutter.net.proto.FireWorkNotifyOuterClass.FireWorkNotify other =
                    (emu.grasscutter.net.proto.FireWorkNotifyOuterClass.FireWorkNotify) obj;

            if (!getFireWorkDataList().equals(other.getFireWorkDataList())) return false;
        ...
        public static emu.grasscutter.net.proto.FireWorkNotifyOuterClass.FireWorkNotify
        ...
        public static Builder newBuilder(
                emu.grasscutter.net.proto.FireWorkNotifyOuterClass.FireWorkNotify prototype) {
        ...
        public static final class Builder
            ...
            // Construct using
            // emu.grasscutter.net.proto.FireWorkNotifyOuterClass.FireWorkNotify.newBuilder()
            private Builder() {
            ...
            @java.lang.Override
            public emu.grasscutter.net.proto.FireWorkNotifyOuterClass.FireWorkNotify
                    getDefaultInstanceForType() {
                return emu.grasscutter.net.proto.FireWorkNotifyOuterClass.FireWorkNotify
                        .getDefaultInstance();
            }
            ...
            public emu.grasscutter.net.proto.FireWorkNotifyOuterClass.FireWorkNotify buildPartial() {
                emu.grasscutter.net.proto.FireWorkNotifyOuterClass.FireWorkNotify result =
                        new emu.grasscutter.net.proto.FireWorkNotifyOuterClass.FireWorkNotify(this);
            ...
            public Builder mergeFrom(
                    emu.grasscutter.net.proto.FireWorkNotifyOuterClass.FireWorkNotify other) {
                if (other
                        == emu.grasscutter.net.proto.FireWorkNotifyOuterClass.FireWorkNotify
            ...
            private com.google.protobuf.RepeatedFieldBuilderV3<
                            emu.grasscutter.net.proto.FireWorkDataOuterClass.FireWorkData,
                            emu.grasscutter.net.proto.FireWorkDataOuterClass.FireWorkData.Builder,
            ...
            public Builder addFireWorkData(
                    emu.grasscutter.net.proto.FireWorkDataOuterClass.FireWorkData value) {
                if (fireWorkDataBuilder_ == null) {
                    if (value == null) {
                        throw new NullPointerException();
                    }
            ...
            public Builder addAllFireWorkData(
                    java.lang.Iterable<
                                    ? extends emu.grasscutter.net.proto.FireWorkDataOuterClass.FireWorkData>
                            values) {
                if (fireWorkDataBuilder_ == null) {
                    ensureFireWorkDataIsMutable();
                    com.google.protobuf.AbstractMessageLite.Builder.addAll(values, fireWorkData_);
                    onChanged();
                } else {
            ...
            /** <code>repeated .FireWorkData fireWorkData = 1;</code> */
            public emu.grasscutter.net.proto.FireWorkDataOuterClass.FireWorkData.Builder
                    getFireWorkDataBuilder(int index) {
            ...
            /** <code>repeated .FireWorkData fireWorkData = 1;</code> */
            public emu.grasscutter.net.proto.FireWorkDataOuterClass.FireWorkData.Builder
                    addFireWorkDataBuilder() {
                return getFireWorkDataFieldBuilder()
                        .addBuilder(
                                emu.grasscutter.net.proto.FireWorkDataOuterClass.FireWorkData.getDefaultInstance());
            }
            /** <code>repeated .FireWorkData fireWorkData = 1;</code> */
            public emu.grasscutter.net.proto.FireWorkDataOuterClass.FireWorkData.Builder
                    addFireWorkDataBuilder(int index) {
                return getFireWorkDataFieldBuilder()
                        .addBuilder(
                                index,
                                emu.grasscutter.net.proto.FireWorkDataOuterClass.FireWorkData.getDefaultInstance());
        ...
        private static final emu.grasscutter.net.proto.FireWorkNotifyOuterClass.FireWorkNotify
                DEFAULT_INSTANCE;
        ...
        private static final com.google.protobuf.Parser<FireWorkNotify> PARSER =
                new com.google.protobuf.AbstractParser<FireWorkNotify>() {
                    @java.lang.Override
