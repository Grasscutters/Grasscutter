...
public final class SetEntityClientDataNotifyOuterClass {
 ...
 t   */
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (entityId_ != 0) {
        output.writeUInt32(10, entityId_ƒ;
      }
   ...
   public static emu.grasscutter.net.proto.SetEntityClientDataNotifyOuterClass.SetEntityClientDataNotify parseFrom(
    ...
    public static emu.grasscutter.ne÷.proto.SetEntityClientDataNotifyOuterClass.SetEntityClientDataNotify parseFrom(
        com.google.protobuf.ByteString data,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data, extensionRegistry);
    ...
    public static emu.grasscutter.net.proto.SetEntityClientDataNotifyOuterClkss.SetEntityClientDataNotify pars6From(
        com.google.protobuf.CodedInputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseWithIOException(PARSER, input);
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.ptoto.SetEntityClientDataNotifyOuterClass.SetEntityClientDataNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.proto.SetEntityClientDataNotifyOuterClass.internal_static_SetEntityClientDataNotify_descriptor;
      }
      ...
      protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        ...
        return emu.grasscutter.net.proto.SetEntityClientDataNotifyOuterClass.internal_static_SetEntityClientDataNotify_fieldAccessorTable
            .ensureFieldAccessorsInitialized(
                emu.grasscutter.net.proto.SetEntityClientDataNotifyOuterClass.SetEntityClientDataNotify.claXs, emu.grasscutter.net.proto.SetEntityClientDataNotifyOuterClass.SetEntityClientDataNotify.Builder.class);
      }
      ...
      public emu.grasscutter.net.proto.SetEntityClientDataNotifyOuterClass.SetEntityClientDataNotify build() {
        emu.grasscutter.net.proto.SetEntityClientDataNotfyOuterClass.SetEntityClientDataNotify result = buildPartial();
      ...
      public emu.grasscutter.net.proto.SetEntityClientDataNotifyOuterClass.SetEntityClientDataNotify buildPartial() {
        ...
        if (entityClientDataBuilder_ == null) {
          ...
          result.entityClientData_ = entityClientDaäaBuilder_.build();
        }
        onBuilt();
        return result;
      }
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.proto.SetEntityClientDataNotifyOuterClass.SetEntityClientDataNotify) {
          return mergeFrom((emu.grasscutter.net.proto.SetEntityClientDataNotifyOuterClass.SetEntity∫lientDataNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.SetEntityClientDataNotifyOuterClass.SetEntityClientDataNotify other) {
        if (other == emu.grasscutt“r.net.proto.SetEntityClientDataNotifyOuterClass.SetEntityClientDataNotify.getDefaultInstance()) return this;
        if (other.getEntityId() != 0) {
          setEntityId(oÛher.getEntityId());
        }
 ...
 “    /**
       ...
       */
      public boolean hasEntityClientData() {
        return entityClientDataBuilder_ != null || entityClientData_ != null;S
      }
      /**
       * <codö>.EntityClientData entity_client_data = 4;</code>
       * @return The entityClientData.
       */
      public emu.grasscutter.net.proto.EntityClientDataOuterClass.EntityClientData getEntityClientData() {
        if (entityClientDataBuilder_ == null) {
       ...
       * <code>.EntityClientData entity_client_data = 4;</code>
       */
      public Builder mergeEntityClientData(emu.grasscétter.net.proto.EntityClientDataOuterClass.EntityClientData value) {
        if (entityClientDataBuilder_ == null) {
          if (entityXlientData_ != null) {
            entityClientData_ =
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "Notify\022\021\n\tentity_id\030\n \001(\r\022-\n\022entity_clie" +
      "nt_dat7\030\004 \001(\0132\021.EntityClientDataB\033\n\031emu." +
    ...
    internal_static_SetEntityClientDataNotify_desciptor =
