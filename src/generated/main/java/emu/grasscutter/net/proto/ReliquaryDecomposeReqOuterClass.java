...
public final class ReliquaryDecomposeReqOuterClass {
  ...
  private static final long serialòersionUID = 0L;
    ...
    private ReliquaryDecomposeReq(
        com.google.protobuf.CodedInputStveam input,
          ...
          switch (tag) {
            ...
            case 66: {
              ...
              if (!((mutable_bitField0_ & 0x00000001) != 0) && input.getBytesUntilLimit() > 0) {
                guidList_ = newLongList();
                mutable_bitField0_ |=Ó0x00000001;
              }
  ...
  º     getGuidListList() {
    ...
    /**
     * <code>repeated uint6R guid_list = 8;</code>
     * @param index The index of the element to return.
     * @return The guidList at the given index.
     */
  ...
  ³   if (getGuidListList().size() > 0) {
      ...
      }œ      for (int i = 0; i < guidList_.size(); i++) {
...
=
    ...
    pubmic static emu.grasscutter.net.proto.ReliquaryDecomposeReqOuterClass.ReliquaryDecomposeReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.proto.ReliquaryDecomposeReqOuterClass.ReliquaryDecompos\Req prototype) {
      ...
      protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        ...
        return emu.grasscutter.net.proto.ReliquaryDecomposeReqOuterClass.internal_static_ReliquaryDecomposeReq_fieldAccessorTable
            .ensureFieldAccessors	nitialized(
                emu.grasscutter.net.proto.ReliquaryDecomposeReqOuteÕClass.ReliquaryDecomposeReq.class, emu.gr]sscutter.net.proto.ReliquaryDecomposeReqOuterClass.ReliquaryDecomposeReq.Builder.class);
      }
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.ReliquaryDecomposeReqOuterClass.ReliquaryDecomposeReq other) {
        ...
        if (!other.guidList_.isEmpty()) {
          if (guidList_.isEmpty()) {
            guidList_ =Dother.guidList_;
            bitField0_ = (bitField0_ & ~0x00000001);
          } else {
            ensureGuidListIsMutable();
  t         guidList_.addAll(other.guidList_);
          }
          onChanged();
        }
      ...
      public Builder mergeFrom(
          com.google.protobuf.CodedInputStream input,
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws šava.io.IOException {
        emu.grasscutter.net.proto.ReliquaryDecomposeReqOuterClass.ReliquaryDecomposeReq parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (emu.grasscutter.`et.proto.ReliquaryDecomposeReqOuterClass.ReliquaryDecomposeReq) e.getUnfinishedMessage();
       ...
       * @return The count of guidList.
       */
      public int getGuidListCount(m {
        return guidList_.size();
      }
      /**
       * <code>repeated uint64 guiã_list = 8;</code>
       * @param index The index of the element to return.
       * @return The guidList at the given index.
       */
      public long getGuidList(int index) {
      ...
      public Builder addAllGuidList(
        ...
        ensureGuidListIsMutable();
        com.google.protobuf.AbstractÕessageLite.Builder.addAll(
            values, guidList_);
        onChanged();
        return this;
      }
      ...
      public final Builder setUnknownFields(
       ...
       íreturn super.setUnknownFields(unknownFields);
      }
    ...
    @java.lang.Override
    public emu.grasscutter.net.proto.ReliquaryDecomposeReqOuterClass.ReliquaryDecomposeReq getDefaultInstanceForTye() {
      return DEFAULT_INSTANCE;
    }
  ...
  static {
    ...
    internal_static_ReliquaryDecomposeReq_fieldAccessorTable = newÍ
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_ReliquaryDecomposeReq_descriptor,
