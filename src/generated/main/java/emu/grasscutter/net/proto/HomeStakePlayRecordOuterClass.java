...
public final class HomeStakePlayRecordOuterClass {
    ...
    public interface HomeStakePlayRecordOrBuilder
            extends
        ...
        emu.grasscutter.net.proto.HomeGroupPlayerInfoOuterClass.HomeGroupPlayerInfo
                getEngagedPlayerInfoList(int index);
        /** <code>repeated .HomeGroupPlayerInfo engaged_player_info_list = 1;</code> */
        ...
        emu.grasscutter.net.proto.HomeGroupPlayerInfoOuterClass.HomeGroupPlayerInfoOrBuilder
                getEngagedPlayerInfoListOrBuilder(int index);
     ...
     */
    public static final class HomeStakePlayRecord extends com.google.protobuf.GeneratedMessageV3
            implements
        ...
        public static final com.google.protobuf.Descriptors.Descriptor getDescriptor() {
            return emu.grasscutter.net.proto.HomeStakePlayRecordOuterClass
        ...
        protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
            ...
            return emu.grasscutter.net.proto.HomeStakePlayRecordOuterClass
                    ...
                    .ensureFieldAccessorsInitialized(
                            emu.grasscutter.net.proto.HomeStakePlayRecordOuterClass.HomeStakePlayRecord.class,
                            emu.grasscutter.net.proto.HomeStakePlayRecordOuterClass.HomeStakePlayRecord.Builder
                                    .class);
        }
            ...
            for (int i = 0; i < engagedPlayerInfoList_.size(); i++) {
                size +=
                        com.google.protobuf.CodedOutputStream.computeMessageSize(
                                1, engagedPlayerInfoList_.get(i));
            }
            if (timestamp_ != 0) {
        ...
        public boolean equals(final java.lang.Object obj) {
            ...
            if (!(obj
                    instanceof emu.grasscutter.net.proto.HomeStakePlayRecordOuterClass.HomeStakePlayRecord)) {
                return super.equals(obj);
            }
            emu.grasscutter.net.proto.HomeStakePlayRecordOuterClass.HomeStakePlayRecord other =
                    (emu.grasscutter.net.proto.HomeStakePlayRecordOuterClass.HomeStakePlayRecord) obj;

            if (!getEngagedPlayerInfoListList().equals(other.getEngagedPlayerInfoListList()))
                return false;
        ...
        public static emu.grasscutter.net.proto.HomeStakePlayRecordOuterClass.HomeStakePlayRecord
        ...
        public static Builder newBuilder(
                emu.grasscutter.net.proto.HomeStakePlayRecordOuterClass.HomeStakePlayRecord prototype) {
        ...
        public static final class Builder
            ...
            // Construct using
            // emu.grasscutter.net.proto.HomeStakePlayRecordOuterClass.HomeStakePlayRecord.newBuilder()
            private Builder() {
            ...
            @java.lang.Override
            public emu.grasscutter.net.proto.HomeStakePlayRecordOuterClass.HomeStakePlayRecord
                    getDefaultInstanceForType() {
                return emu.grasscutter.net.proto.HomeStakePlayRecordOuterClass.HomeStakePlayRecord
                        .getDefaultInstance();
            }

            @java.lang.Override
            public emu.grasscutter.net.proto.HomeStakePlayRecordOuterClass.HomeStakePlayRecord build() {
                emu.grasscutter.net.proto.HomeStakePlayRecordOuterClass.HomeStakePlayRecord result =
                        buildPartial();
            ...
            public emu.grasscutter.net.proto.HomeStakePlayRecordOuterClass.HomeStakePlayRecord
                    buildPartial() {
                emu.grasscutter.net.proto.HomeStakePlayRecordOuterClass.HomeStakePlayRecord result =
                        new emu.grasscutter.net.proto.HomeStakePlayRecordOuterClass.HomeStakePlayRecord(this);
            ...
            public Builder mergeFrom(com.google.protobuf.Message other) {
                if (other
                        instanceof
                        emu.grasscutter.net.proto.HomeStakePlayRecordOuterClass.HomeStakePlayRecord) {
                    return mergeFrom(
                            (emu.grasscutter.net.proto.HomeStakePlayRecordOuterClass.HomeStakePlayRecord) other);
                } else {
            ...
            public Builder mergeFrom(
                    ...
                    com.google.protobuf.ExtensionRegistryLite extensionRegistry)
                    throws java.io.IOException {
                emu.grasscutter.net.proto.HomeStakePlayRecordOuterClass.HomeStakePlayRecord parsedMessage =
                        null;
                try {
            ...
            public Builder addAllEngagedPlayerInfoList(
                ...
                if (engagedPlayerInfoListBuilder_ == null) {
                    ensureEngagedPlayerInfoListIsMutable();
                    com.google.protobuf.AbstractMessageLite.Builder.addAll(values, engagedPlayerInfoList_);
                    onChanged();
                } else {
            ...
            public emu.grasscutter.net.proto.HomeGroupPlayerInfoOuterClass.HomeGroupPlayerInfo.Builder
                    getEngagedPlayerInfoListBuilder(int index) {
            ...
            /** <code>repeated .HomeGroupPlayerInfo engaged_player_info_list = 1;</code> */
            public emu.grasscutter.net.proto.HomeGroupPlayerInfoOuterClass.HomeGroupPlayerInfo.Builder
                    addEngagedPlayerInfoListBuilder() {
                return getEngagedPlayerInfoListFieldBuilder()
                        .addBuilder(
                                emu.grasscutter.net.proto.HomeGroupPlayerInfoOuterClass.HomeGroupPlayerInfo
                                        .getDefaultInstance());
            }
            /** <code>repeated .HomeGroupPlayerInfo engaged_player_info_list = 1;</code> */
            public emu.grasscutter.net.proto.HomeGroupPlayerInfoOuterClass.HomeGroupPlayerInfo.Builder
                    addEngagedPlayerInfoListBuilder(int index) {
                return getEngagedPlayerInfoListFieldBuilder()
                        .addBuilder(
                                index,
                                emu.grasscutter.net.proto.HomeGroupPlayerInfoOuterClass.HomeGroupPlayerInfo
        ...
        private static final emu.grasscutter.net.proto.HomeStakePlayRecordOuterClass.HomeStakePlayRecord
                DEFAULT_INSTANCE;

        static {
            DEFAULT_INSTANCE =
                    new emu.grasscutter.net.proto.HomeStakePlayRecordOuterClass.HomeStakePlayRecord();
        }
        ...
        private static final com.google.protobuf.Parser<HomeStakePlayRecord> PARSER =
                new com.google.protobuf.AbstractParser<HomeStakePlayRecord>() {
                    @java.lang.Override
    ...
    static {
        ...
        internal_static_HomeStakePlayRecord_descriptor = getDescriptor().getMessageTypes().get(0);
        internal_static_HomeStakePlayRecord_fieldAccessorTable =
                new com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
                        internal_static_HomeStakePlayRecord_descriptor,
                        new java.lang.String[] {
                            "EngagedPlayerInfoList", "Timestamp",
                        });
        emu.grasscutter.net.proto.HomeGroupPlayerInfoOuterClass.getDescriptor();
    }
