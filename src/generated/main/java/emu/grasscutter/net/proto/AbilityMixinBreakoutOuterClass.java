...
public final class AbilityMixinBreakoutOuterClass {
    ...
    public interface AbilityMixinBreakoutOrBuilder
            extends
         ...
         */
        emu.grasscutter.net.proto.BreakoutSyncCreateConnectOuterClass.BreakoutSyncCreateConnect
                getSyncCreateConnect();
        /** <code>.BreakoutSyncCreateConnect sync_create_connect = 6;</code> */
        emu.grasscutter.net.proto.BreakoutSyncCreateConnectOuterClass.BreakoutSyncCreateConnectOrBuilder
                getSyncCreateConnectOrBuilder();
         ...
         */
        emu.grasscutter.net.proto.BreakoutSyncFinishGameOuterClass.BreakoutSyncFinishGame
                getSyncFinishGame();
        /** <code>.BreakoutSyncFinishGame sync_finish_game = 13;</code> */
        emu.grasscutter.net.proto.BreakoutSyncFinishGameOuterClass.BreakoutSyncFinishGameOrBuilder
                getSyncFinishGameOrBuilder();
        ...
        emu.grasscutter.net.proto.BreakoutSyncActionOuterClass.BreakoutSyncActionOrBuilder
                getSyncActionOrBuilder();

        public emu.grasscutter.net.proto.AbilityMixinBreakoutOuterClass.AbilityMixinBreakout.SyncCase
                getSyncCase();
    }
    /**
     *
     ...
     */
    public static final class AbilityMixinBreakout extends com.google.protobuf.GeneratedMessageV3
            implements
            ...
            try {
                ...
                while (!done) {
                    ...
                    switch (tag) {
                        ...
                        case 42:
                            {
                                emu.grasscutter.net.proto.BreakoutSyncSnapShotOuterClass.BreakoutSyncSnapShot
                                                .Builder
                                        subBuilder = null;
                                if (syncCase_ == 5) {
                                    subBuilder =
                                            ((emu.grasscutter.net.proto.BreakoutSyncSnapShotOuterClass
                        ...
                        case 50:
                            {
                                emu.grasscutter.net.proto.BreakoutSyncCreateConnectOuterClass
                                                .BreakoutSyncCreateConnect.Builder
                                        subBuilder = null;
                                if (syncCase_ == 6) {
                                    subBuilder =
                                            ((emu.grasscutter.net.proto.BreakoutSyncCreateConnectOuterClass
                                ...
                                sync_ =
                                        input.readMessage(
                                                emu.grasscutter.net.proto.BreakoutSyncCreateConnectOuterClass
                                                        .BreakoutSyncCreateConnect.parser(),
                                                extensionRegistry);
                                if (subBuilder != null) {
                                    subBuilder.mergeFrom(
                                            (emu.grasscutter.net.proto.BreakoutSyncCreateConnectOuterClass
                        ...
                        case 74:
                            {
                                emu.grasscutter.net.proto.BreakoutSyncPingOuterClass.BreakoutSyncPing.Builder
                                        subBuilder = null;
                                if (syncCase_ == 9) {
                                    subBuilder =
                                            ((emu.grasscutter.net.proto.BreakoutSyncPingOuterClass.BreakoutSyncPing)
                                                            sync_)
                                                    .toBuilder();
                                }
                                sync_ =
                        ...
                        case 106:
                            {
                                ...
                                if (syncCase_ == 13) {
                                    subBuilder =
                                            ((emu.grasscutter.net.proto.BreakoutSyncFinishGameOuterClass
                        ...
                        case 122:
                            {
                                emu.grasscutter.net.proto.BreakoutSyncActionOuterClass.BreakoutSyncAction.Builder
                                        subBuilder = null;
                                if (syncCase_ == 15) {
                                    subBuilder =
                                            ((emu.grasscutter.net.proto.BreakoutSyncActionOuterClass.BreakoutSyncAction)
                                                            sync_)
                                                    .toBuilder();
                                }
                                sync_ =
        ...
        public static final com.google.protobuf.Descriptors.Descriptor getDescriptor() {
            return emu.grasscutter.net.proto.AbilityMixinBreakoutOuterClass
        ...
        protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
            ...
            return emu.grasscutter.net.proto.AbilityMixinBreakoutOuterClass
                    ...
                    .ensureFieldAccessorsInitialized(
                            emu.grasscutter.net.proto.AbilityMixinBreakoutOuterClass.AbilityMixinBreakout.class,
                            emu.grasscutter.net.proto.AbilityMixinBreakoutOuterClass.AbilityMixinBreakout.Builder
                                    .class);
        }
         ...
         */
        public enum SyncType implements com.google.protobuf.ProtocolMessageEnum {
            ...
            public static SyncType forNumber(int value) {
                switch (value) {
                    ...
                    case 1:
                        return SYNC_TYPE_CREATE_CONNECT;
                    case 2:
                        return SYNC_TYPE_START_GAME;
                    case 3:
                        return SYNC_TYPE_PING;
                    case 4:
                        return SYNC_TYPE_FINISH_GAME;
                    case 5:
                        return SYNC_TYPE_SNAP_SHOT;
                    case 6:
                        return SYNC_TYPE_ACTION;
                    default:
                        return null;
                }
            }

            public static com.google.protobuf.Internal.EnumLiteMap<SyncType> internalGetValueMap() {
                return internalValueMap;
            }

            private static final com.google.protobuf.Internal.EnumLiteMap<SyncType> internalValueMap =
            ...
            public static final com.google.protobuf.Descriptors.EnumDescriptor getDescriptor() {
                return emu.grasscutter.net.proto.AbilityMixinBreakoutOuterClass.AbilityMixinBreakout
                        .getDescriptor()
                        .getEnumTypes()
                        .get(0);
            }
            ...
            public static SyncType valueOf(com.google.protobuf.Descriptors.EnumValueDescriptor desc) {
        ...
        public enum SyncCase
            ...
            public static SyncCase forNumber(int value) {
                switch (value) {
                    case 6:
                        return SYNC_CREATE_CONNECT;
                    case 9:
                        return SYNC_PING;
                    case 13:
                        return SYNC_FINISH_GAME;
                    case 5:
                        return SYNC_SNAP_SHOT;
                    case 15:
                        return SYNC_ACTION;
                    case 0:
                        return SYNC_NOT_SET;
        ...
        public SyncCase getSyncCase() {
            return SyncCase.forNumber(syncCase_);
        }
         ...
         */
        @java.lang.Override
        public emu.grasscutter.net.proto.AbilityMixinBreakoutOuterClass.AbilityMixinBreakout.SyncType
                getSyncType() {
         ...
         */
        @java.lang.Override
        public emu.grasscutter.net.proto.BreakoutSyncCreateConnectOuterClass.BreakoutSyncCreateConnect
                getSyncCreateConnect() {
            if (syncCase_ == 6) {
                return (emu.grasscutter.net.proto.BreakoutSyncCreateConnectOuterClass
                                .BreakoutSyncCreateConnect)
                        sync_;
            }
            return emu.grasscutter.net.proto.BreakoutSyncCreateConnectOuterClass.BreakoutSyncCreateConnect
                    .getDefaultInstance();
        }
        /** <code>.BreakoutSyncCreateConnect sync_create_connect = 6;</code> */
        @java.lang.Override
        public emu.grasscutter.net.proto.BreakoutSyncCreateConnectOuterClass
        ...
        public emu.grasscutter.net.proto.BreakoutSyncPingOuterClass.BreakoutSyncPing getSyncPing() {
            ...
            return emu.grasscutter.net.proto.BreakoutSyncPingOuterClass.BreakoutSyncPing
                    .getDefaultInstance();
        }
        /** <code>.BreakoutSyncPing sync_ping = 9;</code> */
        @java.lang.Override
        public emu.grasscutter.net.proto.BreakoutSyncPingOuterClass.BreakoutSyncPingOrBuilder
                getSyncPingOrBuilder() {
            if (syncCase_ == 9) {
                return (emu.grasscutter.net.proto.BreakoutSyncPingOuterClass.BreakoutSyncPing) sync_;
            }
         ...
         */
        @java.lang.Override
        public emu.grasscutter.net.proto.BreakoutSyncFinishGameOuterClass.BreakoutSyncFinishGame
                getSyncFinishGame() {
            if (syncCase_ == 13) {
                return (emu.grasscutter.net.proto.BreakoutSyncFinishGameOuterClass.BreakoutSyncFinishGame)
                        sync_;
            }
            return emu.grasscutter.net.proto.BreakoutSyncFinishGameOuterClass.BreakoutSyncFinishGame
                    .getDefaultInstance();
        ...
        /** <code>.BreakoutSyncFinishGame sync_finish_game = 13;</code> */
        @java.lang.Override
        public emu.grasscutter.net.proto.BreakoutSyncFinishGameOuterClass
         ...
         */
        @java.lang.Override
        public emu.grasscutter.net.proto.BreakoutSyncSnapShotOuterClass.BreakoutSyncSnapShot
                getSyncSnapShot() {
            if (syncCase_ == 5) {
                return (emu.grasscutter.net.proto.BreakoutSyncSnapShotOuterClass.BreakoutSyncSnapShot)
                        sync_;
            }
            return emu.grasscutter.net.proto.BreakoutSyncSnapShotOuterClass.BreakoutSyncSnapShot
                    .getDefaultInstance();
        ...
        /** <code>.BreakoutSyncSnapShot sync_snap_shot = 5;</code> */
        @java.lang.Override
        public emu.grasscutter.net.proto.BreakoutSyncSnapShotOuterClass.BreakoutSyncSnapShotOrBuilder
                getSyncSnapShotOrBuilder() {
            if (syncCase_ == 5) {
                return (emu.grasscutter.net.proto.BreakoutSyncSnapShotOuterClass.BreakoutSyncSnapShot)
                        sync_;
         ...
         */
        @java.lang.Override
        public emu.grasscutter.net.proto.BreakoutSyncActionOuterClass.BreakoutSyncAction
                getSyncAction() {
            if (syncCase_ == 15) {
                return (emu.grasscutter.net.proto.BreakoutSyncActionOuterClass.BreakoutSyncAction) sync_;
            }
            return emu.grasscutter.net.proto.BreakoutSyncActionOuterClass.BreakoutSyncAction
                    .getDefaultInstance();
        }
        /** <code>.BreakoutSyncAction sync_action = 15;</code> */
        @java.lang.Override
        public emu.grasscutter.net.proto.BreakoutSyncActionOuterClass.BreakoutSyncActionOrBuilder
                getSyncActionOrBuilder() {
            if (syncCase_ == 15) {
                return (emu.grasscutter.net.proto.BreakoutSyncActionOuterClass.BreakoutSyncAction) sync_;
            }
        ...
        public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
            ...
            if (syncCase_ == 9) {
                output.writeMessage(
                        9, (emu.grasscutter.net.proto.BreakoutSyncPingOuterClass.BreakoutSyncPing) sync_);
            }
            if (syncCase_ == 13) {
                output.writeMessage(
                        13,
            ...
            if (syncCase_ == 15) {
                output.writeMessage(
                        15, (emu.grasscutter.net.proto.BreakoutSyncActionOuterClass.BreakoutSyncAction) sync_);
            }
        ...
        public int getSerializedSize() {
            ...
            if (syncType_
                    != emu.grasscutter.net.proto.AbilityMixinBreakoutOuterClass.AbilityMixinBreakout.SyncType
                            .SYNC_TYPE_NONE
                            .getNumber()) {
                size += com.google.protobuf.CodedOutputStream.computeEnumSize(4, syncType_);
            }
            if (syncCase_ == 5) {
                size +=
        ...
        public boolean equals(final java.lang.Object obj) {
            ...
            if (!(obj
                    instanceof
                    emu.grasscutter.net.proto.AbilityMixinBreakoutOuterClass.AbilityMixinBreakout)) {
                return super.equals(obj);
            }
            emu.grasscutter.net.proto.AbilityMixinBreakoutOuterClass.AbilityMixinBreakout other =
                    (emu.grasscutter.net.proto.AbilityMixinBreakoutOuterClass.AbilityMixinBreakout) obj;
            ...
            switch (syncCase_) {
                case 6:
                    if (!getSyncCreateConnect().equals(other.getSyncCreateConnect())) return false;
                    break;
                case 9:
                    if (!getSyncPing().equals(other.getSyncPing())) return false;
                    break;
                case 13:
                    if (!getSyncFinishGame().equals(other.getSyncFinishGame())) return false;
                    break;
                case 5:
                    if (!getSyncSnapShot().equals(other.getSyncSnapShot())) return false;
                    break;
                case 15:
                    if (!getSyncAction().equals(other.getSyncAction())) return false;
                    break;
                case 0:
                default:
            }
        ...
        public static emu.grasscutter.net.proto.AbilityMixinBreakoutOuterClass.AbilityMixinBreakout
        ...
        public static Builder newBuilder(
                emu.grasscutter.net.proto.AbilityMixinBreakoutOuterClass.AbilityMixinBreakout prototype) {
        ...
        public static final class Builder
            ...
            // Construct using
            // emu.grasscutter.net.proto.AbilityMixinBreakoutOuterClass.AbilityMixinBreakout.newBuilder()
            private Builder() {
            ...
            @java.lang.Override
            public emu.grasscutter.net.proto.AbilityMixinBreakoutOuterClass.AbilityMixinBreakout
            ...
            public emu.grasscutter.net.proto.AbilityMixinBreakoutOuterClass.AbilityMixinBreakout build() {
                emu.grasscutter.net.proto.AbilityMixinBreakoutOuterClass.AbilityMixinBreakout result =
                        buildPartial();
            ...
            public emu.grasscutter.net.proto.AbilityMixinBreakoutOuterClass.AbilityMixinBreakout
                    buildPartial() {
                emu.grasscutter.net.proto.AbilityMixinBreakoutOuterClass.AbilityMixinBreakout result =
                        new emu.grasscutter.net.proto.AbilityMixinBreakoutOuterClass.AbilityMixinBreakout(this);
            ...
            public emu.grasscutter.net.proto.BreakoutSyncCreateConnectOuterClass.BreakoutSyncCreateConnect
                ...
                if (syncCreateConnectBuilder_ == null) {
                    ...
                    return emu.grasscutter.net.proto.BreakoutSyncCreateConnectOuterClass
                            .BreakoutSyncCreateConnect.getDefaultInstance();
                } else {
                    if (syncCase_ == 6) {
            ...
            /** <code>.BreakoutSyncCreateConnect sync_create_connect = 6;</code> */
            public Builder mergeSyncCreateConnect(
                    emu.grasscutter.net.proto.BreakoutSyncCreateConnectOuterClass.BreakoutSyncCreateConnect
                            value) {
                if (syncCreateConnectBuilder_ == null) {
                    if (syncCase_ == 6
                        ...
                        sync_ =
                                emu.grasscutter.net.proto.BreakoutSyncCreateConnectOuterClass
                                        .BreakoutSyncCreateConnect.newBuilder(
                                                (emu.grasscutter.net.proto.BreakoutSyncCreateConnectOuterClass
                                                                .BreakoutSyncCreateConnect)
                                                        sync_)
                                        .mergeFrom(value)
            ...
            public Builder setSyncPing(
                    emu.grasscutter.net.proto.BreakoutSyncPingOuterClass.BreakoutSyncPing value) {
                if (syncPingBuilder_ == null) {
                    if (value == null) {
                        throw new NullPointerException();
                    }
                    ...
                    if (syncCase_ == 9
                            && sync_
                                    != emu.grasscutter.net.proto.BreakoutSyncPingOuterClass.BreakoutSyncPing
                                            .getDefaultInstance()) {
                        sync_ =
                                emu.grasscutter.net.proto.BreakoutSyncPingOuterClass.BreakoutSyncPing.newBuilder(
                                                (emu.grasscutter.net.proto.BreakoutSyncPingOuterClass.BreakoutSyncPing)
                                                        sync_)
                                        .mergeFrom(value)
                                        .buildPartial();
            ...
            /** <code>.BreakoutSyncPing sync_ping = 9;</code> */
            public emu.grasscutter.net.proto.BreakoutSyncPingOuterClass.BreakoutSyncPing.Builder
                    getSyncPingBuilder() {
            ...
            public emu.grasscutter.net.proto.BreakoutSyncFinishGameOuterClass.BreakoutSyncFinishGame
                ...
                if (syncFinishGameBuilder_ == null) {
                    if (syncCase_ == 13) {
                        return (emu.grasscutter.net.proto.BreakoutSyncFinishGameOuterClass
                                        .BreakoutSyncFinishGame)
                                sync_;
                    }
                    return emu.grasscutter.net.proto.BreakoutSyncFinishGameOuterClass.BreakoutSyncFinishGame
            ...
            public Builder setSyncFinishGame(
                    emu.grasscutter.net.proto.BreakoutSyncFinishGameOuterClass.BreakoutSyncFinishGame value) {
                if (syncFinishGameBuilder_ == null) {
                    if (value == null) {
                        throw new NullPointerException();
                    }
            ...
            /** <code>.BreakoutSyncFinishGame sync_finish_game = 13;</code> */
            public Builder setSyncFinishGame(
                    emu.grasscutter.net.proto.BreakoutSyncFinishGameOuterClass.BreakoutSyncFinishGame.Builder
                            builderForValue) {
                if (syncFinishGameBuilder_ == null) {
                    sync_ = builderForValue.build();
                    onChanged();
            ...
            /** <code>.BreakoutSyncFinishGame sync_finish_game = 13;</code> */
            public Builder mergeSyncFinishGame(
                    emu.grasscutter.net.proto.BreakoutSyncFinishGameOuterClass.BreakoutSyncFinishGame value) {
                if (syncFinishGameBuilder_ == null) {
                    if (syncCase_ == 13
                            && sync_
                                    != emu.grasscutter.net.proto.BreakoutSyncFinishGameOuterClass
                                            .BreakoutSyncFinishGame.getDefaultInstance()) {
                        sync_ =
                                emu.grasscutter.net.proto.BreakoutSyncFinishGameOuterClass.BreakoutSyncFinishGame
                                        .newBuilder(
                                                (emu.grasscutter.net.proto.BreakoutSyncFinishGameOuterClass
            ...
            private com.google.protobuf.SingleFieldBuilderV3<
                            emu.grasscutter.net.proto.BreakoutSyncSnapShotOuterClass.BreakoutSyncSnapShot,
                            emu.grasscutter.net.proto.BreakoutSyncSnapShotOuterClass.BreakoutSyncSnapShot.Builder,
                            emu.grasscutter.net.proto.BreakoutSyncSnapShotOuterClass
            ...
            public Builder setSyncSnapShot(
                    emu.grasscutter.net.proto.BreakoutSyncSnapShotOuterClass.BreakoutSyncSnapShot value) {
                if (syncSnapShotBuilder_ == null) {
                    if (value == null) {
                        throw new NullPointerException();
                    }
            ...
            /** <code>.BreakoutSyncSnapShot sync_snap_shot = 5;</code> */
            public Builder mergeSyncSnapShot(
                    emu.grasscutter.net.proto.BreakoutSyncSnapShotOuterClass.BreakoutSyncSnapShot value) {
                if (syncSnapShotBuilder_ == null) {
                    if (syncCase_ == 5
                            && sync_
            ...
            /** <code>.BreakoutSyncSnapShot sync_snap_shot = 5;</code> */
            public emu.grasscutter.net.proto.BreakoutSyncSnapShotOuterClass.BreakoutSyncSnapShot.Builder
                    getSyncSnapShotBuilder() {
            ...
            public Builder setSyncAction(
                    emu.grasscutter.net.proto.BreakoutSyncActionOuterClass.BreakoutSyncAction value) {
                if (syncActionBuilder_ == null) {
                    if (value == null) {
                        throw new NullPointerException();
                    }
            ...
            /** <code>.BreakoutSyncAction sync_action = 15;</code> */
            public Builder mergeSyncAction(
                    emu.grasscutter.net.proto.BreakoutSyncActionOuterClass.BreakoutSyncAction value) {
                if (syncActionBuilder_ == null) {
                    if (syncCase_ == 15
                            && sync_
            ...
            /** <code>.BreakoutSyncAction sync_action = 15;</code> */
            public emu.grasscutter.net.proto.BreakoutSyncActionOuterClass.BreakoutSyncAction.Builder
                    getSyncActionBuilder() {
        ...
        private static final emu.grasscutter.net.proto.AbilityMixinBreakoutOuterClass
                        .AbilityMixinBreakout
                DEFAULT_INSTANCE;

        static {
            DEFAULT_INSTANCE =
                    new emu.grasscutter.net.proto.AbilityMixinBreakoutOuterClass.AbilityMixinBreakout();
        }
        ...
        private static final com.google.protobuf.Parser<AbilityMixinBreakout> PARSER =
                new com.google.protobuf.AbstractParser<AbilityMixinBreakout>() {
                    @java.lang.Override
    ...
    static {
        ...
        internal_static_AbilityMixinBreakout_descriptor = getDescriptor().getMessageTypes().get(0);
        internal_static_AbilityMixinBreakout_fieldAccessorTable =
