...
public final class EvtCreateGadgetNotifyOuterClass {
    ...
    public interface EvtCreateGadgetNotifyOrBuilder
        ...
        /**
         * <code>uint32 DNAKOOADMLE = 9;</code>
         *
         * @return The dNAKOOADMLE.
         */
        int getDNAKOOADMLE();

        /**
         * <code>repeated uint32 target_lock_point_index_list = 1869;</code>
         *
        ...
        /**
         * <code>bool OFEAKOJIKCA = 12;</code>
         *
         * @return The oFEAKOJIKCA.
         */
        boolean getOFEAKOJIKCA();
        ...
        /**
         * <code>bool is_async_load = 174;</code>
         *
        ...
        /**
         * <code>uint32 prop_owner_entity_id = 2;</code>
         *
        ...
        /**
         * <code>bool is_peer_id_from_player = 172;</code>
         *
        ...
        /**
         * <code>.Vector InitEulerAngles = 14;</code>
         *
        ...
        /**
         * <code>bool KJLIAJBFMKL = 6;</code>
         *
         * @return The kJLIAJBFMKL.
         */
        boolean getKJLIAJBFMKL();

        /**
         * <code>repeated uint32 target_entity_id_list = 418;</code>
         *
    ...
    public static final class EvtCreateGadgetNotify extends com.google.protobuf.GeneratedMessageV3
        ...
        public static final int DNAKOOADMLE_FIELD_NUMBER = 9;
        private int dNAKOOADMLE_;
        /**
         * <code>uint32 DNAKOOADMLE = 9;</code>
         *
         * @return The dNAKOOADMLE.
         */
        @java.lang.Override
        public int getDNAKOOADMLE() {
            return dNAKOOADMLE_;
        }

        public static final int TARGET_LOCK_POINT_INDEX_LIST_FIELD_NUMBER = 1869;
         ...
         */
        @java.lang.Override
        public java.util.List<java.lang.Integer> getTargetLockPointIndexListList() {
        ...
        public static final int OFEAKOJIKCA_FIELD_NUMBER = 12;
        private boolean oFEAKOJIKCA_;
        /**
         * <code>bool OFEAKOJIKCA = 12;</code>
         *
         * @return The oFEAKOJIKCA.
        ...
        public static final int IS_ASYNC_LOAD_FIELD_NUMBER = 174;
        ...
        public static final int INITPOS_FIELD_NUMBER = 1;
        ...
        public static final int IS_PEER_ID_FROM_PLAYER_FIELD_NUMBER = 172;
        ...
        public static final int INITEULERANGLES_FIELD_NUMBER = 14;
        ...
        public static final int KJLIAJBFMKL_FIELD_NUMBER = 6;
        private boolean kJLIAJBFMKL_;
        /**
         * <code>bool KJLIAJBFMKL = 6;</code>
         *
         * @return The kJLIAJBFMKL.
         */
        @java.lang.Override
        public boolean getKJLIAJBFMKL() {
            return kJLIAJBFMKL_;
        }

        public static final int TARGET_ENTITY_ID_LIST_FIELD_NUMBER = 418;
         ...
         */
        @java.lang.Override
        public java.util.List<java.lang.Integer> getTargetEntityIdListList() {
        ...
        public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
            getSerializedSize();
            if (initPos_ != null) {
                output.writeMessage(1, getInitPos());
            }
            ...
            if (kJLIAJBFMKL_ != false) {
                output.writeBool(6, kJLIAJBFMKL_);
            }
            ...
            if (dNAKOOADMLE_ != 0) {
                output.writeUInt32(9, dNAKOOADMLE_);
            }
            if (entityId_ != 0) {
            ...
            if (oFEAKOJIKCA_ != false) {
                output.writeBool(12, oFEAKOJIKCA_);
            }
            if (guid_ != 0L) {
                output.writeUInt64(13, guid_);
            }
            if (initEulerAngles_ != null) {
                output.writeMessage(14, getInitEulerAngles());
            }
            if (configId_ != 0) {
                output.writeUInt32(15, configId_);
            }
            if (isPeerIdFromPlayer_ != false) {
                output.writeBool(172, isPeerIdFromPlayer_);
            }
            if (isAsyncLoad_ != false) {
                output.writeBool(174, isAsyncLoad_);
            }
            if (getTargetEntityIdListList().size() > 0) {
                output.writeUInt32NoTag(3346);
        ...
        public int getSerializedSize() {
            ...
            size = 0;
            if (initPos_ != null) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(1, getInitPos());
            }
            if (propOwnerEntityId_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(2, propOwnerEntityId_);
            }
            if (roomId_ != 0) {
            ...
            if (forwardType_
                    != emu.grasscutter.net.proto.ForwardTypeOuterClass.ForwardType.FORWARD_TYPE_LOCAL
                            .getNumber()) {
                size += com.google.protobuf.CodedOutputStream.computeEnumSize(4, forwardType_);
            }
            if (campType_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(5, campType_);
            }
            if (kJLIAJBFMKL_ != false) {
                size += com.google.protobuf.CodedOutputStream.computeBoolSize(6, kJLIAJBFMKL_);
            }
            if (targetEntityId_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(7, targetEntityId_);
            }
            if (ownerEntityId_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(8, ownerEntityId_);
            }
            if (dNAKOOADMLE_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(9, dNAKOOADMLE_);
            }
            if (entityId_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(10, entityId_);
            }
            if (campId_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(11, campId_);
            }
            if (oFEAKOJIKCA_ != false) {
                size += com.google.protobuf.CodedOutputStream.computeBoolSize(12, oFEAKOJIKCA_);
            }
            if (guid_ != 0L) {
                size += com.google.protobuf.CodedOutputStream.computeUInt64Size(13, guid_);
            }
            if (initEulerAngles_ != null) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(14, getInitEulerAngles());
            }
            if (configId_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(15, configId_);
            }
            if (isPeerIdFromPlayer_ != false) {
                size += com.google.protobuf.CodedOutputStream.computeBoolSize(172, isPeerIdFromPlayer_);
            }
            if (isAsyncLoad_ != false) {
                size += com.google.protobuf.CodedOutputStream.computeBoolSize(174, isAsyncLoad_);
            }
            {
                int dataSize = 0;
                for (int i = 0; i < targetEntityIdList_.size(); i++) {
        ...
        public boolean equals(final java.lang.Object obj) {
            ...
            if (getDNAKOOADMLE() != other.getDNAKOOADMLE()) return false;
            if (!getTargetLockPointIndexListList().equals(other.getTargetLockPointIndexListList()))
                return false;
            if (getOFEAKOJIKCA() != other.getOFEAKOJIKCA()) return false;
            ...
            if (getKJLIAJBFMKL() != other.getKJLIAJBFMKL()) return false;
        ...
        public int hashCode() {
            ...
            hash = (37 * hash) + DNAKOOADMLE_FIELD_NUMBER;
            hash = (53 * hash) + getDNAKOOADMLE();
            ...
            hash = (37 * hash) + OFEAKOJIKCA_FIELD_NUMBER;
            hash = (53 * hash) + com.google.protobuf.Internal.hashBoolean(getOFEAKOJIKCA());
            ...
            hash = (37 * hash) + KJLIAJBFMKL_FIELD_NUMBER;
            hash = (53 * hash) + com.google.protobuf.Internal.hashBoolean(getKJLIAJBFMKL());
        ...
        public static final class Builder
            ...
            // Construct using
            // emu.grasscutter.net.proto.EvtCreateGadgetNotifyOuterClass.EvtCreateGadgetNotify.newBuilder()
            private Builder() {
            ...
            @java.lang.Override
            public emu.grasscutter.net.proto.EvtCreateGadgetNotifyOuterClass.EvtCreateGadgetNotify
                    getDefaultInstanceForType() {
                return emu.grasscutter.net.proto.EvtCreateGadgetNotifyOuterClass.EvtCreateGadgetNotify
                        .getDefaultInstance();
            }
            ...
            public emu.grasscutter.net.proto.EvtCreateGadgetNotifyOuterClass.EvtCreateGadgetNotify
                    build() {
                emu.grasscutter.net.proto.EvtCreateGadgetNotifyOuterClass.EvtCreateGadgetNotify result =
                        buildPartial();
            ...
            public emu.grasscutter.net.proto.EvtCreateGadgetNotifyOuterClass.EvtCreateGadgetNotify
                ...
                result.kJLIAJBFMKL_ = kJLIAJBFMKL_;
            ...
            public Builder mergeFrom(
                ...
                if (other.getDNAKOOADMLE() != 0) {
                    setDNAKOOADMLE(other.getDNAKOOADMLE());
                }
                ...
                if (other.getOFEAKOJIKCA() != false) {
                    setOFEAKOJIKCA(other.getOFEAKOJIKCA());
                }
                ...
                if (other.getKJLIAJBFMKL() != false) {
                    setKJLIAJBFMKL(other.getKJLIAJBFMKL());
                }
             ...
             * <code>uint32 DNAKOOADMLE = 9;</code>
             *
             * @param value The dNAKOOADMLE to set.
             * @return This builder for chaining.
             */
            public Builder setDNAKOOADMLE(int value) {
             ...
             * @return This builder for chaining.
             */
            public Builder clearDNAKOOADMLE() {
            ...
            public java.util.List<java.lang.Integer> getTargetLockPointIndexListList() {
                return ((bitField0_ & 0x00000001) != 0)
                        ? java.util.Collections.unmodifiableList(targetLockPointIndexList_)
             ...
             * <code>bool OFEAKOJIKCA = 12;</code>
             *
             * @param value The oFEAKOJIKCA to set.
             * @return This builder for chaining.
             */
            public Builder setOFEAKOJIKCA(boolean value) {
             ...
             * @return This builder for chaining.
             */
            public Builder clearOFEAKOJIKCA() {
             ...
             * <code>bool KJLIAJBFMKL = 6;</code>
             *
             * @param value The kJLIAJBFMKL to set.
             * @return This builder for chaining.
             */
            public Builder setKJLIAJBFMKL(boolean value) {
             ...
             * @return This builder for chaining.
             */
            public Builder clearKJLIAJBFMKL() {
            ...
            public java.util.List<java.lang.Integer> getTargetEntityIdListList() {
                return ((bitField0_ & 0x00000002) != 0)
                        ? java.util.Collections.unmodifiableList(targetEntityIdList_)
                        : targetEntityIdList_;
            }
            /**
             * <code>repeated uint32 target_entity_id_list = 418;</code>
        ...
        private static final com.google.protobuf.Parser<EvtCreateGadgetNotify> PARSER =
                new com.google.protobuf.AbstractParser<EvtCreateGadgetNotify>() {
                    @java.lang.Override
    ...
    static {
        java.lang.String[] descriptorData = {
            "\n\033EvtCreateGadgetNotify.proto\032\021ForwardTy"
                    ...
                    + "t_index_list\030\315\016 \003(\r\022\023\n\013OFEAKOJIKCA\030\014 \001(\010"
                    + "\022\021\n\tentity_id\030\n \001(\r\022\"\n\014forward_type\030\004 \001("
                    + "\0162\014.ForwardType\022\026\n\ris_async_load\030\256\001 \001(\010\022"
                    + "\030\n\007InitPos\030\001 \001(\0132\007.Vector\022\027\n\017owner_entit"
                    + "y_id\030\010 \001(\r\022\017\n\007room_id\030\003 \001(\r\022\034\n\024prop_owne"
                    + "r_entity_id\030\002 \001(\r\022\030\n\020target_entity_id\030\007 "
                    + "\001(\r\022\037\n\026is_peer_id_from_player\030\254\001 \001(\010\022\021\n\t"
                    + "config_id\030\017 \001(\r\022\021\n\tcamp_type\030\005 \001(\r\022 \n\017In"
                    + "itEulerAngles\030\016 \001(\0132\007.Vector\022\023\n\013KJLIAJBF"
                    + "MKL\030\006 \001(\010\022\036\n\025target_entity_id_list\030\242\003 \003("
        ...
        internal_static_EvtCreateGadgetNotify_descriptor = getDescriptor().getMessageTypes().get(0);
        internal_static_EvtCreateGadgetNotify_fieldAccessorTable =
