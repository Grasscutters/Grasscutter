...
public final class SignInInfoRspOuterClass {
    ...
    public interface SignInInfoRspOrBuilder
            extends
     ...
     */
    public static final class SignInInfoRsp extends com.google.protobuf.GeneratedMessageV3
            implements
        ...
        public static final com.google.protobuf.Descriptors.Descriptor getDescriptor() {
            return emu.grasscutter.net.proto.SignInInfoRspOuterClass
        ...
        protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
            ...
            return emu.grasscutter.net.proto.SignInInfoRspOuterClass
                    ...
                    .ensureFieldAccessorsInitialized(
                            emu.grasscutter.net.proto.SignInInfoRspOuterClass.SignInInfoRsp.class,
                            emu.grasscutter.net.proto.SignInInfoRspOuterClass.SignInInfoRsp.Builder.class);
        }

        public static final int SIGN_IN_INFO_LIST_FIELD_NUMBER = 7;
        private java.util.List<emu.grasscutter.net.proto.SignInInfoOuterClass.SignInInfo>
                signInInfoList_;
        /** <code>repeated .SignInInfo sign_in_info_list = 7;</code> */
        @java.lang.Override
        public java.util.List<emu.grasscutter.net.proto.SignInInfoOuterClass.SignInInfo>
                getSignInInfoListList() {
        ...
        public java.util.List<
                        ? extends emu.grasscutter.net.proto.SignInInfoOuterClass.SignInInfoOrBuilder>
                getSignInInfoListOrBuilderList() {
            return signInInfoList_;
        }
        /** <code>repeated .SignInInfo sign_in_info_list = 7;</code> */
        ...
        public emu.grasscutter.net.proto.SignInInfoOuterClass.SignInInfoOrBuilder
                getSignInInfoListOrBuilder(int index) {
            return signInInfoList_.get(index);
        }
        ...
        public int getSerializedSize() {
            ...
            size = 0;
            for (int i = 0; i < signInInfoList_.size(); i++) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(7, signInInfoList_.get(i));
            }
            if (retcode_ != 0) {
        ...
        public boolean equals(final java.lang.Object obj) {
            ...
            emu.grasscutter.net.proto.SignInInfoRspOuterClass.SignInInfoRsp other =
                    (emu.grasscutter.net.proto.SignInInfoRspOuterClass.SignInInfoRsp) obj;

            if (!getSignInInfoListList().equals(other.getSignInInfoListList())) return false;
        ...
        public static emu.grasscutter.net.proto.SignInInfoRspOuterClass.SignInInfoRsp
        ...
        public static Builder newBuilder(
                emu.grasscutter.net.proto.SignInInfoRspOuterClass.SignInInfoRsp prototype) {
        ...
        public static final class Builder
            ...
            // Construct using
            // emu.grasscutter.net.proto.SignInInfoRspOuterClass.SignInInfoRsp.newBuilder()
            private Builder() {
            ...
            @java.lang.Override
            public emu.grasscutter.net.proto.SignInInfoRspOuterClass.SignInInfoRsp
            ...
            public emu.grasscutter.net.proto.SignInInfoRspOuterClass.SignInInfoRsp buildPartial() {
                emu.grasscutter.net.proto.SignInInfoRspOuterClass.SignInInfoRsp result =
                        new emu.grasscutter.net.proto.SignInInfoRspOuterClass.SignInInfoRsp(this);
            ...
            public Builder mergeFrom(
                    emu.grasscutter.net.proto.SignInInfoRspOuterClass.SignInInfoRsp other) {
                if (other
                        == emu.grasscutter.net.proto.SignInInfoRspOuterClass.SignInInfoRsp.getDefaultInstance())
                    return this;
                if (signInInfoListBuilder_ == null) {
            ...
            public Builder mergeFrom(
                ...
                try {
                    ...
                    parsedMessage =
                            (emu.grasscutter.net.proto.SignInInfoRspOuterClass.SignInInfoRsp)
            ...
            private void ensureSignInInfoListIsMutable() {
                if (!((bitField0_ & 0x00000001) != 0)) {
                    signInInfoList_ =
                            new java.util.ArrayList<emu.grasscutter.net.proto.SignInInfoOuterClass.SignInInfo>(
                                    signInInfoList_);
            ...
            /** <code>repeated .SignInInfo sign_in_info_list = 7;</code> */
            public emu.grasscutter.net.proto.SignInInfoOuterClass.SignInInfo getSignInInfoList(
                    int index) {
                if (signInInfoListBuilder_ == null) {
                    return signInInfoList_.get(index);
                } else {
            ...
            public Builder addAllSignInInfoList(
                    java.lang.Iterable<? extends emu.grasscutter.net.proto.SignInInfoOuterClass.SignInInfo>
                            values) {
                if (signInInfoListBuilder_ == null) {
                    ensureSignInInfoListIsMutable();
                    com.google.protobuf.AbstractMessageLite.Builder.addAll(values, signInInfoList_);
                    onChanged();
                } else {
            ...
            public emu.grasscutter.net.proto.SignInInfoOuterClass.SignInInfo.Builder
                    getSignInInfoListBuilder(int index) {
            ...
            /** <code>repeated .SignInInfo sign_in_info_list = 7;</code> */
            public emu.grasscutter.net.proto.SignInInfoOuterClass.SignInInfo.Builder
                    addSignInInfoListBuilder() {
                return getSignInInfoListFieldBuilder()
                        .addBuilder(
                                emu.grasscutter.net.proto.SignInInfoOuterClass.SignInInfo.getDefaultInstance());
            }
            /** <code>repeated .SignInInfo sign_in_info_list = 7;</code> */
            public emu.grasscutter.net.proto.SignInInfoOuterClass.SignInInfo.Builder
                    addSignInInfoListBuilder(int index) {
                return getSignInInfoListFieldBuilder()
                        .addBuilder(
                                index,
                                emu.grasscutter.net.proto.SignInInfoOuterClass.SignInInfo.getDefaultInstance());
        ...
        private static final emu.grasscutter.net.proto.SignInInfoRspOuterClass.SignInInfoRsp
                DEFAULT_INSTANCE;
        ...
        private static final com.google.protobuf.Parser<SignInInfoRsp> PARSER =
                new com.google.protobuf.AbstractParser<SignInInfoRsp>() {
                    @java.lang.Override
    ...
    static {
        ...
        internal_static_SignInInfoRsp_descriptor = getDescriptor().getMessageTypes().get(0);
        internal_static_SignInInfoRsp_fieldAccessorTable =
                new com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
                        internal_static_SignInInfoRsp_descriptor,
                        new java.lang.String[] {
                            "SignInInfoList", "Retcode",
                        });
        emu.grasscutter.net.proto.SignInInfoOuterClass.getDescriptor();
    }
