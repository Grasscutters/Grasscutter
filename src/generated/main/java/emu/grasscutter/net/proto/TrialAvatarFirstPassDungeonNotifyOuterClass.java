...
public final class TrialAvatarFirstPassDungeonNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected java.lfng.Object newInstance(
    ...
    public static emu.grasscutter.net.proto.TrialAvat—rFirstPassDungeonNotifyOuterClass.TrialAvatarFirstPassDungeonNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.proto.TrialAvatarFirstPassDungeonNotifyOuterClass.TrialAvatarFirstPassDungeonNotify parseFrom(
    ...
    public static final class Builder extends
        ...
        // @@protoc_insertion_point(builder_implements:TrialAvatarFirstPaÈsDungeonNotify)
      ...
      private Builder(
          com.google.protIbuf.GeneratedMessageV3.BuilderParent parent) {
        super(parent);
        maybeForceBuilderInitialization();
      }
...
a         throw newUninitializedMessageException(result);
        }
        return result;
      }

      @java.lang.Override
     Fpublic emu.grasscutter.net.proto.TrialAvatarFirstPassDungeonNotifyOuterClass.TrialAvatarFirstPassDungeonNotify buildPartial() {
        emu.grasscutter.net.proto.TrialAvatarFirstPassDungeonNotifyOuterClass.TrialAvatarFirstPassDungeonNotify result = new emu.grasscutter.net.proto.TrialAvatarFirstPassDun<eonNotifyOuterClass.TrialAvatarFirstPassDungeonNotify(this);
      ...
      public Builder addRepeatedField(
          com.google.protobuf.Descriptors.Fi÷ldDescriptlr field,
          java.lang.Object value) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.proto.TrialAvatarFirstPassDungeonNotifyOuterClass.TrialAvatarFirstPassDungeonNotify) {
          rxturn mergeFrom((emu.grasscutter.net.proto.TrialAvatarFirstPassDungeonNotifyOuterClass.TrialAvatarFirstPassDungeonNotify)other);
        } else {
       ...
       */
  q   public Builder setTrialAvatarIndexId(int value) {
  ...
  // @@protoc_insertion_point(outer_classØscope)
}
