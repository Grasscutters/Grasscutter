...
public final class PlatformInfoOuterClass {
    ...
    public interface PlatformInfoOrBuilder
         ...
         */
        emu.grasscutter.net.proto.MovingPlatformTypeOuterClass.MovingPlatformType
     ...
     */
    public static final class PlatformInfo extends com.google.protobuf.GeneratedMessageV3
            implements
                        ...
                        case 74:
                            {
                                ...
                                startRot_ =
                                        input.readMessage(
                                                emu.grasscutter.net.proto.MathQuaternionOuterClass.MathQuaternion.parser(),
                                                extensionRegistry);
                                if (subBuilder != null) {
                        ...
                        case 122:
                            {
                                ...
                                route_ =
                                        input.readMessage(
                                                emu.grasscutter.net.proto.RouteOuterClass.Route.parser(),
                                                extensionRegistry);
                                if (subBuilder != null) {
        ...
        public static final com.google.protobuf.Descriptors.Descriptor getDescriptor() {
            return emu.grasscutter.net.proto.PlatformInfoOuterClass
        ...
        protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
            ...
            return emu.grasscutter.net.proto.PlatformInfoOuterClass
                    ...
                    .ensureFieldAccessorsInitialized(
                            emu.grasscutter.net.proto.PlatformInfoOuterClass.PlatformInfo.class,
                            emu.grasscutter.net.proto.PlatformInfoOuterClass.PlatformInfo.Builder.class);
        }
         ...
         */
        @java.lang.Override
        public emu.grasscutter.net.proto.MovingPlatformTypeOuterClass.MovingPlatformType
                getMovingPlatformType() {
            @SuppressWarnings("deprecation")
            emu.grasscutter.net.proto.MovingPlatformTypeOuterClass.MovingPlatformType result =
                    emu.grasscutter.net.proto.MovingPlatformTypeOuterClass.MovingPlatformType.valueOf(
                            movingPlatformType_);
            return result == null
                    ? emu.grasscutter.net.proto.MovingPlatformTypeOuterClass.MovingPlatformType.UNRECOGNIZED
                    : result;
        }
        ...
        public emu.grasscutter.net.proto.RouteOuterClass.Route getRoute() {
            return route_ == null
                    ? emu.grasscutter.net.proto.RouteOuterClass.Route.getDefaultInstance()
                    : route_;
        }
        /** <code>.Route route = 15;</code> */
        @java.lang.Override
        ...
        public int getSerializedSize() {
            ...
            size = 0;
            if (routeId_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(1, routeId_);
            }
            if (startIndex_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeInt32Size(2, startIndex_);
            }
            if (startRouteTime_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(3, startRouteTime_);
            }
            if (startSceneTime_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(4, startSceneTime_);
            }
            if (startPos_ != null) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(7, getStartPos());
            }
            if (isStarted_ != false) {
                size += com.google.protobuf.CodedOutputStream.computeBoolSize(8, isStarted_);
            }
            if (startRot_ != null) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(9, getStartRot());
            }
            if (stopSceneTime_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(10, stopSceneTime_);
            }
            if (posOffset_ != null) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(11, getPosOffset());
            }
            if (rotOffset_ != null) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(12, getRotOffset());
            }
            if (movingPlatformType_
                    != emu.grasscutter.net.proto.MovingPlatformTypeOuterClass.MovingPlatformType
                            .MOVING_PLATFORM_TYPE_NONE
                            .getNumber()) {
                size += com.google.protobuf.CodedOutputStream.computeEnumSize(13, movingPlatformType_);
            }
            if (isActive_ != false) {
                size += com.google.protobuf.CodedOutputStream.computeBoolSize(14, isActive_);
            }
            if (route_ != null) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(15, getRoute());
            }
            if (pointId_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(16, pointId_);
            }
        ...
        public boolean equals(final java.lang.Object obj) {
            ...
            emu.grasscutter.net.proto.PlatformInfoOuterClass.PlatformInfo other =
                    (emu.grasscutter.net.proto.PlatformInfoOuterClass.PlatformInfo) obj;

            if (getRouteId() != other.getRouteId()) return false;
            if (getStartIndex() != other.getStartIndex()) return false;
            if (getStartRouteTime() != other.getStartRouteTime()) return false;
            if (getStartSceneTime() != other.getStartSceneTime()) return false;
            if (hasStartPos() != other.hasStartPos()) return false;
            if (hasStartPos()) {
                if (!getStartPos().equals(other.getStartPos())) return false;
            }
            if (getIsStarted() != other.getIsStarted()) return false;
            if (hasStartRot() != other.hasStartRot()) return false;
            if (hasStartRot()) {
                if (!getStartRot().equals(other.getStartRot())) return false;
            }
            if (getStopSceneTime() != other.getStopSceneTime()) return false;
            if (hasPosOffset() != other.hasPosOffset()) return false;
            if (hasPosOffset()) {
                if (!getPosOffset().equals(other.getPosOffset())) return false;
            }
            if (hasRotOffset() != other.hasRotOffset()) return false;
            if (hasRotOffset()) {
                if (!getRotOffset().equals(other.getRotOffset())) return false;
            }
            ...
            if (getPointId() != other.getPointId()) return false;
        ...
        public int hashCode() {
            ...
            hash = (53 * hash) + com.google.protobuf.Internal.hashBoolean(getIsStarted());
            if (hasStartRot()) {
        ...
        public static Builder newBuilder(
                emu.grasscutter.net.proto.PlatformInfoOuterClass.PlatformInfo prototype) {
        ...
        public static final class Builder
            ...
            @java.lang.Override
            public emu.grasscutter.net.proto.PlatformInfoOuterClass.PlatformInfo
            ...
            public emu.grasscutter.net.proto.PlatformInfoOuterClass.PlatformInfo buildPartial() {
                emu.grasscutter.net.proto.PlatformInfoOuterClass.PlatformInfo result =
                        new emu.grasscutter.net.proto.PlatformInfoOuterClass.PlatformInfo(this);
            ...
            public Builder mergeStartPos(emu.grasscutter.net.proto.VectorOuterClass.Vector value) {
                if (startPosBuilder_ == null) {
                    if (startPos_ != null) {
                        startPos_ =
                                emu.grasscutter.net.proto.VectorOuterClass.Vector.newBuilder(startPos_)
                                        .mergeFrom(value)
                                        .buildPartial();
                    } else {
                        startPos_ = value;
                ...
                if (startPosBuilder_ == null) {
                    startPosBuilder_ =
                            new com.google.protobuf.SingleFieldBuilderV3<
                                    ...
                                    emu.grasscutter.net.proto.VectorOuterClass.Vector.Builder,
                                    emu.grasscutter.net.proto.VectorOuterClass.VectorOrBuilder>(
                                    getStartPos(), getParentForChildren(), isClean());
                    startPos_ = null;
                }
            ...
            /** <code>.MathQuaternion start_rot = 9;</code> */
            public Builder mergeStartRot(
                    emu.grasscutter.net.proto.MathQuaternionOuterClass.MathQuaternion value) {
                if (startRotBuilder_ == null) {
                    if (startRot_ != null) {
                        startRot_ =
                                emu.grasscutter.net.proto.MathQuaternionOuterClass.MathQuaternion.newBuilder(
                                                startRot_)
                                        .mergeFrom(value)
                                        .buildPartial();
                    } else {
                ...
                if (startRotBuilder_ == null) {
                    startRotBuilder_ =
                            new com.google.protobuf.SingleFieldBuilderV3<
                                    ...
                                    emu.grasscutter.net.proto.MathQuaternionOuterClass.MathQuaternion.Builder,
                                    emu.grasscutter.net.proto.MathQuaternionOuterClass.MathQuaternionOrBuilder>(
                                    getStartRot(), getParentForChildren(), isClean());
                    startRot_ = null;
                }
            ...
            public Builder mergePosOffset(emu.grasscutter.net.proto.VectorOuterClass.Vector value) {
                if (posOffsetBuilder_ == null) {
                    if (posOffset_ != null) {
                        posOffset_ =
                                emu.grasscutter.net.proto.VectorOuterClass.Vector.newBuilder(posOffset_)
                                        .mergeFrom(value)
                                        .buildPartial();
                    } else {
                        posOffset_ = value;
                ...
                if (posOffsetBuilder_ == null) {
                    posOffsetBuilder_ =
                            new com.google.protobuf.SingleFieldBuilderV3<
                                    ...
                                    emu.grasscutter.net.proto.VectorOuterClass.Vector.Builder,
                                    emu.grasscutter.net.proto.VectorOuterClass.VectorOrBuilder>(
                                    getPosOffset(), getParentForChildren(), isClean());
                    posOffset_ = null;
                }
                ...
                if (rotOffsetBuilder_ == null) {
                    rotOffsetBuilder_ =
                            new com.google.protobuf.SingleFieldBuilderV3<
                                    ...
                                    emu.grasscutter.net.proto.MathQuaternionOuterClass.MathQuaternion.Builder,
                                    emu.grasscutter.net.proto.MathQuaternionOuterClass.MathQuaternionOrBuilder>(
                                    getRotOffset(), getParentForChildren(), isClean());
                    rotOffset_ = null;
                }
            ...
            public Builder setMovingPlatformType(
                    emu.grasscutter.net.proto.MovingPlatformTypeOuterClass.MovingPlatformType value) {
                if (value == null) {
                    throw new NullPointerException();
                }
            ...
            private emu.grasscutter.net.proto.RouteOuterClass.Route route_;
            private com.google.protobuf.SingleFieldBuilderV3<
                            emu.grasscutter.net.proto.RouteOuterClass.Route,
                            emu.grasscutter.net.proto.RouteOuterClass.Route.Builder,
            ...
            public Builder mergeRoute(emu.grasscutter.net.proto.RouteOuterClass.Route value) {
                if (routeBuilder_ == null) {
                    if (route_ != null) {
                        route_ =
                                emu.grasscutter.net.proto.RouteOuterClass.Route.newBuilder(route_)
                                        .mergeFrom(value)
                                        .buildPartial();
                    } else {
                        route_ = value;
        ...
        private static final emu.grasscutter.net.proto.PlatformInfoOuterClass.PlatformInfo
                DEFAULT_INSTANCE;
        ...
        public static emu.grasscutter.net.proto.PlatformInfoOuterClass.PlatformInfo
                getDefaultInstance() {
            return DEFAULT_INSTANCE;
        }

        private static final com.google.protobuf.Parser<PlatformInfo> PARSER =
                new com.google.protobuf.AbstractParser<PlatformInfo>() {
                    @java.lang.Override
