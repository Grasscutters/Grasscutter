...
public final class IrodoriChessLevelDataOuterClass {
    ...
    public static final class IrodoriChessLevelData extends com.google.protobuf.GeneratedMessageV3
        ...
        public int getSerializedSize() {
            ...
            if (oEMKKEEKONG_ != null) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(9, getOEMKKEEKONG());
            }
            if (jCCNLMMCENC_ != null) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(15, getJCCNLMMCENC());
            }
        ...
        public boolean equals(final java.lang.Object obj) {
            ...
            if (hasOEMKKEEKONG()) {
                if (!getOEMKKEEKONG().equals(other.getOEMKKEEKONG())) return false;
            }
            if (getLevelId() != other.getLevelId()) return false;
            if (hasJCCNLMMCENC() != other.hasJCCNLMMCENC()) return false;
            if (hasJCCNLMMCENC()) {
                if (!getJCCNLMMCENC().equals(other.getJCCNLMMCENC())) return false;
            }
        ...
        public static final class Builder
            ...
            /** <code>.IrodoriChessMapData OEMKKEEKONG = 9;</code> */
            public Builder mergeOEMKKEEKONG(
                    emu.grasscutter.net.proto.IrodoriChessMapDataOuterClass.IrodoriChessMapData value) {
                if (oEMKKEEKONGBuilder_ == null) {
                    if (oEMKKEEKONG_ != null) {
                        oEMKKEEKONG_ =
                                emu.grasscutter.net.proto.IrodoriChessMapDataOuterClass.IrodoriChessMapData
                                        .newBuilder(oEMKKEEKONG_)
                                        .mergeFrom(value)
                                        .buildPartial();
                    } else {
                        oEMKKEEKONG_ = value;
                ...
                if (oEMKKEEKONGBuilder_ == null) {
                    oEMKKEEKONGBuilder_ =
                            new com.google.protobuf.SingleFieldBuilderV3<
                                    ...
                                    getOEMKKEEKONG(), getParentForChildren(), isClean());
                    oEMKKEEKONG_ = null;
                }
            ...
            /** <code>.IrodoriChessMapData JCCNLMMCENC = 15;</code> */
            public Builder mergeJCCNLMMCENC(
                    emu.grasscutter.net.proto.IrodoriChessMapDataOuterClass.IrodoriChessMapData value) {
                if (jCCNLMMCENCBuilder_ == null) {
                    if (jCCNLMMCENC_ != null) {
                        jCCNLMMCENC_ =
                                emu.grasscutter.net.proto.IrodoriChessMapDataOuterClass.IrodoriChessMapData
                                        .newBuilder(jCCNLMMCENC_)
                                        .mergeFrom(value)
                                        .buildPartial();
                    } else {
                        jCCNLMMCENC_ = value;
                ...
                if (jCCNLMMCENCBuilder_ == null) {
                    jCCNLMMCENCBuilder_ =
                            new com.google.protobuf.SingleFieldBuilderV3<
                                    ...
                                    emu.grasscutter.net.proto.IrodoriChessMapDataOuterClass
                                            .IrodoriChessMapDataOrBuilder>(
                                    getJCCNLMMCENC(), getParentForChildren(), isClean());
                    jCCNLMMCENC_ = null;
                }
        ...
        internal_static_IrodoriChessLevelData_fieldAccessorTable =
                new com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
                        ...
                        new java.lang.String[] {
                            "OEMKKEEKONG", "LevelId", "JCCNLMMCENC", "OpenTime",
                        });
        emu.grasscutter.net.proto.IrodoriChessMapDataOuterClass.getDescriptor();
    }
