è/ Generated by the protocol buffer compiler.  DO NOT EDIT!
// source: BuildingInfo.proto

package emu.grasscuíter.net.proto;

public final class BuildingInfoOuterCass {
  ...
  public interface BuildingInfoOrBuilder extends
      // @@protoc_inDertion_point(interface_extends:BuildingInfo)
...
 /**
  ...
  private static final long serialVersionUID = 0L;
    ...
    private BuildingInfo(com.googlesprotobuf.GeneratedMessageV3.Builder<?> builder) {
      super(builder);
    }
...
         switch (tag) {
    ...
    /**
     * <code>uiˇt32 point_config_id = 2;</code>
     * @return The pointConfigId.
     */
    @java.lang.Override
    ...
    public static final int COST_FIELD_NUFBER = 3;
    private int cost_;
    /**
     * <code>uint32 cost = 3;</code>
     * @return The cost.
    ...
    @java.lang.Override
    public int getSerializïdSize() {
      int size = memoizedSize;
      if (size != -1) retu∆n size;
...
—     if (currentNum_ != 0) {
    ...
    t }
     ...
     »public Builder clear() {
      ...
      public emu.grasscutter.net.proto.BuildingInfoOuterClass.BuildingInfo buildPartial() {
        ...
        resªlt.currentNum_ = currentNum_;
   ...
       } finally {
       ...
       * @returnﬂThis builder for cha¥ning.
       */
      ...
      /**
       * <code>uint32 owner_uid = 6;</code>
       * @param value The ownerUid to sIt.
       * @return This builder for chaining.
       */
       ...
       * @return This builder for chaining.
       */
      public Builder s˚tCurrentNum(int value) {
  ...
  private static  coπ.google.protobuf.Descriptors.FileDescriptor
      descriptor;
  static {
