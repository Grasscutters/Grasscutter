...
public final class RoutePointOuterClass {
    ...
    public interface RoutePointOrBuilder
            extends
        ...
        public emu.grasscutter.net.proto.RoutePointOuterClass.RoutePoint.MoveParamsCase
                getMoveParamsCase();

        public emu.grasscutter.net.proto.RoutePointOuterClass.RoutePoint.RotateParamsCase
                getRotateParamsCase();
    }
    /**
     *
     ...
     */
    public static final class RoutePoint extends com.google.protobuf.GeneratedMessageV3
            implements
        ...
        protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
            ...
            return emu.grasscutter.net.proto.RoutePointOuterClass
                    .internal_static_RoutePoint_fieldAccessorTable
                    .ensureFieldAccessorsInitialized(
                            emu.grasscutter.net.proto.RoutePointOuterClass.RoutePoint.class,
                            emu.grasscutter.net.proto.RoutePointOuterClass.RoutePoint.Builder.class);
        }
        ...
        public MoveParamsCase getMoveParamsCase() {
            return MoveParamsCase.forNumber(moveParamsCase_);
        }
        ...
        public RotateParamsCase getRotateParamsCase() {
            return RotateParamsCase.forNumber(rotateParamsCase_);
        }
        ...
        public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
            ...
            if (moveParamsCase_ == 11) {
                output.writeFloat(11, (float) ((java.lang.Float) moveParams_));
            }
            if (moveParamsCase_ == 12) {
                output.writeFloat(12, (float) ((java.lang.Float) moveParams_));
            }
            if (rotateParamsCase_ == 21) {
            ...
            if (rotateParamsCase_ == 22) {
                output.writeMessage(
                        22, (emu.grasscutter.net.proto.MathQuaternionOuterClass.MathQuaternion) rotateParams_);
            }
            if (rotateParamsCase_ == 23) {
                output.writeMessage(
                        23, (emu.grasscutter.net.proto.MathQuaternionOuterClass.MathQuaternion) rotateParams_);
            }
        ...
        public int getSerializedSize() {
            ...
            if (arriveRange_ != 0F) {
                size += com.google.protobuf.CodedOutputStream.computeFloatSize(2, arriveRange_);
            }
            if (hasReachEvent_ != false) {
                size += com.google.protobuf.CodedOutputStream.computeBoolSize(3, hasReachEvent_);
            }
            if (moveParamsCase_ == 11) {
                size +=
            ...
            if (rotateParamsCase_ == 21) {
                size +=
                        com.google.protobuf.CodedOutputStream.computeMessageSize(
                                21, (emu.grasscutter.net.proto.VectorOuterClass.Vector) rotateParams_);
            }
            if (rotateParamsCase_ == 22) {
                size +=
                        com.google.protobuf.CodedOutputStream.computeMessageSize(
        ...
        public boolean equals(final java.lang.Object obj) {
            ...
            emu.grasscutter.net.proto.RoutePointOuterClass.RoutePoint other =
                    (emu.grasscutter.net.proto.RoutePointOuterClass.RoutePoint) obj;
            ...
            if (getHasReachEvent() != other.getHasReachEvent()) return false;
            ...
            switch (moveParamsCase_) {
                case 11:
                    if (java.lang.Float.floatToIntBits(getVelocity())
                            != java.lang.Float.floatToIntBits(other.getVelocity())) return false;
                    break;
                case 12:
            ...
            switch (rotateParamsCase_) {
                case 21:
                    ...
                    break;
                case 22:
                    if (!getRotationSpeed().equals(other.getRotationSpeed())) return false;
                    break;
                case 23:
                    if (!getAxisSpeed().equals(other.getAxisSpeed())) return false;
                    break;
                case 0:
                default:
            }
        ...
        public int hashCode() {
            ...
            hash = (53 * hash) + com.google.protobuf.Internal.hashBoolean(getHasReachEvent());
            switch (moveParamsCase_) {
                case 11:
                    hash = (37 * hash) + VELOCITY_FIELD_NUMBER;
                    hash = (53 * hash) + java.lang.Float.floatToIntBits(getVelocity());
                    break;
                case 12:
        ...
        public static Builder newBuilder(
                emu.grasscutter.net.proto.RoutePointOuterClass.RoutePoint prototype) {
        ...
        public static final class Builder
            ...
            public emu.grasscutter.net.proto.RoutePointOuterClass.RoutePoint buildPartial() {
                emu.grasscutter.net.proto.RoutePointOuterClass.RoutePoint result =
                        new emu.grasscutter.net.proto.RoutePointOuterClass.RoutePoint(this);
                if (positionBuilder_ == null) {
            ...
            public Builder mergeFrom(emu.grasscutter.net.proto.RoutePointOuterClass.RoutePoint other) {
                if (other == emu.grasscutter.net.proto.RoutePointOuterClass.RoutePoint.getDefaultInstance())
                    return this;
            ...
            public Builder mergeFrom(
                ...
                try {
                    ...
                    parsedMessage =
                            (emu.grasscutter.net.proto.RoutePointOuterClass.RoutePoint) e.getUnfinishedMessage();
            ...
            public emu.grasscutter.net.proto.MathQuaternionOuterClass.MathQuaternion getRotationSpeed() {
                if (rotationSpeedBuilder_ == null) {
                    if (rotateParamsCase_ == 22) {
                        return (emu.grasscutter.net.proto.MathQuaternionOuterClass.MathQuaternion)
                                rotateParams_;
                    }
                    return emu.grasscutter.net.proto.MathQuaternionOuterClass.MathQuaternion
                            .getDefaultInstance();
            ...
            /** <code>.MathQuaternion rotation_speed = 22;</code> */
            public Builder mergeRotationSpeed(
                    emu.grasscutter.net.proto.MathQuaternionOuterClass.MathQuaternion value) {
                if (rotationSpeedBuilder_ == null) {
                    if (rotateParamsCase_ == 22
                            && rotateParams_
        ...
        private static final com.google.protobuf.Parser<RoutePoint> PARSER =
                new com.google.protobuf.AbstractParser<RoutePoint>() {
                    @java.lang.Override
