...
public final class SceneGalleryIslandPartySailInfoOuterClass {
    ...
    public interface SceneGalleryIslandPartySailInfoOrBuilder
            extends
     ...
     */
    public static final class SceneGalleryIslandPartySailInfo
            ...
            return emu.grasscutter.net.proto.SceneGalleryIslandPartySailInfoOuterClass
                    ...
                    .ensureFieldAccessorsInitialized(
                            emu.grasscutter.net.proto.SceneGalleryIslandPartySailInfoOuterClass
                                    .SceneGalleryIslandPartySailInfo.class,
                            emu.grasscutter.net.proto.SceneGalleryIslandPartySailInfoOuterClass
                                    .SceneGalleryIslandPartySailInfo.Builder.class);
        }
        ...
        public int getSerializedSize() {
            ...
            size = 0;
            if (pICIGOLIPOG_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(1, pICIGOLIPOG_);
            }
            if (pOAAKPIBPIF_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(8, pOAAKPIBPIF_);
            }
            if (pJPNOKJPCHO_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(9, pJPNOKJPCHO_);
            }
            if (stage_
                    != emu.grasscutter.net.proto.IslandPartySailStageOuterClass.IslandPartySailStage
                            .ISLAND_PARTY_SAIL_STAGE_NONE
            ...
            if (startSource_
                    != emu.grasscutter.net.proto.GalleryStartSourceOuterClass.GalleryStartSource
                            .GALLERY_START_BY_NONE
                            .getNumber()) {
                size += com.google.protobuf.CodedOutputStream.computeEnumSize(13, startSource_);
            }
            if (dOIFHHACKHE_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(14, dOIFHHACKHE_);
            }
            if (coin_ != 0) {
        ...
        public boolean equals(final java.lang.Object obj) {
            ...
            if (getDOIFHHACKHE() != other.getDOIFHHACKHE()) return false;
            if (getCoin() != other.getCoin()) return false;
            if (startSource_ != other.startSource_) return false;
            if (getPOAAKPIBPIF() != other.getPOAAKPIBPIF()) return false;
            if (getPICIGOLIPOG() != other.getPICIGOLIPOG()) return false;
            if (stage_ != other.stage_) return false;
            if (getPJPNOKJPCHO() != other.getPJPNOKJPCHO()) return false;
        ...
        public static emu.grasscutter.net.proto.SceneGalleryIslandPartySailInfoOuterClass
                        .SceneGalleryIslandPartySailInfo
        ...
        public static final class Builder
            ...
            // Construct using
            // emu.grasscutter.net.proto.SceneGalleryIslandPartySailInfoOuterClass.SceneGalleryIslandPartySailInfo.newBuilder()
            private Builder() {
            ...
            public emu.grasscutter.net.proto.SceneGalleryIslandPartySailInfoOuterClass
                ...
                emu.grasscutter.net.proto.SceneGalleryIslandPartySailInfoOuterClass
                                .SceneGalleryIslandPartySailInfo
                        result =
                                new emu.grasscutter.net.proto.SceneGalleryIslandPartySailInfoOuterClass
                                        .SceneGalleryIslandPartySailInfo(this);
            ...
            public Builder mergeFrom(
                ...
                if (other
                        == emu.grasscutter.net.proto.SceneGalleryIslandPartySailInfoOuterClass
                                .SceneGalleryIslandPartySailInfo.getDefaultInstance()) return this;
        ...
        private static final emu.grasscutter.net.proto.SceneGalleryIslandPartySailInfoOuterClass
                        .SceneGalleryIslandPartySailInfo
                DEFAULT_INSTANCE;
        ...
        private static final com.google.protobuf.Parser<SceneGalleryIslandPartySailInfo> PARSER =
                new com.google.protobuf.AbstractParser<SceneGalleryIslandPartySailInfo>() {
                    @java.lang.Override
