...
public final class DragonSpineActivityDetailInfoOuterClass {
    ...
    public static final class DragonSpineActivityDetailInfo
        ...
        public int getSerializedSize() {
            ...
            size = 0;
            if (bFHMDKOEJPC_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(1, bFHMDKOEJPC_);
            }
            if (isContentClosed_ != false) {
                size += com.google.protobuf.CodedOutputStream.computeBoolSize(4, isContentClosed_);
            }
            if (weaponEnhanceLevel_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(5, weaponEnhanceLevel_);
            }
            if (lNHGDOBIBFH_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(7, lNHGDOBIBFH_);
            }
            if (eFJOFMJNHEM_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(8, eFJOFMJNHEM_);
            }
            if (mPBEPGFLKGH_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(12, mPBEPGFLKGH_);
            }
            for (int i = 0; i < chapterInfoList_.size(); i++) {
                size +=
                        com.google.protobuf.CodedOutputStream.computeMessageSize(14, chapterInfoList_.get(i));
            }
        ...
        public boolean equals(final java.lang.Object obj) {
            ...
            if (getMPBEPGFLKGH() != other.getMPBEPGFLKGH()) return false;
            ...
            if (getEFJOFMJNHEM() != other.getEFJOFMJNHEM()) return false;
            if (getBFHMDKOEJPC() != other.getBFHMDKOEJPC()) return false;
            if (getLNHGDOBIBFH() != other.getLNHGDOBIBFH()) return false;
