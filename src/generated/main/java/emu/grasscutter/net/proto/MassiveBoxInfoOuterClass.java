...
public final class MassiveBoxInfoOuterClass {
    ...
    public interface MassiveBoxInfoOrBuilder
            extends
     ...
     */
    public static final class MassiveBoxInfo extends com.google.protobuf.GeneratedMessageV3
            implements
        ...
        public static final com.google.protobuf.Descriptors.Descriptor getDescriptor() {
            return emu.grasscutter.net.proto.MassiveBoxInfoOuterClass
        ...
        protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
            ...
            return emu.grasscutter.net.proto.MassiveBoxInfoOuterClass
                    ...
                    .ensureFieldAccessorsInitialized(
                            emu.grasscutter.net.proto.MassiveBoxInfoOuterClass.MassiveBoxInfo.class,
                            emu.grasscutter.net.proto.MassiveBoxInfoOuterClass.MassiveBoxInfo.Builder.class);
        }
        ...
        public int getSerializedSize() {
            ...
            if (extents_ != null) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(4, getExtents());
            }
            if (up_ != null) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(5, getUp());
            }
            if (forward_ != null) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(6, getForward());
            }
            if (right_ != null) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(7, getRight());
            }
        ...
        public boolean equals(final java.lang.Object obj) {
            ...
            emu.grasscutter.net.proto.MassiveBoxInfoOuterClass.MassiveBoxInfo other =
                    (emu.grasscutter.net.proto.MassiveBoxInfoOuterClass.MassiveBoxInfo) obj;
            ...
            if (hasUp()) {
                if (!getUp().equals(other.getUp())) return false;
            }
        ...
        public static emu.grasscutter.net.proto.MassiveBoxInfoOuterClass.MassiveBoxInfo
        ...
        public static Builder newBuilder(
                emu.grasscutter.net.proto.MassiveBoxInfoOuterClass.MassiveBoxInfo prototype) {
        ...
        public static final class Builder
            ...
            @java.lang.Override
            public emu.grasscutter.net.proto.MassiveBoxInfoOuterClass.MassiveBoxInfo
            ...
            public emu.grasscutter.net.proto.MassiveBoxInfoOuterClass.MassiveBoxInfo buildPartial() {
                emu.grasscutter.net.proto.MassiveBoxInfoOuterClass.MassiveBoxInfo result =
                        new emu.grasscutter.net.proto.MassiveBoxInfoOuterClass.MassiveBoxInfo(this);
                result.id_ = id_;
            ...
            public Builder mergeExtents(emu.grasscutter.net.proto.VectorOuterClass.Vector value) {
                if (extentsBuilder_ == null) {
                    if (extents_ != null) {
                        extents_ =
                                emu.grasscutter.net.proto.VectorOuterClass.Vector.newBuilder(extents_)
                                        .mergeFrom(value)
                                        .buildPartial();
                    } else {
                        extents_ = value;
                ...
                if (extentsBuilder_ == null) {
                    extentsBuilder_ =
                            new com.google.protobuf.SingleFieldBuilderV3<
                                    ...
                                    emu.grasscutter.net.proto.VectorOuterClass.Vector.Builder,
                                    emu.grasscutter.net.proto.VectorOuterClass.VectorOrBuilder>(
                                    getExtents(), getParentForChildren(), isClean());
                    extents_ = null;
                }
            ...
            public Builder mergeUp(emu.grasscutter.net.proto.VectorOuterClass.Vector value) {
                if (upBuilder_ == null) {
                    if (up_ != null) {
                        up_ =
                                emu.grasscutter.net.proto.VectorOuterClass.Vector.newBuilder(up_)
                                        .mergeFrom(value)
                                        .buildPartial();
                    } else {
                        up_ = value;
                ...
                if (upBuilder_ == null) {
                    upBuilder_ =
                            new com.google.protobuf.SingleFieldBuilderV3<
                                    ...
                                    emu.grasscutter.net.proto.VectorOuterClass.Vector.Builder,
                                    emu.grasscutter.net.proto.VectorOuterClass.VectorOrBuilder>(
                                    getUp(), getParentForChildren(), isClean());
                    up_ = null;
                }
                return upBuilder_;
            }
            ...
            public Builder mergeForward(emu.grasscutter.net.proto.VectorOuterClass.Vector value) {
                if (forwardBuilder_ == null) {
                    if (forward_ != null) {
                        forward_ =
                                emu.grasscutter.net.proto.VectorOuterClass.Vector.newBuilder(forward_)
                                        .mergeFrom(value)
                                        .buildPartial();
                    } else {
                        forward_ = value;
                ...
                if (forwardBuilder_ == null) {
                    forwardBuilder_ =
                            new com.google.protobuf.SingleFieldBuilderV3<
                                    ...
                                    emu.grasscutter.net.proto.VectorOuterClass.Vector.Builder,
                                    emu.grasscutter.net.proto.VectorOuterClass.VectorOrBuilder>(
                                    getForward(), getParentForChildren(), isClean());
                    forward_ = null;
                }
            ...
            public Builder mergeRight(emu.grasscutter.net.proto.VectorOuterClass.Vector value) {
                if (rightBuilder_ == null) {
                    if (right_ != null) {
                        right_ =
                                emu.grasscutter.net.proto.VectorOuterClass.Vector.newBuilder(right_)
                                        .mergeFrom(value)
                                        .buildPartial();
                    } else {
                        right_ = value;
        ...
        private static final emu.grasscutter.net.proto.MassiveBoxInfoOuterClass.MassiveBoxInfo
                DEFAULT_INSTANCE;
        ...
        private static final com.google.protobuf.Parser<MassiveBoxInfo> PARSER =
                new com.google.protobuf.AbstractParser<MassiveBoxInfo>() {
                    @java.lang.Override
    ...
    static {
        ...
        internal_static_MassiveBoxInfo_descriptor = getDescriptor().getMessageTypes().get(0);
        internal_static_MassiveBoxInfo_fieldAccessorTable =
                new com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
                        internal_static_MassiveBoxInfo_descriptor,
                        new java.lang.String[] {
                            "Id", "ConfigId", "Center", "Extents", "Up", "Forward", "Right",
                        });
        emu.grasscutter.net.proto.VectorOuterClass.getDescriptor();
    }
