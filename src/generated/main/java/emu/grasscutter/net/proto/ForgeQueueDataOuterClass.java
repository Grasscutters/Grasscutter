...
public final class ForgeQueueDataOuterClass {
    ...
    public static final class ForgeQueueData extends com.google.protobuf.GeneratedMessageV3
        ...
        public int getSerializedSize() {
            ...
            size = 0;
            if (forgeId_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(1, forgeId_);
            }
            if (finishCount_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(4, finishCount_);
            }
            if (totalFinishTimestamp_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(8, totalFinishTimestamp_);
            }
            if (queueId_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(9, queueId_);
            }
            if (nextFinishTimestamp_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(13, nextFinishTimestamp_);
            }
            if (avatarId_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(14, avatarId_);
            }
            if (unfinishCount_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(15, unfinishCount_);
            }
