...
public final class GravenInnocencePhotoObjectInfoOuterClass {
    ...
    public static final class GravenInnocencePhotoObjectInfo
        ...
        public int getSerializedSize() {
            ...
            size = 0;
            if (objectId_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(2, objectId_);
            }
            if (param_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(4, param_);
            }
            if (finishTime_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(6, finishTime_);
            }
