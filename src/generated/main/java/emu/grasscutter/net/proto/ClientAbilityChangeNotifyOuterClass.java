...
public final class ClientAbilityChangeNotifyOuterClass {
    ...
    public static final class ClientAbilityChangeNotify extends com.google.protobuf.GeneratedMessageV3
        ...
        public int getSerializedSize() {
            ...
            size = 0;
            if (isInitHash_ != false) {
                size += com.google.protobuf.CodedOutputStream.computeBoolSize(1, isInitHash_);
            }
            if (entityId_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(3, entityId_);
            }
            for (int i = 0; i < invokes_.size(); i++) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(8, invokes_.get(i));
            }
