...
public final class GachaWishRspOuterClass {
    ...
    public static final class GachaWishRsp extends com.google.protobuf.GeneratedMessageV3
        ...
        public int getSerializedSize() {
            ...
            size = 0;
            if (wishMaxProgress_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(3, wishMaxProgress_);
            }
            if (gachaScheduleId_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(5, gachaScheduleId_);
            }
            if (gachaType_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(8, gachaType_);
            }
            if (wishItemId_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(9, wishItemId_);
            }
            if (wishProgress_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(10, wishProgress_);
            }
            if (retcode_ != 0) {
