...
public final class SceneRouteChangeInfoOuterClass {
    ...
    public interface SceneRouteChangeInfoOrBuilder
            extends
            // @@protoc_insertion_point(interface_extends:SceneRouteChangeInfo)
            com.google.protobuf.MessageOrBuilder {

        /**
         * <code>uint32 route_id = 3;</code>
         *
         * @return The routeId.
         */
        int getRouteId();

        /** <code>repeated .RoutePointChangeInfo point_list = 6;</code> */
        java.util.List<emu.grasscutter.net.proto.RoutePointChangeInfoOuterClass.RoutePointChangeInfo>
                getPointListList();
        /** <code>repeated .RoutePointChangeInfo point_list = 6;</code> */
        emu.grasscutter.net.proto.RoutePointChangeInfoOuterClass.RoutePointChangeInfo getPointList(
                int index);
        /** <code>repeated .RoutePointChangeInfo point_list = 6;</code> */
        ...
        java.util.List<
                        ? extends
                                emu.grasscutter.net.proto.RoutePointChangeInfoOuterClass
     ...
     */
    public static final class SceneRouteChangeInfo extends com.google.protobuf.GeneratedMessageV3
            implements
        ...
        public static final com.google.protobuf.Descriptors.Descriptor getDescriptor() {
            return emu.grasscutter.net.proto.SceneRouteChangeInfoOuterClass
        ...
        protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
            ...
            return emu.grasscutter.net.proto.SceneRouteChangeInfoOuterClass
                    ...
                    .ensureFieldAccessorsInitialized(
                            emu.grasscutter.net.proto.SceneRouteChangeInfoOuterClass.SceneRouteChangeInfo.class,
        ...
        /** <code>repeated .RoutePointChangeInfo point_list = 6;</code> */
        @java.lang.Override
        public emu.grasscutter.net.proto.RoutePointChangeInfoOuterClass.RoutePointChangeInfo
                getPointList(int index) {
            return pointList_.get(index);
        }
        /** <code>repeated .RoutePointChangeInfo point_list = 6;</code> */
        @java.lang.Override
        public emu.grasscutter.net.proto.RoutePointChangeInfoOuterClass.RoutePointChangeInfoOrBuilder
                getPointListOrBuilder(int index) {
            return pointList_.get(index);
        }
        ...
        public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
            ...
            if (routeId_ != 0) {
                output.writeUInt32(3, routeId_);
            }
            for (int i = 0; i < pointList_.size(); i++) {
                output.writeMessage(6, pointList_.get(i));
            }
            if (isForward_ != false) {
        ...
        public int getSerializedSize() {
            ...
            if (routeId_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(3, routeId_);
            }
            for (int i = 0; i < pointList_.size(); i++) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(6, pointList_.get(i));
            }
            if (isForward_ != false) {
                size += com.google.protobuf.CodedOutputStream.computeBoolSize(14, isForward_);
            }
        ...
        public boolean equals(final java.lang.Object obj) {
            ...
            emu.grasscutter.net.proto.SceneRouteChangeInfoOuterClass.SceneRouteChangeInfo other =
                    (emu.grasscutter.net.proto.SceneRouteChangeInfoOuterClass.SceneRouteChangeInfo) obj;

            if (getRouteId() != other.getRouteId()) return false;
            if (!getPointListList().equals(other.getPointListList())) return false;
            if (getType() != other.getType()) return false;
            if (getIsForward() != other.getIsForward()) return false;
        ...
        public int hashCode() {
            ...
            hash = (53 * hash) + com.google.protobuf.Internal.hashBoolean(getIsForward());
            hash = (29 * hash) + unknownFields.hashCode();
            memoizedHashCode = hash;
            return hash;
        }

        public static emu.grasscutter.net.proto.SceneRouteChangeInfoOuterClass.SceneRouteChangeInfo
        ...
        public static Builder newBuilder(
                emu.grasscutter.net.proto.SceneRouteChangeInfoOuterClass.SceneRouteChangeInfo prototype) {
        ...
        public static final class Builder
            ...
            // Construct using
            // emu.grasscutter.net.proto.SceneRouteChangeInfoOuterClass.SceneRouteChangeInfo.newBuilder()
            private Builder() {
            ...
            public emu.grasscutter.net.proto.SceneRouteChangeInfoOuterClass.SceneRouteChangeInfo
                ...
                return emu.grasscutter.net.proto.SceneRouteChangeInfoOuterClass.SceneRouteChangeInfo
                        .getDefaultInstance();
            }

            @java.lang.Override
            public emu.grasscutter.net.proto.SceneRouteChangeInfoOuterClass.SceneRouteChangeInfo build() {
                emu.grasscutter.net.proto.SceneRouteChangeInfoOuterClass.SceneRouteChangeInfo result =
                        buildPartial();
            ...
            public emu.grasscutter.net.proto.SceneRouteChangeInfoOuterClass.SceneRouteChangeInfo
                    buildPartial() {
                emu.grasscutter.net.proto.SceneRouteChangeInfoOuterClass.SceneRouteChangeInfo result =
                        new emu.grasscutter.net.proto.SceneRouteChangeInfoOuterClass.SceneRouteChangeInfo(this);
            ...
            private com.google.protobuf.RepeatedFieldBuilderV3<
                            emu.grasscutter.net.proto.RoutePointChangeInfoOuterClass.RoutePointChangeInfo,
                            emu.grasscutter.net.proto.RoutePointChangeInfoOuterClass.RoutePointChangeInfo.Builder,
                            emu.grasscutter.net.proto.RoutePointChangeInfoOuterClass
                                    .RoutePointChangeInfoOrBuilder>
                    pointListBuilder_;
            ...
            public Builder setPointList(
                    int index,
                    emu.grasscutter.net.proto.RoutePointChangeInfoOuterClass.RoutePointChangeInfo value) {
                if (pointListBuilder_ == null) {
                    if (value == null) {
            ...
            /** <code>repeated .RoutePointChangeInfo point_list = 6;</code> */
            public emu.grasscutter.net.proto.RoutePointChangeInfoOuterClass.RoutePointChangeInfo.Builder
                    getPointListBuilder(int index) {
            ...
            public emu.grasscutter.net.proto.RoutePointChangeInfoOuterClass.RoutePointChangeInfo.Builder
                    addPointListBuilder() {
                return getPointListFieldBuilder()
                        .addBuilder(
                                emu.grasscutter.net.proto.RoutePointChangeInfoOuterClass.RoutePointChangeInfo
                                        .getDefaultInstance());
            }
                ...
                if (pointListBuilder_ == null) {
                    pointListBuilder_ =
                            new com.google.protobuf.RepeatedFieldBuilderV3<
                                    ...
                                    emu.grasscutter.net.proto.RoutePointChangeInfoOuterClass
                                            .RoutePointChangeInfoOrBuilder>(
                                    pointList_, ((bitField0_ & 0x00000001) != 0), getParentForChildren(), isClean());
                    pointList_ = null;
                }
        ...
        private static final emu.grasscutter.net.proto.SceneRouteChangeInfoOuterClass
                        .SceneRouteChangeInfo
                DEFAULT_INSTANCE;

        static {
            DEFAULT_INSTANCE =
                    new emu.grasscutter.net.proto.SceneRouteChangeInfoOuterClass.SceneRouteChangeInfo();
        }
        ...
        private static final com.google.protobuf.Parser<SceneRouteChangeInfo> PARSER =
                new com.google.protobuf.AbstractParser<SceneRouteChangeInfo>() {
                    @java.lang.Override
    ...
    static {
        ...
        internal_static_SceneRouteChangeInfo_descriptor = getDescriptor().getMessageTypes().get(0);
        internal_static_SceneRouteChangeInfo_fieldAccessorTable =
                new com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
                        internal_static_SceneRouteChangeInfo_descriptor,
                        new java.lang.String[] {
                            "RouteId", "PointList", "Type", "IsForward",
                        });
        emu.grasscutter.net.proto.RoutePointChangeInfoOuterClass.getDescriptor();
    }
