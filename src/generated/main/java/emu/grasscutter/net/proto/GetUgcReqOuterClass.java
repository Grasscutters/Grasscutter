...
public final class GetUgcReqOuterClass {
    ...
    public interface GetUgcReqOrBuilder
            extends
     ...
     */
    public static final class GetUgcReq extends com.google.protobuf.GeneratedMessageV3
            implements
        ...
        protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
            ...
            return emu.grasscutter.net.proto.GetUgcReqOuterClass
                    .internal_static_GetUgcReq_fieldAccessorTable
                    .ensureFieldAccessorsInitialized(
                            emu.grasscutter.net.proto.GetUgcReqOuterClass.GetUgcReq.class,
                            emu.grasscutter.net.proto.GetUgcReqOuterClass.GetUgcReq.Builder.class);
        }
        ...
        public emu.grasscutter.net.proto.GetUgcTypeOuterClass.GetUgcType getGetUgcType() {
            @SuppressWarnings("deprecation")
            emu.grasscutter.net.proto.GetUgcTypeOuterClass.GetUgcType result =
                    emu.grasscutter.net.proto.GetUgcTypeOuterClass.GetUgcType.valueOf(getUgcType_);
            return result == null
                    ? emu.grasscutter.net.proto.GetUgcTypeOuterClass.GetUgcType.UNRECOGNIZED
                    : result;
        }
        ...
        public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
            ...
            if (getUgcType_
                    != emu.grasscutter.net.proto.GetUgcTypeOuterClass.GetUgcType.GET_UGC_NONE.getNumber()) {
        ...
        public int getSerializedSize() {
            ...
            if (ugcRecordUsage_
                    != emu.grasscutter.net.proto.RecordUsageOuterClass.RecordUsage.UGC_RECORD_USAGE_NONE
                            .getNumber()) {
                size += com.google.protobuf.CodedOutputStream.computeEnumSize(2, ugcRecordUsage_);
            }
            if (getUgcType_
                    != emu.grasscutter.net.proto.GetUgcTypeOuterClass.GetUgcType.GET_UGC_NONE.getNumber()) {
                size += com.google.protobuf.CodedOutputStream.computeEnumSize(3, getUgcType_);
            }
            if (ugcType_
                    != emu.grasscutter.net.proto.UgcTypeOuterClass.UgcType.UGC_TYPE_NONE.getNumber()) {
            ...
            if (isRequireBrief_ != false) {
                size += com.google.protobuf.CodedOutputStream.computeBoolSize(13, isRequireBrief_);
            }
            if (ugcGuid_ != 0L) {
        ...
        public boolean equals(final java.lang.Object obj) {
            ...
            emu.grasscutter.net.proto.GetUgcReqOuterClass.GetUgcReq other =
                    (emu.grasscutter.net.proto.GetUgcReqOuterClass.GetUgcReq) obj;

            if (ugcRecordUsage_ != other.ugcRecordUsage_) return false;
            if (getUgcType_ != other.getUgcType_) return false;
            if (getIsRequireBrief() != other.getIsRequireBrief()) return false;
        ...
        public int hashCode() {
            ...
            hash = (53 * hash) + com.google.protobuf.Internal.hashBoolean(getIsRequireBrief());
        ...
        public static Builder newBuilder(
                emu.grasscutter.net.proto.GetUgcReqOuterClass.GetUgcReq prototype) {
        ...
        public static final class Builder
            ...
            public emu.grasscutter.net.proto.GetUgcReqOuterClass.GetUgcReq buildPartial() {
                emu.grasscutter.net.proto.GetUgcReqOuterClass.GetUgcReq result =
                        new emu.grasscutter.net.proto.GetUgcReqOuterClass.GetUgcReq(this);
            ...
            public Builder mergeFrom(emu.grasscutter.net.proto.GetUgcReqOuterClass.GetUgcReq other) {
                if (other == emu.grasscutter.net.proto.GetUgcReqOuterClass.GetUgcReq.getDefaultInstance())
                    return this;
            ...
            public Builder mergeFrom(
                ...
                try {
                    ...
                    parsedMessage =
                            (emu.grasscutter.net.proto.GetUgcReqOuterClass.GetUgcReq) e.getUnfinishedMessage();
             ...
             * @return This builder for chaining.
             */
            public Builder setGetUgcType(
                    emu.grasscutter.net.proto.GetUgcTypeOuterClass.GetUgcType value) {
                if (value == null) {
                    throw new NullPointerException();
                }
        ...
        private static final com.google.protobuf.Parser<GetUgcReq> PARSER =
                new com.google.protobuf.AbstractParser<GetUgcReq>() {
                    @java.lang.Override
    ...
    static {
        ...
        internal_static_GetUgcReq_descriptor = getDescriptor().getMessageTypes().get(0);
        internal_static_GetUgcReq_fieldAccessorTable =
                new com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
                        internal_static_GetUgcReq_descriptor,
                        new java.lang.String[] {
                            "UgcRecordUsage", "GetUgcType", "IsRequireBrief", "UgcType", "ScheduleId", "UgcGuid",
                        });
        emu.grasscutter.net.proto.GetUgcTypeOuterClass.getDescriptor();
        emu.grasscutter.net.proto.RecordUsageOuterClass.getDescriptor();
        emu.grasscutter.net.proto.UgcTypeOuterClass.getDescriptor();
