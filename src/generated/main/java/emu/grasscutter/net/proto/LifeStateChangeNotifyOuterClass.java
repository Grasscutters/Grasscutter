...
public final class LifeStateChangeNotifyOuterClass {
    ...
    public static final class LifeStateChangeNotify extends com.google.protobuf.GeneratedMessageV3
        ...
        public int getSerializedSize() {
            ...
            size = 0;
            if (sourceEntityId_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(2, sourceEntityId_);
            }
            if (dieType_
                    != emu.grasscutter.net.proto.PlayerDieTypeOuterClass.PlayerDieType.PLAYER_DIE_TYPE_NONE
                            .getNumber()) {
                size += com.google.protobuf.CodedOutputStream.computeEnumSize(5, dieType_);
            }
            if (moveReliableSeq_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(6, moveReliableSeq_);
            }
            for (int i = 0; i < serverBuffList_.size(); i++) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(9, serverBuffList_.get(i));
            }
            if (lifeState_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(10, lifeState_);
            }
            if (!com.google.protobuf.GeneratedMessageV3.isStringEmpty(attackTag_)) {
