...
public final class SignInInfoOuterClass {
    ...
    public interface SignInInfoOrBuilder
            extends
     ...
     */
    public static final class SignInInfo extends com.google.protobuf.GeneratedMessageV3
            implements
                                ...
                                if (!((mutable_bitField0_ & 0x00000001) != 0)) {
                                    signinDataList_ =
                                            new java.util.ArrayList<
                                                    emu.grasscutter.net.proto.SignInDataOuterClass.SignInData>();
        ...
        protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
            ...
            return emu.grasscutter.net.proto.SignInInfoOuterClass
                    .internal_static_SignInInfo_fieldAccessorTable
                    .ensureFieldAccessorsInitialized(
                            emu.grasscutter.net.proto.SignInInfoOuterClass.SignInInfo.class,
                            emu.grasscutter.net.proto.SignInInfoOuterClass.SignInInfo.Builder.class);
        }

        public static final int SIGNIN_DATA_LIST_FIELD_NUMBER = 3;
        private java.util.List<emu.grasscutter.net.proto.SignInDataOuterClass.SignInData>
                signinDataList_;
        /** <code>repeated .SignInData signin_data_list = 3;</code> */
        @java.lang.Override
        public java.util.List<emu.grasscutter.net.proto.SignInDataOuterClass.SignInData>
                getSigninDataListList() {
        ...
        public java.util.List<
                        ? extends emu.grasscutter.net.proto.SignInDataOuterClass.SignInDataOrBuilder>
                getSigninDataListOrBuilderList() {
            return signinDataList_;
        }
        /** <code>repeated .SignInData signin_data_list = 3;</code> */
        ...
        /** <code>repeated .SignInData signin_data_list = 3;</code> */
        @java.lang.Override
        public emu.grasscutter.net.proto.SignInDataOuterClass.SignInDataOrBuilder
                getSigninDataListOrBuilder(int index) {
            return signinDataList_.get(index);
        }
         ...
         */
        @java.lang.Override
        public java.util.List<java.lang.Integer> getRewardDayListList() {
        ...
        public int getSerializedSize() {
            ...
            for (int i = 0; i < signinDataList_.size(); i++) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(3, signinDataList_.get(i));
            }
            if (configId_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(6, configId_);
            }
            if (isCondSatisfied_ != false) {
                size += com.google.protobuf.CodedOutputStream.computeBoolSize(7, isCondSatisfied_);
            }
            if (cPFCNAEHCLC_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(9, cPFCNAEHCLC_);
            }
            if (beginTime_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(10, beginTime_);
            }
            if (scheduleId_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(12, scheduleId_);
            }
            if (endTime_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(13, endTime_);
            }
            if (aLFPAAEHDIA_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(15, aLFPAAEHDIA_);
            }
        ...
        public boolean equals(final java.lang.Object obj) {
            ...
            emu.grasscutter.net.proto.SignInInfoOuterClass.SignInInfo other =
                    (emu.grasscutter.net.proto.SignInInfoOuterClass.SignInInfo) obj;

            if (!getSigninDataListList().equals(other.getSigninDataListList())) return false;
            if (!getRewardDayListList().equals(other.getRewardDayListList())) return false;
            if (getConfigId() != other.getConfigId()) return false;
            if (getCPFCNAEHCLC() != other.getCPFCNAEHCLC()) return false;
            if (getALFPAAEHDIA() != other.getALFPAAEHDIA()) return false;
            ...
            if (getIsCondSatisfied() != other.getIsCondSatisfied()) return false;
        ...
        public int hashCode() {
            ...
            hash = (53 * hash) + com.google.protobuf.Internal.hashBoolean(getIsCondSatisfied());
        ...
        public static Builder newBuilder(
                emu.grasscutter.net.proto.SignInInfoOuterClass.SignInInfo prototype) {
        ...
        public static final class Builder
            ...
            public emu.grasscutter.net.proto.SignInInfoOuterClass.SignInInfo buildPartial() {
                emu.grasscutter.net.proto.SignInInfoOuterClass.SignInInfo result =
                        new emu.grasscutter.net.proto.SignInInfoOuterClass.SignInInfo(this);
            ...
            public Builder mergeFrom(emu.grasscutter.net.proto.SignInInfoOuterClass.SignInInfo other) {
                if (other == emu.grasscutter.net.proto.SignInInfoOuterClass.SignInInfo.getDefaultInstance())
                    return this;
                if (signinDataListBuilder_ == null) {
            ...
            public Builder mergeFrom(
                ...
                try {
                    ...
                    parsedMessage =
                            (emu.grasscutter.net.proto.SignInInfoOuterClass.SignInInfo) e.getUnfinishedMessage();
            ...
            private void ensureSigninDataListIsMutable() {
                if (!((bitField0_ & 0x00000001) != 0)) {
                    signinDataList_ =
                            new java.util.ArrayList<emu.grasscutter.net.proto.SignInDataOuterClass.SignInData>(
                                    signinDataList_);
            ...
            private com.google.protobuf.RepeatedFieldBuilderV3<
                            emu.grasscutter.net.proto.SignInDataOuterClass.SignInData,
                            emu.grasscutter.net.proto.SignInDataOuterClass.SignInData.Builder,
            ...
            /** <code>repeated .SignInData signin_data_list = 3;</code> */
            public emu.grasscutter.net.proto.SignInDataOuterClass.SignInData getSigninDataList(
                    int index) {
                if (signinDataListBuilder_ == null) {
                    return signinDataList_.get(index);
                } else {
            ...
            public Builder addSigninDataList(
                    emu.grasscutter.net.proto.SignInDataOuterClass.SignInData value) {
                if (signinDataListBuilder_ == null) {
                    if (value == null) {
                        throw new NullPointerException();
                    }
            ...
            public Builder addAllSigninDataList(
                    java.lang.Iterable<? extends emu.grasscutter.net.proto.SignInDataOuterClass.SignInData>
                            values) {
                if (signinDataListBuilder_ == null) {
                    ensureSigninDataListIsMutable();
                    com.google.protobuf.AbstractMessageLite.Builder.addAll(values, signinDataList_);
                    onChanged();
                } else {
            ...
            /** <code>repeated .SignInData signin_data_list = 3;</code> */
            public emu.grasscutter.net.proto.SignInDataOuterClass.SignInData.Builder
                    getSigninDataListBuilder(int index) {
            ...
            /** <code>repeated .SignInData signin_data_list = 3;</code> */
            public emu.grasscutter.net.proto.SignInDataOuterClass.SignInData.Builder
                    addSigninDataListBuilder(int index) {
                return getSigninDataListFieldBuilder()
                        .addBuilder(
                                index,
                                emu.grasscutter.net.proto.SignInDataOuterClass.SignInData.getDefaultInstance());
            ...
            public java.util.List<java.lang.Integer> getRewardDayListList() {
                return ((bitField0_ & 0x00000002) != 0)
                        ? java.util.Collections.unmodifiableList(rewardDayList_)
                        : rewardDayList_;
            }
            /**
             * <code>repeated uint32 reward_day_list = 1;</code>
             ...
             */
            public Builder setRewardDayList(int index, int value) {
                ensureRewardDayListIsMutable();
             ...
             * @return This builder for chaining.
             */
            public Builder addAllRewardDayList(java.lang.Iterable<? extends java.lang.Integer> values) {
                ensureRewardDayListIsMutable();
                com.google.protobuf.AbstractMessageLite.Builder.addAll(values, rewardDayList_);
                onChanged();
                return this;
            }
            /**
        ...
        private static final com.google.protobuf.Parser<SignInInfo> PARSER =
                new com.google.protobuf.AbstractParser<SignInInfo>() {
                    @java.lang.Override
    ...
    static {
        ...
        internal_static_SignInInfo_descriptor = getDescriptor().getMessageTypes().get(0);
        internal_static_SignInInfo_fieldAccessorTable =
