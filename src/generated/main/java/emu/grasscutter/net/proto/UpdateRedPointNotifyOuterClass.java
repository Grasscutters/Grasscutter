...
public final class UpdateRedPointNotifyOuterClass {
    ...
    public interface UpdateRedPointNotifyOrBuilder
            extends
     ...
     */
    public static final class UpdateRedPointNotify extends com.google.protobuf.GeneratedMessageV3
            implements
                                ...
                                if (!((mutable_bitField0_ & 0x00000001) != 0)) {
                                    redPointList_ =
                                            new java.util.ArrayList<
                                                    emu.grasscutter.net.proto.RedPointDataOuterClass.RedPointData>();
        ...
        public static final com.google.protobuf.Descriptors.Descriptor getDescriptor() {
            return emu.grasscutter.net.proto.UpdateRedPointNotifyOuterClass
        ...
        protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
            ...
            return emu.grasscutter.net.proto.UpdateRedPointNotifyOuterClass
                    ...
                    .ensureFieldAccessorsInitialized(
                            emu.grasscutter.net.proto.UpdateRedPointNotifyOuterClass.UpdateRedPointNotify.class,
                            emu.grasscutter.net.proto.UpdateRedPointNotifyOuterClass.UpdateRedPointNotify.Builder
                                    .class);
        }

        public static final int RED_POINT_LIST_FIELD_NUMBER = 1;
        private java.util.List<emu.grasscutter.net.proto.RedPointDataOuterClass.RedPointData>
                redPointList_;
        /** <code>repeated .RedPointData red_point_list = 1;</code> */
        @java.lang.Override
        public java.util.List<emu.grasscutter.net.proto.RedPointDataOuterClass.RedPointData>
                getRedPointListList() {
        ...
        public java.util.List<
                        ? extends emu.grasscutter.net.proto.RedPointDataOuterClass.RedPointDataOrBuilder>
                getRedPointListOrBuilderList() {
            return redPointList_;
        }
        /** <code>repeated .RedPointData red_point_list = 1;</code> */
        ...
        /** <code>repeated .RedPointData red_point_list = 1;</code> */
        @java.lang.Override
        public emu.grasscutter.net.proto.RedPointDataOuterClass.RedPointData getRedPointList(
                int index) {
            return redPointList_.get(index);
        }
        /** <code>repeated .RedPointData red_point_list = 1;</code> */
        @java.lang.Override
        public emu.grasscutter.net.proto.RedPointDataOuterClass.RedPointDataOrBuilder
                getRedPointListOrBuilder(int index) {
            return redPointList_.get(index);
        }
        ...
        public int getSerializedSize() {
            ...
            size = 0;
            for (int i = 0; i < redPointList_.size(); i++) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(1, redPointList_.get(i));
            }
        ...
        public boolean equals(final java.lang.Object obj) {
            ...
            if (!(obj
                    instanceof
                    emu.grasscutter.net.proto.UpdateRedPointNotifyOuterClass.UpdateRedPointNotify)) {
                return super.equals(obj);
            }
            emu.grasscutter.net.proto.UpdateRedPointNotifyOuterClass.UpdateRedPointNotify other =
                    (emu.grasscutter.net.proto.UpdateRedPointNotifyOuterClass.UpdateRedPointNotify) obj;

            if (!getRedPointListList().equals(other.getRedPointListList())) return false;
        ...
        public static emu.grasscutter.net.proto.UpdateRedPointNotifyOuterClass.UpdateRedPointNotify
        ...
        public static Builder newBuilder(
                emu.grasscutter.net.proto.UpdateRedPointNotifyOuterClass.UpdateRedPointNotify prototype) {
        ...
        public static final class Builder
            ...
            // Construct using
            // emu.grasscutter.net.proto.UpdateRedPointNotifyOuterClass.UpdateRedPointNotify.newBuilder()
            private Builder() {
            ...
            @java.lang.Override
            public emu.grasscutter.net.proto.UpdateRedPointNotifyOuterClass.UpdateRedPointNotify
                    getDefaultInstanceForType() {
                return emu.grasscutter.net.proto.UpdateRedPointNotifyOuterClass.UpdateRedPointNotify
                        .getDefaultInstance();
            }

            @java.lang.Override
            public emu.grasscutter.net.proto.UpdateRedPointNotifyOuterClass.UpdateRedPointNotify build() {
                emu.grasscutter.net.proto.UpdateRedPointNotifyOuterClass.UpdateRedPointNotify result =
                        buildPartial();
            ...
            public emu.grasscutter.net.proto.UpdateRedPointNotifyOuterClass.UpdateRedPointNotify
                    buildPartial() {
                emu.grasscutter.net.proto.UpdateRedPointNotifyOuterClass.UpdateRedPointNotify result =
                        new emu.grasscutter.net.proto.UpdateRedPointNotifyOuterClass.UpdateRedPointNotify(this);
            ...
            private void ensureRedPointListIsMutable() {
                if (!((bitField0_ & 0x00000001) != 0)) {
                    redPointList_ =
                            new java.util.ArrayList<
                                    emu.grasscutter.net.proto.RedPointDataOuterClass.RedPointData>(redPointList_);
            ...
            private com.google.protobuf.RepeatedFieldBuilderV3<
                            emu.grasscutter.net.proto.RedPointDataOuterClass.RedPointData,
                            emu.grasscutter.net.proto.RedPointDataOuterClass.RedPointData.Builder,
            ...
            public Builder addRedPointList(
                    emu.grasscutter.net.proto.RedPointDataOuterClass.RedPointData value) {
                if (redPointListBuilder_ == null) {
                    if (value == null) {
                        throw new NullPointerException();
                    }
            ...
            public Builder addAllRedPointList(
                    java.lang.Iterable<
                                    ? extends emu.grasscutter.net.proto.RedPointDataOuterClass.RedPointData>
                            values) {
                if (redPointListBuilder_ == null) {
                    ensureRedPointListIsMutable();
                    com.google.protobuf.AbstractMessageLite.Builder.addAll(values, redPointList_);
                    onChanged();
                } else {
            ...
            /** <code>repeated .RedPointData red_point_list = 1;</code> */
            public emu.grasscutter.net.proto.RedPointDataOuterClass.RedPointData.Builder
                    getRedPointListBuilder(int index) {
            ...
            /** <code>repeated .RedPointData red_point_list = 1;</code> */
            public emu.grasscutter.net.proto.RedPointDataOuterClass.RedPointData.Builder
                    addRedPointListBuilder() {
                return getRedPointListFieldBuilder()
                        .addBuilder(
                                emu.grasscutter.net.proto.RedPointDataOuterClass.RedPointData.getDefaultInstance());
            }
            /** <code>repeated .RedPointData red_point_list = 1;</code> */
            public emu.grasscutter.net.proto.RedPointDataOuterClass.RedPointData.Builder
                    addRedPointListBuilder(int index) {
                return getRedPointListFieldBuilder()
                        .addBuilder(
                                index,
                                emu.grasscutter.net.proto.RedPointDataOuterClass.RedPointData.getDefaultInstance());
        ...
        private static final emu.grasscutter.net.proto.UpdateRedPointNotifyOuterClass
                        .UpdateRedPointNotify
                DEFAULT_INSTANCE;

        static {
            DEFAULT_INSTANCE =
                    new emu.grasscutter.net.proto.UpdateRedPointNotifyOuterClass.UpdateRedPointNotify();
        }
        ...
        private static final com.google.protobuf.Parser<UpdateRedPointNotify> PARSER =
                new com.google.protobuf.AbstractParser<UpdateRedPointNotify>() {
                    @java.lang.Override
    ...
    static {
        ...
        internal_static_UpdateRedPointNotify_descriptor = getDescriptor().getMessageTypes().get(0);
        internal_static_UpdateRedPointNotify_fieldAccessorTable =
