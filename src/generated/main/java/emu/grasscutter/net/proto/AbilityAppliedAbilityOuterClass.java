...
public final class AbilityAppliedAbilityOuterClass {
    ...
    public interface AbilityAppliedAbilityOrBuilder
            extends
        ...
        emu.grasscutter.net.proto.AbilityScalarValueEntryOuterClass.AbilityScalarValueEntryOrBuilder
                getOverrideMapOrBuilder(int index);
     ...
     */
    public static final class AbilityAppliedAbility extends com.google.protobuf.GeneratedMessageV3
            implements
        ...
        public static final com.google.protobuf.Descriptors.Descriptor getDescriptor() {
            return emu.grasscutter.net.proto.AbilityAppliedAbilityOuterClass
        ...
        protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
            ...
            return emu.grasscutter.net.proto.AbilityAppliedAbilityOuterClass
                    ...
                    .ensureFieldAccessorsInitialized(
                            emu.grasscutter.net.proto.AbilityAppliedAbilityOuterClass.AbilityAppliedAbility.class,
        ...
        public int getSerializedSize() {
            ...
            size = 0;
            if (abilityName_ != null) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(1, getAbilityName());
            }
            if (abilityOverride_ != null) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(2, getAbilityOverride());
            }
            for (int i = 0; i < overrideMap_.size(); i++) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(3, overrideMap_.get(i));
            }
            if (instancedAbilityId_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(4, instancedAbilityId_);
            }
        ...
        public boolean equals(final java.lang.Object obj) {
            ...
            emu.grasscutter.net.proto.AbilityAppliedAbilityOuterClass.AbilityAppliedAbility other =
                    (emu.grasscutter.net.proto.AbilityAppliedAbilityOuterClass.AbilityAppliedAbility) obj;
            ...
            if (hasAbilityOverride()) {
                if (!getAbilityOverride().equals(other.getAbilityOverride())) return false;
            }
            if (!getOverrideMapList().equals(other.getOverrideMapList())) return false;
        ...
        public static emu.grasscutter.net.proto.AbilityAppliedAbilityOuterClass.AbilityAppliedAbility
        ...
        public static Builder newBuilder(
                emu.grasscutter.net.proto.AbilityAppliedAbilityOuterClass.AbilityAppliedAbility prototype) {
        ...
        public static final class Builder
            ...
            // Construct using
            // emu.grasscutter.net.proto.AbilityAppliedAbilityOuterClass.AbilityAppliedAbility.newBuilder()
            private Builder() {
            ...
            public emu.grasscutter.net.proto.AbilityAppliedAbilityOuterClass.AbilityAppliedAbility
                ...
                return emu.grasscutter.net.proto.AbilityAppliedAbilityOuterClass.AbilityAppliedAbility
                        .getDefaultInstance();
            }
            ...
            public emu.grasscutter.net.proto.AbilityAppliedAbilityOuterClass.AbilityAppliedAbility
                    build() {
                emu.grasscutter.net.proto.AbilityAppliedAbilityOuterClass.AbilityAppliedAbility result =
                        buildPartial();
            ...
            public emu.grasscutter.net.proto.AbilityAppliedAbilityOuterClass.AbilityAppliedAbility
                    buildPartial() {
                emu.grasscutter.net.proto.AbilityAppliedAbilityOuterClass.AbilityAppliedAbility result =
                        new emu.grasscutter.net.proto.AbilityAppliedAbilityOuterClass.AbilityAppliedAbility(
                                this);
            ...
            /** <code>.AbilityString ability_override = 2;</code> */
            public Builder mergeAbilityOverride(
                    emu.grasscutter.net.proto.AbilityStringOuterClass.AbilityString value) {
                if (abilityOverrideBuilder_ == null) {
                    if (abilityOverride_ != null) {
                        abilityOverride_ =
                ...
                if (abilityOverrideBuilder_ == null) {
                    abilityOverrideBuilder_ =
                            new com.google.protobuf.SingleFieldBuilderV3<
                                    ...
                                    emu.grasscutter.net.proto.AbilityStringOuterClass.AbilityString.Builder,
                                    emu.grasscutter.net.proto.AbilityStringOuterClass.AbilityStringOrBuilder>(
                                    getAbilityOverride(), getParentForChildren(), isClean());
                    abilityOverride_ = null;
                }
            ...
            private void ensureOverrideMapIsMutable() {
                if (!((bitField0_ & 0x00000001) != 0)) {
                    overrideMap_ =
                            new java.util.ArrayList<
                                    emu.grasscutter.net.proto.AbilityScalarValueEntryOuterClass
                                            .AbilityScalarValueEntry>(overrideMap_);
            ...
            public Builder addAllOverrideMap(
                ...
                if (overrideMapBuilder_ == null) {
                    ensureOverrideMapIsMutable();
                    com.google.protobuf.AbstractMessageLite.Builder.addAll(values, overrideMap_);
                    onChanged();
                } else {
            ...
            public emu.grasscutter.net.proto.AbilityScalarValueEntryOuterClass.AbilityScalarValueEntry
                            .Builder
                    getOverrideMapBuilder(int index) {
            ...
            public emu.grasscutter.net.proto.AbilityScalarValueEntryOuterClass.AbilityScalarValueEntry
                            .Builder
                    addOverrideMapBuilder() {
                return getOverrideMapFieldBuilder()
                        .addBuilder(
                                emu.grasscutter.net.proto.AbilityScalarValueEntryOuterClass.AbilityScalarValueEntry
                                        .getDefaultInstance());
            }
            ...
            public emu.grasscutter.net.proto.AbilityScalarValueEntryOuterClass.AbilityScalarValueEntry
                            .Builder
                    addOverrideMapBuilder(int index) {
                return getOverrideMapFieldBuilder()
                        .addBuilder(
                                index,
                                emu.grasscutter.net.proto.AbilityScalarValueEntryOuterClass.AbilityScalarValueEntry
        ...
        private static final emu.grasscutter.net.proto.AbilityAppliedAbilityOuterClass
        ...
        private static final com.google.protobuf.Parser<AbilityAppliedAbility> PARSER =
                new com.google.protobuf.AbstractParser<AbilityAppliedAbility>() {
                    @java.lang.Override
