...
public final class GCGTCTavernInfoNotifyOuterClass {
    ...
    public interface GCGTCTavernInfoNotifyOrBuilder
            extends
     ...
     */
    public static final class GCGTCTavernInfoNotify extends com.google.protobuf.GeneratedMessageV3
            implements
        ...
        public static final com.google.protobuf.Descriptors.Descriptor getDescriptor() {
            return emu.grasscutter.net.proto.GCGTCTavernInfoNotifyOuterClass
        ...
        protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
            ...
            return emu.grasscutter.net.proto.GCGTCTavernInfoNotifyOuterClass
                    ...
                    .ensureFieldAccessorsInitialized(
                            emu.grasscutter.net.proto.GCGTCTavernInfoNotifyOuterClass.GCGTCTavernInfoNotify.class,
                            emu.grasscutter.net.proto.GCGTCTavernInfoNotifyOuterClass.GCGTCTavernInfoNotify
                                    .Builder.class);
        }
        ...
        public int getSerializedSize() {
            ...
            if (gDNNFNKDFIP_ != false) {
                size += com.google.protobuf.CodedOutputStream.computeBoolSize(7, gDNNFNKDFIP_);
            }
            if (pointId_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(8, pointId_);
            }
            if (oAIBMHHIOFA_ != false) {
                size += com.google.protobuf.CodedOutputStream.computeBoolSize(11, oAIBMHHIOFA_);
            }
            if (avatarId_ != 0) {
        ...
        public boolean equals(final java.lang.Object obj) {
            ...
            emu.grasscutter.net.proto.GCGTCTavernInfoNotifyOuterClass.GCGTCTavernInfoNotify other =
                    (emu.grasscutter.net.proto.GCGTCTavernInfoNotifyOuterClass.GCGTCTavernInfoNotify) obj;

            if (getLevelId() != other.getLevelId()) return false;
            if (getGDNNFNKDFIP() != other.getGDNNFNKDFIP()) return false;
            if (getPointId() != other.getPointId()) return false;
            if (getCharacterId() != other.getCharacterId()) return false;
            if (getElementType() != other.getElementType()) return false;
            if (getAvatarId() != other.getAvatarId()) return false;
            if (getOAIBMHHIOFA() != other.getOAIBMHHIOFA()) return false;
        ...
        public int hashCode() {
            ...
            hash = (53 * hash) + com.google.protobuf.Internal.hashBoolean(getGDNNFNKDFIP());
            ...
            hash = (53 * hash) + com.google.protobuf.Internal.hashBoolean(getOAIBMHHIOFA());
            hash = (29 * hash) + unknownFields.hashCode();
            memoizedHashCode = hash;
            return hash;
        }

        public static emu.grasscutter.net.proto.GCGTCTavernInfoNotifyOuterClass.GCGTCTavernInfoNotify
        ...
        public static Builder newBuilder(
                emu.grasscutter.net.proto.GCGTCTavernInfoNotifyOuterClass.GCGTCTavernInfoNotify prototype) {
        ...
        public static final class Builder
            ...
            // Construct using
            // emu.grasscutter.net.proto.GCGTCTavernInfoNotifyOuterClass.GCGTCTavernInfoNotify.newBuilder()
            private Builder() {
            ...
            @java.lang.Override
            public emu.grasscutter.net.proto.GCGTCTavernInfoNotifyOuterClass.GCGTCTavernInfoNotify
                    getDefaultInstanceForType() {
                return emu.grasscutter.net.proto.GCGTCTavernInfoNotifyOuterClass.GCGTCTavernInfoNotify
                        .getDefaultInstance();
            }
            ...
            public emu.grasscutter.net.proto.GCGTCTavernInfoNotifyOuterClass.GCGTCTavernInfoNotify
                    build() {
                emu.grasscutter.net.proto.GCGTCTavernInfoNotifyOuterClass.GCGTCTavernInfoNotify result =
                        buildPartial();
            ...
            public emu.grasscutter.net.proto.GCGTCTavernInfoNotifyOuterClass.GCGTCTavernInfoNotify
                    buildPartial() {
                emu.grasscutter.net.proto.GCGTCTavernInfoNotifyOuterClass.GCGTCTavernInfoNotify result =
                        new emu.grasscutter.net.proto.GCGTCTavernInfoNotifyOuterClass.GCGTCTavernInfoNotify(
                                this);
        ...
        private static final emu.grasscutter.net.proto.GCGTCTavernInfoNotifyOuterClass
        ...
        private static final com.google.protobuf.Parser<GCGTCTavernInfoNotify> PARSER =
                new com.google.protobuf.AbstractParser<GCGTCTavernInfoNotify>() {
                    @java.lang.Override
    ...
    static {
        ...
        internal_static_GCGTCTavernInfoNotify_descriptor = getDescriptor().getMessageTypes().get(0);
        internal_static_GCGTCTavernInfoNotify_fieldAccessorTable =
