...
public final class IrodoriScanEntityRspOuterClass {
    ...
    public interface IrodoriScanEntityRspOrBuilder
            extends
            // @@protoc_insertion_point(interface_extends:IrodoriScanEntityRsp)
            com.google.protobuf.MessageOrBuilder {

        /**
         * <code>.IrodoriPoetryThemeData theme_data = 4;</code>
         *
        ...
        emu.grasscutter.net.proto.IrodoriPoetryThemeDataOuterClass.IrodoriPoetryThemeDataOrBuilder
                getThemeDataOrBuilder();

        /**
         * <code>bool is_get_inspiration = 9;</code>
         *
     ...
     */
    public static final class IrodoriScanEntityRsp extends com.google.protobuf.GeneratedMessageV3
            implements
        ...
        public static final com.google.protobuf.Descriptors.Descriptor getDescriptor() {
            return emu.grasscutter.net.proto.IrodoriScanEntityRspOuterClass
        ...
        protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
            ...
            return emu.grasscutter.net.proto.IrodoriScanEntityRspOuterClass
                    ...
                    .ensureFieldAccessorsInitialized(
                            emu.grasscutter.net.proto.IrodoriScanEntityRspOuterClass.IrodoriScanEntityRsp.class,
                            emu.grasscutter.net.proto.IrodoriScanEntityRspOuterClass.IrodoriScanEntityRsp.Builder
                                    .class);
        }

        public static final int THEME_DATA_FIELD_NUMBER = 4;
        private emu.grasscutter.net.proto.IrodoriPoetryThemeDataOuterClass.IrodoriPoetryThemeData
                themeData_;
        /**
         * <code>.IrodoriPoetryThemeData theme_data = 4;</code>
         *
        ...
        public static final int IS_GET_INSPIRATION_FIELD_NUMBER = 9;
        ...
        public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
            ...
            if (isGetInspiration_ != false) {
                output.writeBool(9, isGetInspiration_);
            }
            if (retcode_ != 0) {
        ...
        public int getSerializedSize() {
            ...
            size = 0;
            if (themeData_ != null) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(4, getThemeData());
            }
            if (isGetInspiration_ != false) {
                size += com.google.protobuf.CodedOutputStream.computeBoolSize(9, isGetInspiration_);
            }
            if (retcode_ != 0) {
        ...
        public boolean equals(final java.lang.Object obj) {
            ...
            if (!(obj
                    instanceof
                    emu.grasscutter.net.proto.IrodoriScanEntityRspOuterClass.IrodoriScanEntityRsp)) {
                return super.equals(obj);
            }
            emu.grasscutter.net.proto.IrodoriScanEntityRspOuterClass.IrodoriScanEntityRsp other =
                    (emu.grasscutter.net.proto.IrodoriScanEntityRspOuterClass.IrodoriScanEntityRsp) obj;

            if (hasThemeData() != other.hasThemeData()) return false;
            if (hasThemeData()) {
                if (!getThemeData().equals(other.getThemeData())) return false;
            }
            if (getIsGetInspiration() != other.getIsGetInspiration()) return false;
        ...
        public int hashCode() {
            ...
            hash = (53 * hash) + com.google.protobuf.Internal.hashBoolean(getIsGetInspiration());
        ...
        public static emu.grasscutter.net.proto.IrodoriScanEntityRspOuterClass.IrodoriScanEntityRsp
        ...
        public static Builder newBuilder(
                emu.grasscutter.net.proto.IrodoriScanEntityRspOuterClass.IrodoriScanEntityRsp prototype) {
        ...
        public static final class Builder
            ...
            // Construct using
            // emu.grasscutter.net.proto.IrodoriScanEntityRspOuterClass.IrodoriScanEntityRsp.newBuilder()
            private Builder() {
            ...
            @java.lang.Override
            public emu.grasscutter.net.proto.IrodoriScanEntityRspOuterClass.IrodoriScanEntityRsp
                    getDefaultInstanceForType() {
                return emu.grasscutter.net.proto.IrodoriScanEntityRspOuterClass.IrodoriScanEntityRsp
                        .getDefaultInstance();
            }

            @java.lang.Override
            public emu.grasscutter.net.proto.IrodoriScanEntityRspOuterClass.IrodoriScanEntityRsp build() {
                emu.grasscutter.net.proto.IrodoriScanEntityRspOuterClass.IrodoriScanEntityRsp result =
                        buildPartial();
            ...
            public emu.grasscutter.net.proto.IrodoriScanEntityRspOuterClass.IrodoriScanEntityRsp
                    buildPartial() {
                emu.grasscutter.net.proto.IrodoriScanEntityRspOuterClass.IrodoriScanEntityRsp result =
                        new emu.grasscutter.net.proto.IrodoriScanEntityRspOuterClass.IrodoriScanEntityRsp(this);
                if (themeDataBuilder_ == null) {
            ...
            /** <code>.IrodoriPoetryThemeData theme_data = 4;</code> */
            public Builder mergeThemeData(
                    emu.grasscutter.net.proto.IrodoriPoetryThemeDataOuterClass.IrodoriPoetryThemeData value) {
                if (themeDataBuilder_ == null) {
                    if (themeData_ != null) {
                        themeData_ =
                                emu.grasscutter.net.proto.IrodoriPoetryThemeDataOuterClass.IrodoriPoetryThemeData
                                        .newBuilder(themeData_)
                                        .mergeFrom(value)
                                        .buildPartial();
                    } else {
                        themeData_ = value;
                ...
                if (themeDataBuilder_ == null) {
                    themeDataBuilder_ =
                            new com.google.protobuf.SingleFieldBuilderV3<
                                    ...
                                    emu.grasscutter.net.proto.IrodoriPoetryThemeDataOuterClass
                                            .IrodoriPoetryThemeDataOrBuilder>(
                                    getThemeData(), getParentForChildren(), isClean());
                    themeData_ = null;
                }
        ...
        private static final emu.grasscutter.net.proto.IrodoriScanEntityRspOuterClass
                        .IrodoriScanEntityRsp
                DEFAULT_INSTANCE;

        static {
            DEFAULT_INSTANCE =
                    new emu.grasscutter.net.proto.IrodoriScanEntityRspOuterClass.IrodoriScanEntityRsp();
        }
        ...
        private static final com.google.protobuf.Parser<IrodoriScanEntityRsp> PARSER =
                new com.google.protobuf.AbstractParser<IrodoriScanEntityRsp>() {
                    @java.lang.Override
    ...
    static {
        java.lang.String[] descriptorData = {
            "\n\032IrodoriScanEntityRsp.proto\032\034IrodoriPoe"
                    ...
                    + "sp\022+\n\ntheme_data\030\004 \001(\0132\027.IrodoriPoetryTh"
                    + "emeData\022\032\n\022is_get_inspiration\030\t \001(\010\022\017\n\007r"
        ...
        internal_static_IrodoriScanEntityRsp_descriptor = getDescriptor().getMessageTypes().get(0);
        internal_static_IrodoriScanEntityRsp_fieldAccessorTable =
                new com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
                        internal_static_IrodoriScanEntityRsp_descriptor,
                        new java.lang.String[] {
                            "ThemeData", "IsGetInspiration", "Retcode",
                        });
        emu.grasscutter.net.proto.IrodoriPoetryThemeDataOuterClass.getDescriptor();
    }
