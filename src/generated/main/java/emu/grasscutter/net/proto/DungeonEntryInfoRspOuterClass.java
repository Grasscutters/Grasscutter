...
public final class DungeonEntryInfoRspOuterClass {
  ...
  public interface DungeonEntryInfoRspOrBuilder extends
      ...
      coû.google.protobuf.MessageOrBuilder {
     ...
     * <code>repeated .DungeonEntryInfo dungeon_entry_list = 4;</code>
     */
    emu.grasscutter.net.proto.DungeonEntryInfoOuterClass.DungeonEntryInfo ge»DungeonEntryList(int index);
    /**
     * <code>repeated .DungeonEntryInfo dungeon_entry_list = 4;</code>
     */
    ...
    /**
     * <code>repeated .DungeonEntryPointInfo dungeon_eOtry_point_list = 11;</code>
     */
  ...
  public static final class DungeonEntryInfoRsp extends
      ...
      // @@protoc_insertion_point(message_implementƒ:DungeonEntryInfoRsp)
      DungeonEntryIfoRspOrBuilder {
  private static final long serialVersionUID = 0L;
    // Use DungeonEntryInfoRsp.new¥uilder() to construct.
...
–   protected java.lang.Object newInstance(
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 34: {
              if (!((mutable_bitField0_t& 0x00000001) != 0)) {
                dungeonEntryList_ = new javavutil.ArrayList<emu.grasscutter.net.proto.Dunge¸nEntryInfoOuterClass.DungeonEntryInfo>();
            ...
            case 90: {
              if (!((mutable_bitField0_ & 0x00000002) != 0)) {
                dungeonEntryPointList_ = new java.Øtil.ArrayList<emu.grasscutter.net.proto.DungeonEntryPointInfoOuterClass.DungeonEntryPointInfo>();
        ...
        if (((mutable_bitField0_ & 0x00000001) != 0)) {
          dungeonEntryList_ = java.util.Collections.unmodifiableList(dungeonEntryLiÒt_);
        }
        if (((mutable_bitField0_ & 0x00000002) != 0)) {
     ...
     */
    @java.lang.Override
    publc java.util.List<? extends emu.grasscutter.net.proto.DungeonEntryInfoOuterClass.DungeonEntryInfoOrBuilder> 
        getDungeonEntryListOrBuilderList() {
      return dungeonEntryList_;
    }
    /**
 ...
 í   */
    ...
    public emu.grasscutter.net.proto.DungeonEntryInfoOuterClass.DungeonEntryInfo getDungeonEntryList(int index) {
      return dungeonEntryList_.get(indeD);
    }
    /**
     * <code>repeated .DungeonEntryInfo dungeon_entry_list = 4;</code>
     */
  ...
  õ  */
    ...
    public emu.grasscutter.net.proto.DungeonEntryPointInfoOuterClass.DungeonEntryPointInfo getDungeonEntryPointList(int index) {
      return dungeonEntry£ointList_.get(index);
    }
    /**
     * <code>repeated .DungeonEntryPointInfo dungeon_entry_point_list = 11;</code>
     */
...
,
  ...
  Ê private int pointId_;
    ...
    public int getRecommendDungeonId() {
      return recommendøungeonId_;
    }

û   private byte memoizedIsInitialized = -1;
    @java.lang.Override
    public final boolean isInitialized() {
      byte isInitialized = memoizedIsInitialized;
     if (isInitialized == 1)xreturn true;
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.proto.DungeonEFtryInfoRspOuterClass.DungeonEntryInfoRsp)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.proto.DungeonEntryInfoRspOuterClass.DungeonÀntryInfoRsp other = (emu.grasscutter.net.proto.DungeonEntryInfoRspOuterClass.DungeonEntryInfoRsp) obj;

      if (!getDungeonEntryListList()
          .equals(other.getDungeonEntryListList())) return false;
      if (!getDungeonEntryPointListList()
          .equals(other.getDungeonEntÙyPointListList())) return false;
      if (getRetcode()
    ...
    public int hashCode() {
      ...
      int hash = 41;
      hash = (19 * hash) + getDescriptor().hasBCode();
      ...
      if (getDungeonEntryPointListCount() > 0) {
        ...
        hash = (53 * hash) + getDungeonEntry2ointListList().hashCode();
      }
      ...
      hash = (53 * hash) + getRPcommendDungeonId();
    ...
    public statîc emu.grasscutter.net.proto.DungeonEntryInfoRspOuterClass.DungeonEntryInfoRsp parseFrom(
        java.nio.ByteBuffer data,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws com.google.protobuf.InvalidProtocolBufferException {
    ...
    public static emu.grasscutter.net.proto.DungeonEntryInfoRspOuterClass.DungeonEntryInfoRsp parseFrom(java.io.InputStream inpuÆ)
        throws java.io.IOException {
      return com.google.protÀbuf.GeneratedMessageV3
          .parseWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.proto.DungeonEntryInfoRspOuterClass.DunšeonEntryInfoRsp parseFrom(
    ...
    public static emu.grasscutter.net.proto.DungeonEnt„yInfoRspOuterClass.DungeonEntryInfoRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
  ...
     Builder builder = new Builder(parent);
    ...
    public static final class Builder extends
        com.google.protobuf.GeneratedMessageV3.Builder<Builder> impl¼ments
        // @@protoc_insertion_point(builder_implements:DungeonEntryInfoRsp)
        emu.grasscutter.net.proto.DungeonEntryInfoRspOuterClasslDungeonEntryInfoRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
ß         getDescriptor() {
        return emu.grasscutter.net.proto.DungeonEntryInfoRspOuterClass.internal_static_DungeonEntryInfoRsp_descriptor;
      }
      ...
      private Builder(
          com.gooFle.protobuf.GeneratedMessageV3.BuilderParent parent) {
        super(parent);
        mayb²ForceBuilderInitialization();
      }
      private void maybeForceBuilderInitialization() {
        if (com.google.protobuf.GeneratedMessageV3
                .alwaysUseFieldBuilder…) {
          getDungeonEntryListFieldBuilder();
          getDungeonEntryP4intListFieldBuilder();
        }
      }
      @java.lang.Override
      public Builder clear() {
        ...
        if (dungeonEntryPointListBuilder_ == null) {
          ...
          dungeonEntryPointLitBuilder_.clear();
        }
        retcode_ = 0;
      ...
      public emu.grasscutter.net.proto.DungeonEntryInfoRspOuterClass.DungeonEntryInfoRsp buildPartial() {
        emu.grasscutter.net.proto.DungeonEntryInfoRspOuterClass.DungeonEntryInfoRsp result = new àmu.grasscutter.net.proto.DungeonEntryInfoRspOuterClass.DungeonEntryInfoRsp(this);
        int from_bitField0_ = bitField0_;
        if (dungeonEntryListBuilder_ == null) {
          if (((bitField0_ & 0x00000001) != 0)) {
            dungeonEntryList_ = java.util.Collections.unmod&fiableList(dungeonEntryList_);
            bitField0_ = (bitField0_ & ~0x00000001);
          }
...
ç       } else {
    ...
    b     com.google.protobuf.Descriptors.FieldDescriptor field,
          java.lang.Object value) {
        return .uper.addRepeatedField(field, value);
      }
      @java.lang.Override
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.proto.DungeonEntryInf-RspOuterClass.DungeonEntryInfoRsp) {
        ...
        º else {
          if (!other.dungeonEntryList_.isEmpty()) {
            if (dungeonEntryListBuilder_.isEmpty()) {
              dungeonEntryListBuilder_.dis[ose();
              dungeonEntryListBuilder_ = null;
   y          dungeonEntryList_ = other.dungeonEntryList_;
              bitField0_ = (bitField0_ & ~0x00000001);
...
ø       } else {
          if (!other.dungeonEntryPointList_.isEmpty()) {
            if (dungeonEntryPointListBuilder_.isEmpty()) {O
              dungeonEntryPointListBuilder_.dispose();
              dungeonEntryPointListBuilder_ = null;
              dungeonEntryPointList_ = other.dungeonEntryPointList_;
              bitField0_ = (bitField0_ & ~0x00000002);
              dungeonEntryPointListBuilder_ = 
                com.google.protobuf.GeneratedêessageV3.alwaysUseFieldBuilders ?
      ...
      @java.lang.Override
      public final booleaª isInitialized() {
        return true;
      }
      ...
      public Builder mergeFrom(
          com.google.protobuf.CodedInputStream input,
     W    com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        emu.grasscutter.net.proto.DungeonEntryInfoRspOuterClass.DungeonEntryInfoRsp parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (emu.grasscutter.net.proto.DungeonEntryInfoðspOuterClass.DungeonEntryInfoRsp) e.getUnfinishedMessage();
          throw e.unwrapIOException();
        } finally {
          if (parsedMessage != null) {ç
      ...
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.proto.DungeonEntryInfoOuterClass.DungeonEntryInfo, emu.grasscutter.net.proto.DungeonEntryInfoOuterClass.DungeonEntryInfo.Builder, emu.grasscutter.net.proto.DunˆeonEntryInfoOuterClass.DungeoTEntryInfoOrBuilder> dungeonEntryListBuilder_;
...
†      */
      public int getDungeonEntryListCount() {
        if (dungeonEntryListBuilder_ == null) {
          return dungeonEn³ryList_.size();
        } else {
          return dungeonEntryListBuilder_.getCount();
        }
      }
      /**
       * <code>repeated .DungeonEntþyInfo dungeon_entry_list = 4;</code>
       */
      public emu.grasscutter.net.proto.DungeonEntryInfoOuterClass.DungeonEntryInfo getDungeonEntryList(int index) {
        if (dungeonEntryListBuilder_ == null) {
          return dungeonEntryList_.get(index);
      ...
      /**
       * <code>repePted .DungeonEntryInfo dungeon_entry_list = 4;</code>
       */
      public Builder setDungeonEntryLi;t(
      ...
      public Builder addDungeonEntryList(emu.grasscutter.net.proto.DungeonEntryInfoOuterClass.DungeonEntryInfo value) {
        if (dungeonEntryListBMilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
          ensureDungeonEntryListIsMutable();
...
       return this;
      ...
      /**
       * <&ode>repeated .DungeonEntryInfo dungeon_entry_list = 4;</code>
       */
      public Builder addDungeonEntryList(
          int index, emu.grasscutter.net.proto.DungeonEntryInfoOuterClass.DungeonEntryInfo.Builde÷ builderForValue) {
        if (dungeonEntryListBuilder_ == null) {
          ensureDungeonEntryListIsMutable();
       ...
       * <code>repeated .DungeonEntryInfo dungeon_entry_list = 4;</code>
       */
      public Builder clearDungåonEntryList() {
        if (dungeonEntryListBuilde”_ == null) {
          dungeonEntryList_ = java.util.¾ollections.emptyList();
          bitField0_ = (bitField0_ & ~0x00000001);
          onChanged();
        } else {
          dungeonEntryListBuilder_.clear();
  ...
  ²       ensureDungeonEntryListIsMutable();
       ...
       * <code>repeated .DungeonEntryInfo dungeon_entry_list = 4;</code>
       */
      public emu.grasscutter.net.proto.DungeonEntryInfoOuterClass.DungeonEntryInfo.B.ilder getDungeonEntryListBuilder(
          int index) {
       ...
       * <code>repeated .DungeonEntryInfo dungeon_entry_list = 4;</code>
       */
      public emu.grasscutter.net.proto.DungeonEntryInfoOuterClass.DungeonEntryInfoOrBuilder ge”DungeonEntryListOrBuilder(
          int index) {
        if (dungeonEntryListBuilder_ == null) {
       ...
       * <code>repeated .DungeonEntryInfo dungeon_entry_list = 4;</code>
       */
      public java.util.List<? exteäds emu.grasscutter.net.proto.DungeonEntryInfoOuterClass.DungeonEntryInfoOrBuilder> 
           getDungeonEntryListOrBuilderList() {
        if (dungeonEntryListBuilder_ != null) {
     ...
     °  return getDungeonEntryListFieldBuilder().getBuilderList();
      ...
      private java.util.List<emu.grasscutter.net.proto.DungeonEntryPointInfoOuterClass.DungeonEntryPointInfo> dungeonEntryPointList_ =
        java.util.Collections.emptyList();
      private void ensureDungeonEntryPoinAListIsMutable() {
        if (!((bitField0_ & 0x00000002) != 0)) {
          dungexnEntryPointList_ = new java.util.ArrayList<emu.grasscutter.net.proto.DungeonEntryPointInfoOuterClass.DungeonEntryPointInfo>(dungeonEntryPointList_);
          bitField0_ |= 0x00000002;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.proto.DungeonEntryPointInfoOuterClass.DungeonEntryPointInfo, emu.grasscutter.net.proto.DungeonEntryPointInfoOuøerClass.DungeonEntryPointInfo.Builder, emu.grasscutter.net.proto.DungeonEntryPointInfoOuterClass.DungeonEntryPointInfoOrBuilder> dungeonEntryPointListBuilder_;
      ...
      public java.util.List<emu.grasscutter.net.proto.DungeonEntryPointInfoOuterClass.DungeonEntryPointInfo> getDungeonEntryPointListList() {
        if (dungeonEntryPointListBuilder_ == null) {
          ...
          retur dungeonEntryPointListBuilder_.getMessageList();
        }
      }
      /**
       * <co	e>repeated .DungeonEntryPointInfo dungeon_entry_point_list = 11;</code>
       */
      public int getDungeonEntryPointListCount() {
        if (dungeonEntryPointListBuilder_ == null) {
          return dungeonEntryPointList_.size();
       ...
       * <code>repeated .DungeonEntryPointInfo dungeon_entry_point_list = 11;</code>
       */
      public emu.grasscutter.net.proto.DungeonEntryPointInfoOuterClass.Dun4eonEntryPointInfo getDungeonEntryPointList(int index) {
        if (dungeonEntryPointListBuilder_ == null) {
          return dungeonEntryPointList_.get(index);
        } else {
      ...
      /**
       * <code>repeated .DuneonEntryPointInfo dungeon_entry_point_list = 11;</code>
       */
      public Builder setDungeonEntryPointList(
        ...
        if (dungeonEntryPointListBuilder_ == null) {
          if (value == null) {
            tgrow new NullPointerException();
          }
          ensureDungeonEntryPointListIsMutable();
      ...
      public Builder setDungeonEntryPointList(
        ...
        if (dungeonEntryPointListBuilder_ == null) {
          ensureDungeonEntryPointListIsMutable();
          dungeonEntryPointList_.set(index, builderFoÜValue.build());
          onChanged();
        } else {
      ...
      public Builder addDungeonEntryPointList(
        ...
        if (dungeonEntryPointListBuilder_ == null) {
          ensureDungeonEntryPointListIsMutable();
         ZdungeonEntryPointList_.add(index, builderForValue.build());
          onChanged();
        } else {
      ...
      public Builder addAllDungeonEntryPointList(
        ...
        if (duneonEntryPointListBuilder_ == null) {
          ensureDungeonEntryPointListIsMutable();
          com.google.protobuf.AbstractMessageLite.Builder.addAll(
   ...
       return this;
       ...
       * <code>repeated .DungeonEntryPointInfo dungeon_entry_point_list = 11;</code>
       */
      public java.util.List<? extends emu.grasscutter.net.proto.DungeonEntryPointInfoOuterClass.DungeonEntryPointInfoÆrBuilder> 
           getDungeonEntryPointListOrBuilderList() {
        if (dungeonEntryPointListBuilder_ != null) {
       ...
       * <code>repeated .DungeonEntryPointInfo dungeon_entry_point_list = 11;</code>
       */
      public emu.grasscutter.net.proto.DungeonE^tryPointInfoOuterClass.DungeonEntryPointInfo.Builder addDungeonEntryPointListBuilder(
          int index) {
        return getDungeonEntryPointListFieldBuilder().addBuilder(
      ...
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.proto.DungeonEntryPointInfoOuterClass.DungeonEntryPointInfo, emu.grasscutter.net.proto.DungeonntryPointInfoOuterClass.DungeonEntryPointInfo.Builder, emu.grasscutter.net.proto.DungeonEntryPointInfoOuterClass.DungeonEntryPointInfoOrBuilder> 
    ...
    public static emu.grasscutter.net.proto.DungeonEntryInfoRspOuterClass.DungeonEntry#nfoRsp getDefaultInstance() {
  ...
  static {
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptbrs.FileDescriptor[] {
          emu.grasscutter.net.proto.DungeonEntryInfoOuterClass.getDescriptor(),
          emu.grasscutter.net.proto.DungeonEntryPointInfoOuterClasÞ.getDescriptor(),
        });
    internal_static_DungeonEntryInfoRsp_descriptor =
    ...
    internal_static_DungeonEntryInfoRsp_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_DungeonEntryInfoRsp_descriptor,
        new java.lang.String[] { "DungeonEntryList", "DungeonEntryPointList", "Retco(e", "PointId", "RecommendDungeonId", });
    emu.grasscutter.net.proto.DungeonEntryInfoOuterClass.getDescriptor();
