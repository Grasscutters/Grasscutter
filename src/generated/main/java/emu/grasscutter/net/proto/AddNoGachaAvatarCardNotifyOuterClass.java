...
public final class AddNoGachaAvatarCardNotifyOuterClass {
    ...
    public static final class AddNoGachaAvatarCardNotify
        ...
        public int getSerializedSize() {
            ...
            if (initialPromoteLevel_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(2, initialPromoteLevel_);
            }
            if (initialLevel_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(5, initialLevel_);
            }
            if (avatarId_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(7, avatarId_);
            }
            if (reason_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(8, reason_);
            }
            if (isTransferToItem_ != false) {
            ...
            for (int i = 0; i < transferItemList_.size(); i++) {
                size +=
                        com.google.protobuf.CodedOutputStream.computeMessageSize(14, transferItemList_.get(i));
            }
