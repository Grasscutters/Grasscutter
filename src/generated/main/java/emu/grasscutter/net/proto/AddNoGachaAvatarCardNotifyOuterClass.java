...
public final class AddNoGachaAvatarCardNotifyOuterClass {
    ...
    public static final class AddNoGachaAvatarCardNotify
        ...
        public int getSerializedSize() {
            ...
            if (initialPromoteLevel_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(4, initialPromoteLevel_);
            }
            for (int i = 0; i < transferItemList_.size(); i++) {
                size +=
                        com.google.protobuf.CodedOutputStream.computeMessageSize(6, transferItemList_.get(i));
            }
            if (isTransferToItem_ != false) {
                size += com.google.protobuf.CodedOutputStream.computeBoolSize(9, isTransferToItem_);
            }
            if (initialLevel_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(14, initialLevel_);
            }
            if (itemId_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(15, itemId_);
            }
