...
public final class PersonalSceneJumpRspOuterClass {
    ...
    public interface PersonalSceneJumpRspOrBuilder
            extends
     ...
     */
    public static final class PersonalSceneJumpRsp extends com.google.protobuf.GeneratedMessageV3
            implements
        ...
        public static final com.google.protobuf.Descriptors.Descriptor getDescriptor() {
            return emu.grasscutter.net.proto.PersonalSceneJumpRspOuterClass
        ...
        protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
            ...
            return emu.grasscutter.net.proto.PersonalSceneJumpRspOuterClass
                    ...
                    .ensureFieldAccessorsInitialized(
                            emu.grasscutter.net.proto.PersonalSceneJumpRspOuterClass.PersonalSceneJumpRsp.class,
                            emu.grasscutter.net.proto.PersonalSceneJumpRspOuterClass.PersonalSceneJumpRsp.Builder
                                    .class);
        }
        ...
        public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
            if (destPos_ != null) {
                output.writeMessage(4, getDestPos());
            }
            if (retcode_ != 0) {
        ...
        public int getSerializedSize() {
            ...
            size = 0;
            if (destPos_ != null) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(4, getDestPos());
            }
            if (retcode_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeInt32Size(10, retcode_);
            }
            if (destSceneId_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(13, destSceneId_);
            }
        ...
        public boolean equals(final java.lang.Object obj) {
            ...
            emu.grasscutter.net.proto.PersonalSceneJumpRspOuterClass.PersonalSceneJumpRsp other =
                    (emu.grasscutter.net.proto.PersonalSceneJumpRspOuterClass.PersonalSceneJumpRsp) obj;

            if (getDestSceneId() != other.getDestSceneId()) return false;
            if (hasDestPos() != other.hasDestPos()) return false;
            if (hasDestPos()) {
                if (!getDestPos().equals(other.getDestPos())) return false;
            }
        ...
        public static emu.grasscutter.net.proto.PersonalSceneJumpRspOuterClass.PersonalSceneJumpRsp
        ...
        public static Builder newBuilder(
                emu.grasscutter.net.proto.PersonalSceneJumpRspOuterClass.PersonalSceneJumpRsp prototype) {
        ...
        public static final class Builder
            ...
            // Construct using
            // emu.grasscutter.net.proto.PersonalSceneJumpRspOuterClass.PersonalSceneJumpRsp.newBuilder()
            private Builder() {
            ...
            @java.lang.Override
            public emu.grasscutter.net.proto.PersonalSceneJumpRspOuterClass.PersonalSceneJumpRsp
                    getDefaultInstanceForType() {
                return emu.grasscutter.net.proto.PersonalSceneJumpRspOuterClass.PersonalSceneJumpRsp
                        .getDefaultInstance();
            }

            @java.lang.Override
            public emu.grasscutter.net.proto.PersonalSceneJumpRspOuterClass.PersonalSceneJumpRsp build() {
                emu.grasscutter.net.proto.PersonalSceneJumpRspOuterClass.PersonalSceneJumpRsp result =
                        buildPartial();
            ...
            public emu.grasscutter.net.proto.PersonalSceneJumpRspOuterClass.PersonalSceneJumpRsp
                    buildPartial() {
                emu.grasscutter.net.proto.PersonalSceneJumpRspOuterClass.PersonalSceneJumpRsp result =
                        new emu.grasscutter.net.proto.PersonalSceneJumpRspOuterClass.PersonalSceneJumpRsp(this);
            ...
            public Builder mergeDestPos(emu.grasscutter.net.proto.VectorOuterClass.Vector value) {
                if (destPosBuilder_ == null) {
                    if (destPos_ != null) {
                        destPos_ =
                                emu.grasscutter.net.proto.VectorOuterClass.Vector.newBuilder(destPos_)
                                        .mergeFrom(value)
                                        .buildPartial();
                    } else {
                        destPos_ = value;
                ...
                if (destPosBuilder_ == null) {
                    destPosBuilder_ =
                            new com.google.protobuf.SingleFieldBuilderV3<
                                    ...
                                    emu.grasscutter.net.proto.VectorOuterClass.Vector.Builder,
                                    emu.grasscutter.net.proto.VectorOuterClass.VectorOrBuilder>(
                                    getDestPos(), getParentForChildren(), isClean());
                    destPos_ = null;
                }
        ...
        private static final emu.grasscutter.net.proto.PersonalSceneJumpRspOuterClass
                        .PersonalSceneJumpRsp
                DEFAULT_INSTANCE;

        static {
            DEFAULT_INSTANCE =
                    new emu.grasscutter.net.proto.PersonalSceneJumpRspOuterClass.PersonalSceneJumpRsp();
        }
        ...
        private static final com.google.protobuf.Parser<PersonalSceneJumpRsp> PARSER =
                new com.google.protobuf.AbstractParser<PersonalSceneJumpRsp>() {
                    @java.lang.Override
