...
public final class GetInvestigationMonsterRspOuterClass {
    ...
    public static final class GetInvestigationMonsterRsp
        ...
        public int getSerializedSize() {
            ...
            size = 0;
            for (int i = 0; i < monsterList_.size(); i++) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(2, monsterList_.get(i));
            }
            if (isForMark_ != false) {
                size += com.google.protobuf.CodedOutputStream.computeBoolSize(8, isForMark_);
            }
            if (retcode_ != 0) {
