...
public final class GetInvestigationMonsterRspOuterClass {
    ...
    public static final class GetInvestigationMonsterRsp
        ...
        public int getSerializedSize() {
            ...
            size = 0;
            if (isForMark_ != false) {
                size += com.google.protobuf.CodedOutputStream.computeBoolSize(1, isForMark_);
            }
            if (retcode_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeInt32Size(6, retcode_);
            }
            for (int i = 0; i < monsterList_.size(); i++) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(13, monsterList_.get(i));
            }
