...
public final class AJDKBLNNCOIOuterClass {
    ...
    public interface AJDKBLNNCOIOrBuilder
            extends
    ...
    public static final class AJDKBLNNCOI extends com.google.protobuf.GeneratedMessageV3
            implements
        ...
        protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
            ...
            return emu.grasscutter.net.proto.AJDKBLNNCOIOuterClass
                    .internal_static_AJDKBLNNCOI_fieldAccessorTable
                    .ensureFieldAccessorsInitialized(
                            emu.grasscutter.net.proto.AJDKBLNNCOIOuterClass.AJDKBLNNCOI.class,
                            emu.grasscutter.net.proto.AJDKBLNNCOIOuterClass.AJDKBLNNCOI.Builder.class);
        }
        ...
        public int getSerializedSize() {
            ...
            if (cBGCJPMPMKB_ != null) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(5, getCBGCJPMPMKB());
            }
            if (gEOHFGNBHDM_ != null) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(6, getGEOHFGNBHDM());
            }
        ...
        public boolean equals(final java.lang.Object obj) {
            ...
            emu.grasscutter.net.proto.AJDKBLNNCOIOuterClass.AJDKBLNNCOI other =
                    (emu.grasscutter.net.proto.AJDKBLNNCOIOuterClass.AJDKBLNNCOI) obj;

            if (hasGEOHFGNBHDM() != other.hasGEOHFGNBHDM()) return false;
            if (hasGEOHFGNBHDM()) {
                if (!getGEOHFGNBHDM().equals(other.getGEOHFGNBHDM())) return false;
            }
            if (getEntityId() != other.getEntityId()) return false;
            if (hasCBGCJPMPMKB() != other.hasCBGCJPMPMKB()) return false;
            if (hasCBGCJPMPMKB()) {
                if (!getCBGCJPMPMKB().equals(other.getCBGCJPMPMKB())) return false;
            }
        ...
        public static Builder newBuilder(
                emu.grasscutter.net.proto.AJDKBLNNCOIOuterClass.AJDKBLNNCOI prototype) {
        ...
        public static final class Builder
            ...
            @java.lang.Override
            public emu.grasscutter.net.proto.AJDKBLNNCOIOuterClass.AJDKBLNNCOI
            ...
            public emu.grasscutter.net.proto.AJDKBLNNCOIOuterClass.AJDKBLNNCOI buildPartial() {
                emu.grasscutter.net.proto.AJDKBLNNCOIOuterClass.AJDKBLNNCOI result =
                        new emu.grasscutter.net.proto.AJDKBLNNCOIOuterClass.AJDKBLNNCOI(this);
                if (gEOHFGNBHDMBuilder_ == null) {
            ...
            public Builder mergeFrom(emu.grasscutter.net.proto.AJDKBLNNCOIOuterClass.AJDKBLNNCOI other) {
                if (other
                        == emu.grasscutter.net.proto.AJDKBLNNCOIOuterClass.AJDKBLNNCOI.getDefaultInstance())
                    return this;
            ...
            public Builder mergeFrom(
                ...
                try {
                    ...
                    parsedMessage =
                            (emu.grasscutter.net.proto.AJDKBLNNCOIOuterClass.AJDKBLNNCOI)
            ...
            public Builder mergeGEOHFGNBHDM(emu.grasscutter.net.proto.VectorOuterClass.Vector value) {
                if (gEOHFGNBHDMBuilder_ == null) {
                    if (gEOHFGNBHDM_ != null) {
                        gEOHFGNBHDM_ =
                                emu.grasscutter.net.proto.VectorOuterClass.Vector.newBuilder(gEOHFGNBHDM_)
                                        .mergeFrom(value)
                                        .buildPartial();
                    } else {
                        gEOHFGNBHDM_ = value;
                ...
                if (gEOHFGNBHDMBuilder_ == null) {
                    gEOHFGNBHDMBuilder_ =
                            new com.google.protobuf.SingleFieldBuilderV3<
                                    ...
                                    emu.grasscutter.net.proto.VectorOuterClass.Vector.Builder,
                                    emu.grasscutter.net.proto.VectorOuterClass.VectorOrBuilder>(
                                    getGEOHFGNBHDM(), getParentForChildren(), isClean());
                    gEOHFGNBHDM_ = null;
                }
            ...
            public Builder mergeCBGCJPMPMKB(emu.grasscutter.net.proto.VectorOuterClass.Vector value) {
                if (cBGCJPMPMKBBuilder_ == null) {
                    if (cBGCJPMPMKB_ != null) {
                        cBGCJPMPMKB_ =
                                emu.grasscutter.net.proto.VectorOuterClass.Vector.newBuilder(cBGCJPMPMKB_)
                                        .mergeFrom(value)
                                        .buildPartial();
                    } else {
                        cBGCJPMPMKB_ = value;
                ...
                if (cBGCJPMPMKBBuilder_ == null) {
                    cBGCJPMPMKBBuilder_ =
                            new com.google.protobuf.SingleFieldBuilderV3<
                                    ...
                                    emu.grasscutter.net.proto.VectorOuterClass.Vector.Builder,
                                    emu.grasscutter.net.proto.VectorOuterClass.VectorOrBuilder>(
                                    getCBGCJPMPMKB(), getParentForChildren(), isClean());
                    cBGCJPMPMKB_ = null;
                }
        ...
        private static final emu.grasscutter.net.proto.AJDKBLNNCOIOuterClass.AJDKBLNNCOI
                DEFAULT_INSTANCE;
        ...
        private static final com.google.protobuf.Parser<AJDKBLNNCOI> PARSER =
                new com.google.protobuf.AbstractParser<AJDKBLNNCOI>() {
                    @java.lang.Override
    ...
    static {
        ...
        internal_static_AJDKBLNNCOI_descriptor = getDescriptor().getMessageTypes().get(0);
        internal_static_AJDKBLNNCOI_fieldAccessorTable =
                new com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
                        internal_static_AJDKBLNNCOI_descriptor,
                        new java.lang.String[] {
                            "GEOHFGNBHDM", "EntityId", "CBGCJPMPMKB",
                        });
        emu.grasscutter.net.proto.VectorOuterClass.getDescriptor();
    }
