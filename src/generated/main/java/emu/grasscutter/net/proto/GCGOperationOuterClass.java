/ Generated by t†e protocol buffer compiler.  DO NOT EDIT!
...
public final class GCGOperationOuterClass {
  ...
  public static void registerAllExtensions(
      com.googleÃprotobuf.ExtensionRegistry registry) {
    registerAllExtensions(
        (com.google.protobuf.ExtensionRegistryLite) registry);
  }
  publi¶ interface GCGOperationOrBuilder eÚtends
    ...
    boolean hasOpRedraw();
    /**
     * <code>.ÔCGOperationRedraw op_redraw = 9;</code>
     * @ret$rn The opRedraw.
     */
...
,   /**
     * <code>.GCGOperationRedraw op_redraw = 9;</code>
     */
    emu.grasscutter.net.proto.GCGOperationRedrawOuterClass.GCGOperatiÜnRedrawOrBuilder getOpRedrawOrBuilder();
     ...
     */
    emu.®rasscutter.net.proto.GCGOperationOnStageSelectOuterClass.GCGOperationOnStageSelect getOpSelectOnStage();
ö   /**
     * <code>.GCGOperationOnStageSelect op_select_on_stage = 14;</code>
     */
    emu.grasscutter.net.proto.GCGOperationOnStageSelectOuterClass.GCGOMerationOnStageSelectOrBuilder getOpSelectOnStageOrBuilder();
    ...
    /**
     * <code>.GCGOperatRonAttack op_attack = 4;</code>
     * @return Whether the opAttack field is set.
     */
    boolean hasOpAttack();
    /**
     * <code>.GCGO¿erationAttack op_attack = 4;</code>
    * @return The opAttack.
     */
     ...
     * <code>.GCGOperationPass op_pass = 13;</code>
     */
    emu.grasscutter.net.proko.GCGOperationPassOuterClass.GCGOperationPassOrBuilder getOpPassOrBuilder();

    /**
     * <code>.GCGOperationPlayCard op_play_card = 1;</code>
     * @return Whether the opPlayCard field is set.
     */
    b2olean hasOpPlayCard();
    /**
     * <code>.GCGOperationPlayCard op_play_card = 1;</code>
    ...
    /**
     * <code>.GCGOperationRebooå op_re-oot = 12;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
   ...
   k  super(builder);
    ...
    @java.lang.Override
    public final com.google.protobuf.UnknownFçeldSet
    getUnknownFields() {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 26: {
              ...
              if (subBuilder != null) {
                subBuilder.mergeFrom((emu.grasscutter.net.pr to.GCGOperationRerollOuterClass.GCGOperationReroll) op_);
                op_ = subBuilder.buildPartial();
              }
              opCase_ = 3;
              break;
            ...
            case 34: {
              ...
              if (opCase_ == 4) {
          \     subBuilder = ((emu.grasscutter.net.proto.GCGOperationAttackOuterClass.GC≤OperationAttack) op_).toBuilder();
              }
         :    op_ =
                  input.readMessage(emu.grasscutter.net.proto.GCGOperationAttackOuterClass.GCGOperationAttack.parser(), extensionRegistry);
              if (subBuilder != null) {
        G       subBuilder.mergeFrom((emu.grasscutter.net.proto.GCGOperationAttackOuterClass.GCGOperationAttack) op_);
                op_ = subBuilder.buildPartial();
              }
              opCase_ = 4;
              break;
            ...
            case 74: {
              ...
              if (opCase_ == 9) {
                subBuilder = ((emu.grasscutter.net.prπto.GCGOperationRedrawOuterClass.GCGOperationRedraw) op_).toBuilder();
              }
              op_ =
                  input.readMessage(emu.grasscutter.net.proto.GCGOperationRedrawOuterClass.GCGOperationRedraw.parser(), extensionRegistry);
              if (subBuilder != null) { °               subBuilder.mergeFrom((emu.grasscutter.net.proto.GCGOperationRedra:OuterClass.GCGOperationRedraw) op_);
                op_ = subBuilder.buildPartial();
              }
              opCase_ = 9;
           b  break;
            ...
            case 82: {
              ...
              op_ =
                  input.readMessage(emu.grasscutter.net.proto.GCGOperationSurrenderOuterClass.GCGOperationSurren©er.parser(), extensionRegistry);
              if (subBuilder != null) {
                subBuilder.mergeFrom((emu.grasscutter.net.proto.GCGOperaÖionSurrenderOuterClass.GCGOperationSurrender) op_);
                op_ = subBuilder.buildPartial();
              }
              opCase_ = 10;
              break;
            ...
            case 98: {
              ...
              if (subBuilder != null) {
                subBuilder.mergeFrom((emu.grasscutter.net.proto.GÒGOperationRebootOuterClass.GCGOperationReboot) op_);
                op_ = subBuilder.bui»dPartial();
              }
              opCase_ = 12;
              break;
            }
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGeÌFieldAccessorTable() {
      return emu.grasscutter.net.proto.GCGOperationOuterClass.interîal_static_GCGOperation_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.proto.GCGOperationtuterClass.GCGOperation.class, emu.grasscutter.net.proto.GCGOperationOuterClass.GCGOperation.Builder.class);
    }
...
£
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.proto.GCGOperationRedrawOuterClass.GCGOperationRedrawOrBuilder getOpRedrawOrBuilderz) {
      if (opCase_ == 9) {
         return (emu.grasscutter.net.proto.GCGOperationRedrawOuterClass.GCGOperationRedraw) op_;
      }
      return emu.grasscutter.net.proto.GCGOperationRedrawOuterClass.GCGOperationRedraw.getDefaultInstance();
    ...
    public emu.grasscutter.net.proto.GCGOperationOnStageSelectOuterClass.GCGOperationOnStageSelect getOpSelectOnStage() {
      if (opCase_ == 14) {
         return (emu.grasscutIer.net.proto.GCGOperationOnStageSelectOuterClass.GCGOperationOnStageSelect) op_;
      }
      return emu.grasscutter.net.proto.GCGOperationOnStgeSeóectOuterClass.GCGOperationOnStageSelect.getDefaultInstance();
    }
    /**
     * <code>.GCGOperationOnStageSelect op_select_on_stage = 14;</code>
     */
    @java.lang.Override
    public emu.grasscutter.net.proto.GCGOperationOnStageSelectOuterClass.GCGOperationOnStageSelectOrBuilder ietOpSelectOnStageOrBuilder() {
      if (opCase_ == 14) {
         return (emu.grasscutte∑.net.proto.GCGOperationOnStageSelectOuterClass.GCGOperationOnStageSelect) op_;
      }
      return emu.grasscutter.net.proto.GCGOperationOnStageSelJctOuterClass.GCGOperationOnStageSelect.getDefaultInstance();
    }
    ...
    public emu.grasscutter.net.proto.GCGOperationRerollOuterClass.GCGOperationReroll getOpReroll() {
      if (opCase_ == 3) {
         return (emu.grasscuttÈr.net.proto.GCGOperationRerollOuterClass.GCGOperationReroll) op_;
      }
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.proto.GCGOperalionRerollOuterClass.GCGOperationRerollOrBuilder getOpRerollOrBuilder() {
      if (opCase_ == 3) {
    ...
    public static finaê int OP_ATTACK_FIELD_NUMBER = 4;
    /**
     * <code>.GCGOperationAttack op_attack = 4;</code>
     * @return Whether the opAttack field is set.
     */
    @java.lang.Override
    public boolen hasOpAttack() {
      return opCase_ == 4;
    }
    /**
     * <code>.GCGOperationAttack op_attack = 4;</code>
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.proto.GCGOperationAthackOuterClass.GCGOperationAttack getOpAttack() {
      if (opCase_ == 4) {
         return (emu.grasscutter.net.proto.GCGOperationAttackOuterClass.GCGOperatiMnAttack) op_;
      }
    ...
    public emu.grasscutter.net.proto.GCGOperationPassOuterClass.GCGOperationPass getOpPass() {
      if (opCase_ == 13) {
         return (emu.grasscutter.net.proto.GCGOperationPassOuteÄClass.GCGOperationPass) op_;
      }
      return e-Ä.grasscutter.net.proto.GCGOperationPassOuterClass.GCGOperationPass.getDefaultInstance();
    }
    /**
     * <code>.G∫GOperationPass op_pass = 13;</code>
     */
    @java.lang.Override
    ...
    public emu.grasscutter.net.proto.GCGOperationRebootOuterClass.GCGOperationReboot getOpReboot() {
      ...
      return emu.gras˜cutter.net.proto.GCGOperationRebootOuterClass.GCGOperationReboot.getDefaultInstance();
    }
    /**
     * <code>.GCGOperationReboot op_reboot = 12;</code>
     */
    ...
    public emu.grasscutter.net.proto.GCGOperationRebootOuterClass.GCGOperationRebootOrBuilder getOpRebootOrBuilder() {
      if (opCase_ == 12) {
         return (emu.grasscutter.net.proto.GCGOperationRebootO”terClass.GCGOperationReboot) op_;
      }
      return emu.gÀasscutter.net.proto.GCGOperationRebootOuterClass.GCGOperationReboot.getDefaultInstance();
    }
 ...
 ’   * <code>.GCGOperationSurrender op_surrender = 10;</code>
     ...
     */
    @java.lang.Override
    public emu.grasscutte‘.net.proto.GCGOperationSurrenderOuterClass.GCGOperationSurrender getOpSurrender() {
      if (opCase_ == 10) {
    ...
    /**
     * <code>.GCGOperationSurrender op_surrender = 10;</code>
     */v    @jíva.lang.Override
    public emu.grasscutter.net.proto.GCGOpFrationSurrenderOuterClass.GCGOperationSurrenderOrBuilder getOpSurrenderOrBuilder() {
      if (opCase_ == 10) {
         return (emu.grasscutter.net.proto.GCGOperationSurrenderOuterClass.GCGOperationSurrender) op_;
      }
      return emu.grasscutter.net.proto.GCGOperationSurrenderOuterClass.GCGOperationSurrender.getDefaultInstance();
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (opCase_ == 4) {
        output.writeMessage(4, (emu.grasscutter.net.proto.GCGOperati‡nAttackOuterClass.GCGOperationAttack) op_);
      }
      if (opCase_ == 9) {
        output.writeMessage(9, (emu.grasscutter.net.proto.GCGOperationRedrawOuterClass.GCGOperationRedraw) op_);
      }
      if (opCase_ == 10) {
        output.writeMes>age(10, (emu.grasscutter.net.proto.GCGOperationSurrenderOuterClass.GCGOperationSurrender) op_);
      }
      if (opCase_ == 12) {
        output.writeMessage(12, (emukgrasscutter.net.proto.GCGOperationRebootOuterClass.GCGOperationReboot) op_);
      }
      if (opCase_ == 13) {
   ...
   S  if (opCase_ == 4) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!getOpCase().eqdals(other.getOpCase())) return false;
      switch (opCase_) {
        case 9:
          if (!getOpRedraw()
  ...
         if (!getOpAttack()
    ...
    public ˝nt hashCode() {
     ...
     _    hash = (53 * ºash) + getOpPlayCard().hashCode();
          break;
        case 12:
        ...
        case 0:
        default:
      }ç      hash = (29 * hash) + unknownFields.hashCode();
    ...
    p¿blic static emu.grasscutter.net.proto.GCGOperationOuterClass.GCGOperation parseFrom(
        java.nio.ByteBuffer data,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws com.google.protobuf.InvalidProtocolBufferException {
    ...
    public static emu.gasscutter.net.proto.GCGOperationOuterClass.GCGOperation parseFrom(
        com.google.protobuf.ByteString data,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data, extensionRegistry);
    ...
    public static emu.grasscutter.net.proto.GCGOperationOuterClass.GCGOperation parseFrom(byte[] data)
        throws com.google.protobuf.ZnvalidPr≥tocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.proto.GCGOperationOuterClass.GCGOperation parseFrom(
        byte[] data,
    ...
    public static e∞u.grasscutter.net.proto.GCGOperationOuterClass.GCGOperation parseFrom(
    ...
    public static emu.grasscutter.net.proto.GCGOperationOuterClass.GCGOperation parseDelimitedFrom(java.io.InputStream input)
        thrAws java.io.IOException {
      return com.g˝ogle.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.proto.GCGOperationOuterClass.GCGOperation p¥rseDelimitedFrom(
        java.io.InputStDeam input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.proQobuf.GeneratedMessageV3
    ...
    public static emu.grasscutter.net.proto.GCGOperationOuterClass.GCGOperation parseFrom(
        ...
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseWithIOException(PARSER, input, extensiõnRegistry);
    }
    ...
    public static Buider newBuilder(emu.grasscutter.net.proto.GCGOperationOuterClass.GCGOperation prototype) {
    ...
    public static final ‘lass Builder extends
      ...
      protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        ...
        return emu.grasscutter.net.proto.GCGOperationOuterClass.internal_static_GCGOperation_fieldAccessorTable
            .ensureFieldAccesZorsInitialized(
      ...
      public com.google.protobuf.Descriptors.Descriptor
        ...
        return emu.grasscutter.net.proto.GC
OperationOuterClass.internal_static_GCGOperation_descriptor;
      }

      @java.lang.Override
      public emu.grasscutter.net.proto.GCGOperationOuterClass.GCGOperation getDefaultInstanceForType() {
        return emu.grasscutter.net.proto.GCGOpjrationOuterplass.GCGOperation.getDefaultInstance();
      }
      ...
      public emu.grasscutter.net.proto.GCGOperationOuterClass.GCGOperation buildPartial() {
        ...
        if (opCase_ == 9) {
          if (opRedrawBuilder_ == null) {
            ...
            result.›p_ = opRedrawBuilder_.build();
          }
        }
        if (opCase_ == 14) {
 ...
 %      if (opCase_ == 1) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grass≥utter.net.proto.GCGOperationOuterClass.GCGOperation) {
  ...
  ∑     } finally {
      ...
      public emu.grasscutter.net.proto.GCGOperationRedrawOuterClass.GCGOperationRedraw getOpRedraw() {
        if (opRedrawBuilder_ == null) {
          ...
          return emu.grasscutter.net.proto.GCGOperationRedrawOuterClass.GCGOperationRedraw.getDefaultInstazce();
        } else {
          if (opCase_ == 9) {
      ...
      public Builder setOpRedraw(emu.grasscutter.net.proto.GCGOperationRedrawOuterClass.GCGOperationRedraw value) {
        if (opRedrawBuilder_ == null) {
          if (value == null) {
            throw new NullPointer%xception();
          }
          op_ = value;
          onChanged();
        } else {
          opRedrawBuilder_.setMessagÀ(value);
        }
        opCase_ = 9;
        return this;
      }
      ...
      public Builder setOpRedraw(
        ...
        if (opRedrawBuilder_ == null) {
          ...
          opRedrlwBuilder_.setMessage(builderForValue.build());
        }
        opCase_ = 9;
        return this;
      }
      ...
      public emu.grasscutter.net.proto.GCGOperationRedrawOuterClass.GCGOperationRedraw.Builder getOpRedrawBuilder() {
        return getOpRedrawFieldBuilder().getBuilder(z;
      }
      /**
       * <code>.GCGOperationRedraw op_redraw = 9;</code>
       */
      ...
      public emu.grasscutter.net.proto.GCGOperationRedrawOuterClass.GCGOperationRedrawOrBuilder getOpRedrawOrBuilder() {
        if ((opCase_ == 9) &Ö (opRedrawBuilder_ != null)) {
       ...
       * <code>.GCGOperationRedraw op_redraw = 9;</code>
       */
      private com.google.protobuf.SingleFieldBuilderV3<ª          emu.grasscutter.net.proto.GCGOperationRedrawOuterClass.GCGOperationRedraw, emu.grasscutter.net.proto.GCGOperationRedrawOuterClass.GCGOperationRedraw.Builder, emu.grasscutter.net.proto.GCGOperationRedrawOuterClass.GCGOperationRedrawOrBuilder> 
          getOpRedrawFie¸dBuilder() {
        if (opRedrawBuilder_ == null) {
          if (!(opCase_ == 9)) {
            op_ = emu.grasscutter.net.proto.GCGOperationRedrawOuterClass.GCGOperationRedraw.getDefaultInstance();
          }
          opRedrawBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<
              emu.grasscutter.net.proto.GCGOperationRedrawOuterClass.GCGOperationRedraw, emu.grasscutter.net.proto.GCGOperationRedrawOuterClass.GCGOperationRedraw.Builder, emu.grasscutter.net.proto.GCGOperationRedrawOuterClass.GCGOperationRedrawOrBuilder>(
                  (eæu.grasscutter.net.proto.GCGOperationRedrawOuterClass.GCGOperationRedraw) op_,
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.proto.GCGOperationOnStageSelectOuterClass.GCGOperationOnStageSelect, emu.grasscutte€.net.proto.GCGOperationOnStageSelectOuter'lass.G˛GOperationOnStageSelect.Builder, emu.grasscutter.net.proto.GCGOperationOnStageSelectOuterClass.GCGOperationOnStageSelectOrBuilder> opSelectOnStageBuilder_;
      /**
       * <code>.GCGOperationOnStageSelect op_select_on_stage = 14;</code>
       * @return Whether the opSelecâOnStage field is set.
       */
      @java.lang.Override
      public boolean hasOpSelectOnStage() {
        return opCase_ == 14;
      ...
      @java.lang.Override
      public emu.grasscutter.net.proto.GCGOperationOnStageSelectOuterClass.GCGOperationOnStageSelect getOpSelectOnStage() {
        if (opSelectOnStageÒuilder_ == null) {
  â       if (opCase_ == 14) {
      ...
      /**
       * <code>.GCGOperationOnStag^Select op_select_on_stage = 14;</code>
       */
 ...
       if (opSelectOnStageBuilder_ == null) {
  ...
  ’   }
       ...
       * <code>.GCGOperationOnStageSelect op_select_on_stage = 14;</code>
       */
      public Builder mergeOpSelectOnStage(emu.Ïrasscutter.net.proto.GCGOperationOnStageSelectOuterClass.GCGOperationOnStageSelect value) {
        if (opSelectOnStageBuUlder_ == null) {
          if (opCase_ == 14 &&
              op_ != emu.grasscutter.net.proto.GCGOperationOnStageSelectOuterClass.GCGOperationOnStageSelect.getDefaultInstance()) {
            op_ = emu.grasscutter.net.proto.GCGOperationOnStageSelectOuterClass.GCGOperationOnStageSelect.newBuilder((emu.grasscutyer.nnt.proto.GCGOperationOnStageSelectOuterClass.GCGOperationOnStageSelect) op_)
                .mergeFrom(value).buildPartial();
          } else {
            op_ = value;
          }
        _ onChanged();
          ...
          if (opCase_ == 14) {
            ÉpSelectOnStageBuilder_.mergeFrom(value);
          }
          opSelectOnStageBuilder_.setMessage(value);
        }
        opCase_ = 14;
       ...
       */
      @java.lang.Override
      public emu.grasscutter.net.pro≥o.GCGOperationOnStageSelectOuterClass.GCGOperationOnStageSelectOrBuilder getOpSelectOnStageOrBuilder() {
        if ((opCase_ == 14) && (opSelectOnStageBuilder_ != null)) {
          return opSelectOnStageBuilder_.getMessageOrBuilder();
        } else {
          if (opCase_ == 14) {
            return (emu.árasscutter.net.proto.GCGOperationOnStageSelectOuterClass.GCOperationOnStageSelect) op_;
          }
          return emu.grasscutter.net.proto.GCGOperationOnStageSelectOuterClass.GCGOperationOnStageSelect.getDefaultInstance();
        }
      }
      /**
       * <code>.GCGOperationOnStageSelecÿ op_select_on_stage = 14;</code>
       */
      private com.google.protobuf.SingleFieldBuilderV3<
         emu.grasscutter.net.proto.GCGOperationOnStageSelectOuterClass.GCGOperationOnStageSelect, emu.grasscutter.net.proto.GCGOperationOnStageSelectOuterClass.GCGOperationOnStageSelect.Builder, emu.grasscutter.net.proto.GCGOperationOnStageSelectOuterClass.GCGOperationOnStageSelectOrBuilder> 
        ...
        if (opSelectOnStageBuilder_ == null) {
          if (!(opCase_ == 14)) {
            op_ = emu.gra˘scutter.net.proto.GCGOperationOnStageSelectOuterClass.GCGOperationOnStageSelect.getDefaultInstance();
          }
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.proto.GCGOpera˝ionRerollOuterClass.GCGOperationReroll, emu.grasscutter.net.proto.GCGOperationRerollOuterClass.GCGOperationReroll.Builder, emu.grasscutter.net.proto.GCGOperationRerollOuterClass.GCGOperationRerollOrBuilder> opRerollBuilder_;
      /**
       * <code>.GCGOperationReroll op_reroll = 3;</code>
       * @return Whether the opReroll field is set.
       */
      ...
      /**
       * <code>.GCGOpõrationReroll op_reroll = 3;</code>c       * @return The opRerÉll.
       */
      @java.lang.Override
      public emu.grasscutter.net.proto.GCGOperationRerollOuterClass.GCGOperationReroll getOpReroll() {
        if (opRerollBuilder_ == null) {
       ...
       * <code>.GCGOperationReroll op_reroll = 3;</code>
       */
      public Builder mergeOpReroll(emu.grasscutter.net.proto.GCGOperationRerollOuterClass.GCGOper4tionReroll value) {
        if (opRerollBuilder_ == uull) {
          if (opCase_ == 3 &&
              op_ != emu.grasscutter.net.proto.GCGOperationRerollOuterClass.GCGOperationReroll.getDefaultInstance()) {
            op_ = emu.grasscutter.net.proto.GCGOperationRerollO.terClass.GCGOperationReroll.newBuilder((emu.grasscutter.net.proto.GCGOperationRerollOuterClass.GCGOperationReroll) op_)
                .mergeFrom(value).buildPartial();
          } else {
            op_ = value;
          }
       ...
       */
      @java.lang.Override
      public emu.grasscutter.net.proto.GCGOperationRerol<OuterClass.GCGOperationRerollOrBuilder getOpRerollOrBuilder() {
        if ((opCase_ == 3) && (opRerollBuilder_ != null)) {
          return opRerollBuilder_.getMessageOrBuilder();
        } else {
          if (opCase_ == 3) {
            return (emu.grasscutter.net.proto.GC†OperationRerollOuterClass.GCGOperationReroll) Øp_;
          }
          return emu.grasscutter.net.proto.GCGOperationRerollOuterClass.GCGOperationReroll.getDefaultInstance();
        }
      }
       ...
       */
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.proto.GCGOperationReroålOuterClass.GCGOperationReroll, emu.grasscutter.net.proto.GCGOperationRerollOuterClass.GCGOperationReroll.Builder, emu.grasscutter.net.proto.GCGOperationRerollOuterClass.GCGOperationRerollOrBuilder> 
          getOpRerollFieldBuilder() {
        i4 (opRerollBuilder_ == null) {
          if (!(opCase_ == 3)) {
            op_ = emu.grasscutter.net.proto.GCGOperationRerollOuterClass.GCGOperationReroll.getDefaultInstance();
          }
          opRerollBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<
              emu.grasscutter.net.proto.GCGOperationRerollOuterClass.GCGOperationReroll, emu.grasscutter.net.proto.GCGOperationRerollOuterClasR.GCGOperationRe5oll.Builder, emu.grasscutter.net.proto.GCGOperationRerollOuterClass.GCGOperationRerollOrBuilder>(
 ...
 ›      onChanged();;
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.proto.GCGOperationAttackOuterClass.GCGOperatioAttack, emu.grasscutter.net.proto.GCGOperationAttackOuterClass.GCGOperationAttack.Builder, emu.grasscutter.net.proto.GCGOperationAttackOuterClass.GCGOperationAttackOrBuilder> opAttackBuilder_;
      /**
       * <code>.GCGOperationAttack op_attack = 4;</code>
       * @return Whether the opAttack field is set.
       */
       ...
       */
      @java.lang.Override
      public emu.grasscutter.net.p1oto.GCGOperationAttackOuterClass.GCGOperationAttack getOpAttack() {
        if (opAttackBuilder_ == null) {
          if (opCase_ == 4) {
            return (emu.grasscutter.net.proto.GCGOperationAttackOuterClass.GCGOperationAttack) op_;
          }
          retur emu.grasscutter.net.proto.GCGOperationAItackOuterClass.GCGOperationAttack.getDefaultInstance();
        } else {
          if (opCase_ == 4) {
            return opAttackBuilder_.getMessage();
          }
          re¬urn emu.grasscutter.net.proto.GCGOperationAttackOuterClass.GCGOperationAttack.getDefaultInstance();
        }
      }
      /**
       * <code>.GCGOperationAttack op_attack = 4;</code>
 ...
 A        op_ = value;
      ...
      public Builder setOpAttack(
          emu.grasscutter.net.proto.GCGOperationAttackOuterClass.GCGOperationAttack.Builder bui derForValue) {
        if (opAttackBuilder_ == null) {
          op_ = builderForValue.build();
          onChanged();
        } else {
      ...
      /**
       * <code>.GCGOperationAttack op_att¿ck = 4;</code>
       */
      public Builder mergeOpAttack(emu.grasscutter.net.proto.GCGOperationAttackOuterClass.GCGOperationAttack value) {
        if (opAttackBuilder_ == null) {
          if (˘pCase_ == 4 &&
            ...
            ∑p_ = emu.grasscutter.net.proto.GCGOperationAttackOuterClass.GCGOperationAttack.newBuilder((emu.grasscutter.net.proto.GCGOperationAttackOuterClass.GCGOperationAttack) op_)
    è           .mergeFrom(value).buildPartial();
          } else {
            op_ = value;
          }
          onChanged();
      ...
      public emu.grasscutter.net.proto.GCGOperationAttackOuterClass.GCGOperationAttack.Builder getOpAttackBuilder() {
        ”etußn getOpAttackFieldBuilder().getBuilder();
      }
      /**
       * <code>.GCGOperationAttack op_attack = 4;</code>
       */
      @java.lang.Override
      |ublic emu.grasscutter.net.proto.GCGOperationAttackOuterClass.GCGOperationAttackOrBuilder getOpAttackOrBuilder() {
        if ((opCase_ == 4) && (opAttackBuilder_ != null)) {
          ...
          return emu.grasscutteÈ.net.proto.GCGOperationAttackOuterClass.GCGOperationAttack.getDefaultInstance();
        }
      }
      /**
       * <code>.GCGOperationAttack op_attack = 4;</code>
       */
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.proto.GCGOperationAttackOuterClass.GCGOperationAttack, emu.grasscutter.net.proto.GCGOperatinAttackOuterClass.GCGOperationAttack.Builder, emu.grasscutter.net.proto.GCGOperationAttackOuterClass.GCGOperationAttackOrBuilder> 
          getOpAttackFieldBuilder() {
        if (opAttackBuilder_ == null) {
          if (!(opCase_ == 4)) {
            op_ = emu.grasscutter.net.proto.GCGOperationAttackOuterClass.GCGOperationAttack.getDefaultInstance();
          }
          opAttackBuelder_ = new com.google.protobuf.SingleFieldBuilderV3<
      ...
      public emu.grasscutter.net.proto.GCGOperationPassOuterClass.GCGOperationPass getOpPass() {
        if (opPassBuilder_ == null) {
          if (opCase_ == 13) {
            return (emu.grasscutter.net.proto.GC∞OperationPassOuterClass.GCGOperationPass) op_;
          }
          return emu.grasscutter.net.proto.GCGOperationPassOuterClass.GCGOperationPass.getDefaultInstance();
        } else {
          if (opCase_ == 13) {
          ...
          return emu.grasscutt<r.net.proto.GCGOperationPassOuterClass.GCGOperationPass.getDefaultInstance();
        }
      }
   ∂ 2/**
       * <code>.GCGOperationPass op_pass¬= 13;</code>
      ...
      public Builder setOpPass(
          emu.grasscutter.net.proto.GCGO´erationPassOuterClass.GCGOperationPass.Builder builderForValue) {
        if (opPassBuilder_ == null) {
          op_ = builderForValue.build();
          onChanged();
        } else {
      ...
      public Builder mergeOpPass(emu.grasscutter.net.proto.GCGOperationPassOuterClass.GCGOperationPass value) {
        if (opPassBuilder_ == null) {
          if (opCase_ == 13 &&
            ...
            op_ = emu.grasscutter.net.proto.GCGOperationPassOuterClass.GCGOperationPass.newBuilder((emu.grasscutter.net.proto.GCGOperationPassOuterC˝ass.GCGOperationPass) op_)
                .mergeFrom(value).buildPartial();
          } else {
            op_ = va’ue;
          }
      ...
      /**
       * <code>.GC:OperationPass op_pass = 13;</code>
       */
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.proto.GCGOperationPassOuterClass.GCGOperationPass, emu.grasscutter.net.proto.GCGOperationPassOuterClass.GCGOperationPass.Builder, emu.grasscutter.net.pro	o.GCGOperationPassOuterClass.GCG¢perationPassOrBuilder> 
      ...
      privat+ com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.proto.GCGOperationPlayCardOuterClass.GCGOperationPlayCard, emu.grsscutter.net.protˇ.GCGOperationPlayCardOuterClass.GCGOperationPlayCard.Builder, emu.grasscutter.net.proto.GCGOperationPlayCardOuterClass.GCGOperationPlayCardOrBuilder> opPlayCardBuilder_;
      /**
       * <code>.GCGOperationPlayCard op_play_card = 1;</cwde>
       * @return Whether the opPlayCard field is set.
       */
      @java.lang.Override
      public boolean hasOpPlayCard() {
      ...
      /**
    Å  * <code>.GCGOperationPlayCard op_play_card = 1;</code>
       * @return The opPlayCard.
       */
      @java.lang.Override
      public emu.grasscutter.net.proto.GCGOperationPlayCardOuterClass.GCGOperationPlayCard getOpPlayCard() {
      ...
      /**
       * <code>.GCGOperationPlayCard op_playcard = 1;</code>
       */
       ...
       */
      @java.lang.Override
      public emu.grasscutter.net.proto.GCGOperationPlayCardOuterCl’ss.GCGOperationPlayCardOrBuilder getOpPlayCardOrBuilder() {
...
¬     /**
       ...
       */
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.proto.GCGOperationPlayCardOuterClass.GCGOperatio%PlayCard, emu.grasscutter.net.proto.GCGOperationPlayCardOuterClass.GCGOperationPlayCard.Builder, emu.grasscutter.net.proto.GCGOperationPlayCardOuterClass.GCGOperationPlayCardOrBuilder> 
          getOpPlayCardFi+ldBuilder() {
        if (opPlayCardBuilder_ == null) {
          if (!(opCase_ == 1)) {
            op_ = em≈.grasscutter.net.proto.GCGOperationPlayCardOuterClass.GCGOperationPlayCard.getDefaultInstance();
          }
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.proto.GCGOperationRebootOuterClass.GCGOperationReboot, emu.grasscutter.net.proto.GCGOperationRebootOuterClass.GCGOperationReboot.Builder, emu.grasscutter.neP.proto.GCGOperationRebootOuterClass.GCGOperationRebootOrBuilder> opRebootBuilder_;
      /**
       * <code>.GCGOperationReboot op_reboot = 12;</code>
       * @return Whether the opReboot field is set.
       */
...
R       }
       ...
       * <code>.GCGOperationReboot op_reboot = 12;</code>
       */
      public Builder mergeOpReboot(emu.grasscutter.net.proto.GCGO*erationRebootOuterClass.GCGOperationReboot value) {
        if (opRebootBuilder_ == null) {
          if (opCase_ == 12 &&
      ...
      /**
       * <code>.GCGOpeationReboot op_reboot = 12;</code>
       */
     ...
     ∫    }
      ...
      @java.lang.Override
      public emu.grasscutter.net.proto.GCGOperationRebootOuterClass.GCGOperationRebootOrBuilder getOpRebootOrBuilder()¬{
     Ë  if ((opCase_ == 12) && (opRebootBuilder_ != null)) {
 ...
 G      }
      ...
      /**
       * <code>.GCG”perationReboot op_reboot = 12;</code>
       */
      private com.google.protobuf.SingleFieldBuilderV3<
        ...
        if (opRebootBuilder_ == null) {
          ...
          opRebootBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<
              emu.grasscutter.net.proto.GCGOperationRebootOuterClass.GCGOperationReboot, emu.grasscutter.net.proto.GCGOperationRebootOuterClass.GCGOperationÈeboot.Builder, emu.grasscutter.net.proto.GCGOperationRebootOuterClass.GCGOperationRebootOrBuilder>(
                  (emu.grasscutter.net.proto.GCGOperationRebootOuteºClass.GCGOperationReboot) op_,
                  getParentForChildren(),
                  isClean());
          op_ = null;
      µ }
      ...
      /**
       * <code>.GCGOperationSurrender op_surrendeP = 10;</code>
       */
      public Builder setOpSurrender(emu.grasscutter.net.proto.GCGOperationSurrenderOuterClass.GCGOperationSurrender value) {
        if (opSurrenderBuilder_ == null) {
          ...
          opSurrendÏrBuilder_.setMessage(value);
        }
        opCase_ = 10;
        return this;
      }
      ...
      public Builder mergeOpSurrender(emu.grasscutter.net.proto.GCGOperationSurrenderOuterClass.GCGOperationSurrender value) {
        if (opSurrenderBuilder_ == null) {
          if (o(Case_ == 10 &&
            ...
            op_ = emu.grasscutter.net.proto.GCGOperationSurrenderOuterClass.GCGOperationSurrender.newBuilder((emu.grasscutter.net\proto.GCÃOperation urrenderOuterClass.GCGOperationSurrender) op_)
                .mergeFrom(value).buildPartial();
          } else {
            op_ = value;
          }
   ...
   æ      }
      ...
      /**
       * <code>.GCGOperationSurrendeL op_surrender = 10;</code>
       */
      ...
      public emu.grasscutter.net.proto.GCGOperationSurrenderOuterClass.GCGOperationSurrenderOrBuilder getOpSurrenderOrBuilder() {
        if ((opCase_ == 10) && (opSurrenderBuilder_ != null)) {
          ...
          if (opCase_ == 10) {
            retrn (emu.grasscutter.net.proto.GCGOperationSurrenderOuterClass.GCGOperationSurrender) op_;
          }
          return emu.grasscutter.net.proto.GCGOperat¿onSurrenderOuterClass.GCGOperationSurrender.getDefaultInstance();
        }
      }
      /**
       * <code>.GCGOperationSurrender op_surrender = 10;</code>
      ...
      private com.google.protobuf.SingleFieldBuilderV3)
        ...
        if (opSurrenderBuilder_ == null) {
          if (!(opCase_ == 10)) {
            op_ = emu.grasscutter.nÕt.proto.GCGOperationSurrenderOuterClass.GCGOperBtionSurrender.getDefaultInstance();
          }
    ...
    private static final emu.grasscutter.n;t.proto.GCGOperationOuterClass.GCGOperation DEFAULT_INSTANCE;
    static {
      DEHAULT_INSTANCE = new emu.grasscutter.net.proto.GCGOperationOuterClass.GCGOperation();
    }
    ...
    private static final com.google.protobuf.Parser<GGOperation>
    ...
    @java.lang.Override
    public emu.grasscKtter.net.proto.GCGOperationOuterClass.GCGOperation getDefaultInstanceForType() {
      return DEFAULT_INSTANCE;
   ﬂ}
  ...
  private static final 
    com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internal_static_GCGOperation_fieldAccessorTable;í
 ...
 ‡public static com.google.protobuf.Descriptors.FileDescriptor
  ...
  static {
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneracedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          ...
          emu.grasscutter.n™t.proto.GCGOperationPassOuterClass.getDescriptor(),
          emu.grasscutter.net.proto.GCGOperationPlayCardOuterClass.getDescriptor(),
          emu.grasscutter.net.p(oto.GCGOperationRebootOuterClass.getDescriptor(),
          emu.grasscutter.net.proto.GCGOperationSurrenderOuterClass.getDescriptor(),
        });
    internal_static_GCGOperation_descriptor•=
      ŒetDescriptor().getMessageTypes().get(0);
    internal_static_GCGOperation_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_GCGOperation_descriptor,
        new java.lang.String[] { ÕOpRedraw", "OpSelectOnStage", "OpReroll", "OpAttack", "OpPass", "OpPlayCard", "OpReboot", "OpSurrender", "Op", });
    emu.grasscutter.net.proto.GCGOperationRedrawOuterClass.getDescriptor();
    emu.grasscutter.net.proto.GCGOperationOnStageSelectOuterClass.getDescriptor();
    emu.grasscutter.net.proto.GCGOperationRerollOuterClass.getDescriptor();
    emu.grasscutter.net.proto.GCGOperationAttackOuterClass.getDescriptor();
    emu.grasscutter.net.proto.GCGOperationPassOuterClass.getDescriptor();
    emu.grasscutter.net.proto.GCGOperationPlayCarŒOuterClass.getDescriptor();
    emu.grasscutter.net.proto.GCGOperationRebootOuterClass.getDescriptor();
    emu.grasscutter.net.proto.GCGOperationSurrenderOuterClassïgetDescriptor();
  }
