...
public final class GetAllH5ActivityInfoRspOuterClass {
    ...
    public interface GetAllH5ActivityInfoRspOrBuilder
            extends
        ...
        /** <code>repeated .H5ActivityInfo h5_activity_info_list = 1;</code> */
        java.util.List<emu.grasscutter.net.proto.H5ActivityInfoOuterClass.H5ActivityInfo>
                getH5ActivityInfoListList();
        /** <code>repeated .H5ActivityInfo h5_activity_info_list = 1;</code> */
        emu.grasscutter.net.proto.H5ActivityInfoOuterClass.H5ActivityInfo getH5ActivityInfoList(
                int index);
        /** <code>repeated .H5ActivityInfo h5_activity_info_list = 1;</code> */
        int getH5ActivityInfoListCount();
        /** <code>repeated .H5ActivityInfo h5_activity_info_list = 1;</code> */
        java.util.List<
                        ? extends emu.grasscutter.net.proto.H5ActivityInfoOuterClass.H5ActivityInfoOrBuilder>
                getH5ActivityInfoListOrBuilderList();
        /** <code>repeated .H5ActivityInfo h5_activity_info_list = 1;</code> */
        emu.grasscutter.net.proto.H5ActivityInfoOuterClass.H5ActivityInfoOrBuilder
                getH5ActivityInfoListOrBuilder(int index);

        /**
         * <code>uint32 client_red_dot_timestamp = 8;</code>
         *
     ...
     */
    public static final class GetAllH5ActivityInfoRsp extends com.google.protobuf.GeneratedMessageV3
            implements
        ...
        public static final com.google.protobuf.Descriptors.Descriptor getDescriptor() {
            return emu.grasscutter.net.proto.GetAllH5ActivityInfoRspOuterClass
        ...
        public static final int H5_ACTIVITY_INFO_LIST_FIELD_NUMBER = 1;
        private java.util.List<emu.grasscutter.net.proto.H5ActivityInfoOuterClass.H5ActivityInfo>
                h5ActivityInfoList_;
        /** <code>repeated .H5ActivityInfo h5_activity_info_list = 1;</code> */
        @java.lang.Override
        public java.util.List<emu.grasscutter.net.proto.H5ActivityInfoOuterClass.H5ActivityInfo>
                getH5ActivityInfoListList() {
        ...
        /** <code>repeated .H5ActivityInfo h5_activity_info_list = 1;</code> */
        @java.lang.Override
        public emu.grasscutter.net.proto.H5ActivityInfoOuterClass.H5ActivityInfo getH5ActivityInfoList(
                int index) {
            return h5ActivityInfoList_.get(index);
        }
        /** <code>repeated .H5ActivityInfo h5_activity_info_list = 1;</code> */
        @java.lang.Override
        public emu.grasscutter.net.proto.H5ActivityInfoOuterClass.H5ActivityInfoOrBuilder
                getH5ActivityInfoListOrBuilder(int index) {
            return h5ActivityInfoList_.get(index);
        }

        public static final int CLIENT_RED_DOT_TIMESTAMP_FIELD_NUMBER = 8;
        ...
        public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
            for (int i = 0; i < h5ActivityInfoList_.size(); i++) {
                output.writeMessage(1, h5ActivityInfoList_.get(i));
            }
            if (retcode_ != 0) {
                output.writeInt32(6, retcode_);
            }
            if (clientRedDotTimestamp_ != 0) {
                output.writeUInt32(8, clientRedDotTimestamp_);
            }
        ...
        public int getSerializedSize() {
            ...
            for (int i = 0; i < h5ActivityInfoList_.size(); i++) {
                size +=
                        com.google.protobuf.CodedOutputStream.computeMessageSize(1, h5ActivityInfoList_.get(i));
            }
            if (retcode_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeInt32Size(6, retcode_);
            }
            if (clientRedDotTimestamp_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(8, clientRedDotTimestamp_);
            }
        ...
        public boolean equals(final java.lang.Object obj) {
            ...
            emu.grasscutter.net.proto.GetAllH5ActivityInfoRspOuterClass.GetAllH5ActivityInfoRsp other =
                    (emu.grasscutter.net.proto.GetAllH5ActivityInfoRspOuterClass.GetAllH5ActivityInfoRsp) obj;

            if (getRetcode() != other.getRetcode()) return false;
            if (!getH5ActivityInfoListList().equals(other.getH5ActivityInfoListList())) return false;
            if (getClientRedDotTimestamp() != other.getClientRedDotTimestamp()) return false;
        ...
        public static emu.grasscutter.net.proto.GetAllH5ActivityInfoRspOuterClass
        ...
        public static final class Builder
                ...
                emu.grasscutter.net.proto.GetAllH5ActivityInfoRspOuterClass
                        .GetAllH5ActivityInfoRspOrBuilder {
            public static final com.google.protobuf.Descriptors.Descriptor getDescriptor() {
                return emu.grasscutter.net.proto.GetAllH5ActivityInfoRspOuterClass
                        .internal_static_GetAllH5ActivityInfoRsp_descriptor;
            ...
            // Construct using
            // emu.grasscutter.net.proto.GetAllH5ActivityInfoRspOuterClass.GetAllH5ActivityInfoRsp.newBuilder()
            private Builder() {
            ...
            @java.lang.Override
            public emu.grasscutter.net.proto.GetAllH5ActivityInfoRspOuterClass.GetAllH5ActivityInfoRsp
                    getDefaultInstanceForType() {
                return emu.grasscutter.net.proto.GetAllH5ActivityInfoRspOuterClass.GetAllH5ActivityInfoRsp
                        .getDefaultInstance();
            }
            ...
            public emu.grasscutter.net.proto.GetAllH5ActivityInfoRspOuterClass.GetAllH5ActivityInfoRsp
                    build() {
                emu.grasscutter.net.proto.GetAllH5ActivityInfoRspOuterClass.GetAllH5ActivityInfoRsp result =
                        buildPartial();
            ...
            public emu.grasscutter.net.proto.GetAllH5ActivityInfoRspOuterClass.GetAllH5ActivityInfoRsp
                    buildPartial() {
                emu.grasscutter.net.proto.GetAllH5ActivityInfoRspOuterClass.GetAllH5ActivityInfoRsp result =
                        new emu.grasscutter.net.proto.GetAllH5ActivityInfoRspOuterClass.GetAllH5ActivityInfoRsp(
                                this);
            ...
            private com.google.protobuf.RepeatedFieldBuilderV3<
                            emu.grasscutter.net.proto.H5ActivityInfoOuterClass.H5ActivityInfo,
                            emu.grasscutter.net.proto.H5ActivityInfoOuterClass.H5ActivityInfo.Builder,
                            emu.grasscutter.net.proto.H5ActivityInfoOuterClass.H5ActivityInfoOrBuilder>
                    h5ActivityInfoListBuilder_;
            ...
            public emu.grasscutter.net.proto.H5ActivityInfoOuterClass.H5ActivityInfo
                    getH5ActivityInfoList(int index) {
                if (h5ActivityInfoListBuilder_ == null) {
                    return h5ActivityInfoList_.get(index);
                } else {
            ...
            public Builder addH5ActivityInfoList(
                    emu.grasscutter.net.proto.H5ActivityInfoOuterClass.H5ActivityInfo value) {
                if (h5ActivityInfoListBuilder_ == null) {
                    if (value == null) {
                        throw new NullPointerException();
                    }
            ...
            public Builder addAllH5ActivityInfoList(
                    java.lang.Iterable<
                                    ? extends emu.grasscutter.net.proto.H5ActivityInfoOuterClass.H5ActivityInfo>
                            values) {
                if (h5ActivityInfoListBuilder_ == null) {
                    ensureH5ActivityInfoListIsMutable();
                    com.google.protobuf.AbstractMessageLite.Builder.addAll(values, h5ActivityInfoList_);
                    onChanged();
                } else {
            ...
            /** <code>repeated .H5ActivityInfo h5_activity_info_list = 1;</code> */
            public emu.grasscutter.net.proto.H5ActivityInfoOuterClass.H5ActivityInfo.Builder
                    getH5ActivityInfoListBuilder(int index) {
            ...
            /** <code>repeated .H5ActivityInfo h5_activity_info_list = 1;</code> */
            public emu.grasscutter.net.proto.H5ActivityInfoOuterClass.H5ActivityInfo.Builder
                    addH5ActivityInfoListBuilder() {
                return getH5ActivityInfoListFieldBuilder()
                        .addBuilder(
                                emu.grasscutter.net.proto.H5ActivityInfoOuterClass.H5ActivityInfo
                                        .getDefaultInstance());
            }
            /** <code>repeated .H5ActivityInfo h5_activity_info_list = 1;</code> */
            public emu.grasscutter.net.proto.H5ActivityInfoOuterClass.H5ActivityInfo.Builder
                    addH5ActivityInfoListBuilder(int index) {
                return getH5ActivityInfoListFieldBuilder()
                        .addBuilder(
                                index,
                                emu.grasscutter.net.proto.H5ActivityInfoOuterClass.H5ActivityInfo
        ...
        private static final emu.grasscutter.net.proto.GetAllH5ActivityInfoRspOuterClass
                        .GetAllH5ActivityInfoRsp
                DEFAULT_INSTANCE;
        ...
        private static final com.google.protobuf.Parser<GetAllH5ActivityInfoRsp> PARSER =
                new com.google.protobuf.AbstractParser<GetAllH5ActivityInfoRsp>() {
                    @java.lang.Override
    ...
    static {
        java.lang.String[] descriptorData = {
            "\n\035GetAllH5ActivityInfoRsp.proto\032\024H5Activ"
                    ...
                    + "st\030\001 \003(\0132\017.H5ActivityInfo\022 \n\030client_red_"
                    + "dot_timestamp\030\010 \001(\rB\033\n\031emu.grasscutter.n"
                    + "et.protob\006proto3"
        };
        descriptor =
        ...
        internal_static_GetAllH5ActivityInfoRsp_descriptor = getDescriptor().getMessageTypes().get(0);
        internal_static_GetAllH5ActivityInfoRsp_fieldAccessorTable =
                new com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
                        internal_static_GetAllH5ActivityInfoRsp_descriptor,
                        new java.lang.String[] {
                            "Retcode", "H5ActivityInfoList", "ClientRedDotTimestamp",
                        });
        emu.grasscutter.net.proto.H5ActivityInfoOuterClass.getDescriptor();
    }
