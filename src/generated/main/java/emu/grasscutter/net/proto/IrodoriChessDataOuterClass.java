...
public final class IrodoriChessDataOuterClass {
    ...
    public interface IrodoriChessDataOrBuilder
            extends
            // @@protoc_insertion_point(interface_extends:IrodoriChessData)
            com.google.protobuf.MessageOrBuilder {

        /** <code>repeated .IrodoriChessLevelData level_data_list = 8;</code> */
        ...
        java.util.List<
                        ? extends
                                emu.grasscutter.net.proto.IrodoriChessLevelDataOuterClass
     ...
     */
    public static final class IrodoriChessData extends com.google.protobuf.GeneratedMessageV3
            implements
        ...
        public static final com.google.protobuf.Descriptors.Descriptor getDescriptor() {
            return emu.grasscutter.net.proto.IrodoriChessDataOuterClass
        ...
        protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
            ...
            return emu.grasscutter.net.proto.IrodoriChessDataOuterClass
                    ...
                    .ensureFieldAccessorsInitialized(
                            emu.grasscutter.net.proto.IrodoriChessDataOuterClass.IrodoriChessData.class,
                            emu.grasscutter.net.proto.IrodoriChessDataOuterClass.IrodoriChessData.Builder.class);
        }
        ...
        /** <code>repeated .IrodoriChessLevelData level_data_list = 8;</code> */
        @java.lang.Override
        public emu.grasscutter.net.proto.IrodoriChessLevelDataOuterClass.IrodoriChessLevelDataOrBuilder
                getLevelDataListOrBuilder(int index) {
            return levelDataList_.get(index);
        }
        ...
        public int getSerializedSize() {
            ...
            for (int i = 0; i < levelDataList_.size(); i++) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(8, levelDataList_.get(i));
            }
        ...
        public boolean equals(final java.lang.Object obj) {
            ...
            emu.grasscutter.net.proto.IrodoriChessDataOuterClass.IrodoriChessData other =
                    (emu.grasscutter.net.proto.IrodoriChessDataOuterClass.IrodoriChessData) obj;
        ...
        public static emu.grasscutter.net.proto.IrodoriChessDataOuterClass.IrodoriChessData
        ...
        public static Builder newBuilder(
                emu.grasscutter.net.proto.IrodoriChessDataOuterClass.IrodoriChessData prototype) {
        ...
        public static final class Builder
            ...
            @java.lang.Override
            public emu.grasscutter.net.proto.IrodoriChessDataOuterClass.IrodoriChessData
                    getDefaultInstanceForType() {
                return emu.grasscutter.net.proto.IrodoriChessDataOuterClass.IrodoriChessData
                        .getDefaultInstance();
            }

            @java.lang.Override
            public emu.grasscutter.net.proto.IrodoriChessDataOuterClass.IrodoriChessData build() {
                emu.grasscutter.net.proto.IrodoriChessDataOuterClass.IrodoriChessData result =
                        buildPartial();
            ...
            public emu.grasscutter.net.proto.IrodoriChessDataOuterClass.IrodoriChessData buildPartial() {
                emu.grasscutter.net.proto.IrodoriChessDataOuterClass.IrodoriChessData result =
                        new emu.grasscutter.net.proto.IrodoriChessDataOuterClass.IrodoriChessData(this);
            ...
            public Builder mergeFrom(com.google.protobuf.Message other) {
                if (other
                        instanceof emu.grasscutter.net.proto.IrodoriChessDataOuterClass.IrodoriChessData) {
                    return mergeFrom(
                            (emu.grasscutter.net.proto.IrodoriChessDataOuterClass.IrodoriChessData) other);
                } else {
            ...
            public Builder setLevelDataList(
                    int index,
                    emu.grasscutter.net.proto.IrodoriChessLevelDataOuterClass.IrodoriChessLevelData value) {
                if (levelDataListBuilder_ == null) {
                    if (value == null) {
            ...
            public Builder setLevelDataList(
                    int index,
                    emu.grasscutter.net.proto.IrodoriChessLevelDataOuterClass.IrodoriChessLevelData.Builder
                            builderForValue) {
                if (levelDataListBuilder_ == null) {
                    ensureLevelDataListIsMutable();
            ...
            /** <code>repeated .IrodoriChessLevelData level_data_list = 8;</code> */
            public emu.grasscutter.net.proto.IrodoriChessLevelDataOuterClass.IrodoriChessLevelData.Builder
                    getLevelDataListBuilder(int index) {
                return getLevelDataListFieldBuilder().getBuilder(index);
            }
            /** <code>repeated .IrodoriChessLevelData level_data_list = 8;</code> */
            public emu.grasscutter.net.proto.IrodoriChessLevelDataOuterClass
                            .IrodoriChessLevelDataOrBuilder
                    getLevelDataListOrBuilder(int index) {
                if (levelDataListBuilder_ == null) {
                    return levelDataList_.get(index);
        ...
        private static final emu.grasscutter.net.proto.IrodoriChessDataOuterClass.IrodoriChessData
                DEFAULT_INSTANCE;

        static {
            DEFAULT_INSTANCE =
                    new emu.grasscutter.net.proto.IrodoriChessDataOuterClass.IrodoriChessData();
        }
        ...
        private static final com.google.protobuf.Parser<IrodoriChessData> PARSER =
                new com.google.protobuf.AbstractParser<IrodoriChessData>() {
                    @java.lang.Override
    ...
    static {
        java.lang.String[] descriptorData = {
            "\n\026IrodoriChessData.proto\032\033IrodoriChessLe"
                    ...
                    + "el_data_list\030\010 \003(\0132\026.IrodoriChessLevelDa"
        ...
        internal_static_IrodoriChessData_descriptor = getDescriptor().getMessageTypes().get(0);
        internal_static_IrodoriChessData_fieldAccessorTable =
                new com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
                        internal_static_IrodoriChessData_descriptor,
                        new java.lang.String[] {
                            "LevelDataList", "IsOpen",
                        });
        emu.grasscutter.net.proto.IrodoriChessLevelDataOuterClass.getDescriptor();
    }
