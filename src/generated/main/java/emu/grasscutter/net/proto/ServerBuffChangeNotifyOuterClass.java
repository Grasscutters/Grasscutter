...
public final class ServerBuffChangeNotifyOuterClass {
    ...
    public static final class ServerBuffChangeNotify extends com.google.protobuf.GeneratedMessageV3
        ...
        public int getSerializedSize() {
            ...
            for (int i = 0; i < serverBuffList_.size(); i++) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(9, serverBuffList_.get(i));
            }
            {
                int dataSize = 0;
                for (int i = 0; i < entityIdList_.size(); i++) {
            ...
            if (serverBuffChangeType_
                    != emu.grasscutter.net.proto.ServerBuffChangeNotifyOuterClass.ServerBuffChangeNotify
                            .ServerBuffChangeType.SERVER_BUFF_CHANGE_TYPE_ADD_SERVER_BUFF
                            .getNumber()) {
                size += com.google.protobuf.CodedOutputStream.computeEnumSize(15, serverBuffChangeType_);
            }
