...
public final class CalcWeaponUpgradeReturnItemsReqOuterClass {
    ...
    public static final class CalcWeaponUpgradeReturnItemsReq
        ...
        public int getSerializedSize() {
            ...
            size = 0;
            if (targetWeaponGuid_ != 0L) {
                size += com.google.protobuf.CodedOutputStream.computeUInt64Size(8, targetWeaponGuid_);
            }
            for (int i = 0; i < itemParamList_.size(); i++) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(11, itemParamList_.get(i));
            }
            {
                int dataSize = 0;
                for (int i = 0; i < foodWeaponGuidList_.size(); i++) {
