...
public final class EvtRushMoveInfoOuterClass {
    ...
    public interface EvtRushMoveInfoOrBuilder
            extends
     ...
     */
    public static final class EvtRushMoveInfo extends com.google.protobuf.GeneratedMessageV3
            implements
        ...
        public static final com.google.protobuf.Descriptors.Descriptor getDescriptor() {
            return emu.grasscutter.net.proto.EvtRushMoveInfoOuterClass
        ...
        protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
            ...
            return emu.grasscutter.net.proto.EvtRushMoveInfoOuterClass
                    ...
                    .ensureFieldAccessorsInitialized(
                            emu.grasscutter.net.proto.EvtRushMoveInfoOuterClass.EvtRushMoveInfo.class,
                            emu.grasscutter.net.proto.EvtRushMoveInfoOuterClass.EvtRushMoveInfo.Builder.class);
        }
        ...
        public int getSerializedSize() {
            ...
            if (stateNameHash_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeInt32Size(2, stateNameHash_);
            }
            if (pONJIJJIKCL_ != null) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(3, getPONJIJJIKCL());
            }
            if (entityId_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(5, entityId_);
            }
            if (velocity_ != null) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(7, getVelocity());
            }
            if (faceAngleCompact_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeInt32Size(9, faceAngleCompact_);
            }
            if (timeRange_ != 0F) {
                size += com.google.protobuf.CodedOutputStream.computeFloatSize(11, timeRange_);
            }
            if (eHOAONODFHE_ != null) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(12, getEHOAONODFHE());
            }
        ...
        public boolean equals(final java.lang.Object obj) {
            ...
            emu.grasscutter.net.proto.EvtRushMoveInfoOuterClass.EvtRushMoveInfo other =
                    (emu.grasscutter.net.proto.EvtRushMoveInfoOuterClass.EvtRushMoveInfo) obj;
            ...
            if (hasEHOAONODFHE()) {
                if (!getEHOAONODFHE().equals(other.getEHOAONODFHE())) return false;
            }
            if (java.lang.Float.floatToIntBits(getTimeRange())
                    != java.lang.Float.floatToIntBits(other.getTimeRange())) return false;
            if (getStateNameHash() != other.getStateNameHash()) return false;
            if (hasPONJIJJIKCL() != other.hasPONJIJJIKCL()) return false;
            if (hasPONJIJJIKCL()) {
                if (!getPONJIJJIKCL().equals(other.getPONJIJJIKCL())) return false;
            }
        ...
        public int hashCode() {
            ...
            hash = (53 * hash) + java.lang.Float.floatToIntBits(getTimeRange());
        ...
        public static emu.grasscutter.net.proto.EvtRushMoveInfoOuterClass.EvtRushMoveInfo
        ...
        public static Builder newBuilder(
                emu.grasscutter.net.proto.EvtRushMoveInfoOuterClass.EvtRushMoveInfo prototype) {
        ...
        public static final class Builder
            ...
            // Construct using
            // emu.grasscutter.net.proto.EvtRushMoveInfoOuterClass.EvtRushMoveInfo.newBuilder()
            private Builder() {
            ...
            @java.lang.Override
            public emu.grasscutter.net.proto.EvtRushMoveInfoOuterClass.EvtRushMoveInfo
                    getDefaultInstanceForType() {
                return emu.grasscutter.net.proto.EvtRushMoveInfoOuterClass.EvtRushMoveInfo
                        .getDefaultInstance();
            }
            ...
            public emu.grasscutter.net.proto.EvtRushMoveInfoOuterClass.EvtRushMoveInfo buildPartial() {
                emu.grasscutter.net.proto.EvtRushMoveInfoOuterClass.EvtRushMoveInfo result =
                        new emu.grasscutter.net.proto.EvtRushMoveInfoOuterClass.EvtRushMoveInfo(this);
                if (velocityBuilder_ == null) {
            ...
            public Builder mergeFrom(
                    emu.grasscutter.net.proto.EvtRushMoveInfoOuterClass.EvtRushMoveInfo other) {
                if (other
                        == emu.grasscutter.net.proto.EvtRushMoveInfoOuterClass.EvtRushMoveInfo
            ...
            public Builder mergeEHOAONODFHE(emu.grasscutter.net.proto.VectorOuterClass.Vector value) {
                if (eHOAONODFHEBuilder_ == null) {
                    if (eHOAONODFHE_ != null) {
                        eHOAONODFHE_ =
                                emu.grasscutter.net.proto.VectorOuterClass.Vector.newBuilder(eHOAONODFHE_)
                                        .mergeFrom(value)
                                        .buildPartial();
                    } else {
                        eHOAONODFHE_ = value;
                ...
                if (eHOAONODFHEBuilder_ == null) {
                    eHOAONODFHEBuilder_ =
                            new com.google.protobuf.SingleFieldBuilderV3<
                                    ...
                                    emu.grasscutter.net.proto.VectorOuterClass.Vector.Builder,
                                    emu.grasscutter.net.proto.VectorOuterClass.VectorOrBuilder>(
                                    getEHOAONODFHE(), getParentForChildren(), isClean());
                    eHOAONODFHE_ = null;
                }
            ...
            public Builder mergePONJIJJIKCL(emu.grasscutter.net.proto.VectorOuterClass.Vector value) {
                if (pONJIJJIKCLBuilder_ == null) {
                    if (pONJIJJIKCL_ != null) {
                        pONJIJJIKCL_ =
                                emu.grasscutter.net.proto.VectorOuterClass.Vector.newBuilder(pONJIJJIKCL_)
                                        .mergeFrom(value)
                                        .buildPartial();
                    } else {
                        pONJIJJIKCL_ = value;
                ...
                if (pONJIJJIKCLBuilder_ == null) {
                    pONJIJJIKCLBuilder_ =
                            new com.google.protobuf.SingleFieldBuilderV3<
                                    ...
                                    emu.grasscutter.net.proto.VectorOuterClass.Vector.Builder,
                                    emu.grasscutter.net.proto.VectorOuterClass.VectorOrBuilder>(
                                    getPONJIJJIKCL(), getParentForChildren(), isClean());
                    pONJIJJIKCL_ = null;
                }
        ...
        private static final emu.grasscutter.net.proto.EvtRushMoveInfoOuterClass.EvtRushMoveInfo
                DEFAULT_INSTANCE;
        ...
        private static final com.google.protobuf.Parser<EvtRushMoveInfo> PARSER =
                new com.google.protobuf.AbstractParser<EvtRushMoveInfo>() {
                    @java.lang.Override
    ...
    static {
        ...
        internal_static_EvtRushMoveInfo_descriptor = getDescriptor().getMessageTypes().get(0);
        internal_static_EvtRushMoveInfo_fieldAccessorTable =
