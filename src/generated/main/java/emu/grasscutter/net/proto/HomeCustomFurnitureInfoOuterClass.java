...
public final class HomeCustomFurnitureInfoOuterClass {
    ...
    public interface HomeCustomFurnitureInfoOrBuilder
            extends
        ...
        /** <code>repeated .CustomCommonNodeInfo sub_furniture_list = 1;</code> */
        ...
        emu.grasscutter.net.proto.CustomCommonNodeInfoOuterClass.CustomCommonNodeInfo
                getSubFurnitureList(int index);
        /** <code>repeated .CustomCommonNodeInfo sub_furniture_list = 1;</code> */
        int getSubFurnitureListCount();
        /** <code>repeated .CustomCommonNodeInfo sub_furniture_list = 1;</code> */
        java.util.List<
                        ? extends
                                emu.grasscutter.net.proto.CustomCommonNodeInfoOuterClass
        ...
        emu.grasscutter.net.proto.CustomCommonNodeInfoOuterClass.CustomCommonNodeInfoOrBuilder
                getSubFurnitureListOrBuilder(int index);
    }
    /**
     *
     *
     ...
     */
    public static final class HomeCustomFurnitureInfo extends com.google.protobuf.GeneratedMessageV3
            implements
        ...
        public static final com.google.protobuf.Descriptors.Descriptor getDescriptor() {
            return emu.grasscutter.net.proto.HomeCustomFurnitureInfoOuterClass
        ...
        public static final int SUB_FURNITURE_LIST_FIELD_NUMBER = 1;
        ...
        /** <code>repeated .CustomCommonNodeInfo sub_furniture_list = 1;</code> */
        @java.lang.Override
        public emu.grasscutter.net.proto.CustomCommonNodeInfoOuterClass.CustomCommonNodeInfoOrBuilder
                getSubFurnitureListOrBuilder(int index) {
            return subFurnitureList_.get(index);
        }
        ...
        public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
            for (int i = 0; i < subFurnitureList_.size(); i++) {
                output.writeMessage(1, subFurnitureList_.get(i));
            }
            if (guid_ != 0) {
        ...
        public int getSerializedSize() {
            ...
            for (int i = 0; i < subFurnitureList_.size(); i++) {
                size +=
                        com.google.protobuf.CodedOutputStream.computeMessageSize(1, subFurnitureList_.get(i));
            }
            if (guid_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(7, guid_);
            }
        ...
        public boolean equals(final java.lang.Object obj) {
            ...
            emu.grasscutter.net.proto.HomeCustomFurnitureInfoOuterClass.HomeCustomFurnitureInfo other =
                    (emu.grasscutter.net.proto.HomeCustomFurnitureInfoOuterClass.HomeCustomFurnitureInfo) obj;

            if (getGuid() != other.getGuid()) return false;
            if (!getSubFurnitureListList().equals(other.getSubFurnitureListList())) return false;
        ...
        public static emu.grasscutter.net.proto.HomeCustomFurnitureInfoOuterClass
        ...
        public static final class Builder
            ...
            // Construct using
            // emu.grasscutter.net.proto.HomeCustomFurnitureInfoOuterClass.HomeCustomFurnitureInfo.newBuilder()
            private Builder() {
            ...
            public emu.grasscutter.net.proto.HomeCustomFurnitureInfoOuterClass.HomeCustomFurnitureInfo
                ...
                return emu.grasscutter.net.proto.HomeCustomFurnitureInfoOuterClass.HomeCustomFurnitureInfo
                        .getDefaultInstance();
            }
            ...
            public emu.grasscutter.net.proto.HomeCustomFurnitureInfoOuterClass.HomeCustomFurnitureInfo
                    build() {
                emu.grasscutter.net.proto.HomeCustomFurnitureInfoOuterClass.HomeCustomFurnitureInfo result =
                        buildPartial();
            ...
            public emu.grasscutter.net.proto.HomeCustomFurnitureInfoOuterClass.HomeCustomFurnitureInfo
                    buildPartial() {
                emu.grasscutter.net.proto.HomeCustomFurnitureInfoOuterClass.HomeCustomFurnitureInfo result =
                        new emu.grasscutter.net.proto.HomeCustomFurnitureInfoOuterClass.HomeCustomFurnitureInfo(
                                this);
            ...
            public Builder setSubFurnitureList(
                    int index,
                    emu.grasscutter.net.proto.CustomCommonNodeInfoOuterClass.CustomCommonNodeInfo value) {
                if (subFurnitureListBuilder_ == null) {
                    if (value == null) {
            ...
            public Builder addAllSubFurnitureList(
                ...
                if (subFurnitureListBuilder_ == null) {
                    ensureSubFurnitureListIsMutable();
                    com.google.protobuf.AbstractMessageLite.Builder.addAll(values, subFurnitureList_);
                    onChanged();
                } else {
            ...
            /** <code>repeated .CustomCommonNodeInfo sub_furniture_list = 1;</code> */
            public emu.grasscutter.net.proto.CustomCommonNodeInfoOuterClass.CustomCommonNodeInfo.Builder
                    getSubFurnitureListBuilder(int index) {
            ...
            /** <code>repeated .CustomCommonNodeInfo sub_furniture_list = 1;</code> */
            public emu.grasscutter.net.proto.CustomCommonNodeInfoOuterClass.CustomCommonNodeInfo.Builder
                    addSubFurnitureListBuilder() {
                return getSubFurnitureListFieldBuilder()
                        .addBuilder(
                                emu.grasscutter.net.proto.CustomCommonNodeInfoOuterClass.CustomCommonNodeInfo
                                        .getDefaultInstance());
            }
            /** <code>repeated .CustomCommonNodeInfo sub_furniture_list = 1;</code> */
            public emu.grasscutter.net.proto.CustomCommonNodeInfoOuterClass.CustomCommonNodeInfo.Builder
                    addSubFurnitureListBuilder(int index) {
                return getSubFurnitureListFieldBuilder()
                        .addBuilder(
                                index,
                                emu.grasscutter.net.proto.CustomCommonNodeInfoOuterClass.CustomCommonNodeInfo
        ...
        private static final emu.grasscutter.net.proto.HomeCustomFurnitureInfoOuterClass
                        .HomeCustomFurnitureInfo
                DEFAULT_INSTANCE;
        ...
        private static final com.google.protobuf.Parser<HomeCustomFurnitureInfo> PARSER =
                new com.google.protobuf.AbstractParser<HomeCustomFurnitureInfo>() {
                    @java.lang.Override
    ...
    static {
        java.lang.String[] descriptorData = {
            "\n\035HomeCustomFurnitureInfo.proto\032\032CustomC"
                    ...
                    + "st\030\001 \003(\0132\025.CustomCommonNodeInfoB\033\n\031emu.g"
        ...
        internal_static_HomeCustomFurnitureInfo_descriptor = getDescriptor().getMessageTypes().get(0);
        internal_static_HomeCustomFurnitureInfo_fieldAccessorTable =
                new com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
                        internal_static_HomeCustomFurnitureInfo_descriptor,
                        new java.lang.String[] {
                            "Guid", "SubFurnitureList",
                        });
        emu.grasscutter.net.proto.CustomCommonNodeInfoOuterClass.getDescriptor();
    }
