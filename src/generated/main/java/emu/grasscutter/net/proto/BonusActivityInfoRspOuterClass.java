...
public final class BonusActivityInfoRspOuterClass {
    ...
    public interface BonusActivityInfoRspOrBuilder
            extends
        ...
        emu.grasscutter.net.proto.BonusActivityInfoOuterClass.BonusActivityInfo
                getBonusActivityInfoList(int index);
        /** <code>repeated .BonusActivityInfo bonus_activity_info_list = 3;</code> */
        ...
        /** <code>repeated .BonusActivityInfo bonus_activity_info_list = 3;</code> */
        emu.grasscutter.net.proto.BonusActivityInfoOuterClass.BonusActivityInfoOrBuilder
                getBonusActivityInfoListOrBuilder(int index);
    }
    /**
     *
     *
     ...
     */
    public static final class BonusActivityInfoRsp extends com.google.protobuf.GeneratedMessageV3
            implements
                                ...
                                if (!((mutable_bitField0_ & 0x00000001) != 0)) {
                                    bonusActivityInfoList_ =
                                            new java.util.ArrayList<
                                                    emu.grasscutter.net.proto.BonusActivityInfoOuterClass
                                                            .BonusActivityInfo>();
        ...
        public static final com.google.protobuf.Descriptors.Descriptor getDescriptor() {
            return emu.grasscutter.net.proto.BonusActivityInfoRspOuterClass
        ...
        protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
            ...
            return emu.grasscutter.net.proto.BonusActivityInfoRspOuterClass
                    ...
                    .ensureFieldAccessorsInitialized(
                            emu.grasscutter.net.proto.BonusActivityInfoRspOuterClass.BonusActivityInfoRsp.class,
                            emu.grasscutter.net.proto.BonusActivityInfoRspOuterClass.BonusActivityInfoRsp.Builder
                                    .class);
        }
        ...
        private java.util.List<emu.grasscutter.net.proto.BonusActivityInfoOuterClass.BonusActivityInfo>
                bonusActivityInfoList_;
        /** <code>repeated .BonusActivityInfo bonus_activity_info_list = 3;</code> */
        @java.lang.Override
        public java.util.List<emu.grasscutter.net.proto.BonusActivityInfoOuterClass.BonusActivityInfo>
                getBonusActivityInfoListList() {
            ...
            for (int i = 0; i < bonusActivityInfoList_.size(); i++) {
                size +=
                        com.google.protobuf.CodedOutputStream.computeMessageSize(
                                3, bonusActivityInfoList_.get(i));
            }
            if (retcode_ != 0) {
        ...
        public boolean equals(final java.lang.Object obj) {
            ...
            if (!(obj
                    instanceof
                    emu.grasscutter.net.proto.BonusActivityInfoRspOuterClass.BonusActivityInfoRsp)) {
                return super.equals(obj);
            }
            emu.grasscutter.net.proto.BonusActivityInfoRspOuterClass.BonusActivityInfoRsp other =
                    (emu.grasscutter.net.proto.BonusActivityInfoRspOuterClass.BonusActivityInfoRsp) obj;

            if (getRetcode() != other.getRetcode()) return false;
            if (!getBonusActivityInfoListList().equals(other.getBonusActivityInfoListList()))
                return false;
        ...
        public static emu.grasscutter.net.proto.BonusActivityInfoRspOuterClass.BonusActivityInfoRsp
        ...
        public static Builder newBuilder(
                emu.grasscutter.net.proto.BonusActivityInfoRspOuterClass.BonusActivityInfoRsp prototype) {
        ...
        public static final class Builder
            ...
            // Construct using
            // emu.grasscutter.net.proto.BonusActivityInfoRspOuterClass.BonusActivityInfoRsp.newBuilder()
            private Builder() {
            ...
            @java.lang.Override
            public emu.grasscutter.net.proto.BonusActivityInfoRspOuterClass.BonusActivityInfoRsp
                    getDefaultInstanceForType() {
                return emu.grasscutter.net.proto.BonusActivityInfoRspOuterClass.BonusActivityInfoRsp
                        .getDefaultInstance();
            }

            @java.lang.Override
            public emu.grasscutter.net.proto.BonusActivityInfoRspOuterClass.BonusActivityInfoRsp build() {
                emu.grasscutter.net.proto.BonusActivityInfoRspOuterClass.BonusActivityInfoRsp result =
                        buildPartial();
            ...
            public emu.grasscutter.net.proto.BonusActivityInfoRspOuterClass.BonusActivityInfoRsp
                    buildPartial() {
                emu.grasscutter.net.proto.BonusActivityInfoRspOuterClass.BonusActivityInfoRsp result =
                        new emu.grasscutter.net.proto.BonusActivityInfoRspOuterClass.BonusActivityInfoRsp(this);
            ...
            public Builder addAllBonusActivityInfoList(
                    java.lang.Iterable<
                                    ? extends emu.grasscutter.net.proto.BonusActivityInfoOuterClass.BonusActivityInfo>
                            values) {
                if (bonusActivityInfoListBuilder_ == null) {
                    ensureBonusActivityInfoListIsMutable();
                    com.google.protobuf.AbstractMessageLite.Builder.addAll(values, bonusActivityInfoList_);
                    onChanged();
                } else {
            ...
            public emu.grasscutter.net.proto.BonusActivityInfoOuterClass.BonusActivityInfo.Builder
                    getBonusActivityInfoListBuilder(int index) {
            ...
            /** <code>repeated .BonusActivityInfo bonus_activity_info_list = 3;</code> */
            public emu.grasscutter.net.proto.BonusActivityInfoOuterClass.BonusActivityInfo.Builder
                    addBonusActivityInfoListBuilder() {
                return getBonusActivityInfoListFieldBuilder()
                        .addBuilder(
                                emu.grasscutter.net.proto.BonusActivityInfoOuterClass.BonusActivityInfo
                                        .getDefaultInstance());
            }
            /** <code>repeated .BonusActivityInfo bonus_activity_info_list = 3;</code> */
            public emu.grasscutter.net.proto.BonusActivityInfoOuterClass.BonusActivityInfo.Builder
                    addBonusActivityInfoListBuilder(int index) {
                return getBonusActivityInfoListFieldBuilder()
                        .addBuilder(
                                index,
                                emu.grasscutter.net.proto.BonusActivityInfoOuterClass.BonusActivityInfo
        ...
        private static final emu.grasscutter.net.proto.BonusActivityInfoRspOuterClass
                        .BonusActivityInfoRsp
                DEFAULT_INSTANCE;

        static {
            DEFAULT_INSTANCE =
                    new emu.grasscutter.net.proto.BonusActivityInfoRspOuterClass.BonusActivityInfoRsp();
        }
        ...
        private static final com.google.protobuf.Parser<BonusActivityInfoRsp> PARSER =
                new com.google.protobuf.AbstractParser<BonusActivityInfoRsp>() {
                    @java.lang.Override
    ...
    static {
        ...
        internal_static_BonusActivityInfoRsp_descriptor = getDescriptor().getMessageTypes().get(0);
        internal_static_BonusActivityInfoRsp_fieldAccessorTable =
                new com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
                        internal_static_BonusActivityInfoRsp_descriptor,
                        new java.lang.String[] {
                            "Retcode", "BonusActivityInfoList",
                        });
        emu.grasscutter.net.proto.BonusActivityInfoOuterClass.getDescriptor();
    }
