...
public final class GCGSkillPreviewNotifyOuterClass {
    ...
    public interface GCGSkillPreviewNotifyOrBuilder
            extends
        ...
        /** <code>repeated .GCGSkillPreviewInfo skill_preview_list = 15;</code> */
        emu.grasscutter.net.proto.GCGSkillPreviewInfoOuterClass.GCGSkillPreviewInfo getSkillPreviewList(
                int index);
        /** <code>repeated .GCGSkillPreviewInfo skill_preview_list = 15;</code> */
        ...
        emu.grasscutter.net.proto.GCGSkillPreviewInfoOuterClass.GCGSkillPreviewInfoOrBuilder
                getSkillPreviewListOrBuilder(int index);
        ...
        /** <code>repeated .GCGChangeOnstageInfo change_onstage_preview_list = 2;</code> */
        emu.grasscutter.net.proto.GCGChangeOnstageInfoOuterClass.GCGChangeOnstageInfo
                getChangeOnstagePreviewList(int index);
        /** <code>repeated .GCGChangeOnstageInfo change_onstage_preview_list = 2;</code> */
        int getChangeOnstagePreviewListCount();
        /** <code>repeated .GCGChangeOnstageInfo change_onstage_preview_list = 2;</code> */
        java.util.List<
                        ? extends
                                emu.grasscutter.net.proto.GCGChangeOnstageInfoOuterClass
        ...
        emu.grasscutter.net.proto.GCGChangeOnstageInfoOuterClass.GCGChangeOnstageInfoOrBuilder
                getChangeOnstagePreviewListOrBuilder(int index);
        ...
        java.util.List<
                ...
                getPlayCardListList();
        /** <code>repeated .GCGSkillPreviewPlayCardInfo play_card_list = 4;</code> */
        emu.grasscutter.net.proto.GCGSkillPreviewPlayCardInfoOuterClass.GCGSkillPreviewPlayCardInfo
                getPlayCardList(int index);
        /** <code>repeated .GCGSkillPreviewPlayCardInfo play_card_list = 4;</code> */
        ...
        emu.grasscutter.net.proto.GCGSkillPreviewPlayCardInfoOuterClass
                        .GCGSkillPreviewPlayCardInfoOrBuilder
                getPlayCardListOrBuilder(int index);
    }
    /**
     *
     *
     ...
     */
    public static final class GCGSkillPreviewNotify extends com.google.protobuf.GeneratedMessageV3
            implements
        ...
        private GCGSkillPreviewNotify(
            ...
            try {
                        ...
                        case 34:
                            {
                                ...
                                playCardList_.add(
                                        input.readMessage(
                                                emu.grasscutter.net.proto.GCGSkillPreviewPlayCardInfoOuterClass
                                                        .GCGSkillPreviewPlayCardInfo.parser(),
                                                extensionRegistry));
                                break;
                            }
                        case 40:
                ...
                if (((mutable_bitField0_ & 0x00000002) != 0)) {
                    changeOnstagePreviewList_ =
                            java.util.Collections.unmodifiableList(changeOnstagePreviewList_);
                }
                if (((mutable_bitField0_ & 0x00000004) != 0)) {
        ...
        public static final com.google.protobuf.Descriptors.Descriptor getDescriptor() {
            return emu.grasscutter.net.proto.GCGSkillPreviewNotifyOuterClass
        ...
        protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
            ...
            return emu.grasscutter.net.proto.GCGSkillPreviewNotifyOuterClass
                    ...
                    .ensureFieldAccessorsInitialized(
                            emu.grasscutter.net.proto.GCGSkillPreviewNotifyOuterClass.GCGSkillPreviewNotify.class,
                            emu.grasscutter.net.proto.GCGSkillPreviewNotifyOuterClass.GCGSkillPreviewNotify
                                    .Builder.class);
        }
        ...
        public emu.grasscutter.net.proto.GCGSkillPreviewInfoOuterClass.GCGSkillPreviewInfo
                getSkillPreviewList(int index) {
            return skillPreviewList_.get(index);
        }
        /** <code>repeated .GCGSkillPreviewInfo skill_preview_list = 15;</code> */
        @java.lang.Override
        public emu.grasscutter.net.proto.GCGSkillPreviewInfoOuterClass.GCGSkillPreviewInfoOrBuilder
                getSkillPreviewListOrBuilder(int index) {
            return skillPreviewList_.get(index);
        }
        ...
        /** <code>repeated .GCGChangeOnstageInfo change_onstage_preview_list = 2;</code> */
        @java.lang.Override
        public emu.grasscutter.net.proto.GCGChangeOnstageInfoOuterClass.GCGChangeOnstageInfo
                getChangeOnstagePreviewList(int index) {
            return changeOnstagePreviewList_.get(index);
        }
        /** <code>repeated .GCGChangeOnstageInfo change_onstage_preview_list = 2;</code> */
        @java.lang.Override
        public emu.grasscutter.net.proto.GCGChangeOnstageInfoOuterClass.GCGChangeOnstageInfoOrBuilder
                getChangeOnstagePreviewListOrBuilder(int index) {
            return changeOnstagePreviewList_.get(index);
        }
        ...
        /** <code>repeated .GCGSkillPreviewPlayCardInfo play_card_list = 4;</code> */
        @java.lang.Override
        public emu.grasscutter.net.proto.GCGSkillPreviewPlayCardInfoOuterClass
                        .GCGSkillPreviewPlayCardInfo
                getPlayCardList(int index) {
            ...
            for (int i = 0; i < changeOnstagePreviewList_.size(); i++) {
                size +=
                        com.google.protobuf.CodedOutputStream.computeMessageSize(
                                2, changeOnstagePreviewList_.get(i));
            }
            for (int i = 0; i < playCardList_.size(); i++) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(4, playCardList_.get(i));
            }
            if (controllerId_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(5, controllerId_);
            }
            if (cEGLEJFCGIF_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(14, cEGLEJFCGIF_);
            }
            for (int i = 0; i < skillPreviewList_.size(); i++) {
                size +=
                        com.google.protobuf.CodedOutputStream.computeMessageSize(15, skillPreviewList_.get(i));
            }
        ...
        public boolean equals(final java.lang.Object obj) {
            ...
            emu.grasscutter.net.proto.GCGSkillPreviewNotifyOuterClass.GCGSkillPreviewNotify other =
                    (emu.grasscutter.net.proto.GCGSkillPreviewNotifyOuterClass.GCGSkillPreviewNotify) obj;

            if (!getSkillPreviewListList().equals(other.getSkillPreviewListList())) return false;
            if (getCEGLEJFCGIF() != other.getCEGLEJFCGIF()) return false;
            if (getControllerId() != other.getControllerId()) return false;
            if (!getChangeOnstagePreviewListList().equals(other.getChangeOnstagePreviewListList()))
                return false;
            if (!getPlayCardListList().equals(other.getPlayCardListList())) return false;
        ...
        public static emu.grasscutter.net.proto.GCGSkillPreviewNotifyOuterClass.GCGSkillPreviewNotify
        ...
        public static Builder newBuilder(
                emu.grasscutter.net.proto.GCGSkillPreviewNotifyOuterClass.GCGSkillPreviewNotify prototype) {
        ...
        public static final class Builder
            ...
            // Construct using
            // emu.grasscutter.net.proto.GCGSkillPreviewNotifyOuterClass.GCGSkillPreviewNotify.newBuilder()
            private Builder() {
            ...
            @java.lang.Override
            public emu.grasscutter.net.proto.GCGSkillPreviewNotifyOuterClass.GCGSkillPreviewNotify
                    getDefaultInstanceForType() {
                return emu.grasscutter.net.proto.GCGSkillPreviewNotifyOuterClass.GCGSkillPreviewNotify
                        .getDefaultInstance();
            }
            ...
            public emu.grasscutter.net.proto.GCGSkillPreviewNotifyOuterClass.GCGSkillPreviewNotify
                    build() {
                emu.grasscutter.net.proto.GCGSkillPreviewNotifyOuterClass.GCGSkillPreviewNotify result =
                        buildPartial();
            ...
            public emu.grasscutter.net.proto.GCGSkillPreviewNotifyOuterClass.GCGSkillPreviewNotify
                    buildPartial() {
                emu.grasscutter.net.proto.GCGSkillPreviewNotifyOuterClass.GCGSkillPreviewNotify result =
                        new emu.grasscutter.net.proto.GCGSkillPreviewNotifyOuterClass.GCGSkillPreviewNotify(
                                this);
            ...
            public Builder setSkillPreviewList(
                    int index,
                    emu.grasscutter.net.proto.GCGSkillPreviewInfoOuterClass.GCGSkillPreviewInfo value) {
                if (skillPreviewListBuilder_ == null) {
                    if (value == null) {
            ...
            public Builder addAllSkillPreviewList(
                ...
                if (skillPreviewListBuilder_ == null) {
                    ensureSkillPreviewListIsMutable();
                    com.google.protobuf.AbstractMessageLite.Builder.addAll(values, skillPreviewList_);
                    onChanged();
                } else {
            ...
            /** <code>repeated .GCGSkillPreviewInfo skill_preview_list = 15;</code> */
            public emu.grasscutter.net.proto.GCGSkillPreviewInfoOuterClass.GCGSkillPreviewInfo.Builder
                    getSkillPreviewListBuilder(int index) {
            ...
            /** <code>repeated .GCGSkillPreviewInfo skill_preview_list = 15;</code> */
            public emu.grasscutter.net.proto.GCGSkillPreviewInfoOuterClass.GCGSkillPreviewInfo.Builder
                    addSkillPreviewListBuilder() {
                return getSkillPreviewListFieldBuilder()
                        .addBuilder(
                                emu.grasscutter.net.proto.GCGSkillPreviewInfoOuterClass.GCGSkillPreviewInfo
                                        .getDefaultInstance());
            }
            /** <code>repeated .GCGSkillPreviewInfo skill_preview_list = 15;</code> */
            public emu.grasscutter.net.proto.GCGSkillPreviewInfoOuterClass.GCGSkillPreviewInfo.Builder
                    addSkillPreviewListBuilder(int index) {
                return getSkillPreviewListFieldBuilder()
                        .addBuilder(
                                index,
                                emu.grasscutter.net.proto.GCGSkillPreviewInfoOuterClass.GCGSkillPreviewInfo
            ...
            private com.google.protobuf.RepeatedFieldBuilderV3<
                            emu.grasscutter.net.proto.GCGChangeOnstageInfoOuterClass.GCGChangeOnstageInfo,
                            emu.grasscutter.net.proto.GCGChangeOnstageInfoOuterClass.GCGChangeOnstageInfo.Builder,
                            emu.grasscutter.net.proto.GCGChangeOnstageInfoOuterClass
                                    .GCGChangeOnstageInfoOrBuilder>
                    changeOnstagePreviewListBuilder_;
            ...
            public Builder setChangeOnstagePreviewList(
                    int index,
                    emu.grasscutter.net.proto.GCGChangeOnstageInfoOuterClass.GCGChangeOnstageInfo value) {
                if (changeOnstagePreviewListBuilder_ == null) {
                    if (value == null) {
                        throw new NullPointerException();
                    }
            ...
            public Builder addAllChangeOnstagePreviewList(
                ...
                if (changeOnstagePreviewListBuilder_ == null) {
                    ensureChangeOnstagePreviewListIsMutable();
                    com.google.protobuf.AbstractMessageLite.Builder.addAll(values, changeOnstagePreviewList_);
                    onChanged();
                } else {
            ...
            /** <code>repeated .GCGChangeOnstageInfo change_onstage_preview_list = 2;</code> */
            public emu.grasscutter.net.proto.GCGChangeOnstageInfoOuterClass.GCGChangeOnstageInfo.Builder
                    getChangeOnstagePreviewListBuilder(int index) {
            ...
            /** <code>repeated .GCGChangeOnstageInfo change_onstage_preview_list = 2;</code> */
            public emu.grasscutter.net.proto.GCGChangeOnstageInfoOuterClass.GCGChangeOnstageInfo.Builder
                    addChangeOnstagePreviewListBuilder() {
                return getChangeOnstagePreviewListFieldBuilder()
                        .addBuilder(
                                emu.grasscutter.net.proto.GCGChangeOnstageInfoOuterClass.GCGChangeOnstageInfo
                                        .getDefaultInstance());
            }
            /** <code>repeated .GCGChangeOnstageInfo change_onstage_preview_list = 2;</code> */
            public emu.grasscutter.net.proto.GCGChangeOnstageInfoOuterClass.GCGChangeOnstageInfo.Builder
                    addChangeOnstagePreviewListBuilder(int index) {
                return getChangeOnstagePreviewListFieldBuilder()
                        .addBuilder(
                                index,
                                emu.grasscutter.net.proto.GCGChangeOnstageInfoOuterClass.GCGChangeOnstageInfo
            ...
            private void ensurePlayCardListIsMutable() {
                if (!((bitField0_ & 0x00000004) != 0)) {
                    playCardList_ =
                            new java.util.ArrayList<
                                    emu.grasscutter.net.proto.GCGSkillPreviewPlayCardInfoOuterClass
                                            .GCGSkillPreviewPlayCardInfo>(playCardList_);
            ...
            private com.google.protobuf.RepeatedFieldBuilderV3<
                            emu.grasscutter.net.proto.GCGSkillPreviewPlayCardInfoOuterClass
                                    .GCGSkillPreviewPlayCardInfo,
                            emu.grasscutter.net.proto.GCGSkillPreviewPlayCardInfoOuterClass
                                    .GCGSkillPreviewPlayCardInfo.Builder,
                            emu.grasscutter.net.proto.GCGSkillPreviewPlayCardInfoOuterClass
                                    .GCGSkillPreviewPlayCardInfoOrBuilder>
                    playCardListBuilder_;
            ...
            public Builder addAllPlayCardList(
                ...
                if (playCardListBuilder_ == null) {
                    ensurePlayCardListIsMutable();
                    com.google.protobuf.AbstractMessageLite.Builder.addAll(values, playCardList_);
                    onChanged();
                } else {
            ...
            public emu.grasscutter.net.proto.GCGSkillPreviewPlayCardInfoOuterClass
                            .GCGSkillPreviewPlayCardInfo.Builder
                    getPlayCardListBuilder(int index) {
            ...
            public emu.grasscutter.net.proto.GCGSkillPreviewPlayCardInfoOuterClass
                            .GCGSkillPreviewPlayCardInfo.Builder
                    addPlayCardListBuilder() {
                return getPlayCardListFieldBuilder()
                        .addBuilder(
                                emu.grasscutter.net.proto.GCGSkillPreviewPlayCardInfoOuterClass
                                        .GCGSkillPreviewPlayCardInfo.getDefaultInstance());
            }
            /** <code>repeated .GCGSkillPreviewPlayCardInfo play_card_list = 4;</code> */
            public emu.grasscutter.net.proto.GCGSkillPreviewPlayCardInfoOuterClass
                            .GCGSkillPreviewPlayCardInfo.Builder
                    addPlayCardListBuilder(int index) {
                return getPlayCardListFieldBuilder()
                        .addBuilder(
                                index,
                                emu.grasscutter.net.proto.GCGSkillPreviewPlayCardInfoOuterClass
        ...
        private static final emu.grasscutter.net.proto.GCGSkillPreviewNotifyOuterClass
        ...
        private static final com.google.protobuf.Parser<GCGSkillPreviewNotify> PARSER =
                new com.google.protobuf.AbstractParser<GCGSkillPreviewNotify>() {
                    @java.lang.Override
    ...
    static {
        ...
        internal_static_GCGSkillPreviewNotify_descriptor = getDescriptor().getMessageTypes().get(0);
        internal_static_GCGSkillPreviewNotify_fieldAccessorTable =
