...
public final class SceneTeamAvatarOuterClass {
    ...
    public static final class SceneTeamAvatar extends com.google.protobuf.GeneratedMessageV3
        ...
        public int getSerializedSize() {
            ...
            size = 0;
            if (avatarInfo_ != null) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(1, getAvatarInfo());
            }
            if (sceneId_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(2, sceneId_);
            }
            if (avatarGuid_ != 0L) {
                size += com.google.protobuf.CodedOutputStream.computeUInt64Size(3, avatarGuid_);
            }
            if (weaponEntityId_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(4, weaponEntityId_);
            }
            for (int i = 0; i < serverBuffList_.size(); i++) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(5, serverBuffList_.get(i));
            }
            if (sceneEntityInfo_ != null) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(6, getSceneEntityInfo());
            }
            if (weaponGuid_ != 0L) {
                size += com.google.protobuf.CodedOutputStream.computeUInt64Size(7, weaponGuid_);
            }
            if (avatarAbilityInfo_ != null) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(8, getAvatarAbilityInfo());
            }
            if (playerUid_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(9, playerUid_);
            }
            if (isReconnect_ != false) {
                size += com.google.protobuf.CodedOutputStream.computeBoolSize(10, isReconnect_);
            }
            if (abilityControlBlock_ != null) {
                size +=
                        com.google.protobuf.CodedOutputStream.computeMessageSize(11, getAbilityControlBlock());
            }
            if (isOnScene_ != false) {
                size += com.google.protobuf.CodedOutputStream.computeBoolSize(12, isOnScene_);
            }
            if (entityId_ != 0) {
            ...
            if (weaponAbilityInfo_ != null) {
                size +=
                        com.google.protobuf.CodedOutputStream.computeMessageSize(14, getWeaponAbilityInfo());
            }
            if (sceneAvatarInfo_ != null) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(15, getSceneAvatarInfo());
            }
            if (isPlayerCurAvatar_ != false) {
                size += com.google.protobuf.CodedOutputStream.computeBoolSize(1511, isPlayerCurAvatar_);
            }
