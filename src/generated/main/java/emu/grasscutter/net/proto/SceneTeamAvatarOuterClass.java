...
public final class SceneTeamAvatarOuterClass {
    ...
    public static final class SceneTeamAvatar extends com.google.protobuf.GeneratedMessageV3
        ...
        public int getSerializedSize() {
            ...
            size = 0;
            for (int i = 0; i < serverBuffList_.size(); i++) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(1, serverBuffList_.get(i));
            }
            if (avatarAbilityInfo_ != null) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(2, getAvatarAbilityInfo());
            }
            if (sceneEntityInfo_ != null) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(3, getSceneEntityInfo());
            }
            if (sceneId_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(4, sceneId_);
            }
            if (weaponEntityId_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(5, weaponEntityId_);
            }
            if (isReconnect_ != false) {
                size += com.google.protobuf.CodedOutputStream.computeBoolSize(6, isReconnect_);
            }
            if (weaponAbilityInfo_ != null) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(7, getWeaponAbilityInfo());
            }
            if (sceneAvatarInfo_ != null) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(8, getSceneAvatarInfo());
            }
            if (isOnScene_ != false) {
                size += com.google.protobuf.CodedOutputStream.computeBoolSize(9, isOnScene_);
            }
            if (weaponGuid_ != 0L) {
                size += com.google.protobuf.CodedOutputStream.computeUInt64Size(10, weaponGuid_);
            }
            if (avatarInfo_ != null) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(11, getAvatarInfo());
            }
            if (playerUid_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(12, playerUid_);
            }
            if (entityId_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(13, entityId_);
            }
            if (avatarGuid_ != 0L) {
                size += com.google.protobuf.CodedOutputStream.computeUInt64Size(14, avatarGuid_);
            }
            if (abilityControlBlock_ != null) {
                size +=
                        com.google.protobuf.CodedOutputStream.computeMessageSize(15, getAbilityControlBlock());
            }
            if (isPlayerCurAvatar_ != false) {
                size += com.google.protobuf.CodedOutputStream.computeBoolSize(1077, isPlayerCurAvatar_);
            }
