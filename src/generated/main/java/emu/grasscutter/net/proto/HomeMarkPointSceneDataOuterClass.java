...
public final class HomeMarkPointSceneDataOuterClass {
    ...
    public interface HomeMarkPointSceneDataOrBuilder
            extends
        ...
        emu.grasscutter.net.proto.HomeMarkPointFurnitureDataOuterClass
                        .HomeMarkPointFurnitureDataOrBuilder
                getFurnitureListOrBuilder(int index);
    }
    /**
     *
     *
     ...
     */
    public static final class HomeMarkPointSceneData extends com.google.protobuf.GeneratedMessageV3
            implements
                        ...
                        case 82:
                            {
                                ...
                                furnitureList_.add(
                                        input.readMessage(
                                                emu.grasscutter.net.proto.HomeMarkPointFurnitureDataOuterClass
                                                        .HomeMarkPointFurnitureData.parser(),
                                                extensionRegistry));
                                break;
                            }
                        case 96:
        ...
        public static final com.google.protobuf.Descriptors.Descriptor getDescriptor() {
            return emu.grasscutter.net.proto.HomeMarkPointSceneDataOuterClass
        ...
        protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
            ...
            return emu.grasscutter.net.proto.HomeMarkPointSceneDataOuterClass
                    ...
                    .ensureFieldAccessorsInitialized(
                            emu.grasscutter.net.proto.HomeMarkPointSceneDataOuterClass.HomeMarkPointSceneData
                                    .class,
                            emu.grasscutter.net.proto.HomeMarkPointSceneDataOuterClass.HomeMarkPointSceneData
                                    .Builder.class);
        }
        ...
        /** <code>repeated .HomeMarkPointFurnitureData furniture_list = 10;</code> */
        @java.lang.Override
        public emu.grasscutter.net.proto.HomeMarkPointFurnitureDataOuterClass.HomeMarkPointFurnitureData
                getFurnitureList(int index) {
            return furnitureList_.get(index);
        }
        /** <code>repeated .HomeMarkPointFurnitureData furniture_list = 10;</code> */
        @java.lang.Override
        public emu.grasscutter.net.proto.HomeMarkPointFurnitureDataOuterClass
                        .HomeMarkPointFurnitureDataOrBuilder
                getFurnitureListOrBuilder(int index) {
            return furnitureList_.get(index);
        }
        ...
        public int getSerializedSize() {
            ...
            size = 0;
            if (safePointPos_ != null) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(1, getSafePointPos());
            }
            if (sceneId_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(6, sceneId_);
            }
            for (int i = 0; i < furnitureList_.size(); i++) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(10, furnitureList_.get(i));
            }
            if (moduleId_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(12, moduleId_);
            }
            if (teapotSpiritPos_ != null) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(13, getTeapotSpiritPos());
            }
        ...
        public boolean equals(final java.lang.Object obj) {
            ...
            emu.grasscutter.net.proto.HomeMarkPointSceneDataOuterClass.HomeMarkPointSceneData other =
                    (emu.grasscutter.net.proto.HomeMarkPointSceneDataOuterClass.HomeMarkPointSceneData) obj;

            if (hasSafePointPos() != other.hasSafePointPos()) return false;
            if (hasSafePointPos()) {
                if (!getSafePointPos().equals(other.getSafePointPos())) return false;
            }
            if (hasTeapotSpiritPos() != other.hasTeapotSpiritPos()) return false;
            if (hasTeapotSpiritPos()) {
                if (!getTeapotSpiritPos().equals(other.getTeapotSpiritPos())) return false;
            }
            if (getModuleId() != other.getModuleId()) return false;
            if (getSceneId() != other.getSceneId()) return false;
            if (!getFurnitureListList().equals(other.getFurnitureListList())) return false;
        ...
        public static emu.grasscutter.net.proto.HomeMarkPointSceneDataOuterClass.HomeMarkPointSceneData
        ...
        public static final class Builder
            ...
            // Construct using
            // emu.grasscutter.net.proto.HomeMarkPointSceneDataOuterClass.HomeMarkPointSceneData.newBuilder()
            private Builder() {
            ...
            @java.lang.Override
            public emu.grasscutter.net.proto.HomeMarkPointSceneDataOuterClass.HomeMarkPointSceneData
                    getDefaultInstanceForType() {
                return emu.grasscutter.net.proto.HomeMarkPointSceneDataOuterClass.HomeMarkPointSceneData
                        .getDefaultInstance();
            }
            ...
            public emu.grasscutter.net.proto.HomeMarkPointSceneDataOuterClass.HomeMarkPointSceneData
                    build() {
                emu.grasscutter.net.proto.HomeMarkPointSceneDataOuterClass.HomeMarkPointSceneData result =
                        buildPartial();
            ...
            public emu.grasscutter.net.proto.HomeMarkPointSceneDataOuterClass.HomeMarkPointSceneData
                    buildPartial() {
                emu.grasscutter.net.proto.HomeMarkPointSceneDataOuterClass.HomeMarkPointSceneData result =
                        new emu.grasscutter.net.proto.HomeMarkPointSceneDataOuterClass.HomeMarkPointSceneData(
                                this);
            ...
            public Builder mergeSafePointPos(emu.grasscutter.net.proto.VectorOuterClass.Vector value) {
                if (safePointPosBuilder_ == null) {
                    if (safePointPos_ != null) {
                        safePointPos_ =
                                emu.grasscutter.net.proto.VectorOuterClass.Vector.newBuilder(safePointPos_)
                                        .mergeFrom(value)
                                        .buildPartial();
                    } else {
                        safePointPos_ = value;
                ...
                if (safePointPosBuilder_ == null) {
                    safePointPosBuilder_ =
                            new com.google.protobuf.SingleFieldBuilderV3<
                                    ...
                                    emu.grasscutter.net.proto.VectorOuterClass.Vector.Builder,
                                    emu.grasscutter.net.proto.VectorOuterClass.VectorOrBuilder>(
                                    getSafePointPos(), getParentForChildren(), isClean());
                    safePointPos_ = null;
                }
            ...
            public Builder mergeTeapotSpiritPos(emu.grasscutter.net.proto.VectorOuterClass.Vector value) {
                if (teapotSpiritPosBuilder_ == null) {
                    if (teapotSpiritPos_ != null) {
                        teapotSpiritPos_ =
                                emu.grasscutter.net.proto.VectorOuterClass.Vector.newBuilder(teapotSpiritPos_)
                                        .mergeFrom(value)
                                        .buildPartial();
                    } else {
                        teapotSpiritPos_ = value;
                ...
                if (teapotSpiritPosBuilder_ == null) {
                    teapotSpiritPosBuilder_ =
                            new com.google.protobuf.SingleFieldBuilderV3<
                                    ...
                                    emu.grasscutter.net.proto.VectorOuterClass.Vector.Builder,
                                    emu.grasscutter.net.proto.VectorOuterClass.VectorOrBuilder>(
                                    getTeapotSpiritPos(), getParentForChildren(), isClean());
                    teapotSpiritPos_ = null;
                }
            ...
            private void ensureFurnitureListIsMutable() {
                if (!((bitField0_ & 0x00000001) != 0)) {
                    furnitureList_ =
                            new java.util.ArrayList<
                                    emu.grasscutter.net.proto.HomeMarkPointFurnitureDataOuterClass
                                            .HomeMarkPointFurnitureData>(furnitureList_);
            ...
            private com.google.protobuf.RepeatedFieldBuilderV3<
                            emu.grasscutter.net.proto.HomeMarkPointFurnitureDataOuterClass
                                    .HomeMarkPointFurnitureData,
                            emu.grasscutter.net.proto.HomeMarkPointFurnitureDataOuterClass
                                    .HomeMarkPointFurnitureData.Builder,
                            emu.grasscutter.net.proto.HomeMarkPointFurnitureDataOuterClass
                                    .HomeMarkPointFurnitureDataOrBuilder>
                    furnitureListBuilder_;
            ...
            public Builder addAllFurnitureList(
                ...
                if (furnitureListBuilder_ == null) {
                    ensureFurnitureListIsMutable();
                    com.google.protobuf.AbstractMessageLite.Builder.addAll(values, furnitureList_);
                    onChanged();
                } else {
            ...
            public emu.grasscutter.net.proto.HomeMarkPointFurnitureDataOuterClass
                            .HomeMarkPointFurnitureData.Builder
                    getFurnitureListBuilder(int index) {
            ...
            public emu.grasscutter.net.proto.HomeMarkPointFurnitureDataOuterClass
                            .HomeMarkPointFurnitureData.Builder
                    addFurnitureListBuilder() {
                return getFurnitureListFieldBuilder()
                        .addBuilder(
                                emu.grasscutter.net.proto.HomeMarkPointFurnitureDataOuterClass
                                        .HomeMarkPointFurnitureData.getDefaultInstance());
            }
            /** <code>repeated .HomeMarkPointFurnitureData furniture_list = 10;</code> */
            public emu.grasscutter.net.proto.HomeMarkPointFurnitureDataOuterClass
                            .HomeMarkPointFurnitureData.Builder
                    addFurnitureListBuilder(int index) {
                return getFurnitureListFieldBuilder()
                        .addBuilder(
                                index,
                                emu.grasscutter.net.proto.HomeMarkPointFurnitureDataOuterClass
        ...
        private static final emu.grasscutter.net.proto.HomeMarkPointSceneDataOuterClass
        ...
        private static final com.google.protobuf.Parser<HomeMarkPointSceneData> PARSER =
                new com.google.protobuf.AbstractParser<HomeMarkPointSceneData>() {
                    @java.lang.Override
        ...
        internal_static_HomeMarkPointSceneData_fieldAccessorTable =
                new com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
                        ...
                        new java.lang.String[] {
                            "SafePointPos", "TeapotSpiritPos", "ModuleId", "SceneId", "FurnitureList",
                        });
        emu.grasscutter.net.proto.VectorOuterClass.getDescriptor();
        emu.grasscutter.net.proto.HomeMarkPointFurnitureDataOuterClass.getDescriptor();
    }
