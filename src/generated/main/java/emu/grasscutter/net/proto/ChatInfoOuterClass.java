...
public final class ChatInfoOuterClass {
    ...
    public interface ChatInfoOrBuilder
        ...
        /**
         * <code>.ChatInfo.SystemHint system_hint = 772;</code>
         *
    ...
    public static final class ChatInfo extends com.google.protobuf.GeneratedMessageV3
        ...
        public static final class SystemHint extends com.google.protobuf.GeneratedMessageV3
            ...
            public int getSerializedSize() {
                ...
                size = 0;
                if (type_ != 0) {
                    size += com.google.protobuf.CodedOutputStream.computeUInt32Size(12, type_);
                }
        ...
        public static final int TEXT_FIELD_NUMBER = 1362;
        /**
         * <code>string text = 1362;</code>
         *
         * @return Whether the text field is set.
        ...
        public static final int ICON_FIELD_NUMBER = 451;
        /**
         * <code>uint32 icon = 451;</code>
         *
         * @return Whether the icon field is set.
        ...
        public static final int SYSTEM_HINT_FIELD_NUMBER = 772;
        /**
         * <code>.ChatInfo.SystemHint system_hint = 772;</code>
         *
         * @return Whether the systemHint field is set.
        ...
        public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
            ...
            if (contentCase_ == 451) {
                output.writeUInt32(451, (int) ((java.lang.Integer) content_));
            }
            if (contentCase_ == 772) {
                output.writeMessage(
                        772, (emu.grasscutter.net.proto.ChatInfoOuterClass.ChatInfo.SystemHint) content_);
            }
            if (contentCase_ == 1362) {
                com.google.protobuf.GeneratedMessageV3.writeString(output, 1362, content_);
            }
            unknownFields.writeTo(output);
        }
        ...
        public int getSerializedSize() {
            ...
            size = 0;
            if (lHKGJHPFJKA_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(2, lHKGJHPFJKA_);
            }
            if (toUid_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(4, toUid_);
            }
            if (uid_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(11, uid_);
            }
            if (isRead_ != false) {
                size += com.google.protobuf.CodedOutputStream.computeBoolSize(12, isRead_);
            }
            if (time_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(15, time_);
            }
            if (contentCase_ == 451) {
                size +=
                        com.google.protobuf.CodedOutputStream.computeUInt32Size(
                                451, (int) ((java.lang.Integer) content_));
            }
            if (contentCase_ == 772) {
                size +=
            ...
            if (contentCase_ == 1362) {
                size += com.google.protobuf.GeneratedMessageV3.computeStringSize(1362, content_);
            }
            size += unknownFields.getSerializedSize();
            memoizedSize = size;
            return size;
        ...
        public boolean equals(final java.lang.Object obj) {
            ...
            if (getLHKGJHPFJKA() != other.getLHKGJHPFJKA()) return false;
        ...
        public static final class Builder
            ...
            public emu.grasscutter.net.proto.ChatInfoOuterClass.ChatInfo.SystemHintOrBuilder
                    getSystemHintOrBuilder() {
                if ((contentCase_ == 772) && (systemHintBuilder_ != null)) {
