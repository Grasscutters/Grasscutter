...
public final class SceneMonsterInfoOuterClass {
    ...
    public interface SceneMonsterInfoOrBuilder
            extends
        ...
        /** <code>repeated .SceneWeaponInfo weapon_list = 4;</code> */
        java.util.List<
                        ? extends emu.grasscutter.net.proto.SceneWeaponInfoOuterClass.SceneWeaponInfoOrBuilder>
                getWeaponListOrBuilderList();
        /** <code>repeated .SceneWeaponInfo weapon_list = 4;</code> */
        emu.grasscutter.net.proto.SceneWeaponInfoOuterClass.SceneWeaponInfoOrBuilder
                getWeaponListOrBuilder(int index);
        ...
        java.util.Map<java.lang.Integer, java.lang.Integer> getSummonTagMap();
        /** <code>map&lt;uint32, uint32&gt; summon_tag_map = 10;</code> */
        java.util.Map<java.lang.Integer, java.lang.Integer> getSummonTagMapMap();
        /** <code>map&lt;uint32, uint32&gt; summon_tag_map = 10;</code> */
        ...
        public emu.grasscutter.net.proto.SceneMonsterInfoOuterClass.SceneMonsterInfo.ContentCase
                getContentCase();
    }
    /**
     *
     ...
     */
    public static final class SceneMonsterInfo extends com.google.protobuf.GeneratedMessageV3
            implements
            ...
            try {
                ...
                while (!done) {
                    ...
                    switch (tag) {
                        ...
                        case 82:
                            {
                                ...
                                com.google.protobuf.MapEntry<java.lang.Integer, java.lang.Integer> summonTagMap__ =
                                        input.readMessage(
                                                SummonTagMapDefaultEntryHolder.defaultEntry.getParserForType(),
                                                extensionRegistry);
                                summonTagMap_
                                        .getMutableMap()
                                        .put(summonTagMap__.getKey(), summonTagMap__.getValue());
                                break;
                            }
                        case 88:
                            {
                        ...
                        case 146:
                            {
                                emu.grasscutter.net.proto.MonsterRouteOuterClass.MonsterRoute.Builder subBuilder =
                                        null;
                                ...
                                monsterRoute_ =
                                        input.readMessage(
                                                emu.grasscutter.net.proto.MonsterRouteOuterClass.MonsterRoute.parser(),
                                                extensionRegistry);
                                if (subBuilder != null) {
                        ...
                        case 402:
                            {
                                emu.grasscutter.net.proto.SceneFishInfoOuterClass.SceneFishInfo.Builder subBuilder =
                                        null;
                                if (contentCase_ == 50) {
                                    subBuilder =
                                ...
                                content_ =
                                        input.readMessage(
                                                emu.grasscutter.net.proto.SceneFishInfoOuterClass.SceneFishInfo.parser(),
                                                extensionRegistry);
                                if (subBuilder != null) {
                        ...
                        case 410:
                            {
                                emu.grasscutter.net.proto.FishtankFishInfoOuterClass.FishtankFishInfo.Builder
                                        subBuilder = null;
                                if (contentCase_ == 51) {
                                    subBuilder =
                                            ((emu.grasscutter.net.proto.FishtankFishInfoOuterClass.FishtankFishInfo)
                                                            content_)
                                                    .toBuilder();
                                }
                                content_ =
        ...
        public static final com.google.protobuf.Descriptors.Descriptor getDescriptor() {
            return emu.grasscutter.net.proto.SceneMonsterInfoOuterClass
        ...
        protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
            ...
            return emu.grasscutter.net.proto.SceneMonsterInfoOuterClass
                    ...
                    .ensureFieldAccessorsInitialized(
                            emu.grasscutter.net.proto.SceneMonsterInfoOuterClass.SceneMonsterInfo.class,
                            emu.grasscutter.net.proto.SceneMonsterInfoOuterClass.SceneMonsterInfo.Builder.class);
        }
        ...
        private java.util.List<emu.grasscutter.net.proto.SceneWeaponInfoOuterClass.SceneWeaponInfo>
                weaponList_;
        /** <code>repeated .SceneWeaponInfo weapon_list = 4;</code> */
        @java.lang.Override
        public java.util.List<emu.grasscutter.net.proto.SceneWeaponInfoOuterClass.SceneWeaponInfo>
                getWeaponListList() {
            return weaponList_;
        }
        /** <code>repeated .SceneWeaponInfo weapon_list = 4;</code> */
        ...
        /** <code>repeated .SceneWeaponInfo weapon_list = 4;</code> */
        @java.lang.Override
        public emu.grasscutter.net.proto.SceneWeaponInfoOuterClass.SceneWeaponInfoOrBuilder
                getWeaponListOrBuilder(int index) {
            return weaponList_.get(index);
        }
         ...
         */
        @java.lang.Override
        public java.util.List<java.lang.Integer> getAffixListList() {
            return affixList_;
        }
        /**
         * <code>repeated uint32 affix_list = 6;</code>
        ...
        private static final class SummonTagMapDefaultEntryHolder {
            static final com.google.protobuf.MapEntry<java.lang.Integer, java.lang.Integer> defaultEntry =
                    com.google.protobuf.MapEntry.<java.lang.Integer, java.lang.Integer>newDefaultInstance(
                            emu.grasscutter.net.proto.SceneMonsterInfoOuterClass
        ...
        private com.google.protobuf.MapField<java.lang.Integer, java.lang.Integer> summonTagMap_;
        ...
        public int getSummonTagMapOrDefault(int key, int defaultValue) {
            ...
            java.util.Map<java.lang.Integer, java.lang.Integer> map = internalGetSummonTagMap().getMap();
        ...
        public emu.grasscutter.net.proto.MonsterBornTypeOuterClass.MonsterBornType getBornType() {
            ...
            emu.grasscutter.net.proto.MonsterBornTypeOuterClass.MonsterBornType result =
                    emu.grasscutter.net.proto.MonsterBornTypeOuterClass.MonsterBornType.valueOf(bornType_);
            return result == null
                    ? emu.grasscutter.net.proto.MonsterBornTypeOuterClass.MonsterBornType.UNRECOGNIZED
                    : result;
        }
        ...
        public emu.grasscutter.net.proto.MonsterRouteOuterClass.MonsterRoute getMonsterRoute() {
            return monsterRoute_ == null
                    ? emu.grasscutter.net.proto.MonsterRouteOuterClass.MonsterRoute.getDefaultInstance()
                    : monsterRoute_;
        }
        /** <code>.MonsterRoute monster_route = 18;</code> */
        @java.lang.Override
        public emu.grasscutter.net.proto.MonsterRouteOuterClass.MonsterRouteOrBuilder
                getMonsterRouteOrBuilder() {
        ...
        /** <code>.SceneFishInfo fish_info = 50;</code> */
        @java.lang.Override
        public emu.grasscutter.net.proto.SceneFishInfoOuterClass.SceneFishInfoOrBuilder
         ...
         */
        @java.lang.Override
        public emu.grasscutter.net.proto.FishtankFishInfoOuterClass.FishtankFishInfo
                getFishtankFishInfo() {
            if (contentCase_ == 51) {
                return (emu.grasscutter.net.proto.FishtankFishInfoOuterClass.FishtankFishInfo) content_;
            }
            return emu.grasscutter.net.proto.FishtankFishInfoOuterClass.FishtankFishInfo
                    .getDefaultInstance();
        }
        /** <code>.FishtankFishInfo fishtank_fish_info = 51;</code> */
        @java.lang.Override
        public emu.grasscutter.net.proto.FishtankFishInfoOuterClass.FishtankFishInfoOrBuilder
                getFishtankFishInfoOrBuilder() {
            if (contentCase_ == 51) {
                return (emu.grasscutter.net.proto.FishtankFishInfoOuterClass.FishtankFishInfo) content_;
            }
        ...
        public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
            ...
            com.google.protobuf.GeneratedMessageV3.serializeIntegerMapTo(
                    output, internalGetSummonTagMap(), SummonTagMapDefaultEntryHolder.defaultEntry, 10);
            if (poseId_ != 0) {
                output.writeUInt32(11, poseId_);
            }
            if (bornType_
                    != emu.grasscutter.net.proto.MonsterBornTypeOuterClass.MonsterBornType
            ...
            if (contentCase_ == 50) {
                output.writeMessage(
                        50, (emu.grasscutter.net.proto.SceneFishInfoOuterClass.SceneFishInfo) content_);
            }
            if (contentCase_ == 51) {
                output.writeMessage(
                        51, (emu.grasscutter.net.proto.FishtankFishInfoOuterClass.FishtankFishInfo) content_);
            }
        ...
        public int getSerializedSize() {
            ...
            for (int i = 0; i < weaponList_.size(); i++) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(4, weaponList_.get(i));
            }
            if (authorityPeerId_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(5, authorityPeerId_);
            }
            {
                int dataSize = 0;
                for (int i = 0; i < affixList_.size(); i++) {
                    dataSize +=
                            com.google.protobuf.CodedOutputStream.computeUInt32SizeNoTag(affixList_.getInt(i));
                }
                size += dataSize;
            ...
            if (isElite_ != false) {
                size += com.google.protobuf.CodedOutputStream.computeBoolSize(7, isElite_);
            }
            if (ownerEntityId_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(8, ownerEntityId_);
            }
            if (summonedTag_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(9, summonedTag_);
            }
            for (java.util.Map.Entry<java.lang.Integer, java.lang.Integer> entry :
                ...
                com.google.protobuf.MapEntry<java.lang.Integer, java.lang.Integer> summonTagMap__ =
                        SummonTagMapDefaultEntryHolder.defaultEntry
                                ...
                                .build();
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(10, summonTagMap__);
            }
            if (poseId_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(11, poseId_);
            }
            if (bornType_
                    != emu.grasscutter.net.proto.MonsterBornTypeOuterClass.MonsterBornType
                            .MONSTER_BORN_TYPE_NONE
                            .getNumber()) {
                size += com.google.protobuf.CodedOutputStream.computeEnumSize(12, bornType_);
            }
            if (blockId_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(13, blockId_);
            }
            if (markFlag_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(14, markFlag_);
            }
            if (titleId_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(15, titleId_);
            }
            if (specialNameId_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(16, specialNameId_);
            }
            if (attackTargetId_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(17, attackTargetId_);
            }
            if (monsterRoute_ != null) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(18, getMonsterRoute());
            }
            if (aiConfigId_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(19, aiConfigId_);
            }
            if (levelRouteId_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(20, levelRouteId_);
            }
            if (initPoseId_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(21, initPoseId_);
            }
            if (isLight_ != false) {
                size += com.google.protobuf.CodedOutputStream.computeBoolSize(22, isLight_);
            }
            if (killNum_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(23, killNum_);
            }
            if (contentCase_ == 50) {
                size +=
        ...
        public boolean equals(final java.lang.Object obj) {
            ...
            emu.grasscutter.net.proto.SceneMonsterInfoOuterClass.SceneMonsterInfo other =
                    (emu.grasscutter.net.proto.SceneMonsterInfoOuterClass.SceneMonsterInfo) obj;
            ...
            if (!getWeaponListList().equals(other.getWeaponListList())) return false;
            if (getAuthorityPeerId() != other.getAuthorityPeerId()) return false;
            if (!getAffixListList().equals(other.getAffixListList())) return false;
            if (getIsElite() != other.getIsElite()) return false;
            if (getOwnerEntityId() != other.getOwnerEntityId()) return false;
            if (getSummonedTag() != other.getSummonedTag()) return false;
            if (!internalGetSummonTagMap().equals(other.internalGetSummonTagMap())) return false;
            if (getPoseId() != other.getPoseId()) return false;
            ...
            if (getTitleId() != other.getTitleId()) return false;
            if (getSpecialNameId() != other.getSpecialNameId()) return false;
            if (getAttackTargetId() != other.getAttackTargetId()) return false;
            if (hasMonsterRoute() != other.hasMonsterRoute()) return false;
            if (hasMonsterRoute()) {
                if (!getMonsterRoute().equals(other.getMonsterRoute())) return false;
            }
            if (getAiConfigId() != other.getAiConfigId()) return false;
            if (getLevelRouteId() != other.getLevelRouteId()) return false;
            if (getInitPoseId() != other.getInitPoseId()) return false;
            if (getIsLight() != other.getIsLight()) return false;
            if (getKillNum() != other.getKillNum()) return false;
            if (!getContentCase().equals(other.getContentCase())) return false;
            switch (contentCase_) {
                case 50:
                    if (!getFishInfo().equals(other.getFishInfo())) return false;
                    break;
                case 51:
                    if (!getFishtankFishInfo().equals(other.getFishtankFishInfo())) return false;
                    break;
                case 0:
                default:
            }
        ...
        public int hashCode() {
            ...
            hash = (53 * hash) + com.google.protobuf.Internal.hashBoolean(getIsElite());
            ...
            hash = (53 * hash) + com.google.protobuf.Internal.hashBoolean(getIsLight());
        ...
        public static emu.grasscutter.net.proto.SceneMonsterInfoOuterClass.SceneMonsterInfo
        ...
        public static Builder newBuilder(
                emu.grasscutter.net.proto.SceneMonsterInfoOuterClass.SceneMonsterInfo prototype) {
        ...
        public static final class Builder
            ...
            @java.lang.Override
            public emu.grasscutter.net.proto.SceneMonsterInfoOuterClass.SceneMonsterInfo
            ...
            public emu.grasscutter.net.proto.SceneMonsterInfoOuterClass.SceneMonsterInfo build() {
                emu.grasscutter.net.proto.SceneMonsterInfoOuterClass.SceneMonsterInfo result =
                        buildPartial();
            ...
            public emu.grasscutter.net.proto.SceneMonsterInfoOuterClass.SceneMonsterInfo buildPartial() {
                emu.grasscutter.net.proto.SceneMonsterInfoOuterClass.SceneMonsterInfo result =
                        new emu.grasscutter.net.proto.SceneMonsterInfoOuterClass.SceneMonsterInfo(this);
            ...
            public Builder mergeFrom(com.google.protobuf.Message other) {
                if (other
                        instanceof emu.grasscutter.net.proto.SceneMonsterInfoOuterClass.SceneMonsterInfo) {
                    return mergeFrom(
                            (emu.grasscutter.net.proto.SceneMonsterInfoOuterClass.SceneMonsterInfo) other);
                } else {
            ...
            private void ensureWeaponListIsMutable() {
                if (!((bitField0_ & 0x00000001) != 0)) {
                    weaponList_ =
                            new java.util.ArrayList<
                                    emu.grasscutter.net.proto.SceneWeaponInfoOuterClass.SceneWeaponInfo>(weaponList_);
            ...
            private com.google.protobuf.RepeatedFieldBuilderV3<
                            emu.grasscutter.net.proto.SceneWeaponInfoOuterClass.SceneWeaponInfo,
                            emu.grasscutter.net.proto.SceneWeaponInfoOuterClass.SceneWeaponInfo.Builder,
                            emu.grasscutter.net.proto.SceneWeaponInfoOuterClass.SceneWeaponInfoOrBuilder>
                    weaponListBuilder_;
            ...
            public Builder addWeaponList(
                    emu.grasscutter.net.proto.SceneWeaponInfoOuterClass.SceneWeaponInfo value) {
                if (weaponListBuilder_ == null) {
                    if (value == null) {
                        throw new NullPointerException();
                    }
            ...
            public Builder addAllWeaponList(
                    java.lang.Iterable<
                                    ? extends emu.grasscutter.net.proto.SceneWeaponInfoOuterClass.SceneWeaponInfo>
                            values) {
                if (weaponListBuilder_ == null) {
                    ensureWeaponListIsMutable();
                    com.google.protobuf.AbstractMessageLite.Builder.addAll(values, weaponList_);
                    onChanged();
                } else {
            ...
            /** <code>repeated .SceneWeaponInfo weapon_list = 4;</code> */
            public emu.grasscutter.net.proto.SceneWeaponInfoOuterClass.SceneWeaponInfo.Builder
                    getWeaponListBuilder(int index) {
            ...
            /** <code>repeated .SceneWeaponInfo weapon_list = 4;</code> */
            public emu.grasscutter.net.proto.SceneWeaponInfoOuterClass.SceneWeaponInfo.Builder
                    addWeaponListBuilder() {
                return getWeaponListFieldBuilder()
                        .addBuilder(
                                emu.grasscutter.net.proto.SceneWeaponInfoOuterClass.SceneWeaponInfo
                                        .getDefaultInstance());
            }
            /** <code>repeated .SceneWeaponInfo weapon_list = 4;</code> */
            public emu.grasscutter.net.proto.SceneWeaponInfoOuterClass.SceneWeaponInfo.Builder
                    addWeaponListBuilder(int index) {
                return getWeaponListFieldBuilder()
                        .addBuilder(
                                index,
                                emu.grasscutter.net.proto.SceneWeaponInfoOuterClass.SceneWeaponInfo
                ...
                if (weaponListBuilder_ == null) {
                    weaponListBuilder_ =
                            new com.google.protobuf.RepeatedFieldBuilderV3<
                                    ...
                                    emu.grasscutter.net.proto.SceneWeaponInfoOuterClass.SceneWeaponInfo.Builder,
                                    emu.grasscutter.net.proto.SceneWeaponInfoOuterClass.SceneWeaponInfoOrBuilder>(
                                    weaponList_, ((bitField0_ & 0x00000001) != 0), getParentForChildren(), isClean());
                    weaponList_ = null;
                }
            ...
            public java.util.List<java.lang.Integer> getAffixListList() {
                return ((bitField0_ & 0x00000002) != 0)
                        ? java.util.Collections.unmodifiableList(affixList_)
                        : affixList_;
            }
            /**
             * <code>repeated uint32 affix_list = 6;</code>
             ...
             * @return This builder for chaining.
             */
            public Builder addAllAffixList(java.lang.Iterable<? extends java.lang.Integer> values) {
                ensureAffixListIsMutable();
                com.google.protobuf.AbstractMessageLite.Builder.addAll(values, affixList_);
                onChanged();
                return this;
            }
            /**
            ...
            private com.google.protobuf.MapField<java.lang.Integer, java.lang.Integer>
                ...
                if (summonTagMap_ == null) {
                    summonTagMap_ =
                            com.google.protobuf.MapField.newMapField(SummonTagMapDefaultEntryHolder.defaultEntry);
                }
            ...
            public Builder removeSummonTagMap(int key) {
                ...
                internalGetMutableSummonTagMap().getMutableMap().remove(key);
                return this;
            }
            /** Use alternate mutation accessors instead. */
            @java.lang.Deprecated
            public java.util.Map<java.lang.Integer, java.lang.Integer> getMutableSummonTagMap() {
                return internalGetMutableSummonTagMap().getMutableMap();
            }
            /** <code>map&lt;uint32, uint32&gt; summon_tag_map = 10;</code> */
            public Builder putSummonTagMap(int key, int value) {

                internalGetMutableSummonTagMap().getMutableMap().put(key, value);
                return this;
            }
            /** <code>map&lt;uint32, uint32&gt; summon_tag_map = 10;</code> */
            ...
            public Builder setBornType(
                    emu.grasscutter.net.proto.MonsterBornTypeOuterClass.MonsterBornType value) {
                if (value == null) {
                    throw new NullPointerException();
                }
            ...
            private com.google.protobuf.SingleFieldBuilderV3<
                            emu.grasscutter.net.proto.MonsterRouteOuterClass.MonsterRoute,
                            emu.grasscutter.net.proto.MonsterRouteOuterClass.MonsterRoute.Builder,
                            emu.grasscutter.net.proto.MonsterRouteOuterClass.MonsterRouteOrBuilder>
                    monsterRouteBuilder_;
            /**
             * <code>.MonsterRoute monster_route = 18;</code>
             *
             * @return Whether the monsterRoute field is set.
            ...
            public Builder setMonsterRoute(
                    emu.grasscutter.net.proto.MonsterRouteOuterClass.MonsterRoute value) {
                if (monsterRouteBuilder_ == null) {
                    if (value == null) {
                        throw new NullPointerException();
                    }
            ...
            /** <code>.MonsterRoute monster_route = 18;</code> */
            public Builder mergeMonsterRoute(
                    emu.grasscutter.net.proto.MonsterRouteOuterClass.MonsterRoute value) {
                if (monsterRouteBuilder_ == null) {
                    if (monsterRoute_ != null) {
                        monsterRoute_ =
                                emu.grasscutter.net.proto.MonsterRouteOuterClass.MonsterRoute.newBuilder(
                                                monsterRoute_)
                                        .mergeFrom(value)
                                        .buildPartial();
                    } else {
            ...
            /** <code>.MonsterRoute monster_route = 18;</code> */
            public emu.grasscutter.net.proto.MonsterRouteOuterClass.MonsterRoute.Builder
                    getMonsterRouteBuilder() {
                ...
                if (monsterRouteBuilder_ == null) {
                    monsterRouteBuilder_ =
                            new com.google.protobuf.SingleFieldBuilderV3<
                                    ...
                                    emu.grasscutter.net.proto.MonsterRouteOuterClass.MonsterRoute.Builder,
                                    emu.grasscutter.net.proto.MonsterRouteOuterClass.MonsterRouteOrBuilder>(
                                    getMonsterRoute(), getParentForChildren(), isClean());
                    monsterRoute_ = null;
                }
            ...
            private com.google.protobuf.SingleFieldBuilderV3<
                            emu.grasscutter.net.proto.SceneFishInfoOuterClass.SceneFishInfo,
                            emu.grasscutter.net.proto.SceneFishInfoOuterClass.SceneFishInfo.Builder,
            ...
            public emu.grasscutter.net.proto.SceneFishInfoOuterClass.SceneFishInfo getFishInfo() {
                if (fishInfoBuilder_ == null) {
                    ...
                    return emu.grasscutter.net.proto.SceneFishInfoOuterClass.SceneFishInfo
                            .getDefaultInstance();
                } else {
                    if (contentCase_ == 50) {
            ...
            public Builder setFishInfo(
                    emu.grasscutter.net.proto.SceneFishInfoOuterClass.SceneFishInfo value) {
                if (fishInfoBuilder_ == null) {
                    if (value == null) {
                        throw new NullPointerException();
                    }
                    ...
                    if (contentCase_ == 50
                            && content_
                                    != emu.grasscutter.net.proto.SceneFishInfoOuterClass.SceneFishInfo
                                            .getDefaultInstance()) {
                        content_ =
                                emu.grasscutter.net.proto.SceneFishInfoOuterClass.SceneFishInfo.newBuilder(
                                                (emu.grasscutter.net.proto.SceneFishInfoOuterClass.SceneFishInfo) content_)
                                        .mergeFrom(value)
                                        .buildPartial();
                    } else {
            ...
            /** <code>.SceneFishInfo fish_info = 50;</code> */
            public emu.grasscutter.net.proto.SceneFishInfoOuterClass.SceneFishInfo.Builder
                    getFishInfoBuilder() {
            ...
            public Builder setFishtankFishInfo(
                    emu.grasscutter.net.proto.FishtankFishInfoOuterClass.FishtankFishInfo value) {
                if (fishtankFishInfoBuilder_ == null) {
                    if (value == null) {
                        throw new NullPointerException();
                    }
            ...
            /** <code>.FishtankFishInfo fishtank_fish_info = 51;</code> */
            public Builder mergeFishtankFishInfo(
                    emu.grasscutter.net.proto.FishtankFishInfoOuterClass.FishtankFishInfo value) {
                if (fishtankFishInfoBuilder_ == null) {
                    if (contentCase_ == 51
                            && content_
                                    != emu.grasscutter.net.proto.FishtankFishInfoOuterClass.FishtankFishInfo
                                            .getDefaultInstance()) {
                        content_ =
                                emu.grasscutter.net.proto.FishtankFishInfoOuterClass.FishtankFishInfo.newBuilder(
                                                (emu.grasscutter.net.proto.FishtankFishInfoOuterClass.FishtankFishInfo)
                                                        content_)
                                        .mergeFrom(value)
                                        .buildPartial();
            ...
            /** <code>.FishtankFishInfo fishtank_fish_info = 51;</code> */
            public emu.grasscutter.net.proto.FishtankFishInfoOuterClass.FishtankFishInfo.Builder
        ...
        private static final emu.grasscutter.net.proto.SceneMonsterInfoOuterClass.SceneMonsterInfo
                DEFAULT_INSTANCE;

        static {
            DEFAULT_INSTANCE =
                    new emu.grasscutter.net.proto.SceneMonsterInfoOuterClass.SceneMonsterInfo();
        }
        ...
        private static final com.google.protobuf.Parser<SceneMonsterInfo> PARSER =
                new com.google.protobuf.AbstractParser<SceneMonsterInfo>() {
                    @java.lang.Override
