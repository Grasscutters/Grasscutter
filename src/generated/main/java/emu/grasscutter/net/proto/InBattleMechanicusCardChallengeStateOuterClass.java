...
public final class InBattleMechanicusCardChallengeStateOuterClass {
    ...
    public enum InBattleMechanicusCardChallengeState
        ...
        public static InBattleMechanicusCardChallengeState forNumber(int value) {
            switch (value) {
                case 0:
                    return IN_BATTLE_MECHANICUS_CARD_CHALLENGE_NONE;
                case 1:
                    return IN_BATTLE_MECHANICUS_CARD_CHALLENGE_ON_GOING;
                case 2:
                    return IN_BATTLE_MECHANICUS_CARD_CHALLENGE_FAIL;
                case 3:
                    return IN_BATTLE_MECHANICUS_CARD_CHALLENGE_SUCCESS;
                default:
                    return null;
            }
        }
        ...
        public static final com.google.protobuf.Descriptors.EnumDescriptor getDescriptor() {
            return emu.grasscutter.net.proto.InBattleMechanicusCardChallengeStateOuterClass
                    .getDescriptor()
                    .getEnumTypes()
                    .get(0);
        }
