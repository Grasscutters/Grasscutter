...
public final class GachaInfoOuterClass {
    ...
    public static final class GachaInfo extends com.google.protobuf.GeneratedMessageV3
        ...
        public int getSerializedSize() {
            ...
            if (endTime_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(3, endTime_);
            }
            if (gachaTimesLimit_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(4, gachaTimesLimit_);
            }
            if (!com.google.protobuf.GeneratedMessageV3.isStringEmpty(gachaPrefabPath_)) {
                size += com.google.protobuf.GeneratedMessageV3.computeStringSize(5, gachaPrefabPath_);
            }
            if (beginTime_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(6, beginTime_);
            }
            if (costItemNum_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(7, costItemNum_);
            }
            if (!com.google.protobuf.GeneratedMessageV3.isStringEmpty(gachaProbUrl_)) {
                size += com.google.protobuf.GeneratedMessageV3.computeStringSize(8, gachaProbUrl_);
            }
            if (wishItemId_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(9, wishItemId_);
            }
            if (leftGachaTimes_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(10, leftGachaTimes_);
            }
            if (gachaSortId_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(11, gachaSortId_);
            }
            if (!com.google.protobuf.GeneratedMessageV3.isStringEmpty(gachaPreviewPrefabPath_)) {
                size +=
                        com.google.protobuf.GeneratedMessageV3.computeStringSize(12, gachaPreviewPrefabPath_);
            }
            if (tenCostItemNum_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(13, tenCostItemNum_);
            }
            if (costItemId_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(14, costItemId_);
            }
            if (gachaType_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(15, gachaType_);
            }
            if (!com.google.protobuf.GeneratedMessageV3.isStringEmpty(titleTextmap_)) {
            ...
            if (wishMaxProgress_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(911, wishMaxProgress_);
            }
            if (!com.google.protobuf.GeneratedMessageV3.isStringEmpty(gachaProbUrlOversea_)) {
                size +=
                        com.google.protobuf.GeneratedMessageV3.computeStringSize(1128, gachaProbUrlOversea_);
            }
            if (curScheduleDailyGachaTimes_ != 0) {
                size +=
                        com.google.protobuf.CodedOutputStream.computeUInt32Size(
                                1245, curScheduleDailyGachaTimes_);
            }
            if (tenCostItemId_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(1298, tenCostItemId_);
            }
            {
                int dataSize = 0;
                for (int i = 0; i < displayUp5ItemList_.size(); i++) {
            ...
            if (isNewWish_ != false) {
                size += com.google.protobuf.CodedOutputStream.computeBoolSize(1693, isNewWish_);
            }
            if (!com.google.protobuf.GeneratedMessageV3.isStringEmpty(gachaRecordUrlOversea_)) {
                size +=
                        com.google.protobuf.GeneratedMessageV3.computeStringSize(1718, gachaRecordUrlOversea_);
            }
            if (wishProgress_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(1755, wishProgress_);
            }
            for (int i = 0; i < gachaUpInfoList_.size(); i++) {
                size +=
                        com.google.protobuf.CodedOutputStream.computeMessageSize(1953, gachaUpInfoList_.get(i));
            }
