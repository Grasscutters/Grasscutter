...
public final class HomeMarkPointFurnitureDataOuterClass {
    ...
    public interface HomeMarkPointFurnitureDataOrBuilder
            extends
         ...
         */
        emu.grasscutter.net.proto.HomeMarkPointSuiteDataOuterClass.HomeMarkPointSuiteData
                getSuiteData();
        /** <code>.HomeMarkPointSuiteData suite_data = 7;</code> */
        emu.grasscutter.net.proto.HomeMarkPointSuiteDataOuterClass.HomeMarkPointSuiteDataOrBuilder
                getSuiteDataOrBuilder();
     ...
     */
    public static final class HomeMarkPointFurnitureData
            ...
            try {
                ...
                while (!done) {
                    ...
                    switch (tag) {
                        ...
                        case 50:
                            {
                                emu.grasscutter.net.proto.HomeMarkPointNPCDataOuterClass.HomeMarkPointNPCData
                                                .Builder
                                        subBuilder = null;
                                if (extraCase_ == 6) {
                                    subBuilder =
                                            ((emu.grasscutter.net.proto.HomeMarkPointNPCDataOuterClass
        ...
        public static final com.google.protobuf.Descriptors.Descriptor getDescriptor() {
            return emu.grasscutter.net.proto.HomeMarkPointFurnitureDataOuterClass
            ...
            return emu.grasscutter.net.proto.HomeMarkPointFurnitureDataOuterClass
                    ...
                    .ensureFieldAccessorsInitialized(
                            emu.grasscutter.net.proto.HomeMarkPointFurnitureDataOuterClass
                                    .HomeMarkPointFurnitureData.class,
                            emu.grasscutter.net.proto.HomeMarkPointFurnitureDataOuterClass
                                    .HomeMarkPointFurnitureData.Builder.class);
        }
        ...
        public ExtraCase getExtraCase() {
            return ExtraCase.forNumber(extraCase_);
        }
         ...
         */
        @java.lang.Override
        public emu.grasscutter.net.proto.HomeMarkPointNPCDataOuterClass.HomeMarkPointNPCData
                getNpcData() {
            if (extraCase_ == 6) {
                return (emu.grasscutter.net.proto.HomeMarkPointNPCDataOuterClass.HomeMarkPointNPCData)
                        extra_;
            }
            return emu.grasscutter.net.proto.HomeMarkPointNPCDataOuterClass.HomeMarkPointNPCData
                    .getDefaultInstance();
        ...
        /** <code>.HomeMarkPointNPCData npc_data = 6;</code> */
        @java.lang.Override
        public emu.grasscutter.net.proto.HomeMarkPointNPCDataOuterClass.HomeMarkPointNPCDataOrBuilder
                getNpcDataOrBuilder() {
            if (extraCase_ == 6) {
                return (emu.grasscutter.net.proto.HomeMarkPointNPCDataOuterClass.HomeMarkPointNPCData)
                        extra_;
         ...
         */
        @java.lang.Override
        public emu.grasscutter.net.proto.HomeMarkPointSuiteDataOuterClass.HomeMarkPointSuiteData
                getSuiteData() {
            if (extraCase_ == 7) {
                return (emu.grasscutter.net.proto.HomeMarkPointSuiteDataOuterClass.HomeMarkPointSuiteData)
                        extra_;
            }
            return emu.grasscutter.net.proto.HomeMarkPointSuiteDataOuterClass.HomeMarkPointSuiteData
                    .getDefaultInstance();
        ...
        /** <code>.HomeMarkPointSuiteData suite_data = 7;</code> */
        @java.lang.Override
        public emu.grasscutter.net.proto.HomeMarkPointSuiteDataOuterClass
        ...
        public int getSerializedSize() {
            ...
            if (furnitureId_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(2, furnitureId_);
            }
            if (furnitureType_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(3, furnitureType_);
            }
            if (pos_ != null) {
        ...
        public boolean equals(final java.lang.Object obj) {
            ...
            if (getFurnitureType() != other.getFurnitureType()) return false;
            ...
            switch (extraCase_) {
                case 6:
                    if (!getNpcData().equals(other.getNpcData())) return false;
                    break;
                case 7:
                    if (!getSuiteData().equals(other.getSuiteData())) return false;
                    break;
                case 0:
                default:
            }
        ...
        public static emu.grasscutter.net.proto.HomeMarkPointFurnitureDataOuterClass
                        .HomeMarkPointFurnitureData
        ...
        public static final class Builder
            ...
            // Construct using
            // emu.grasscutter.net.proto.HomeMarkPointFurnitureDataOuterClass.HomeMarkPointFurnitureData.newBuilder()
            private Builder() {
            ...
            public emu.grasscutter.net.proto.HomeMarkPointFurnitureDataOuterClass
                ...
                emu.grasscutter.net.proto.HomeMarkPointFurnitureDataOuterClass.HomeMarkPointFurnitureData
                        result =
                                new emu.grasscutter.net.proto.HomeMarkPointFurnitureDataOuterClass
                                        .HomeMarkPointFurnitureData(this);
                result.guid_ = guid_;
            ...
            public Builder mergeFrom(
                ...
                if (other
                        == emu.grasscutter.net.proto.HomeMarkPointFurnitureDataOuterClass
                                .HomeMarkPointFurnitureData.getDefaultInstance()) return this;
                if (other.getGuid() != 0) {
            ...
            private com.google.protobuf.SingleFieldBuilderV3<
                            emu.grasscutter.net.proto.HomeMarkPointNPCDataOuterClass.HomeMarkPointNPCData,
                            emu.grasscutter.net.proto.HomeMarkPointNPCDataOuterClass.HomeMarkPointNPCData.Builder,
                            emu.grasscutter.net.proto.HomeMarkPointNPCDataOuterClass
            ...
            public Builder setNpcData(
                    emu.grasscutter.net.proto.HomeMarkPointNPCDataOuterClass.HomeMarkPointNPCData value) {
                if (npcDataBuilder_ == null) {
                    if (value == null) {
                        throw new NullPointerException();
                    }
            ...
            /** <code>.HomeMarkPointNPCData npc_data = 6;</code> */
            public emu.grasscutter.net.proto.HomeMarkPointNPCDataOuterClass.HomeMarkPointNPCData.Builder
                    getNpcDataBuilder() {
            ...
            public emu.grasscutter.net.proto.HomeMarkPointSuiteDataOuterClass.HomeMarkPointSuiteData
                ...
                if (suiteDataBuilder_ == null) {
                    if (extraCase_ == 7) {
                        return (emu.grasscutter.net.proto.HomeMarkPointSuiteDataOuterClass
                                        .HomeMarkPointSuiteData)
                                extra_;
                    }
                    return emu.grasscutter.net.proto.HomeMarkPointSuiteDataOuterClass.HomeMarkPointSuiteData
            ...
            public Builder setSuiteData(
                    emu.grasscutter.net.proto.HomeMarkPointSuiteDataOuterClass.HomeMarkPointSuiteData value) {
                if (suiteDataBuilder_ == null) {
                    if (value == null) {
                        throw new NullPointerException();
                    }
            ...
            /** <code>.HomeMarkPointSuiteData suite_data = 7;</code> */
            public Builder setSuiteData(
                    emu.grasscutter.net.proto.HomeMarkPointSuiteDataOuterClass.HomeMarkPointSuiteData.Builder
                            builderForValue) {
                if (suiteDataBuilder_ == null) {
                    extra_ = builderForValue.build();
                    onChanged();
            ...
            /** <code>.HomeMarkPointSuiteData suite_data = 7;</code> */
            public Builder mergeSuiteData(
                    emu.grasscutter.net.proto.HomeMarkPointSuiteDataOuterClass.HomeMarkPointSuiteData value) {
                if (suiteDataBuilder_ == null) {
                    if (extraCase_ == 7
                            && extra_
                                    != emu.grasscutter.net.proto.HomeMarkPointSuiteDataOuterClass
                                            .HomeMarkPointSuiteData.getDefaultInstance()) {
                        extra_ =
                                emu.grasscutter.net.proto.HomeMarkPointSuiteDataOuterClass.HomeMarkPointSuiteData
                                        .newBuilder(
                                                (emu.grasscutter.net.proto.HomeMarkPointSuiteDataOuterClass
        ...
        private static final emu.grasscutter.net.proto.HomeMarkPointFurnitureDataOuterClass
                        .HomeMarkPointFurnitureData
                DEFAULT_INSTANCE;
        ...
        private static final com.google.protobuf.Parser<HomeMarkPointFurnitureData> PARSER =
                new com.google.protobuf.AbstractParser<HomeMarkPointFurnitureData>() {
                    @java.lang.Override
