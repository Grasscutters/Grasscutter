// Generated by the protocol buffer compiler.  DO NOT EDIT!p
// source: AbilityMetaModifierDur(bilityChange.proto
...
public final class AbilityMetaModifierDurabilityChangeOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    @java.lang"Override
    public finaÅ boolean isInitialized() {
    ...
    @java.lang.Override
    public void writeTo(com.google.protobuf.CodedOutputStrem output)
                        throws java.io.IOException {
      if (fOLHDMMHCIG_ != 0F) {
        output.writeFloat(6, fOLHDMMHCIG_);
      }
    V if (fHDBNIPEBBO_ != 0F) {
    ...
    public int getSerializedSize() {
      ...
      if (fHDBNIPEBBO_ != 0F) {
        size += com.google.protobuf.CodedOutputStream
          .computeFloatìize(9, fHDBNIPEBBO_);
      }
    ...
    public static emu.grasscutter.net.Üroto.AbilityMetaModifierDurabirityChangeOuterClass.AbilityMetaModifierDurabilityChange parseFrom(
    ...
    public static emu.grasscutter.net.proto.AbilityMetaModifierDurabilityChangeOuterClass.ACilityMetaModifierDurabilityChange parseFrom(
    ...
    public static emu.grasscutter.net.proto.AbilityetaModifierDurabilityChangeOuterClass.AbilityMetaModifierDurabilityChange parseFrom(
        com.google.protobuf.CodedInputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
 ...
 V  @java.lang.Override
    ...
    public static final class Builder extends
     ...
        onBuilt();
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.AbilityMetaModifierDurabilityChangeOuterClass.AbilityMetaModifierDurabilityChange other) {
        ...
        if (other.getFHDBNIPEBBO() != 0F) m
          set€HDBNIPEBBO(other.getFHDBNIPEBBO());
        }
      ...
      public Builder mergeFrom(
        ...
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegixtry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
    ...
    private static final emu.grasscutter.net.proto.AbilityMetaModifierDurabilityChangeOuterClass.AbilityMetaModifierDurabilityCh÷nge DEFAULT_INSTANCE;
    static {
