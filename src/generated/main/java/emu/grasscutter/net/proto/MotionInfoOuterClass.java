...
public final class MotionInfoOuterClass {
    ...
    public interface MotionInfoOrBuilder
            extends
        ...
        java.util.List<emu.grasscutter.net.proto.VectorOuterClass.Vector> getParamsList();
        /** <code>repeated .Vector params = 5;</code> */
        ...
        /** <code>repeated .Vector params = 5;</code> */
        emu.grasscutter.net.proto.VectorOuterClass.VectorOrBuilder getParamsOrBuilder(int index);
     ...
     */
    public static final class MotionInfo extends com.google.protobuf.GeneratedMessageV3
            implements
        ...
        protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
            ...
            return emu.grasscutter.net.proto.MotionInfoOuterClass
                    .internal_static_MotionInfo_fieldAccessorTable
                    .ensureFieldAccessorsInitialized(
                            emu.grasscutter.net.proto.MotionInfoOuterClass.MotionInfo.class,
                            emu.grasscutter.net.proto.MotionInfoOuterClass.MotionInfo.Builder.class);
        }
        ...
        public emu.grasscutter.net.proto.MotionStateOuterClass.MotionState getState() {
            ...
            emu.grasscutter.net.proto.MotionStateOuterClass.MotionState result =
                    emu.grasscutter.net.proto.MotionStateOuterClass.MotionState.valueOf(state_);
            return result == null
                    ? emu.grasscutter.net.proto.MotionStateOuterClass.MotionState.UNRECOGNIZED
                    : result;
        }
        ...
        public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
            ...
            if (state_
                    != emu.grasscutter.net.proto.MotionStateOuterClass.MotionState.MOTION_STATE_NONE
                            .getNumber()) {
        ...
        public int getSerializedSize() {
            ...
            if (rot_ != null) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(2, getRot());
            }
            if (speed_ != null) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(3, getSpeed());
            }
            if (state_
                    != emu.grasscutter.net.proto.MotionStateOuterClass.MotionState.MOTION_STATE_NONE
                            .getNumber()) {
            ...
            for (int i = 0; i < params_.size(); i++) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(5, params_.get(i));
            }
            if (refPos_ != null) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(6, getRefPos());
            }
            if (refId_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(7, refId_);
            }
            if (sceneTime_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(8, sceneTime_);
            }
            if (intervalVelocity_ != 0L) {
                size += com.google.protobuf.CodedOutputStream.computeUInt64Size(9, intervalVelocity_);
            }
        ...
        public boolean equals(final java.lang.Object obj) {
            ...
            emu.grasscutter.net.proto.MotionInfoOuterClass.MotionInfo other =
                    (emu.grasscutter.net.proto.MotionInfoOuterClass.MotionInfo) obj;
            ...
            if (hasRefPos()) {
                if (!getRefPos().equals(other.getRefPos())) return false;
            }
            if (getRefId() != other.getRefId()) return false;
            if (getSceneTime() != other.getSceneTime()) return false;
            if (getIntervalVelocity() != other.getIntervalVelocity()) return false;
        ...
        public int hashCode() {
            ...
            hash = (53 * hash) + com.google.protobuf.Internal.hashLong(getIntervalVelocity());
        ...
        public static Builder newBuilder(
                emu.grasscutter.net.proto.MotionInfoOuterClass.MotionInfo prototype) {
        ...
        public static final class Builder
            ...
            public emu.grasscutter.net.proto.MotionInfoOuterClass.MotionInfo buildPartial() {
                emu.grasscutter.net.proto.MotionInfoOuterClass.MotionInfo result =
                        new emu.grasscutter.net.proto.MotionInfoOuterClass.MotionInfo(this);
            ...
            public Builder mergeFrom(emu.grasscutter.net.proto.MotionInfoOuterClass.MotionInfo other) {
                if (other == emu.grasscutter.net.proto.MotionInfoOuterClass.MotionInfo.getDefaultInstance())
                    return this;
                if (other.hasPos()) {
            ...
            public Builder mergeFrom(
                ...
                try {
                    ...
                    parsedMessage =
                            (emu.grasscutter.net.proto.MotionInfoOuterClass.MotionInfo) e.getUnfinishedMessage();
            ...
            public Builder mergeSpeed(emu.grasscutter.net.proto.VectorOuterClass.Vector value) {
                if (speedBuilder_ == null) {
                    if (speed_ != null) {
                        speed_ =
                                emu.grasscutter.net.proto.VectorOuterClass.Vector.newBuilder(speed_)
                                        .mergeFrom(value)
                                        .buildPartial();
                    } else {
                        speed_ = value;
            ...
            private void ensureParamsIsMutable() {
                if (!((bitField0_ & 0x00000001) != 0)) {
                    params_ =
                            new java.util.ArrayList<emu.grasscutter.net.proto.VectorOuterClass.Vector>(params_);
            ...
            /** <code>repeated .Vector params = 5;</code> */
            public Builder setParams(int index, emu.grasscutter.net.proto.VectorOuterClass.Vector value) {
                if (paramsBuilder_ == null) {
                    if (value == null) {
                        throw new NullPointerException();
                    }
            ...
            /** <code>repeated .Vector params = 5;</code> */
            public Builder addParams(int index, emu.grasscutter.net.proto.VectorOuterClass.Vector value) {
                if (paramsBuilder_ == null) {
                    if (value == null) {
                        throw new NullPointerException();
                    }
            ...
            /** <code>repeated .Vector params = 5;</code> */
            public emu.grasscutter.net.proto.VectorOuterClass.Vector.Builder getParamsBuilder(int index) {
            ...
            /** <code>repeated .Vector params = 5;</code> */
            public emu.grasscutter.net.proto.VectorOuterClass.Vector.Builder addParamsBuilder(int index) {
                return getParamsFieldBuilder()
                        .addBuilder(
            ...
            public Builder mergeRefPos(emu.grasscutter.net.proto.VectorOuterClass.Vector value) {
                if (refPosBuilder_ == null) {
                    if (refPos_ != null) {
                        refPos_ =
                                emu.grasscutter.net.proto.VectorOuterClass.Vector.newBuilder(refPos_)
                                        .mergeFrom(value)
                                        .buildPartial();
                    } else {
                        refPos_ = value;
                ...
                if (refPosBuilder_ == null) {
                    refPosBuilder_ =
                            new com.google.protobuf.SingleFieldBuilderV3<
                                    ...
                                    emu.grasscutter.net.proto.VectorOuterClass.Vector.Builder,
                                    emu.grasscutter.net.proto.VectorOuterClass.VectorOrBuilder>(
                                    getRefPos(), getParentForChildren(), isClean());
                    refPos_ = null;
                }
        ...
        private static final com.google.protobuf.Parser<MotionInfo> PARSER =
