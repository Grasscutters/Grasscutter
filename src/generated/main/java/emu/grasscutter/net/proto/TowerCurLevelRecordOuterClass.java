...
public final class TowerCurLevelRecordOuterClass {
    ...
    public interface TowerCurLevelRecordOrBuilder
        ...
        /**
         * <code>bool is_upper_part = 1;</code>
         *
         ...
         * </pre>
         *
         * <code>uint32 cur_floor_id = 5;</code>
         *
    ...
    public static final class TowerCurLevelRecord extends com.google.protobuf.GeneratedMessageV3
        ...
        public static final int IS_UPPER_PART_FIELD_NUMBER = 1;
        ...
        public static final int CUR_FLOOR_ID_FIELD_NUMBER = 5;
        ...
        public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
            ...
            if (curFloorId_ != 0) {
                output.writeUInt32(5, curFloorId_);
            }
            if (curLevelIndex_ != 0) {
        ...
        public int getSerializedSize() {
            ...
            size = 0;
            if (isUpperPart_ != false) {
                size += com.google.protobuf.CodedOutputStream.computeBoolSize(1, isUpperPart_);
            }
            if (curFloorId_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(5, curFloorId_);
            }
            if (curLevelIndex_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(6, curLevelIndex_);
            }
            if (isEmpty_ != false) {
                size += com.google.protobuf.CodedOutputStream.computeBoolSize(12, isEmpty_);
            }
            {
                int dataSize = 0;
                for (int i = 0; i < buffIdList_.size(); i++) {
            ...
            for (int i = 0; i < towerTeamList_.size(); i++) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(14, towerTeamList_.get(i));
            }
    ...
    static {
        java.lang.String[] descriptorData = {
            "\n\031TowerCurLevelRecord.proto\032\017TowerTeam.p"
                    ...
                    + "st\030\r \003(\r\022\024\n\014cur_floor_id\030\005 \001(\r\022\027\n\017cur_le"
                    + "vel_index\030\006 \001(\rB!\n\031emu.grasscutter.net.p"
