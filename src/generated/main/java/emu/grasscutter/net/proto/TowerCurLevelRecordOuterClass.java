...
public final class TowerCurLevelRecordOuterClass {
    ...
    public static final class TowerCurLevelRecord extends com.google.protobuf.GeneratedMessageV3
        ...
        public int getSerializedSize() {
            ...
            size = 0;
            if (isEmpty_ != false) {
                size += com.google.protobuf.CodedOutputStream.computeBoolSize(1, isEmpty_);
            }
            if (curFloorId_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(2, curFloorId_);
            }
            {
                int dataSize = 0;
                for (int i = 0; i < buffIdList_.size(); i++) {
            ...
            if (isUpperPart_ != false) {
                size += com.google.protobuf.CodedOutputStream.computeBoolSize(6, isUpperPart_);
            }
            for (int i = 0; i < towerTeamList_.size(); i++) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(11, towerTeamList_.get(i));
            }
            if (curLevelIndex_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(15, curLevelIndex_);
            }
