...
public final class AbilityInvokeEntryOuterClass {
    ...
    public static final class AbilityInvokeEntry extends com.google.protobuf.GeneratedMessageV3
        ...
        public int getSerializedSize() {
            ...
            if (!abilityData_.isEmpty()) {
                size += com.google.protobuf.CodedOutputStream.computeBytesSize(3, abilityData_);
            }
            if (forwardType_
                    != emu.grasscutter.net.proto.ForwardTypeOuterClass.ForwardType.FORWARD_TYPE_LOCAL
                            .getNumber()) {
            ...
            if (isIgnoreAuth_ != false) {
                size += com.google.protobuf.CodedOutputStream.computeBoolSize(5, isIgnoreAuth_);
            }
            if (argumentType_
                    != emu.grasscutter.net.proto.AbilityInvokeArgumentOuterClass.AbilityInvokeArgument
                            .ABILITY_INVOKE_ARGUMENT_NONE
            ...
            if (eventId_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(7, eventId_);
            }
            if (totalTickTime_ != 0D) {
                size += com.google.protobuf.CodedOutputStream.computeDoubleSize(9, totalTickTime_);
            }
            if (entityId_ != 0) {
