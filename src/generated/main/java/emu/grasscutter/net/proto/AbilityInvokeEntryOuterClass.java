...
public final class AbilityInvokeEntryOuterClass {
    ...
    public static final class AbilityInvokeEntry extends com.google.protobuf.GeneratedMessageV3
        ...
        public int getSerializedSize() {
            ...
            size = 0;
            if (forwardPeer_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(1, forwardPeer_);
            }
            if (eventId_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(2, eventId_);
            }
            if (isIgnoreAuth_ != false) {
                size += com.google.protobuf.CodedOutputStream.computeBoolSize(4, isIgnoreAuth_);
            }
            if (!abilityData_.isEmpty()) {
                size += com.google.protobuf.CodedOutputStream.computeBytesSize(6, abilityData_);
            }
            if (entityId_ != 0) {
            ...
            if (argumentType_
                    != emu.grasscutter.net.proto.AbilityInvokeArgumentOuterClass.AbilityInvokeArgument
                            .ABILITY_INVOKE_ARGUMENT_NONE
                            .getNumber()) {
                size += com.google.protobuf.CodedOutputStream.computeEnumSize(12, argumentType_);
            }
            if (head_ != null) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(13, getHead());
            }
            if (forwardType_
                    != emu.grasscutter.net.proto.ForwardTypeOuterClass.ForwardType.FORWARD_TYPE_LOCAL
                            .getNumber()) {
                size += com.google.protobuf.CodedOutputStream.computeEnumSize(14, forwardType_);
            }
    ...
    static {
        java.lang.String[] descriptorData = {
            "\n\030AbilityInvokeEntry.proto\032\033AbilityInvok"
                    ...
                    + "s_ignore_auth\030\004 \001(\010B!\n\031emu.grasscutter.n"
