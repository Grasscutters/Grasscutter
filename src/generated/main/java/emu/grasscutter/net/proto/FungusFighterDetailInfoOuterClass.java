...
public final class FungusFighterDetailInfoOuterClass {
    ...
    public interface FungusFighterDetailInfoOrBuilder
        ...
        /**
         * <code>repeated .FungusTrainingProgressDetail training_dungeon_progress_detail_list = 12;
         * </code>
         */
        java.util.List<
    ...
    public static final class FungusFighterDetailInfo extends com.google.protobuf.GeneratedMessageV3
         ...
         */
        @java.lang.Override
        public java.util.List<java.lang.Integer> getLKGHAADOFLFList() {
            return lKGHAADOFLF_;
        }
        /**
         * <code>repeated uint32 LKGHAADOFLF = 1;</code>
         ...
         */
        @java.lang.Override
        public java.util.List<java.lang.Integer> getKIKFFIHPEKIList() {
            return kIKFFIHPEKI_;
        }
        /**
         * <code>repeated uint32 KIKFFIHPEKI = 6;</code>
         ...
         */
        @java.lang.Override
        public java.util.List<java.lang.Integer> getDJDBGBNHGGLList() {
            return dJDBGBNHGGL_;
        }
        /**
         * <code>repeated uint32 DJDBGBNHGGL = 9;</code>
        ...
        public int getSerializedSize() {
            ...
            size = 0;
            {
                ...
                for (int i = 0; i < lKGHAADOFLF_.size(); i++) {
                    dataSize +=
                            com.google.protobuf.CodedOutputStream.computeUInt32SizeNoTag(lKGHAADOFLF_.getInt(i));
                }
                size += dataSize;
            ...
            }
            {
                ...
                for (int i = 0; i < kIKFFIHPEKI_.size(); i++) {
                    dataSize +=
                            com.google.protobuf.CodedOutputStream.computeUInt32SizeNoTag(kIKFFIHPEKI_.getInt(i));
                }
                size += dataSize;
            ...
            }
            {
                ...
                for (int i = 0; i < dJDBGBNHGGL_.size(); i++) {
                    dataSize +=
                            com.google.protobuf.CodedOutputStream.computeUInt32SizeNoTag(dJDBGBNHGGL_.getInt(i));
                }
                size += dataSize;
            ...
            for (int i = 0; i < trainingDungeonDetailList_.size(); i++) {
                size +=
                        com.google.protobuf.CodedOutputStream.computeMessageSize(
                                10, trainingDungeonDetailList_.get(i));
            }
            for (int i = 0; i < trainingDungeonProgressDetailList_.size(); i++) {
                size +=
                        com.google.protobuf.CodedOutputStream.computeMessageSize(
                                12, trainingDungeonProgressDetailList_.get(i));
            }
            for (int i = 0; i < plotStageDetailList_.size(); i++) {
                size +=
                        com.google.protobuf.CodedOutputStream.computeMessageSize(
                                13, plotStageDetailList_.get(i));
            }
            for (int i = 0; i < fungusDetailList_.size(); i++) {
                size +=
                        com.google.protobuf.CodedOutputStream.computeMessageSize(14, fungusDetailList_.get(i));
            }
        ...
        public boolean equals(final java.lang.Object obj) {
            ...
            if (!getLKGHAADOFLFList().equals(other.getLKGHAADOFLFList())) return false;
            ...
            if (!getKIKFFIHPEKIList().equals(other.getKIKFFIHPEKIList())) return false;
            ...
            if (!getDJDBGBNHGGLList().equals(other.getDJDBGBNHGGLList())) return false;
        ...
        public static final class Builder
            ...
            public java.util.List<java.lang.Integer> getLKGHAADOFLFList() {
                return ((bitField0_ & 0x00000001) != 0)
                        ? java.util.Collections.unmodifiableList(lKGHAADOFLF_)
                        : lKGHAADOFLF_;
            }
            /**
             * <code>repeated uint32 LKGHAADOFLF = 1;</code>
             ...
             */
            public Builder setLKGHAADOFLF(int index, int value) {
                ensureLKGHAADOFLFIsMutable();
             ...
             * @return This builder for chaining.
             */
            public Builder addAllLKGHAADOFLF(java.lang.Iterable<? extends java.lang.Integer> values) {
                ensureLKGHAADOFLFIsMutable();
                com.google.protobuf.AbstractMessageLite.Builder.addAll(values, lKGHAADOFLF_);
                onChanged();
                return this;
            }
            /**
            ...
            public java.util.List<java.lang.Integer> getKIKFFIHPEKIList() {
                return ((bitField0_ & 0x00000008) != 0)
                        ? java.util.Collections.unmodifiableList(kIKFFIHPEKI_)
                        : kIKFFIHPEKI_;
            }
            /**
             * <code>repeated uint32 KIKFFIHPEKI = 6;</code>
             ...
             * @return This builder for chaining.
             */
            public Builder setKIKFFIHPEKI(int index, int value) {
                ensureKIKFFIHPEKIIsMutable();
             ...
             * @return This builder for chaining.
             */
            public Builder addAllKIKFFIHPEKI(java.lang.Iterable<? extends java.lang.Integer> values) {
                ensureKIKFFIHPEKIIsMutable();
                com.google.protobuf.AbstractMessageLite.Builder.addAll(values, kIKFFIHPEKI_);
                onChanged();
                return this;
            }
            /**
            ...
            public java.util.List<java.lang.Integer> getDJDBGBNHGGLList() {
                return ((bitField0_ & 0x00000040) != 0)
                        ? java.util.Collections.unmodifiableList(dJDBGBNHGGL_)
                        : dJDBGBNHGGL_;
            }
            /**
             * <code>repeated uint32 DJDBGBNHGGL = 9;</code>
             ...
             * @return This builder for chaining.
             */
            public Builder setDJDBGBNHGGL(int index, int value) {
                ensureDJDBGBNHGGLIsMutable();
             ...
             * @return This builder for chaining.
             */
            public Builder addAllDJDBGBNHGGL(java.lang.Iterable<? extends java.lang.Integer> values) {
                ensureDJDBGBNHGGLIsMutable();
