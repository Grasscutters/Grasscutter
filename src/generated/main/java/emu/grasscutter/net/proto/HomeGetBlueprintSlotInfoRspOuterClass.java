...
public final class HomeGetBlueprintSlotInfoRspOuterClass {
    ...
    public interface HomeGetBlueprintSlotInfoRspOrBuilder
            extends
        ...
        java.util.List<emu.grasscutter.net.proto.HomeBlueprintSlotInfoOuterClass.HomeBlueprintSlotInfo>
                getSlotInfoListList();
        /** <code>repeated .HomeBlueprintSlotInfo slot_info_list = 3;</code> */
        emu.grasscutter.net.proto.HomeBlueprintSlotInfoOuterClass.HomeBlueprintSlotInfo getSlotInfoList(
                int index);
        /** <code>repeated .HomeBlueprintSlotInfo slot_info_list = 3;</code> */
        ...
        java.util.List<
                        ? extends
                                emu.grasscutter.net.proto.HomeBlueprintSlotInfoOuterClass
        ...
        emu.grasscutter.net.proto.HomeBlueprintSlotInfoOuterClass.HomeBlueprintSlotInfoOrBuilder
                getSlotInfoListOrBuilder(int index);
     ...
     */
    public static final class HomeGetBlueprintSlotInfoRsp
        ...
        public static final com.google.protobuf.Descriptors.Descriptor getDescriptor() {
            return emu.grasscutter.net.proto.HomeGetBlueprintSlotInfoRspOuterClass
        ...
        protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
            ...
            return emu.grasscutter.net.proto.HomeGetBlueprintSlotInfoRspOuterClass
                    ...
                    .ensureFieldAccessorsInitialized(
                            emu.grasscutter.net.proto.HomeGetBlueprintSlotInfoRspOuterClass
                                    .HomeGetBlueprintSlotInfoRsp.class,
                            emu.grasscutter.net.proto.HomeGetBlueprintSlotInfoRspOuterClass
                                    .HomeGetBlueprintSlotInfoRsp.Builder.class);
        }
        ...
        public emu.grasscutter.net.proto.HomeBlueprintSlotInfoOuterClass.HomeBlueprintSlotInfo
                getSlotInfoList(int index) {
            return slotInfoList_.get(index);
        }
        /** <code>repeated .HomeBlueprintSlotInfo slot_info_list = 3;</code> */
        @java.lang.Override
        public emu.grasscutter.net.proto.HomeBlueprintSlotInfoOuterClass.HomeBlueprintSlotInfoOrBuilder
                getSlotInfoListOrBuilder(int index) {
            return slotInfoList_.get(index);
        }
         ...
         */
        @java.lang.Override
        public java.util.List<java.lang.Integer> getDeleteSlotIdListList() {
        ...
        public int getSerializedSize() {
            ...
            size = 0;
            for (int i = 0; i < slotInfoList_.size(); i++) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(3, slotInfoList_.get(i));
            }
            if (retcode_ != 0) {
        ...
        public boolean equals(final java.lang.Object obj) {
            ...
            emu.grasscutter.net.proto.HomeGetBlueprintSlotInfoRspOuterClass.HomeGetBlueprintSlotInfoRsp
                    other =
                            (emu.grasscutter.net.proto.HomeGetBlueprintSlotInfoRspOuterClass
                                            .HomeGetBlueprintSlotInfoRsp)
                                    obj;

            if (!getSlotInfoListList().equals(other.getSlotInfoListList())) return false;
            if (getRetcode() != other.getRetcode()) return false;
            if (!getDeleteSlotIdListList().equals(other.getDeleteSlotIdListList())) return false;
        ...
        public static emu.grasscutter.net.proto.HomeGetBlueprintSlotInfoRspOuterClass
                        .HomeGetBlueprintSlotInfoRsp
        ...
        public static final class Builder
            ...
            // Construct using
            // emu.grasscutter.net.proto.HomeGetBlueprintSlotInfoRspOuterClass.HomeGetBlueprintSlotInfoRsp.newBuilder()
            private Builder() {
            ...
            @java.lang.Override
            public emu.grasscutter.net.proto.HomeGetBlueprintSlotInfoRspOuterClass
                            .HomeGetBlueprintSlotInfoRsp
                    getDefaultInstanceForType() {
                return emu.grasscutter.net.proto.HomeGetBlueprintSlotInfoRspOuterClass
                        .HomeGetBlueprintSlotInfoRsp.getDefaultInstance();
            }
            ...
            public emu.grasscutter.net.proto.HomeGetBlueprintSlotInfoRspOuterClass
                ...
                emu.grasscutter.net.proto.HomeGetBlueprintSlotInfoRspOuterClass.HomeGetBlueprintSlotInfoRsp
                        result =
                                new emu.grasscutter.net.proto.HomeGetBlueprintSlotInfoRspOuterClass
                                        .HomeGetBlueprintSlotInfoRsp(this);
            ...
            public Builder mergeFrom(
                ...
                if (other
                        == emu.grasscutter.net.proto.HomeGetBlueprintSlotInfoRspOuterClass
                                .HomeGetBlueprintSlotInfoRsp.getDefaultInstance()) return this;
                if (slotInfoListBuilder_ == null) {
            ...
            public Builder setSlotInfoList(
                    int index,
                    emu.grasscutter.net.proto.HomeBlueprintSlotInfoOuterClass.HomeBlueprintSlotInfo value) {
                if (slotInfoListBuilder_ == null) {
                    if (value == null) {
            ...
            public Builder setSlotInfoList(
                    int index,
                    emu.grasscutter.net.proto.HomeBlueprintSlotInfoOuterClass.HomeBlueprintSlotInfo.Builder
                            builderForValue) {
                if (slotInfoListBuilder_ == null) {
                    ensureSlotInfoListIsMutable();
            ...
            public Builder addAllSlotInfoList(
                ...
                if (slotInfoListBuilder_ == null) {
                    ensureSlotInfoListIsMutable();
                    com.google.protobuf.AbstractMessageLite.Builder.addAll(values, slotInfoList_);
                    onChanged();
                } else {
            ...
            /** <code>repeated .HomeBlueprintSlotInfo slot_info_list = 3;</code> */
            public emu.grasscutter.net.proto.HomeBlueprintSlotInfoOuterClass.HomeBlueprintSlotInfo.Builder
                    getSlotInfoListBuilder(int index) {
                return getSlotInfoListFieldBuilder().getBuilder(index);
            }
            /** <code>repeated .HomeBlueprintSlotInfo slot_info_list = 3;</code> */
            public emu.grasscutter.net.proto.HomeBlueprintSlotInfoOuterClass
                            .HomeBlueprintSlotInfoOrBuilder
                    getSlotInfoListOrBuilder(int index) {
                if (slotInfoListBuilder_ == null) {
                    return slotInfoList_.get(index);
            ...
            /** <code>repeated .HomeBlueprintSlotInfo slot_info_list = 3;</code> */
            public emu.grasscutter.net.proto.HomeBlueprintSlotInfoOuterClass.HomeBlueprintSlotInfo.Builder
                    addSlotInfoListBuilder() {
                return getSlotInfoListFieldBuilder()
                        .addBuilder(
                                emu.grasscutter.net.proto.HomeBlueprintSlotInfoOuterClass.HomeBlueprintSlotInfo
                                        .getDefaultInstance());
            }
            /** <code>repeated .HomeBlueprintSlotInfo slot_info_list = 3;</code> */
            public emu.grasscutter.net.proto.HomeBlueprintSlotInfoOuterClass.HomeBlueprintSlotInfo.Builder
                    addSlotInfoListBuilder(int index) {
                return getSlotInfoListFieldBuilder()
                        .addBuilder(
                                index,
                                emu.grasscutter.net.proto.HomeBlueprintSlotInfoOuterClass.HomeBlueprintSlotInfo
            ...
            public java.util.List<java.lang.Integer> getDeleteSlotIdListList() {
                return ((bitField0_ & 0x00000002) != 0)
                        ? java.util.Collections.unmodifiableList(deleteSlotIdList_)
                        : deleteSlotIdList_;
            }
            /**
             * <code>repeated uint32 delete_slot_id_list = 9;</code>
             ...
             * @return This builder for chaining.
             */
            public Builder setDeleteSlotIdList(int index, int value) {
                ensureDeleteSlotIdListIsMutable();
            ...
            public Builder addAllDeleteSlotIdList(
                ...
                ensureDeleteSlotIdListIsMutable();
                com.google.protobuf.AbstractMessageLite.Builder.addAll(values, deleteSlotIdList_);
                onChanged();
                return this;
            }
            /**
        ...
        private static final emu.grasscutter.net.proto.HomeGetBlueprintSlotInfoRspOuterClass
                        .HomeGetBlueprintSlotInfoRsp
                DEFAULT_INSTANCE;
        ...
        private static final com.google.protobuf.Parser<HomeGetBlueprintSlotInfoRsp> PARSER =
                new com.google.protobuf.AbstractParser<HomeGetBlueprintSlotInfoRsp>() {
                    @java.lang.Override
        ...
        internal_static_HomeGetBlueprintSlotInfoRsp_fieldAccessorTable =
                new com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
                        ...
                        new java.lang.String[] {
                            "SlotInfoList", "Retcode", "DeleteSlotIdList",
                        });
        emu.grasscutter.net.proto.HomeBlueprintSlotInfoOuterClass.getDescriptor();
    }
