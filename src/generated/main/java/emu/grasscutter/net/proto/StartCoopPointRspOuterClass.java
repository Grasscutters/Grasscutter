...
public final class StartCoopPointRspOuterClass {
    ...
    public interface StartCoopPointRspOrBuilder
            extends
     ...
     */
    public static final class StartCoopPointRsp extends com.google.protobuf.GeneratedMessageV3
            implements
        ...
        public static final com.google.protobuf.Descriptors.Descriptor getDescriptor() {
            return emu.grasscutter.net.proto.StartCoopPointRspOuterClass
        ...
        protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
            ...
            return emu.grasscutter.net.proto.StartCoopPointRspOuterClass
                    ...
                    .ensureFieldAccessorsInitialized(
                            emu.grasscutter.net.proto.StartCoopPointRspOuterClass.StartCoopPointRsp.class,
                            emu.grasscutter.net.proto.StartCoopPointRspOuterClass.StartCoopPointRsp.Builder
                                    .class);
        }
        ...
        public int getSerializedSize() {
            ...
            size = 0;
            if (coopPoint_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(6, coopPoint_);
            }
            if (startMainCoop_ != null) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(9, getStartMainCoop());
            }
            if (retcode_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeInt32Size(10, retcode_);
            }
            if (isStart_ != false) {
                size += com.google.protobuf.CodedOutputStream.computeBoolSize(12, isStart_);
            }
        ...
        public boolean equals(final java.lang.Object obj) {
            ...
            if (!(obj
                    instanceof emu.grasscutter.net.proto.StartCoopPointRspOuterClass.StartCoopPointRsp)) {
                return super.equals(obj);
            }
            emu.grasscutter.net.proto.StartCoopPointRspOuterClass.StartCoopPointRsp other =
                    (emu.grasscutter.net.proto.StartCoopPointRspOuterClass.StartCoopPointRsp) obj;

            if (getIsStart() != other.getIsStart()) return false;
            if (getCoopPoint() != other.getCoopPoint()) return false;
            if (getRetcode() != other.getRetcode()) return false;
            if (hasStartMainCoop() != other.hasStartMainCoop()) return false;
            if (hasStartMainCoop()) {
                if (!getStartMainCoop().equals(other.getStartMainCoop())) return false;
            }
        ...
        public int hashCode() {
            ...
            hash = (53 * hash) + com.google.protobuf.Internal.hashBoolean(getIsStart());
        ...
        public static emu.grasscutter.net.proto.StartCoopPointRspOuterClass.StartCoopPointRsp
        ...
        public static Builder newBuilder(
                emu.grasscutter.net.proto.StartCoopPointRspOuterClass.StartCoopPointRsp prototype) {
        ...
        public static final class Builder
            ...
            // Construct using
            // emu.grasscutter.net.proto.StartCoopPointRspOuterClass.StartCoopPointRsp.newBuilder()
            private Builder() {
            ...
            @java.lang.Override
            public emu.grasscutter.net.proto.StartCoopPointRspOuterClass.StartCoopPointRsp
                    getDefaultInstanceForType() {
                return emu.grasscutter.net.proto.StartCoopPointRspOuterClass.StartCoopPointRsp
                        .getDefaultInstance();
            }

            @java.lang.Override
            public emu.grasscutter.net.proto.StartCoopPointRspOuterClass.StartCoopPointRsp build() {
                emu.grasscutter.net.proto.StartCoopPointRspOuterClass.StartCoopPointRsp result =
                        buildPartial();
            ...
            public emu.grasscutter.net.proto.StartCoopPointRspOuterClass.StartCoopPointRsp
                    buildPartial() {
                emu.grasscutter.net.proto.StartCoopPointRspOuterClass.StartCoopPointRsp result =
                        new emu.grasscutter.net.proto.StartCoopPointRspOuterClass.StartCoopPointRsp(this);
            ...
            public Builder mergeFrom(
                    emu.grasscutter.net.proto.StartCoopPointRspOuterClass.StartCoopPointRsp other) {
                if (other
                        == emu.grasscutter.net.proto.StartCoopPointRspOuterClass.StartCoopPointRsp
            ...
            public Builder mergeFrom(
                    ...
                    com.google.protobuf.ExtensionRegistryLite extensionRegistry)
                    throws java.io.IOException {
                emu.grasscutter.net.proto.StartCoopPointRspOuterClass.StartCoopPointRsp parsedMessage =
                        null;
                try {
            ...
            /** <code>.MainCoop start_main_coop = 9;</code> */
            public Builder mergeStartMainCoop(
                    emu.grasscutter.net.proto.MainCoopOuterClass.MainCoop value) {
                if (startMainCoopBuilder_ == null) {
                    if (startMainCoop_ != null) {
                        startMainCoop_ =
                                emu.grasscutter.net.proto.MainCoopOuterClass.MainCoop.newBuilder(startMainCoop_)
                                        .mergeFrom(value)
                                        .buildPartial();
                    } else {
                        startMainCoop_ = value;
                ...
                if (startMainCoopBuilder_ == null) {
                    startMainCoopBuilder_ =
                            new com.google.protobuf.SingleFieldBuilderV3<
                                    ...
                                    emu.grasscutter.net.proto.MainCoopOuterClass.MainCoop.Builder,
                                    emu.grasscutter.net.proto.MainCoopOuterClass.MainCoopOrBuilder>(
                                    getStartMainCoop(), getParentForChildren(), isClean());
                    startMainCoop_ = null;
                }
        ...
        private static final emu.grasscutter.net.proto.StartCoopPointRspOuterClass.StartCoopPointRsp
                DEFAULT_INSTANCE;

        static {
            DEFAULT_INSTANCE =
                    new emu.grasscutter.net.proto.StartCoopPointRspOuterClass.StartCoopPointRsp();
        }
        ...
        private static final com.google.protobuf.Parser<StartCoopPointRsp> PARSER =
                new com.google.protobuf.AbstractParser<StartCoopPointRsp>() {
                    @java.lang.Override
    ...
    static {
        ...
        internal_static_StartCoopPointRsp_descriptor = getDescriptor().getMessageTypes().get(0);
        internal_static_StartCoopPointRsp_fieldAccessorTable =
                new com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
                        internal_static_StartCoopPointRsp_descriptor,
                        new java.lang.String[] {
                            "IsStart", "CoopPoint", "Retcode", "StartMainCoop",
                        });
        emu.grasscutter.net.proto.MainCoopOuterClass.getDescriptor();
    }
