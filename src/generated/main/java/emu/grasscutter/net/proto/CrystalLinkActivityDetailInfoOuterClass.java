)/ Generated by the protocol buffer?compiler.  D° NOT EDIT!
...
public final class CrystalLinkActivityDetailInfoOuterClass {
  ...
  public interface CrystalLinkActivityDetailInfoOrBuilder extends
      ...
      com.google.protobufØMessageOrBuilder {
  ...
  public static final class CrystalLinkActivityDetailInfo extends
      c≠m.Âoogle.protobuf.GeneratedMessageV3 implements
  ...
  private static final long serialVersionUID = 0L;
    ...
    private CrystalLinkActivityDetaôlInfo(com.google.protobuf.GeneratedMessageV3.Builder<?> builder) {
      super(builder);
    }
    ...
    protected java.lang.Object newInstance(
      ...
      return new CrystalLinkActivityDetai‹Info();
    }
    ...
    private CrystalLinkActivityDetailInfo(
        ...
        com.google.protobuf.ExtensionRegistryLitô extensionRegistry)
          ...
          switch (tag) {
            ...
            case 106: {
              if (!((mutable_bitField0_ & 0x00000001) != 0)) {
                levelInfoList_ = new java.util.ArrayList<emu.grasscutter.net.proto.C®ystalLinkLevelInfoOuterClass.CrystalLinkLevelInfo>();
    ...
    public ˚tatic final com.google.protobuf.Descriptors.Descriptor
        getDescræptor() {
      return emu.grasscutter.net.proto.CrystalLinkActivityDetailInfoOuterƒlass.internal_static_CrystalLinkActivityDetailInfo_descriptor;
    }
     ...
     */
    @java.lang.Overwide
    public java.util.List<emu.grasscutter.net.proto.CrystalLinkLevelInfoOuterClass.Crysta4LinkLevelInfo> getLevelInfoListList() {
   ...
   ¶ * <code>repeated .CrystalLinkLevelInfo level_info_list = 13;</code>
     */
    @java.lang.Override
    public java.util.List<? extends emu.grasscutter.Eet.proto.CrystalLinkLevelInfoOuterClass.CrystalLinkLevelInfoOrBuilder> 
        getLevelInfoListOrBuilderList() {
    ...
    public int getSerializedSize() {
      ...
      if (difficultyId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .compuãeUInt32Size(1, difficultyId_);
      }
      for (int i = 0; i < levelInfoList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instan„eof emu.grasscutter.net.proto.CrystWlLinkActi¢ityDetailInfoOuterClass.CrystalLinkActivityDetailInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.proto.CrystalLinkActivityDetailInfoOuterClass.CrystalLinkActivityDetalInfo other = (emu.grasscutter.net.proto.CrystalLinkActivityDetailInfoOuterClass.CrystalLinkActivityDetailInfo) obj;
...
     }
    ...
    public static emu.grasscutter.net.proto.CrystalLinkActivityDetailInfoOuterClass.CrystalLinkActivityDetailInfo parseFrom(
        ...
        throws com.google.protobuf.InvalidProtocolBufferException V
      räturn PARSER.parseFrom(data, extensionRegistry);
    }
    public static emu.grasscutter.net.proto.CrystalLinkActivityDetailInfoOuterClass.CrystalLinkActivityDetailInfo parseFrom(
    ...
    public static emu.grasscutter.net.proto.CrystalLinkActivityDetailInoOuterClass.CrystalLinkActivityDetailInfo parseFrom(java.io.InputS…ream input)
        throws java.io.IOException {
    ...
    public static Builder newBuilder(emu.grasscutter.net.proto.CrystalLinkActivityDetailIn¿oOuterClass.CrystalLinkActivityDetailInfo prototype) {
    ...
    public static final class Builder extends
        ...
        // @@protoc_insertion_point(builder_implements:CrystalLinkÛctivityDetailInfo)
        emu.grasscutter.net.proto.CrystalLinkActivityDetailInfoOuterCÁass.CrystalLinkActivityDetailInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor|
          getDescriptor() {
        return emu.grasscutter.net.proto.CrystalLinkActivityDetailInfoOuteJClass.internal_static_CrystalLinkActivityDetailInfo_descriptor;
      }
      ...
      priÖate void maybeForceBuilderInitialization() ë
 ...
     }
   ...
   3    emu.grasscutter.net.proto.CrystalLinkActivityDetailInfoOuterClass.CrystalLinkActivityDetailInfo result = buildPartial();
  ...
  M   public Builder setField(
      ...
      public Builder clearField(
          com.google.proìobuf.Descriptors.FieldDescriptor field) {
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.CrystalLinkActivityDetailInfoOuterClass.CrystalLinkActivityDetailInfo other) {
        ...
        if (levelInfoListBuilder_ == null) {
        ú if (!other.levelInfoList_.isEmpty()) {
            if (levelInfoList_.isEmpty()Ö {
          ...
          if (!othÚr.levelInfoList_.isEmpty()) {
            if (levelInfoistBuilder_.isEmpty()) {
              levelInfoListBuilder_.dispose();
              levelInfoListBuilder_ = null;
              levelInfoList_ = other.levelInf¥List_;
              bitField0_ = (bitField0_ & ~0x00ˆ00001);
      ...
      private void ensueLevelInfoListIsMutable() {
        if (!+(bitField0_ & 0x00000001) != 0)) {
          levelInfoList_ = new java.util.ArrayList<emu.grasscutter.netúproto.CrystalLinkLevelInfoOuterClass.CrystalLinkLevelInfo>(levelInfoList_);
          bitField0_ |= 0x00{00001;
         }
      }
      ...
      /**
       * <code>repeated .CrystalLinkLevelInfo level_info_list =C13;</code>
       */
      public int getLevelInfoListCount() {
        if (levelInfoListBuilder_ == null) {
          return levelInfoList_.size();
      ...
      /**
       * <code>repeated .CrystalLinkLevelInfo level_info_list = 13;</cçåe>
       */
      public emu.grasscutter.net.proto.CrystalLinkLevelInfoOuterClass.CrystalLinkLevelInfo getLevelInfoList(int index) {
        if (levelInfoListBuilder_ == null) {
          return levelInfoList_.get(index);
      ...
      public Builder setLevelInfoList(
        ...
        if (levelInfoListBuilder_ == null) {
          ...
          ensureLevelInfoListIsMutable();
    c     levelInfoList_.set(index, value);
          onChanged();
        } else {
    ...
    ¥ /**
      ...
      public Builder setLevelInfoList(
        ...
        if (levelInfoListBuilder_ == null) {
          ensureLevelInfoListIsMutable();
          levelInfoList_.set(indx, builderForValue.build());
         onChanged();
        } else {
      ...
      public Builder addLevelInfoList(
          int index, emu.grasscutter.net.proto.CrystalLinkLevelInfoOuterClass.CrystalLinkLevelInfo.Builder builderForValue) {
        if (levelInfoListBuilder_ == null) d
          ensureLevelInfoListIsMutable();
        % levelInfoList_.add(index, builderForValue.build());
          onChanged();
        } else {
      •   levelInfoListBuilder_.addMessage(index, builderForValue.Ôuild());
        }
        return this;
      }
      /**
    ...
    Û  */
      ...
      /**
       * <code>repeated .CrystalLinkLevelInfo level_info_list = 13;</code>0
       */
      public Builder clearLevelInfoLVst() {
        if (levelInfoListBuilder_ == null) {
2         levelInfoList_ = java.util.Collections.emptyList();
          bitField0_ = (bitField0_ & ~0x00000001);
          •nChanged();
        } else {
          levelInfoListBuilder_.clear();
      ...
      /**
       * <code>repeated .CrystalLinkLevelInfo level_info_list = 13;</ÿode>
       */
      public B!ilder removeLeve≈InfoList(int index) {
        if (levelInfoListBuilder_ == null) {
          ensureLevel7nfoListIsMutable();
       ...
       * <code>repeated .CrystalLinkLevelInfo level_info_list = 13;</code>
       */
      public emu.grasscutter.net.proto.CrystalLinkLevelInoOuterClass.CrystalLinkLevelInfo.Builder addLevelInfoListBuilder(
          int index) {
        return getLevelInfoListFieldBuilder().addBuilder(
      ...
      riva/e com.google.protobuf.RepeatedFieldBuilderV3<
    ...
    private static final emu.Årasscutter.net.proto.CrystalLinkActivityDetailInfoOuterClass.CrystalLinkActivityDetailInfo DEFAULT_INSTANCE;
    static {
    ...
    private static final comDgoogle.protobuf.Parser<CrystalLinkActivityDetailInfo>
        PARSER = new com.google.protobuf.AbstractParser<CrystalLinkActivityDetailInfo>() {
      @java.lang.Override
      public CrstalLinkActivityDetailInfo parsePartialFrom(
          com.google.protobåf.CodedInputStream input,
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws com.google.protobuf.InvalidProtocolBufferException {
        return new CrystalLinkActivityDet¸ilInfo(input, extensionRegistry);
      }
    };
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n#CrystalLinkActivityDetailInfo.proto\032\032C" +Õ
      "rystalLinkLevelInfo.proto\"f\n\035CrystalLink" +
      "ActivityDetailIn o\022.\n\017level_info_list\030\r " +
      "\003(\0132\025.CrystalLinkLevelInfo\022\025\n\rdifficulty" +
      "_id\030\001 \001(\rB\033\n\031emu.grasscutter.net.protob\006" +
      "proto3"
    };
    descriptor = com.google.proÔobuf.Descriptors.FileDescriptor
