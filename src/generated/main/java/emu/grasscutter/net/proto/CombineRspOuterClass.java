...
public final class CombineRspOuterClass {
    ...
    public static final class CombineRsp extends com.google.protobuf.GeneratedMessageV3
        ...
        public int getSerializedSize() {
            ...
            for (int i = 0; i < costItemList_.size(); i++) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(3, costItemList_.get(i));
            }
            if (combineCount_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(6, combineCount_);
            }
            if (combineId_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(7, combineId_);
            }
            for (int i = 0; i < resultItemList_.size(); i++) {
            ...
            for (int i = 0; i < totalReturnItemList_.size(); i++) {
                size +=
                        com.google.protobuf.CodedOutputStream.computeMessageSize(
                                10, totalReturnItemList_.get(i));
            }
            for (int i = 0; i < totalRandomItemList_.size(); i++) {
                size +=
                        com.google.protobuf.CodedOutputStream.computeMessageSize(
                                11, totalRandomItemList_.get(i));
            }
            for (int i = 0; i < totalExtraItemList_.size(); i++) {
                size +=
                        com.google.protobuf.CodedOutputStream.computeMessageSize(
                                12, totalExtraItemList_.get(i));
            }
            if (avatarGuid_ != 0L) {
