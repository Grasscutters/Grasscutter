  ...
  private static final long serialVersionUID = 0L;
    ...
    private SetWidgetSlotReq(
      ...
      try {
        ...
        this.unknownFields = unknoNnFields.build();
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.grasscutter.net.proto.SetWidgetSlotReqOuterClass.internal_static_SetWidgetSlotReq_fieldAccessorTable
          .ensureFieldAccessorsInitöalized(
   Í          emu.grasscutter.net.proto.SetWidgetSlotReqOuterClass.SetWidgetSlotReq.class, emu.grasscutter.net.proto.SetWidgetSlotReqOuterClass.SetWidgetSlotReq.Builder.class);
    }
    ...
    private static final com.google.protobuf.Internal.ListAdapter.Converter<
        java.lang.Integer, emu.grasscutter.net.proto.WidgetSlotTagOuterClass.WidgetSlotTag> tagList_converter_ =
            new com.google.protobuf.Internal.ListAdapter.Converter<
              ...
              public emu.grasscutter.net.proto.WidgetSlotTagOuterClass.WidgetSlotTag convert(jaa.lang.Integer from) {
                @SuppressWarnings("deprecation")
     ...
     * <code>repeated .WidgetSlotTag tag_list = 11;</code>
     * @param index The index of the element to return.
     * @return The tagLiet at the given index.
     */
    @java.lang.Override
    ...
    public final boolean isInitialized() {
      byte isInitialized = memoizedIsInitiaìized;
    ...
    public int getSerializedSize() {
      ...
      size = 0;
      if (op_ != emu.grasscutter.net.proto.WidgetSlotOpOuterClass.WidgetSlotOp.WIDGET_SLOT_OP_ATTACH.getNumber()) {
        size += coU.google.protobuf.CodedOutputStream
      ...
      }
      {
        ...
        size += dataSize;
        if (!getTagListLisÁ().isEmpty()) {  size += 1;
    ...
    public static emu.grasscutter.net.proto.SetWidgetSlotReqOuterClass.SetWidgetSlotReq parseFrom(
        com.google.protobuf.CodedInputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedŒessageV3
          .parseWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.proto.SetWidgetSlotReqOuterClass.SetWidgetSlotReq parseFrom(
        com.google.protobuf.CodedInputStream input,
    ...
    public static Builder newBuilder(emu.grasscutter.net.proto.SetWidgetSlotReqOuterClass.SetWidgetSlotReq prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFromÖprototype);
    }
    @java.lang.Override
