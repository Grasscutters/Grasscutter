...
public final class WidgetSorushInfoOuterClass {
    ...
    public interface WidgetSorushInfoOrBuilder
            extends
     ...
     */
    public static final class WidgetSorushInfo extends com.google.protobuf.GeneratedMessageV3
            implements
        ...
        public static final com.google.protobuf.Descriptors.Descriptor getDescriptor() {
            return emu.grasscutter.net.proto.WidgetSorushInfoOuterClass
        ...
        protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
            ...
            return emu.grasscutter.net.proto.WidgetSorushInfoOuterClass
                    ...
                    .ensureFieldAccessorsInitialized(
                            emu.grasscutter.net.proto.WidgetSorushInfoOuterClass.WidgetSorushInfo.class,
                            emu.grasscutter.net.proto.WidgetSorushInfoOuterClass.WidgetSorushInfo.Builder.class);
        }
        ...
        public int getSerializedSize() {
            ...
            if (eDBKNMHNOLP_ != false) {
                size += com.google.protobuf.CodedOutputStream.computeBoolSize(3, eDBKNMHNOLP_);
            }
            if (slot_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(7, slot_);
            }
            if (rot_ != null) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(8, getRot());
            }
            if (eMLEJFAGFBF_ != false) {
                size += com.google.protobuf.CodedOutputStream.computeBoolSize(10, eMLEJFAGFBF_);
            }
            if (pLDLMAFLGDJ_ != false) {
                size += com.google.protobuf.CodedOutputStream.computeBoolSize(11, pLDLMAFLGDJ_);
            }
        ...
        public boolean equals(final java.lang.Object obj) {
            ...
            emu.grasscutter.net.proto.WidgetSorushInfoOuterClass.WidgetSorushInfo other =
                    (emu.grasscutter.net.proto.WidgetSorushInfoOuterClass.WidgetSorushInfo) obj;

            if (hasPos() != other.hasPos()) return false;
            if (hasPos()) {
                if (!getPos().equals(other.getPos())) return false;
            }
            if (getPLDLMAFLGDJ() != other.getPLDLMAFLGDJ()) return false;
            if (getEDBKNMHNOLP() != other.getEDBKNMHNOLP()) return false;
            if (hasRot() != other.hasRot()) return false;
            if (hasRot()) {
                if (!getRot().equals(other.getRot())) return false;
            }
            if (getEMLEJFAGFBF() != other.getEMLEJFAGFBF()) return false;
        ...
        public int hashCode() {
            ...
            hash = (53 * hash) + com.google.protobuf.Internal.hashBoolean(getPLDLMAFLGDJ());
            hash = (37 * hash) + EDBKNMHNOLP_FIELD_NUMBER;
            hash = (53 * hash) + com.google.protobuf.Internal.hashBoolean(getEDBKNMHNOLP());
            if (hasRot()) {
                hash = (37 * hash) + ROT_FIELD_NUMBER;
                hash = (53 * hash) + getRot().hashCode();
            }
            hash = (37 * hash) + EMLEJFAGFBF_FIELD_NUMBER;
            hash = (53 * hash) + com.google.protobuf.Internal.hashBoolean(getEMLEJFAGFBF());
        ...
        public static emu.grasscutter.net.proto.WidgetSorushInfoOuterClass.WidgetSorushInfo
        ...
        public static Builder newBuilder(
                emu.grasscutter.net.proto.WidgetSorushInfoOuterClass.WidgetSorushInfo prototype) {
        ...
        public static final class Builder
            ...
            @java.lang.Override
            public emu.grasscutter.net.proto.WidgetSorushInfoOuterClass.WidgetSorushInfo
            ...
            public emu.grasscutter.net.proto.WidgetSorushInfoOuterClass.WidgetSorushInfo build() {
                emu.grasscutter.net.proto.WidgetSorushInfoOuterClass.WidgetSorushInfo result =
                        buildPartial();
            ...
            public emu.grasscutter.net.proto.WidgetSorushInfoOuterClass.WidgetSorushInfo buildPartial() {
                emu.grasscutter.net.proto.WidgetSorushInfoOuterClass.WidgetSorushInfo result =
                        new emu.grasscutter.net.proto.WidgetSorushInfoOuterClass.WidgetSorushInfo(this);
                if (posBuilder_ == null) {
                    result.pos_ = pos_;
                } else {
            ...
            public Builder mergeFrom(com.google.protobuf.Message other) {
                if (other
                        instanceof emu.grasscutter.net.proto.WidgetSorushInfoOuterClass.WidgetSorushInfo) {
                    return mergeFrom(
                            (emu.grasscutter.net.proto.WidgetSorushInfoOuterClass.WidgetSorushInfo) other);
                } else {
        ...
        private static final emu.grasscutter.net.proto.WidgetSorushInfoOuterClass.WidgetSorushInfo
                DEFAULT_INSTANCE;

        static {
            DEFAULT_INSTANCE =
                    new emu.grasscutter.net.proto.WidgetSorushInfoOuterClass.WidgetSorushInfo();
        }
        ...
        private static final com.google.protobuf.Parser<WidgetSorushInfo> PARSER =
                new com.google.protobuf.AbstractParser<WidgetSorushInfo>() {
                    @java.lang.Override
    ...
    static {
        ...
        internal_static_WidgetSorushInfo_descriptor = getDescriptor().getMessageTypes().get(0);
        internal_static_WidgetSorushInfo_fieldAccessorTable =
                new com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
                        internal_static_WidgetSorushInfo_descriptor,
                        new java.lang.String[] {
                            "Pos", "PLDLMAFLGDJ", "EDBKNMHNOLP", "Rot", "EMLEJFAGFBF", "Slot",
                        });
        emu.grasscutter.net.proto.VectorOuterClass.getDescriptor();
    }
