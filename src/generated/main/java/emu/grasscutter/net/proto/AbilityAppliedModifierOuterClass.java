...
public final class AbilityAppliedModifierOuterClass {
    ...
    public interface AbilityAppliedModifierOrBuilder
            extends
         ...
         */
        emu.grasscutter.net.proto.ModifierDurabilityOuterClass.ModifierDurability
     ...
     */
    public static final class AbilityAppliedModifier extends com.google.protobuf.GeneratedMessageV3
            implements
            ...
            try {
                ...
                while (!done) {
                    ...
                    switch (tag) {
                        ...
                        case 90:
                            {
                                emu.grasscutter.net.proto.ModifierDurabilityOuterClass.ModifierDurability.Builder
                                        subBuilder = null;
        ...
        public static final com.google.protobuf.Descriptors.Descriptor getDescriptor() {
            return emu.grasscutter.net.proto.AbilityAppliedModifierOuterClass
        ...
        private emu.grasscutter.net.proto.ModifierDurabilityOuterClass.ModifierDurability
                modifierDurability_;
        /**
         * <code>.ModifierDurability modifier_durability = 11;</code>
         *
         ...
         */
        @java.lang.Override
        public emu.grasscutter.net.proto.ModifierDurabilityOuterClass.ModifierDurability
                getModifierDurability() {
            return modifierDurability_ == null
                    ? emu.grasscutter.net.proto.ModifierDurabilityOuterClass.ModifierDurability
                            .getDefaultInstance()
        ...
        /** <code>.ModifierDurability modifier_durability = 11;</code> */
        @java.lang.Override
        public emu.grasscutter.net.proto.ModifierDurabilityOuterClass.ModifierDurabilityOrBuilder
                getModifierDurabilityOrBuilder() {
        ...
        public int getSerializedSize() {
            ...
            size = 0;
            if (modifierLocalId_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeInt32Size(1, modifierLocalId_);
            }
            if (parentAbilityEntityId_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(2, parentAbilityEntityId_);
            }
            if (parentAbilityName_ != null) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(3, getParentAbilityName());
            }
            if (parentAbilityOverride_ != null) {
                size +=
                        com.google.protobuf.CodedOutputStream.computeMessageSize(4, getParentAbilityOverride());
            }
            if (instancedAbilityId_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(5, instancedAbilityId_);
            }
            if (instancedModifierId_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(6, instancedModifierId_);
            }
            if (existDuration_ != 0F) {
                size += com.google.protobuf.CodedOutputStream.computeFloatSize(7, existDuration_);
            }
            if (attachedInstancedModifier_ != null) {
                size +=
                        com.google.protobuf.CodedOutputStream.computeMessageSize(
                                8, getAttachedInstancedModifier());
            }
            if (applyEntityId_ != 0) {
            ...
            if (modifierDurability_ != null) {
                size +=
                        com.google.protobuf.CodedOutputStream.computeMessageSize(11, getModifierDurability());
            }
            if (sbuffUid_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(12, sbuffUid_);
            }
            if (isServerbuffModifier_ != false) {
                size += com.google.protobuf.CodedOutputStream.computeBoolSize(13, isServerbuffModifier_);
            }
        ...
        public boolean equals(final java.lang.Object obj) {
            ...
            emu.grasscutter.net.proto.AbilityAppliedModifierOuterClass.AbilityAppliedModifier other =
                    (emu.grasscutter.net.proto.AbilityAppliedModifierOuterClass.AbilityAppliedModifier) obj;

            if (getModifierLocalId() != other.getModifierLocalId()) return false;
            if (getParentAbilityEntityId() != other.getParentAbilityEntityId()) return false;
            ...
            if (java.lang.Float.floatToIntBits(getExistDuration())
                    != java.lang.Float.floatToIntBits(other.getExistDuration())) return false;
            ...
            if (getSbuffUid() != other.getSbuffUid()) return false;
        ...
        public int hashCode() {
            ...
            hash = (53 * hash) + java.lang.Float.floatToIntBits(getExistDuration());
            if (hasAttachedInstancedModifier()) {
        ...
        public static emu.grasscutter.net.proto.AbilityAppliedModifierOuterClass.AbilityAppliedModifier
        ...
        public static final class Builder
            ...
            // Construct using
            // emu.grasscutter.net.proto.AbilityAppliedModifierOuterClass.AbilityAppliedModifier.newBuilder()
            private Builder() {
            ...
            public emu.grasscutter.net.proto.AbilityAppliedModifierOuterClass.AbilityAppliedModifier
                ...
                return emu.grasscutter.net.proto.AbilityAppliedModifierOuterClass.AbilityAppliedModifier
                        .getDefaultInstance();
            }
            ...
            public emu.grasscutter.net.proto.AbilityAppliedModifierOuterClass.AbilityAppliedModifier
                    build() {
                emu.grasscutter.net.proto.AbilityAppliedModifierOuterClass.AbilityAppliedModifier result =
                        buildPartial();
            ...
            public emu.grasscutter.net.proto.AbilityAppliedModifierOuterClass.AbilityAppliedModifier
                    buildPartial() {
                emu.grasscutter.net.proto.AbilityAppliedModifierOuterClass.AbilityAppliedModifier result =
                        new emu.grasscutter.net.proto.AbilityAppliedModifierOuterClass.AbilityAppliedModifier(
                                this);
            ...
            public Builder setModifierDurability(
                    emu.grasscutter.net.proto.ModifierDurabilityOuterClass.ModifierDurability value) {
                if (modifierDurabilityBuilder_ == null) {
                    if (value == null) {
                        throw new NullPointerException();
                    }
            ...
            /** <code>.ModifierDurability modifier_durability = 11;</code> */
            public Builder mergeModifierDurability(
                    emu.grasscutter.net.proto.ModifierDurabilityOuterClass.ModifierDurability value) {
                if (modifierDurabilityBuilder_ == null) {
                    if (modifierDurability_ != null) {
                        modifierDurability_ =
                                emu.grasscutter.net.proto.ModifierDurabilityOuterClass.ModifierDurability
                                        .newBuilder(modifierDurability_)
                                        .mergeFrom(value)
                                        .buildPartial();
                    } else {
                        modifierDurability_ = value;
            ...
            /** <code>.ModifierDurability modifier_durability = 11;</code> */
            public emu.grasscutter.net.proto.ModifierDurabilityOuterClass.ModifierDurability.Builder
                    getModifierDurabilityBuilder() {
                ...
                if (modifierDurabilityBuilder_ == null) {
                    modifierDurabilityBuilder_ =
                            new com.google.protobuf.SingleFieldBuilderV3<
                                    emu.grasscutter.net.proto.ModifierDurabilityOuterClass.ModifierDurability,
                                    emu.grasscutter.net.proto.ModifierDurabilityOuterClass.ModifierDurability.Builder,
                                    emu.grasscutter.net.proto.ModifierDurabilityOuterClass
                                            .ModifierDurabilityOrBuilder>(
                                    getModifierDurability(), getParentForChildren(), isClean());
                    modifierDurability_ = null;
                }
        ...
        private static final emu.grasscutter.net.proto.AbilityAppliedModifierOuterClass
        ...
        private static final com.google.protobuf.Parser<AbilityAppliedModifier> PARSER =
                new com.google.protobuf.AbstractParser<AbilityAppliedModifier>() {
                    @java.lang.Override
