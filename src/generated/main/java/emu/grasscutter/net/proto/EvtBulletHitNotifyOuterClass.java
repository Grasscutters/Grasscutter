...
public final class EvtBulletHitNotifyOuterClass {
    ...
    public interface EvtBulletHitNotifyOrBuilder
            extends
     ...
     */
    public static final class EvtBulletHitNotify extends com.google.protobuf.GeneratedMessageV3
            implements
        ...
        public static final com.google.protobuf.Descriptors.Descriptor getDescriptor() {
            return emu.grasscutter.net.proto.EvtBulletHitNotifyOuterClass
        ...
        protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
            ...
            return emu.grasscutter.net.proto.EvtBulletHitNotifyOuterClass
                    ...
                    .ensureFieldAccessorsInitialized(
                            emu.grasscutter.net.proto.EvtBulletHitNotifyOuterClass.EvtBulletHitNotify.class,
                            emu.grasscutter.net.proto.EvtBulletHitNotifyOuterClass.EvtBulletHitNotify.Builder
                                    .class);
        }
        ...
        public int getSerializedSize() {
            ...
            size = 0;
            if (iKCAFAGALFA_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(3, iKCAFAGALFA_);
            }
            if (dAPDLJGIEOI_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(4, dAPDLJGIEOI_);
            }
            if (hitBoxIndex_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeInt32Size(6, hitBoxIndex_);
            }
            if (iKLAJLIJHPL_ != null) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(7, getIKLAJLIJHPL());
            }
            if (forwardType_
                    != emu.grasscutter.net.proto.ForwardTypeOuterClass.ForwardType.FORWARD_TYPE_LOCAL
                            .getNumber()) {
                size += com.google.protobuf.CodedOutputStream.computeEnumSize(8, forwardType_);
            }
            if (forwardPeer_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(9, forwardPeer_);
            }
            if (entityId_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(10, entityId_);
            }
            if (hitPoint_ != null) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(11, getHitPoint());
            }
            if (hitColliderType_
                    != emu.grasscutter.net.proto.HitColliderTypeOuterClass.HitColliderType
                            .HIT_COLLIDER_INVALID
                            .getNumber()) {
                size += com.google.protobuf.CodedOutputStream.computeEnumSize(12, hitColliderType_);
            }
        ...
        public boolean equals(final java.lang.Object obj) {
            ...
            if (!(obj
                    instanceof emu.grasscutter.net.proto.EvtBulletHitNotifyOuterClass.EvtBulletHitNotify)) {
                return super.equals(obj);
            }
            emu.grasscutter.net.proto.EvtBulletHitNotifyOuterClass.EvtBulletHitNotify other =
                    (emu.grasscutter.net.proto.EvtBulletHitNotifyOuterClass.EvtBulletHitNotify) obj;

            if (getForwardPeer() != other.getForwardPeer()) return false;
            if (hitColliderType_ != other.hitColliderType_) return false;
            if (hasIKLAJLIJHPL() != other.hasIKLAJLIJHPL()) return false;
            if (hasIKLAJLIJHPL()) {
                if (!getIKLAJLIJHPL().equals(other.getIKLAJLIJHPL())) return false;
            }
            if (getEntityId() != other.getEntityId()) return false;
            if (forwardType_ != other.forwardType_) return false;
            if (getIKCAFAGALFA() != other.getIKCAFAGALFA()) return false;
            if (hasHitPoint() != other.hasHitPoint()) return false;
            if (hasHitPoint()) {
                if (!getHitPoint().equals(other.getHitPoint())) return false;
            }
            if (getDAPDLJGIEOI() != other.getDAPDLJGIEOI()) return false;
        ...
        public static emu.grasscutter.net.proto.EvtBulletHitNotifyOuterClass.EvtBulletHitNotify
        ...
        public static Builder newBuilder(
                emu.grasscutter.net.proto.EvtBulletHitNotifyOuterClass.EvtBulletHitNotify prototype) {
        ...
        public static final class Builder
            ...
            // Construct using
            // emu.grasscutter.net.proto.EvtBulletHitNotifyOuterClass.EvtBulletHitNotify.newBuilder()
            private Builder() {
            ...
            @java.lang.Override
            public emu.grasscutter.net.proto.EvtBulletHitNotifyOuterClass.EvtBulletHitNotify
                    getDefaultInstanceForType() {
                return emu.grasscutter.net.proto.EvtBulletHitNotifyOuterClass.EvtBulletHitNotify
                        .getDefaultInstance();
            }

            @java.lang.Override
            public emu.grasscutter.net.proto.EvtBulletHitNotifyOuterClass.EvtBulletHitNotify build() {
                emu.grasscutter.net.proto.EvtBulletHitNotifyOuterClass.EvtBulletHitNotify result =
                        buildPartial();
            ...
            public emu.grasscutter.net.proto.EvtBulletHitNotifyOuterClass.EvtBulletHitNotify
                    buildPartial() {
                emu.grasscutter.net.proto.EvtBulletHitNotifyOuterClass.EvtBulletHitNotify result =
                        new emu.grasscutter.net.proto.EvtBulletHitNotifyOuterClass.EvtBulletHitNotify(this);
            ...
            public Builder mergeFrom(
                    emu.grasscutter.net.proto.EvtBulletHitNotifyOuterClass.EvtBulletHitNotify other) {
                if (other
                        == emu.grasscutter.net.proto.EvtBulletHitNotifyOuterClass.EvtBulletHitNotify
            ...
            public Builder mergeFrom(
                    ...
                    com.google.protobuf.ExtensionRegistryLite extensionRegistry)
                    throws java.io.IOException {
                emu.grasscutter.net.proto.EvtBulletHitNotifyOuterClass.EvtBulletHitNotify parsedMessage =
                        null;
                try {
            ...
            public Builder mergeIKLAJLIJHPL(emu.grasscutter.net.proto.VectorOuterClass.Vector value) {
                if (iKLAJLIJHPLBuilder_ == null) {
                    if (iKLAJLIJHPL_ != null) {
                        iKLAJLIJHPL_ =
                                emu.grasscutter.net.proto.VectorOuterClass.Vector.newBuilder(iKLAJLIJHPL_)
                                        .mergeFrom(value)
                                        .buildPartial();
                    } else {
                        iKLAJLIJHPL_ = value;
                ...
                if (iKLAJLIJHPLBuilder_ == null) {
                    iKLAJLIJHPLBuilder_ =
                            new com.google.protobuf.SingleFieldBuilderV3<
                                    ...
                                    emu.grasscutter.net.proto.VectorOuterClass.Vector.Builder,
                                    emu.grasscutter.net.proto.VectorOuterClass.VectorOrBuilder>(
                                    getIKLAJLIJHPL(), getParentForChildren(), isClean());
                    iKLAJLIJHPL_ = null;
                }
            ...
            public Builder mergeHitPoint(emu.grasscutter.net.proto.VectorOuterClass.Vector value) {
                if (hitPointBuilder_ == null) {
                    if (hitPoint_ != null) {
                        hitPoint_ =
                                emu.grasscutter.net.proto.VectorOuterClass.Vector.newBuilder(hitPoint_)
                                        .mergeFrom(value)
                                        .buildPartial();
                    } else {
                        hitPoint_ = value;
                ...
                if (hitPointBuilder_ == null) {
                    hitPointBuilder_ =
                            new com.google.protobuf.SingleFieldBuilderV3<
                                    ...
                                    emu.grasscutter.net.proto.VectorOuterClass.Vector.Builder,
                                    emu.grasscutter.net.proto.VectorOuterClass.VectorOrBuilder>(
                                    getHitPoint(), getParentForChildren(), isClean());
                    hitPoint_ = null;
                }
        ...
        private static final emu.grasscutter.net.proto.EvtBulletHitNotifyOuterClass.EvtBulletHitNotify
                DEFAULT_INSTANCE;

        static {
            DEFAULT_INSTANCE =
                    new emu.grasscutter.net.proto.EvtBulletHitNotifyOuterClass.EvtBulletHitNotify();
        }
        ...
        private static final com.google.protobuf.Parser<EvtBulletHitNotify> PARSER =
                new com.google.protobuf.AbstractParser<EvtBulletHitNotify>() {
                    @java.lang.Override
    ...
    static {
        ...
        internal_static_EvtBulletHitNotify_descriptor = getDescriptor().getMessageTypes().get(0);
        internal_static_EvtBulletHitNotify_fieldAccessorTable =
