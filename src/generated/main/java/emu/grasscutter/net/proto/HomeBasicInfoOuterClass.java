...
public final class HomeBasicInfoOuterClass {
    ...
    public static final class HomeBasicInfo extends com.google.protobuf.GeneratedMessageV3
        ...
        public int getSerializedSize() {
            ...
            if (curModuleId_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(3, curModuleId_);
            }
            if (limitedShopInfo_ != null) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(5, getLimitedShopInfo());
            }
            if (homeOwnerUid_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(6, homeOwnerUid_);
            }
            if (!com.google.protobuf.GeneratedMessageV3.isStringEmpty(ownerNickName_)) {
                size += com.google.protobuf.GeneratedMessageV3.computeStringSize(7, ownerNickName_);
            }
            if (exp_ != 0L) {
                size += com.google.protobuf.CodedOutputStream.computeUInt64Size(8, exp_);
            }
            if (isInEditMode_ != false) {
                size += com.google.protobuf.CodedOutputStream.computeBoolSize(9, isInEditMode_);
            }
            if (level_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(14, level_);
            }
