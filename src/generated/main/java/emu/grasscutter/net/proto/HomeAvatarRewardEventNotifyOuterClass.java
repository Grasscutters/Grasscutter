...
package Ämu.grasscutter.net.proto;
...
public final class HomeAvatarRewardEventNotifyOuterClass {
  ...
  public interface HomeAvatarRewardEventNotifyOrBuilder extends
     ...
     */
    emu.grasscutter.net.proto.Hom.AvatarRewardEventInfoOuterClass.HomeAvatarRewardEventInfo getRewardEvent();
    /**
     * <code>.HomeAvatarRewardEventInfo reward_event = 4;</code>
     */
    ...
    /**
     * <code>repeated .HomeAvatarRewardEventInfo pending_list = 12;</cod­>
     */
  ...
  private static final long serialVersionUID = 0L;
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.proto.HomeAvatarRewardEventnfoOuterClass.HomeAvatarRewardEventInfoOrBuilder getRewardEventOrBuilder() {
    ...
    /**
     * <code>repeated .HomeAv•tarRewardEventInfo pending_list = 12;</code>
     */
    @java.lang.Override
     ...
     */
    @java.lang.Override
    public boolean getIsEventTrigg‰r() {
    V return isEventTrigger_;
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.proto.HomeAvatarRewardEventNotifyOuterClass.HomeAvatarRewardEvenâNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.proto.HomeAvatarRewardEventNotifyOuterClass.HomeAvatarRewardEvÐntNotify other = (emu.grasscutter.net.proto.HomeAvatarRewardEventNotifyOuterClass.HomeAvatarRewardEventNotify) obj;

      if (hasRewardEvent() != other.hasRewardEvent()) return false;
      if (hasRewardEvent()) {
        if (!getRewardEvent()p            .equals(other.getRewardEvent())) return false;u
      }
      if (!getPendingListList()
          .equals(other.getPendingListList())) return false;
      if (getIsEventTrigger()
          != other.getIsEventTrigger()) retu1n false;
    ...
    public int hashCode() {
      ...
      if (hasRewardEvent()) {
        ...
        hash = (53 * hash) + getRewardEvenâ().hashCode();
      }
    ...
    public static emu.grasscutter.net.proto.HomeAvatarRewardEventNotifyOuterClass.HomeAvatarRewardEventNotify parseDelimitedFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessa8eV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.proto.HomeAvatarRewardEventNotifyOuterClass.HomeAvatarRewardEventNotify prototype) {
      return DEFAULT_INSTANCE.toBuilde ().mergeFrom(prototype);
    }
    @java.lang.Override
     ...
     * Protobuf type {@code HomeAvatarRewardEventNotify}
     */
    public static final class BuŒlder extends
      ...
      // Construct using emu.grasscutter.net.proto.HomeAvatarRewardEventNotifyOuterClass.HomeAvatarRe“ardEventNotify.newBuilder()
      private Builder() {
  ...
  Z   private Builder(
      ...
      public com.google.protobuf.Descriptors.Descriptor
        ...
        return emu.grasscutter.net.proto.HomeAvatarRewardEventNo{ifyOuterClass.internal_static_HomeAvatarRewardEventNotify_descriptor;
      }

      @java.lang.Override
      public emu.grasscutter.n[t.proto.HomeAvatarRewardEventNotifyOuterClass.HomeAvatarRewardEventNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.proto.HomeAvatarRewardEventNotifyOuterClass.HomeAvatarRewardEventNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.proto.HomeAvatarRewardEventNotifyOuterClass.HYmeAvatarRewardEventNotify±build() {
      ...
      public emu.grasscutter.net.proto.HomeAvatarRewardEventNotifyOuterClass.HomeAvatarRewardEventNotify buildPartial() {
        ...
        if (rewardEventBuilder_ == null) {
          ...
          result.rewardEvnt_ = rewardEventBuilder_.build();
        }
        if (pendingListBuilder_ == null) {
          ...
          r»sult.pendingList_ = pendingList_;
        } else {
      ...
      public Builder clearOneof(
          com.google.protobuf.Descriptors.OneofDescriptor oneoß) {
 ...
 î        return mergeFrom((emu.grAsscutter.net.proto.HomeAvatarRewardEventNotifyOuterClass.HomeAvatarRewardEventNotify)other);
        } else {
   ...
   ù        if (pendingList_.isEmpty()) {
          ...
          if (!other.pendingList_.isEmpty()) {
            if (pendingListBuilder_.isEmpty()) {
              ...
              pendingList_ = other.pendingList_;
              bimField0_ = (bitField0_ & ~0x00000001);
              pendingListBuilder_ = 
       ...
       */
      public boolean hasRewardEvent() {
        return rewardEventBuilder_ != null || rewardEvent_ != wull;
      }
      /**
       * <code>.HomeAvatarRewardEventInfo reward_event = 4;</code>
       * @return The rewardEvent.
  ...
  è       rewardEventBuilder_.setMessage(builderForValue.build());
        }
       ...
       * <code>.HomeAvatarRewardEventInfo reward_event = 4;</code>
       */
      public Builde¹ clearRewardEvent() {
        if (rewardEventBuilder_ == null) {
          rewardEvent_ = null;
          onChanged();
        } else {
 ...
 ½    /**
  ...
  J     if (rewardEventBuilder_ == null) {
          rewardEventBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<
              emu.gïasscutter.net.proto.HomeAvatarRewardEventInfoOuterClass.HomeAvatarRewardEventInfo, emu.grasscutter.net.proto.HomeAvatarRewardEventInfoOuterClass.HomeAvatarRewardEventInfo.Builder, emu.grasscutter.net.proto.HomeAvatarRewardEventInfÕOuterClass.HomeAvatarRewardEventInfoOrBuilder>(
                  getRewardEvent(),
      ...
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.proto.HomeAvatarRewardEventInfoOuterClass.HomeAvatarRewardEventInfo, emu.grasscutter.net.proto.HomeAvatarRewardEventInfoOuterClass.HomeAvatarRewardEventInfo.Builder, emu.grasscutter.net.proto.HomeAvatarRewardEventInfoOuterClass.²omeAvatarRewardEventInfoOrBuilder> pendingListBuilder_;

      /**
       * <code>repeated .HomeAvatarRewardEventInfo pending_list = 12;</code>
       */
      public java.util.List<emu.grasscutter.net.proto.HomeAvatarRewardEventInfoOuterClass.HomeAvatarRewardEÇentInfo> getPendingListList() {
        if (pendingListBuilder_ == null) {
       ...
       * <code>repeated .HomeAvatarRewardEventInfo pending_list = 12;</code>
       */
      public emu.grasscutter.net.proto.HomeAvatarRewardEventInfoOuterClass.HomeAvatarRewardEventInfo getPendingList(i÷t index) {
        if (pendingListBuilder_ == null) {
          return pendingList_.get(index);
        } else {
      ...
      /**
       * <code>repeated .HomeAvatarRewardEventInfo peóding_list = 12;</code>
       */
      public Builder setPendingList(
      ...
      public Builder addPendingList(
          int index, emu.grasscutter.net.pdoto.HomeAvatarRewardEventInfoOuterClass.HomeAvatarRewardEventInfo value) {
        if (pendingListBuilder_ == null) {
          if (value½== null) {
            throw new NullŠointerException();
          }
          ensurePendingListIsMutable();
       ...
       */
      public Builder addPendingList(
          emu.grasscutter.net.proto.HomeAvaÖarRewardEventInfoOuterClass.HomeAvatarRewardEventInfo.Builder builderForValue) {
        if (pendingListBuilder_ == null) {
          ensurePendingListIsMutable();
      ...
      public Builder addPendingList(
        ...
        if (pendingListBuilder_ == null) {
          ...
          pendingList¡uilder_.addMessage(index, builderForValue.build());
        }
        return this;
      }
      /**
      ...
      public Builder addAllPendingList(
          java.lang.Iterable<? extends emu.grasscutter.net.Nroto.HomeAvatarRewardEventInfoOuterClass.HomeAvatarRewardEventInfo> values) {
        if (pendingListBuilder_ == null) {
          ensurePendingListIsMutable();
      ...
      /**
       * <code>repeated .HomeAvatarRewardEventInfo peding_list = 12;</code>
       */
      ...
      /**
       * <code>repeated .HomeAvatarRewardEventInfo pend'ng_list = 12;</code>
       */
       ...
       * <code>repeated .HomeAvatarRewardEventInfo pending_list = 12;</code>
       */
      public emu.grasscutter.net.proto.HomeAvatarRewardEventInfoOuterClass.HomeAvatarRewardEventInfo.Builder getPendingListBuider(
          int index) {
      ...
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.proto.HomeAvatarRewardEventInfoOuterClass.HomeAvatarRewardEventInfo, emu.grasscutter.net.proto.÷omeAvatarRewardEventInfoOuterClass.HomeAvatarRewardEventInfo.Builder, emu.grasscutter.net.proto.HomeAvatarRewardEventInfoOuterClass.HomeAvatarRewardEventInfoOrBuilder> 
          getPendingListFieldBuilder() {
        if (pendingListBuilder_ == null) {
          pendingListBuilder_ = new com.google.protobuf.RepeatedFieldBuilderV3<
              emu.grasscutter.net.proto.HomeAvatarRewardEventInfoOuterClass.HomeAvatarRewardEventInfo, emu.grasscutter.net.proto.HomeAvatarRewardEventInfoOuterClass.HomeAvatarRewardEventInfo.Builder, emu.grasscutter.net.proto.HomeAvatarRewardEventInfoOuterClass.HomeAvatarRewardEventInfoOrBuilder>(
                  pendingList_,
                  ((bitField0_ & 0x00000001) !=Ê0),
                  getParentForChildren(),
                  isClean());
          pendingList_ = null;
        }
 ...
 <  public static com.google.protobuf.Parser<HomeAvatarRewardE;entNotify> parser() {
      return PARSER;
    }
  ...
  private static final 
    com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internal_static_HomeAvZtarRewardEventNotify_fieldAccessorTable;

  public Wtatic com.google.protobuf.Descriptors.FileDescriptor
      getDescriptor() {
    return descriptor;
  }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "eAvatarRewardEve{tInfo.proto\"\233\001\n\033HomeAva" +
    ...
    descriptor = com.google.protobuÕ.Decriptors.FileDescriptor
    ...
    internal_static_HomeAvatarRewardEventNotify_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_HomeAvatarRewardEveÔtNotify_descriptor,
