...
public final class WidgetUpdateExtraCDRspOuterClass {
    ...
    public interface WidgetUpdateExtraCDRspOrBuilder
            extends
        ...
        /**
         * <code>.WIDGET_EXTRA_CD_TYPE extra_cd_type = 6;</code>
         *
        ...
        /**
         * <code>.WidgetCoolDownData cool_data = 8;</code>
         *
     ...
     */
    public static final class WidgetUpdateExtraCDRsp extends com.google.protobuf.GeneratedMessageV3
            implements
        ...
        public static final com.google.protobuf.Descriptors.Descriptor getDescriptor() {
            return emu.grasscutter.net.proto.WidgetUpdateExtraCDRspOuterClass
        ...
        protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
            ...
            return emu.grasscutter.net.proto.WidgetUpdateExtraCDRspOuterClass
                    ...
                    .ensureFieldAccessorsInitialized(
                            emu.grasscutter.net.proto.WidgetUpdateExtraCDRspOuterClass.WidgetUpdateExtraCDRsp
                                    .class,
                            emu.grasscutter.net.proto.WidgetUpdateExtraCDRspOuterClass.WidgetUpdateExtraCDRsp
                                    .Builder.class);
        }
        ...
        public emu.grasscutter.net.proto.WIDGETEXTRACDTYPE.WIDGET_EXTRA_CD_TYPE getExtraCdType() {
            ...
            emu.grasscutter.net.proto.WIDGETEXTRACDTYPE.WIDGET_EXTRA_CD_TYPE result =
                    emu.grasscutter.net.proto.WIDGETEXTRACDTYPE.WIDGET_EXTRA_CD_TYPE.valueOf(extraCdType_);
            return result == null
                    ? emu.grasscutter.net.proto.WIDGETEXTRACDTYPE.WIDGET_EXTRA_CD_TYPE.UNRECOGNIZED
                    : result;
        }

        public static final int CD_GROUP_FIELD_NUMBER = 12;
        ...
        public static final int COOL_DATA_FIELD_NUMBER = 8;
        ...
        public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
            ...
            if (extraCdType_
                    != emu.grasscutter.net.proto.WIDGETEXTRACDTYPE.WIDGET_EXTRA_CD_TYPE
                            .WIDGET_EXTRA_CD_TYPE_NONE.getNumber()) {
                output.writeEnum(6, extraCdType_);
            }
            if (coolData_ != null) {
                output.writeMessage(8, getCoolData());
            }
            if (cdGroup_ != 0) {
                output.writeUInt32(12, cdGroup_);
            }
            if (materialId_ != 0) {
        ...
        public int getSerializedSize() {
            ...
            if (extraCdType_
                    != emu.grasscutter.net.proto.WIDGETEXTRACDTYPE.WIDGET_EXTRA_CD_TYPE
                            .WIDGET_EXTRA_CD_TYPE_NONE.getNumber()) {
                size += com.google.protobuf.CodedOutputStream.computeEnumSize(6, extraCdType_);
            }
            if (coolData_ != null) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(8, getCoolData());
            }
            if (cdGroup_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(12, cdGroup_);
            }
            if (materialId_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(14, materialId_);
            }
        ...
        public boolean equals(final java.lang.Object obj) {
            ...
            emu.grasscutter.net.proto.WidgetUpdateExtraCDRspOuterClass.WidgetUpdateExtraCDRsp other =
                    (emu.grasscutter.net.proto.WidgetUpdateExtraCDRspOuterClass.WidgetUpdateExtraCDRsp) obj;

            if (getRetcode() != other.getRetcode()) return false;
            if (extraCdType_ != other.extraCdType_) return false;
            if (getCdGroup() != other.getCdGroup()) return false;
            if (getMaterialId() != other.getMaterialId()) return false;
            if (hasCoolData() != other.hasCoolData()) return false;
            if (hasCoolData()) {
                if (!getCoolData().equals(other.getCoolData())) return false;
            }
        ...
        public static emu.grasscutter.net.proto.WidgetUpdateExtraCDRspOuterClass.WidgetUpdateExtraCDRsp
        ...
        public static final class Builder
            ...
            // Construct using
            // emu.grasscutter.net.proto.WidgetUpdateExtraCDRspOuterClass.WidgetUpdateExtraCDRsp.newBuilder()
            private Builder() {
            ...
            @java.lang.Override
            public emu.grasscutter.net.proto.WidgetUpdateExtraCDRspOuterClass.WidgetUpdateExtraCDRsp
                    getDefaultInstanceForType() {
                return emu.grasscutter.net.proto.WidgetUpdateExtraCDRspOuterClass.WidgetUpdateExtraCDRsp
                        .getDefaultInstance();
            }
            ...
            public emu.grasscutter.net.proto.WidgetUpdateExtraCDRspOuterClass.WidgetUpdateExtraCDRsp
                    build() {
                emu.grasscutter.net.proto.WidgetUpdateExtraCDRspOuterClass.WidgetUpdateExtraCDRsp result =
                        buildPartial();
            ...
            public emu.grasscutter.net.proto.WidgetUpdateExtraCDRspOuterClass.WidgetUpdateExtraCDRsp
                    buildPartial() {
                emu.grasscutter.net.proto.WidgetUpdateExtraCDRspOuterClass.WidgetUpdateExtraCDRsp result =
                        new emu.grasscutter.net.proto.WidgetUpdateExtraCDRspOuterClass.WidgetUpdateExtraCDRsp(
                                this);
             ...
             * @return This builder for chaining.
             */
            public Builder setExtraCdType(
                    emu.grasscutter.net.proto.WIDGETEXTRACDTYPE.WIDGET_EXTRA_CD_TYPE value) {
                if (value == null) {
            ...
            /** <code>.WidgetCoolDownData cool_data = 8;</code> */
            public Builder mergeCoolData(
                    emu.grasscutter.net.proto.WidgetCoolDownDataOuterClass.WidgetCoolDownData value) {
                if (coolDataBuilder_ == null) {
                    if (coolData_ != null) {
                        coolData_ =
                                emu.grasscutter.net.proto.WidgetCoolDownDataOuterClass.WidgetCoolDownData
                                        .newBuilder(coolData_)
                                        .mergeFrom(value)
                                        .buildPartial();
                    } else {
                        coolData_ = value;
                ...
                if (coolDataBuilder_ == null) {
                    coolDataBuilder_ =
                            new com.google.protobuf.SingleFieldBuilderV3<
                                    ...
                                    getCoolData(), getParentForChildren(), isClean());
                    coolData_ = null;
                }
        ...
        private static final emu.grasscutter.net.proto.WidgetUpdateExtraCDRspOuterClass
        ...
        private static final com.google.protobuf.Parser<WidgetUpdateExtraCDRsp> PARSER =
                new com.google.protobuf.AbstractParser<WidgetUpdateExtraCDRsp>() {
                    @java.lang.Override
    ...
    static {
        java.lang.String[] descriptorData = {
            "\n\034WidgetUpdateExtraCDRsp.proto\032\032WIDGET_E"
                    ...
                    + "de\030\005 \001(\005\022,\n\rextra_cd_type\030\006 \001(\0162\025.WIDGET"
                    + "_EXTRA_CD_TYPE\022\020\n\010cd_group\030\014 \001(\r\022\023\n\013mate"
                    + "rial_id\030\016 \001(\r\022&\n\tcool_data\030\010 \001(\0132\023.Widge"
        ...
        internal_static_WidgetUpdateExtraCDRsp_descriptor = getDescriptor().getMessageTypes().get(0);
        internal_static_WidgetUpdateExtraCDRsp_fieldAccessorTable =
                new com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
                        internal_static_WidgetUpdateExtraCDRsp_descriptor,
                        new java.lang.String[] {
                            "Retcode", "ExtraCdType", "CdGroup", "MaterialId", "CoolData",
                        });
        emu.grasscutter.net.proto.WIDGETEXTRACDTYPE.getDescriptor();
        emu.grasscutter.net.proto.WidgetCoolDownDataOuterClass.getDescriptor();
    }
