...
public final class MailItemOuterClass {
     ...
     */
    public static final class MailItem extends com.google.protobuf.GeneratedMessageV3
            implements
        ...
        protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
            ...
            return emu.grasscutter.net.proto.MailItemOuterClass
                    .internal_static_MailItem_fieldAccessorTable
                    .ensureFieldAccessorsInitialized(
                            emu.grasscutter.net.proto.MailItemOuterClass.MailItem.class,
                            emu.grasscutter.net.proto.MailItemOuterClass.MailItem.Builder.class);
        }
        ...
        /** <code>.MaterialDeleteInfo delete_info = 2;</code> */
        @java.lang.Override
        public emu.grasscutter.net.proto.MaterialDeleteInfoOuterClass.MaterialDeleteInfoOrBuilder
                getDeleteInfoOrBuilder() {
        ...
        public int getSerializedSize() {
            ...
            size = 0;
            if (equipParam_ != null) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(1, getEquipParam());
            }
            if (deleteInfo_ != null) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(2, getDeleteInfo());
            }
        ...
        public boolean equals(final java.lang.Object obj) {
            ...
            emu.grasscutter.net.proto.MailItemOuterClass.MailItem other =
                    (emu.grasscutter.net.proto.MailItemOuterClass.MailItem) obj;

            if (hasEquipParam() != other.hasEquipParam()) return false;
            if (hasEquipParam()) {
                if (!getEquipParam().equals(other.getEquipParam())) return false;
            }
            if (hasDeleteInfo() != other.hasDeleteInfo()) return false;
            if (hasDeleteInfo()) {
                if (!getDeleteInfo().equals(other.getDeleteInfo())) return false;
            }
        ...
        public static Builder newBuilder(
                emu.grasscutter.net.proto.MailItemOuterClass.MailItem prototype) {
        ...
        public static final class Builder
            ...
            public emu.grasscutter.net.proto.MailItemOuterClass.MailItem buildPartial() {
                emu.grasscutter.net.proto.MailItemOuterClass.MailItem result =
                        new emu.grasscutter.net.proto.MailItemOuterClass.MailItem(this);
                if (equipParamBuilder_ == null) {
            ...
            public Builder mergeFrom(emu.grasscutter.net.proto.MailItemOuterClass.MailItem other) {
                if (other == emu.grasscutter.net.proto.MailItemOuterClass.MailItem.getDefaultInstance())
                    return this;
            ...
            public Builder mergeFrom(
                ...
                try {
                    ...
                    parsedMessage =
                            (emu.grasscutter.net.proto.MailItemOuterClass.MailItem) e.getUnfinishedMessage();
            ...
            public Builder setEquipParam(
                    emu.grasscutter.net.proto.EquipParamOuterClass.EquipParam value) {
                if (equipParamBuilder_ == null) {
                    if (value == null) {
            ...
            /** <code>.EquipParam equip_param = 1;</code> */
            public Builder mergeEquipParam(
                    emu.grasscutter.net.proto.EquipParamOuterClass.EquipParam value) {
                if (equipParamBuilder_ == null) {
                    if (equipParam_ != null) {
                        equipParam_ =
                                emu.grasscutter.net.proto.EquipParamOuterClass.EquipParam.newBuilder(equipParam_)
                                        .mergeFrom(value)
                                        .buildPartial();
                    } else {
                        equipParam_ = value;
                ...
                if (equipParamBuilder_ == null) {
                    equipParamBuilder_ =
                            new com.google.protobuf.SingleFieldBuilderV3<
                                    ...
                                    emu.grasscutter.net.proto.EquipParamOuterClass.EquipParam.Builder,
                                    emu.grasscutter.net.proto.EquipParamOuterClass.EquipParamOrBuilder>(
                                    getEquipParam(), getParentForChildren(), isClean());
                    equipParam_ = null;
                }
            ...
            public Builder setDeleteInfo(
                    emu.grasscutter.net.proto.MaterialDeleteInfoOuterClass.MaterialDeleteInfo value) {
                if (deleteInfoBuilder_ == null) {
                    if (value == null) {
                        throw new NullPointerException();
                    }
            ...
            /** <code>.MaterialDeleteInfo delete_info = 2;</code> */
            public Builder mergeDeleteInfo(
                    emu.grasscutter.net.proto.MaterialDeleteInfoOuterClass.MaterialDeleteInfo value) {
                if (deleteInfoBuilder_ == null) {
                    if (deleteInfo_ != null) {
                        deleteInfo_ =
            ...
            /** <code>.MaterialDeleteInfo delete_info = 2;</code> */
            public emu.grasscutter.net.proto.MaterialDeleteInfoOuterClass.MaterialDeleteInfo.Builder
                    getDeleteInfoBuilder() {
                ...
                if (deleteInfoBuilder_ == null) {
                    deleteInfoBuilder_ =
                            new com.google.protobuf.SingleFieldBuilderV3<
                                    ...
                                    getDeleteInfo(), getParentForChildren(), isClean());
                    deleteInfo_ = null;
                }
        ...
        private static final com.google.protobuf.Parser<MailItem> PARSER =
