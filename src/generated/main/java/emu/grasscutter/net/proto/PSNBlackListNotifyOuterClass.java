...
public final class PSNBlackListNotifyOuterClass {
    ...
    public interface PSNBlackListNotifyOrBuilder
            extends
            // @@protoc_insertion_point(interface_extends:PSNBlackListNotify)
            com.google.protobuf.MessageOrBuilder {

        /** <code>repeated .FriendBrief psn_blacklist = 14;</code> */
     ...
     */
    public static final class PSNBlackListNotify extends com.google.protobuf.GeneratedMessageV3
            implements
        ...
        public static final com.google.protobuf.Descriptors.Descriptor getDescriptor() {
            return emu.grasscutter.net.proto.PSNBlackListNotifyOuterClass
        ...
        protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
            ...
            return emu.grasscutter.net.proto.PSNBlackListNotifyOuterClass
                    ...
                    .ensureFieldAccessorsInitialized(
                            emu.grasscutter.net.proto.PSNBlackListNotifyOuterClass.PSNBlackListNotify.class,
                            emu.grasscutter.net.proto.PSNBlackListNotifyOuterClass.PSNBlackListNotify.Builder
                                    .class);
        }

        public static final int PSN_BLACKLIST_FIELD_NUMBER = 14;
        ...
        public emu.grasscutter.net.proto.FriendBriefOuterClass.FriendBriefOrBuilder
                getPsnBlacklistOrBuilder(int index) {
            return psnBlacklist_.get(index);
        }
        ...
        public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
            for (int i = 0; i < psnBlacklist_.size(); i++) {
                output.writeMessage(14, psnBlacklist_.get(i));
            }
        ...
        public int getSerializedSize() {
            ...
            size = 0;
            for (int i = 0; i < psnBlacklist_.size(); i++) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(14, psnBlacklist_.get(i));
            }
        ...
        public boolean equals(final java.lang.Object obj) {
            ...
            if (!(obj
                    instanceof emu.grasscutter.net.proto.PSNBlackListNotifyOuterClass.PSNBlackListNotify)) {
                return super.equals(obj);
            }
            emu.grasscutter.net.proto.PSNBlackListNotifyOuterClass.PSNBlackListNotify other =
                    (emu.grasscutter.net.proto.PSNBlackListNotifyOuterClass.PSNBlackListNotify) obj;

            if (!getPsnBlacklistList().equals(other.getPsnBlacklistList())) return false;
        ...
        public static emu.grasscutter.net.proto.PSNBlackListNotifyOuterClass.PSNBlackListNotify
        ...
        public static Builder newBuilder(
                emu.grasscutter.net.proto.PSNBlackListNotifyOuterClass.PSNBlackListNotify prototype) {
        ...
        public static final class Builder
            ...
            // Construct using
            // emu.grasscutter.net.proto.PSNBlackListNotifyOuterClass.PSNBlackListNotify.newBuilder()
            private Builder() {
            ...
            @java.lang.Override
            public emu.grasscutter.net.proto.PSNBlackListNotifyOuterClass.PSNBlackListNotify
                    getDefaultInstanceForType() {
                return emu.grasscutter.net.proto.PSNBlackListNotifyOuterClass.PSNBlackListNotify
                        .getDefaultInstance();
            }

            @java.lang.Override
            public emu.grasscutter.net.proto.PSNBlackListNotifyOuterClass.PSNBlackListNotify build() {
                emu.grasscutter.net.proto.PSNBlackListNotifyOuterClass.PSNBlackListNotify result =
                        buildPartial();
            ...
            public emu.grasscutter.net.proto.PSNBlackListNotifyOuterClass.PSNBlackListNotify
                    buildPartial() {
                emu.grasscutter.net.proto.PSNBlackListNotifyOuterClass.PSNBlackListNotify result =
                        new emu.grasscutter.net.proto.PSNBlackListNotifyOuterClass.PSNBlackListNotify(this);
            ...
            public Builder mergeFrom(
                    emu.grasscutter.net.proto.PSNBlackListNotifyOuterClass.PSNBlackListNotify other) {
                if (other
                        == emu.grasscutter.net.proto.PSNBlackListNotifyOuterClass.PSNBlackListNotify
            ...
            public Builder mergeFrom(
                    ...
                    com.google.protobuf.ExtensionRegistryLite extensionRegistry)
                    throws java.io.IOException {
                emu.grasscutter.net.proto.PSNBlackListNotifyOuterClass.PSNBlackListNotify parsedMessage =
                        null;
                try {
            ...
            /** <code>repeated .FriendBrief psn_blacklist = 14;</code> */
            public emu.grasscutter.net.proto.FriendBriefOuterClass.FriendBrief getPsnBlacklist(
                    int index) {
                if (psnBlacklistBuilder_ == null) {
                    return psnBlacklist_.get(index);
                } else {
            ...
            public Builder addAllPsnBlacklist(
                ...
                if (psnBlacklistBuilder_ == null) {
                    ensurePsnBlacklistIsMutable();
                    com.google.protobuf.AbstractMessageLite.Builder.addAll(values, psnBlacklist_);
                    onChanged();
                } else {
            ...
            public emu.grasscutter.net.proto.FriendBriefOuterClass.FriendBrief.Builder
                    getPsnBlacklistBuilder(int index) {
            ...
            /** <code>repeated .FriendBrief psn_blacklist = 14;</code> */
            public emu.grasscutter.net.proto.FriendBriefOuterClass.FriendBrief.Builder
                    addPsnBlacklistBuilder() {
                return getPsnBlacklistFieldBuilder()
                        .addBuilder(
                                emu.grasscutter.net.proto.FriendBriefOuterClass.FriendBrief.getDefaultInstance());
            }
            /** <code>repeated .FriendBrief psn_blacklist = 14;</code> */
            public emu.grasscutter.net.proto.FriendBriefOuterClass.FriendBrief.Builder
                    addPsnBlacklistBuilder(int index) {
                return getPsnBlacklistFieldBuilder()
                        .addBuilder(
                                index,
                                emu.grasscutter.net.proto.FriendBriefOuterClass.FriendBrief.getDefaultInstance());
        ...
        private static final emu.grasscutter.net.proto.PSNBlackListNotifyOuterClass.PSNBlackListNotify
                DEFAULT_INSTANCE;

        static {
            DEFAULT_INSTANCE =
                    new emu.grasscutter.net.proto.PSNBlackListNotifyOuterClass.PSNBlackListNotify();
        }
        ...
        private static final com.google.protobuf.Parser<PSNBlackListNotify> PARSER =
                new com.google.protobuf.AbstractParser<PSNBlackListNotify>() {
                    @java.lang.Override
    ...
    static {
        java.lang.String[] descriptorData = {
            "\n\030PSNBlackListNotify.proto\032\021FriendBrief."
                    ...
                    + "list\030\016 \003(\0132\014.FriendBriefB\033\n\031emu.grasscut"
        ...
        internal_static_PSNBlackListNotify_descriptor = getDescriptor().getMessageTypes().get(0);
        internal_static_PSNBlackListNotify_fieldAccessorTable =
