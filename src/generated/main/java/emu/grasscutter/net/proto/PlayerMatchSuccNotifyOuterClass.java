...
public final class PlayerMatchSuccNotifyOuterClass {
    ...
    public interface PlayerMatchSuccNotifyOrBuilder
            extends
     ...
     */
    public static final class PlayerMatchSuccNotify extends com.google.protobuf.GeneratedMessageV3
            implements
            ...
            try {
                ...
                while (!done) {
                    ...
                    switch (tag) {
                        ...
                        case 18:
                            {
                                ...
                                generalMatchInfo_ =
                                        input.readMessage(
                                                emu.grasscutter.net.proto.GeneralMatchInfoOuterClass.GeneralMatchInfo
                                                        .parser(),
                                                extensionRegistry);
                                if (subBuilder != null) {
                        ...
                        case 34:
                            {
                                emu.grasscutter.net.proto.GCGMatchInfoOuterClass.GCGMatchInfo.Builder subBuilder =
                                        null;
                                ...
                                gcgMatchInfo_ =
                                        input.readMessage(
                                                emu.grasscutter.net.proto.GCGMatchInfoOuterClass.GCGMatchInfo.parser(),
                                                extensionRegistry);
                                if (subBuilder != null) {
        ...
        public static final com.google.protobuf.Descriptors.Descriptor getDescriptor() {
            return emu.grasscutter.net.proto.PlayerMatchSuccNotifyOuterClass
        ...
        protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
            ...
            return emu.grasscutter.net.proto.PlayerMatchSuccNotifyOuterClass
                    ...
                    .ensureFieldAccessorsInitialized(
                            emu.grasscutter.net.proto.PlayerMatchSuccNotifyOuterClass.PlayerMatchSuccNotify.class,
                            emu.grasscutter.net.proto.PlayerMatchSuccNotifyOuterClass.PlayerMatchSuccNotify
                                    .Builder.class);
        }
        ...
        public emu.grasscutter.net.proto.GCGMatchInfoOuterClass.GCGMatchInfo getGcgMatchInfo() {
            return gcgMatchInfo_ == null
                    ? emu.grasscutter.net.proto.GCGMatchInfoOuterClass.GCGMatchInfo.getDefaultInstance()
                    : gcgMatchInfo_;
        }
        /** <code>.GCGMatchInfo gcg_match_info = 4;</code> */
        @java.lang.Override
        public emu.grasscutter.net.proto.GCGMatchInfoOuterClass.GCGMatchInfoOrBuilder
                getGcgMatchInfoOrBuilder() {
         ...
         */
        @java.lang.Override
        public emu.grasscutter.net.proto.GeneralMatchInfoOuterClass.GeneralMatchInfo
                getGeneralMatchInfo() {
            return generalMatchInfo_ == null
                    ? emu.grasscutter.net.proto.GeneralMatchInfoOuterClass.GeneralMatchInfo
                            .getDefaultInstance()
        ...
        /** <code>.GeneralMatchInfo general_match_info = 2;</code> */
        @java.lang.Override
        public emu.grasscutter.net.proto.GeneralMatchInfoOuterClass.GeneralMatchInfoOrBuilder
                getGeneralMatchInfoOrBuilder() {
        ...
        public int getSerializedSize() {
            ...
            size = 0;
            if (generalMatchInfo_ != null) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(2, getGeneralMatchInfo());
            }
            if (gcgMatchInfo_ != null) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(4, getGcgMatchInfo());
            }
            if (hostUid_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(8, hostUid_);
            }
            if (matchType_
                    != emu.grasscutter.net.proto.MatchTypeOuterClass.MatchType.MATCH_TYPE_NONE.getNumber()) {
                size += com.google.protobuf.CodedOutputStream.computeEnumSize(10, matchType_);
            }
            if (mpPlayId_ != 0) {
            ...
            if (mechanicusDifficultLevel_ != 0) {
                size +=
                        com.google.protobuf.CodedOutputStream.computeUInt32Size(13, mechanicusDifficultLevel_);
            }
            if (confirmEndTime_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(14, confirmEndTime_);
            }
            if (dungeonId_ != 0) {
        ...
        public boolean equals(final java.lang.Object obj) {
            ...
            emu.grasscutter.net.proto.PlayerMatchSuccNotifyOuterClass.PlayerMatchSuccNotify other =
                    (emu.grasscutter.net.proto.PlayerMatchSuccNotifyOuterClass.PlayerMatchSuccNotify) obj;

            if (hasGcgMatchInfo() != other.hasGcgMatchInfo()) return false;
            if (hasGcgMatchInfo()) {
                if (!getGcgMatchInfo().equals(other.getGcgMatchInfo())) return false;
            }
            ...
            if (hasGeneralMatchInfo()) {
                if (!getGeneralMatchInfo().equals(other.getGeneralMatchInfo())) return false;
            }
            if (getMpPlayId() != other.getMpPlayId()) return false;
            if (getMechanicusDifficultLevel() != other.getMechanicusDifficultLevel()) return false;
            if (getDungeonId() != other.getDungeonId()) return false;
            if (getConfirmEndTime() != other.getConfirmEndTime()) return false;
        ...
        public static emu.grasscutter.net.proto.PlayerMatchSuccNotifyOuterClass.PlayerMatchSuccNotify
        ...
        public static Builder newBuilder(
                emu.grasscutter.net.proto.PlayerMatchSuccNotifyOuterClass.PlayerMatchSuccNotify prototype) {
        ...
        public static final class Builder
            ...
            // Construct using
            // emu.grasscutter.net.proto.PlayerMatchSuccNotifyOuterClass.PlayerMatchSuccNotify.newBuilder()
            private Builder() {
            ...
            @java.lang.Override
            public emu.grasscutter.net.proto.PlayerMatchSuccNotifyOuterClass.PlayerMatchSuccNotify
                    getDefaultInstanceForType() {
                return emu.grasscutter.net.proto.PlayerMatchSuccNotifyOuterClass.PlayerMatchSuccNotify
                        .getDefaultInstance();
            }
            ...
            public emu.grasscutter.net.proto.PlayerMatchSuccNotifyOuterClass.PlayerMatchSuccNotify
                    build() {
                emu.grasscutter.net.proto.PlayerMatchSuccNotifyOuterClass.PlayerMatchSuccNotify result =
                        buildPartial();
            ...
            public emu.grasscutter.net.proto.PlayerMatchSuccNotifyOuterClass.PlayerMatchSuccNotify
                    buildPartial() {
                emu.grasscutter.net.proto.PlayerMatchSuccNotifyOuterClass.PlayerMatchSuccNotify result =
                        new emu.grasscutter.net.proto.PlayerMatchSuccNotifyOuterClass.PlayerMatchSuccNotify(
                                this);
                if (gcgMatchInfoBuilder_ == null) {
            ...
            private com.google.protobuf.SingleFieldBuilderV3<
                            emu.grasscutter.net.proto.GCGMatchInfoOuterClass.GCGMatchInfo,
                            emu.grasscutter.net.proto.GCGMatchInfoOuterClass.GCGMatchInfo.Builder,
                            emu.grasscutter.net.proto.GCGMatchInfoOuterClass.GCGMatchInfoOrBuilder>
                    gcgMatchInfoBuilder_;
            /**
             * <code>.GCGMatchInfo gcg_match_info = 4;</code>
             *
             * @return Whether the gcgMatchInfo field is set.
            ...
            public Builder setGcgMatchInfo(
                    emu.grasscutter.net.proto.GCGMatchInfoOuterClass.GCGMatchInfo value) {
                if (gcgMatchInfoBuilder_ == null) {
                    if (value == null) {
            ...
            /** <code>.GCGMatchInfo gcg_match_info = 4;</code> */
            public Builder mergeGcgMatchInfo(
                    emu.grasscutter.net.proto.GCGMatchInfoOuterClass.GCGMatchInfo value) {
                if (gcgMatchInfoBuilder_ == null) {
                    if (gcgMatchInfo_ != null) {
                        gcgMatchInfo_ =
                                emu.grasscutter.net.proto.GCGMatchInfoOuterClass.GCGMatchInfo.newBuilder(
                                                gcgMatchInfo_)
                                        .mergeFrom(value)
                                        .buildPartial();
                    } else {
            ...
            /** <code>.GCGMatchInfo gcg_match_info = 4;</code> */
            public emu.grasscutter.net.proto.GCGMatchInfoOuterClass.GCGMatchInfo.Builder
                ...
                if (gcgMatchInfoBuilder_ == null) {
                    gcgMatchInfoBuilder_ =
                            new com.google.protobuf.SingleFieldBuilderV3<
                                    ...
                                    emu.grasscutter.net.proto.GCGMatchInfoOuterClass.GCGMatchInfo.Builder,
                                    emu.grasscutter.net.proto.GCGMatchInfoOuterClass.GCGMatchInfoOrBuilder>(
                                    getGcgMatchInfo(), getParentForChildren(), isClean());
                    gcgMatchInfo_ = null;
                }
            ...
            private emu.grasscutter.net.proto.GeneralMatchInfoOuterClass.GeneralMatchInfo
                    generalMatchInfo_;
            private com.google.protobuf.SingleFieldBuilderV3<
                            emu.grasscutter.net.proto.GeneralMatchInfoOuterClass.GeneralMatchInfo,
                            emu.grasscutter.net.proto.GeneralMatchInfoOuterClass.GeneralMatchInfo.Builder,
                            emu.grasscutter.net.proto.GeneralMatchInfoOuterClass.GeneralMatchInfoOrBuilder>
                    generalMatchInfoBuilder_;
            /**
             * <code>.GeneralMatchInfo general_match_info = 2;</code>
             *
             * @return Whether the generalMatchInfo field is set.
            ...
            public Builder setGeneralMatchInfo(
                    emu.grasscutter.net.proto.GeneralMatchInfoOuterClass.GeneralMatchInfo value) {
                if (generalMatchInfoBuilder_ == null) {
                    if (value == null) {
                        throw new NullPointerException();
                    }
            ...
            /** <code>.GeneralMatchInfo general_match_info = 2;</code> */
            public Builder mergeGeneralMatchInfo(
                    emu.grasscutter.net.proto.GeneralMatchInfoOuterClass.GeneralMatchInfo value) {
                if (generalMatchInfoBuilder_ == null) {
                    if (generalMatchInfo_ != null) {
                        generalMatchInfo_ =
                                emu.grasscutter.net.proto.GeneralMatchInfoOuterClass.GeneralMatchInfo.newBuilder(
                                                generalMatchInfo_)
                                        .mergeFrom(value)
                                        .buildPartial();
                    } else {
            ...
            /** <code>.GeneralMatchInfo general_match_info = 2;</code> */
            public emu.grasscutter.net.proto.GeneralMatchInfoOuterClass.GeneralMatchInfo.Builder
                ...
                if (generalMatchInfoBuilder_ == null) {
                    generalMatchInfoBuilder_ =
                            new com.google.protobuf.SingleFieldBuilderV3<
                                    ...
                                    emu.grasscutter.net.proto.GeneralMatchInfoOuterClass.GeneralMatchInfo.Builder,
                                    emu.grasscutter.net.proto.GeneralMatchInfoOuterClass.GeneralMatchInfoOrBuilder>(
                                    getGeneralMatchInfo(), getParentForChildren(), isClean());
                    generalMatchInfo_ = null;
                }
        ...
        private static final emu.grasscutter.net.proto.PlayerMatchSuccNotifyOuterClass
        ...
        private static final com.google.protobuf.Parser<PlayerMatchSuccNotify> PARSER =
                new com.google.protobuf.AbstractParser<PlayerMatchSuccNotify>() {
                    @java.lang.Override
    ...
    static {
        ...
        internal_static_PlayerMatchSuccNotify_descriptor = getDescriptor().getMessageTypes().get(0);
        internal_static_PlayerMatchSuccNotify_fieldAccessorTable =
