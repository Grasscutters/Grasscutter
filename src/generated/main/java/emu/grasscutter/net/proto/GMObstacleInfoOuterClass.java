...
public final class GMObstacleInfoOuterClass {
    ...
    public interface GMObstacleInfoOrBuilder
            extends
     ...
     */
    public static final class GMObstacleInfo extends com.google.protobuf.GeneratedMessageV3
            implements
        ...
        public static final com.google.protobuf.Descriptors.Descriptor getDescriptor() {
            return emu.grasscutter.net.proto.GMObstacleInfoOuterClass
        ...
        protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
            ...
            return emu.grasscutter.net.proto.GMObstacleInfoOuterClass
                    ...
                    .ensureFieldAccessorsInitialized(
                            emu.grasscutter.net.proto.GMObstacleInfoOuterClass.GMObstacleInfo.class,
                            emu.grasscutter.net.proto.GMObstacleInfoOuterClass.GMObstacleInfo.Builder.class);
        }
        ...
        public emu.grasscutter.net.proto.ObstacleInfoOuterClass.ObstacleInfo.ShapeType getShape() {
            ...
            emu.grasscutter.net.proto.ObstacleInfoOuterClass.ObstacleInfo.ShapeType result =
                    emu.grasscutter.net.proto.ObstacleInfoOuterClass.ObstacleInfo.ShapeType.valueOf(shape_);
            return result == null
                    ? emu.grasscutter.net.proto.ObstacleInfoOuterClass.ObstacleInfo.ShapeType.UNRECOGNIZED
                    : result;
        }
        ...
        public int getSerializedSize() {
            ...
            if (shape_
                    != emu.grasscutter.net.proto.ObstacleInfoOuterClass.ObstacleInfo.ShapeType
                            .OBSTACLE_SHAPE_CAPSULE
                            .getNumber()) {
                size += com.google.protobuf.CodedOutputStream.computeEnumSize(2, shape_);
            }
            if (extents_ != null) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(3, getExtents());
            }
            if (obstacleId_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeInt32Size(4, obstacleId_);
            }
            if (center_ != null) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(5, getCenter());
            }
            if (rotation_ != null) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(11, getRotation());
            }
            if (timestamp_ != 0L) {
        ...
        public boolean equals(final java.lang.Object obj) {
            ...
            emu.grasscutter.net.proto.GMObstacleInfoOuterClass.GMObstacleInfo other =
                    (emu.grasscutter.net.proto.GMObstacleInfoOuterClass.GMObstacleInfo) obj;
        ...
        public static emu.grasscutter.net.proto.GMObstacleInfoOuterClass.GMObstacleInfo
        ...
        public static Builder newBuilder(
                emu.grasscutter.net.proto.GMObstacleInfoOuterClass.GMObstacleInfo prototype) {
        ...
        public static final class Builder
            ...
            // Construct using
            // emu.grasscutter.net.proto.GMObstacleInfoOuterClass.GMObstacleInfo.newBuilder()
            private Builder() {
            ...
            @java.lang.Override
            public emu.grasscutter.net.proto.GMObstacleInfoOuterClass.GMObstacleInfo
                    getDefaultInstanceForType() {
                return emu.grasscutter.net.proto.GMObstacleInfoOuterClass.GMObstacleInfo
                        .getDefaultInstance();
            }
            ...
            public emu.grasscutter.net.proto.GMObstacleInfoOuterClass.GMObstacleInfo buildPartial() {
                emu.grasscutter.net.proto.GMObstacleInfoOuterClass.GMObstacleInfo result =
                        new emu.grasscutter.net.proto.GMObstacleInfoOuterClass.GMObstacleInfo(this);
                if (centerBuilder_ == null) {
            ...
            public Builder mergeFrom(
                    emu.grasscutter.net.proto.GMObstacleInfoOuterClass.GMObstacleInfo other) {
                if (other
                        == emu.grasscutter.net.proto.GMObstacleInfoOuterClass.GMObstacleInfo
            ...
            public Builder mergeExtents(emu.grasscutter.net.proto.Vector3IntOuterClass.Vector3Int value) {
                if (extentsBuilder_ == null) {
                    if (extents_ != null) {
                        extents_ =
                                emu.grasscutter.net.proto.Vector3IntOuterClass.Vector3Int.newBuilder(extents_)
                                        .mergeFrom(value)
                                        .buildPartial();
                    } else {
                        extents_ = value;
            ...
            public Builder setShape(
                    emu.grasscutter.net.proto.ObstacleInfoOuterClass.ObstacleInfo.ShapeType value) {
                if (value == null) {
                    throw new NullPointerException();
                }
        ...
        private static final emu.grasscutter.net.proto.GMObstacleInfoOuterClass.GMObstacleInfo
                DEFAULT_INSTANCE;
        ...
        private static final com.google.protobuf.Parser<GMObstacleInfo> PARSER =
                new com.google.protobuf.AbstractParser<GMObstacleInfo>() {
                    @java.lang.Override
    ...
    static {
        ...
        internal_static_GMObstacleInfo_descriptor = getDescriptor().getMessageTypes().get(0);
        internal_static_GMObstacleInfo_fieldAccessorTable =
                new com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
                        internal_static_GMObstacleInfo_descriptor,
                        new java.lang.String[] {
                            "Center", "Extents", "Shape", "Timestamp", "Rotation", "ObstacleId",
                        });
        emu.grasscutter.net.proto.VectorOuterClass.getDescriptor();
        emu.grasscutter.net.proto.Vector3IntOuterClass.getDescriptor();
        emu.grasscutter.net.proto.ObstacleInfoOuterClass.getDescriptor();
