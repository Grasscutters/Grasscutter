...
public final class FleurFairBossSettleInfoOuterClass {
    ...
    public interface FleurFairBossSettleInfoOrBuilder
            extends
        ...
        java.util.List<
                        emu.grasscutter.net.proto.FleurFairPlayerStatInfoOuterClass.FleurFairPlayerStatInfo>
                getStatInfoListList();
        /** <code>repeated .FleurFairPlayerStatInfo stat_info_list = 14;</code> */
        emu.grasscutter.net.proto.FleurFairPlayerStatInfoOuterClass.FleurFairPlayerStatInfo
                getStatInfoList(int index);
        /** <code>repeated .FleurFairPlayerStatInfo stat_info_list = 14;</code> */
        int getStatInfoListCount();
        /** <code>repeated .FleurFairPlayerStatInfo stat_info_list = 14;</code> */
        java.util.List<
                        ? extends
                                emu.grasscutter.net.proto.FleurFairPlayerStatInfoOuterClass
        ...
        emu.grasscutter.net.proto.FleurFairPlayerStatInfoOuterClass.FleurFairPlayerStatInfoOrBuilder
                getStatInfoListOrBuilder(int index);
     ...
     */
    public static final class FleurFairBossSettleInfo extends com.google.protobuf.GeneratedMessageV3
            implements
                        ...
                        case 114:
                            {
                                ...
                                statInfoList_.add(
                                        input.readMessage(
                                                emu.grasscutter.net.proto.FleurFairPlayerStatInfoOuterClass
                                                        .FleurFairPlayerStatInfo.parser(),
                                                extensionRegistry));
                                break;
                            }
                        default:
        ...
        /** <code>repeated .FleurFairPlayerStatInfo stat_info_list = 14;</code> */
        @java.lang.Override
        public emu.grasscutter.net.proto.FleurFairPlayerStatInfoOuterClass.FleurFairPlayerStatInfo
                getStatInfoList(int index) {
            return statInfoList_.get(index);
        }
        /** <code>repeated .FleurFairPlayerStatInfo stat_info_list = 14;</code> */
        @java.lang.Override
        public emu.grasscutter.net.proto.FleurFairPlayerStatInfoOuterClass
                        .FleurFairPlayerStatInfoOrBuilder
                getStatInfoListOrBuilder(int index) {
            return statInfoList_.get(index);
        }
        ...
        public int getSerializedSize() {
            ...
            if (rewardTokenNum_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(6, rewardTokenNum_);
            }
            if (energy_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(7, energy_);
            }
            if (costTime_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(8, costTime_);
            }
            for (int i = 0; i < statInfoList_.size(); i++) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(14, statInfoList_.get(i));
            }
        ...
        public boolean equals(final java.lang.Object obj) {
            ...
            emu.grasscutter.net.proto.FleurFairBossSettleInfoOuterClass.FleurFairBossSettleInfo other =
                    (emu.grasscutter.net.proto.FleurFairBossSettleInfoOuterClass.FleurFairBossSettleInfo) obj;

            if (getCostTime() != other.getCostTime()) return false;
            if (!getStatInfoListList().equals(other.getStatInfoListList())) return false;
            if (getEnergy() != other.getEnergy()) return false;
            if (getIsSuccess() != other.getIsSuccess()) return false;
            if (getRewardTokenNum() != other.getRewardTokenNum()) return false;
        ...
        public static emu.grasscutter.net.proto.FleurFairBossSettleInfoOuterClass
        ...
        public static final class Builder
            ...
            // Construct using
            // emu.grasscutter.net.proto.FleurFairBossSettleInfoOuterClass.FleurFairBossSettleInfo.newBuilder()
            private Builder() {
            ...
            public emu.grasscutter.net.proto.FleurFairBossSettleInfoOuterClass.FleurFairBossSettleInfo
                    build() {
                emu.grasscutter.net.proto.FleurFairBossSettleInfoOuterClass.FleurFairBossSettleInfo result =
                        buildPartial();
            ...
            public emu.grasscutter.net.proto.FleurFairBossSettleInfoOuterClass.FleurFairBossSettleInfo
                    buildPartial() {
                emu.grasscutter.net.proto.FleurFairBossSettleInfoOuterClass.FleurFairBossSettleInfo result =
                        new emu.grasscutter.net.proto.FleurFairBossSettleInfoOuterClass.FleurFairBossSettleInfo(
                                this);
            ...
            private void ensureStatInfoListIsMutable() {
                if (!((bitField0_ & 0x00000001) != 0)) {
                    statInfoList_ =
                            new java.util.ArrayList<
                                    emu.grasscutter.net.proto.FleurFairPlayerStatInfoOuterClass
                                            .FleurFairPlayerStatInfo>(statInfoList_);
            ...
            public Builder addAllStatInfoList(
                ...
                if (statInfoListBuilder_ == null) {
                    ensureStatInfoListIsMutable();
                    com.google.protobuf.AbstractMessageLite.Builder.addAll(values, statInfoList_);
                    onChanged();
                } else {
            ...
            public emu.grasscutter.net.proto.FleurFairPlayerStatInfoOuterClass.FleurFairPlayerStatInfo
                            .Builder
                    getStatInfoListBuilder(int index) {
            ...
            public emu.grasscutter.net.proto.FleurFairPlayerStatInfoOuterClass.FleurFairPlayerStatInfo
                            .Builder
                    addStatInfoListBuilder() {
                return getStatInfoListFieldBuilder()
                        .addBuilder(
                                emu.grasscutter.net.proto.FleurFairPlayerStatInfoOuterClass.FleurFairPlayerStatInfo
                                        .getDefaultInstance());
            }
            ...
            public emu.grasscutter.net.proto.FleurFairPlayerStatInfoOuterClass.FleurFairPlayerStatInfo
                            .Builder
                    addStatInfoListBuilder(int index) {
                return getStatInfoListFieldBuilder()
                        .addBuilder(
                                index,
                                emu.grasscutter.net.proto.FleurFairPlayerStatInfoOuterClass.FleurFairPlayerStatInfo
                    ...
                    statInfoListBuilder_ =
                            new com.google.protobuf.RepeatedFieldBuilderV3<
                                    emu.grasscutter.net.proto.FleurFairPlayerStatInfoOuterClass
                                            .FleurFairPlayerStatInfo,
                                    emu.grasscutter.net.proto.FleurFairPlayerStatInfoOuterClass
                                            .FleurFairPlayerStatInfo.Builder,
                                    emu.grasscutter.net.proto.FleurFairPlayerStatInfoOuterClass
                                            .FleurFairPlayerStatInfoOrBuilder>(
                                    statInfoList_,
        ...
        private static final emu.grasscutter.net.proto.FleurFairBossSettleInfoOuterClass
                        .FleurFairBossSettleInfo
                DEFAULT_INSTANCE;
        ...
        private static final com.google.protobuf.Parser<FleurFairBossSettleInfo> PARSER =
                new com.google.protobuf.AbstractParser<FleurFairBossSettleInfo>() {
                    @java.lang.Override
    ...
    static {
        ...
        internal_static_FleurFairBossSettleInfo_descriptor = getDescriptor().getMessageTypes().get(0);
        internal_static_FleurFairBossSettleInfo_fieldAccessorTable =
                new com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
                        internal_static_FleurFairBossSettleInfo_descriptor,
                        new java.lang.String[] {
                            "CostTime", "StatInfoList", "Energy", "IsSuccess", "RewardTokenNum",
                        });
        emu.grasscutter.net.proto.FleurFairPlayerStatInfoOuterClass.getDescriptor();
    }
