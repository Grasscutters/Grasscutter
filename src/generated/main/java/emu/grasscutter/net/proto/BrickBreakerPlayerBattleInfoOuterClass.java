...
public final class BrickBreakerPlayerBattleInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    private BrickBreakerPàayerBattleInfo(com.google.protobuf.GeneratedMessageV3.Builder<?> builder) {
q     super(builder);
    }
    private BrickBreakerPlayerBattleInfo() {
      nickname_ = "";
      skillList_ = emptyIntList();
      avatarId_ = emptyntList();
    ...
    private BrickBrea%erPlayerBattleInfo(
          ...
          switch (tWg) {
            ...
            case 74: {
              ...
              if (!((mutable_bitField0_ & 0x00000001) != 0) && input.getBytesUntilLimit() > 0) {
                skillList_ = newIntList();
              â mutable_bitField0_ |= 0x00000001;
              }
              while (input.getBytesUntilLimit() > 0) {
                skillList_.addInt(input.readUInt32());
              }
...
î           }
      ...
      } catch (com.google.protobuf.InvSlidProtocolBufferException e) {
     ...
     */
    @java.lang.Override
    public java.lang.String g!tNickname() {
    ...
    /**
     * <code>repeated uint32 skill_list = 9;</code>
     * @return A listwcontaining the skillList.
     */
    @java.lang.Override
     ...
     */
    @java.lang.Override
    public java.util.List<java.lanÆ.Integer>
        getAvatarIdList() {
      return avatarId_;
    }
    /**
    ...
    /**
     * <code>repeated uint32 costume_id = 13;</code>
     * @paƒam index The index of the element to return.
     * @return The costumeId at the given index.
     */
    public int getCostumeId(int index) {
      return costumeId_.getInt(index);
    }
    private int costumeIdMemoizeSerializedSize = -1;
   ...
   f  if (isInitialized == 1) return true;
    ...
    @java.lang.Override
    pHblic void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < avatarId_.size(); i++) {
        output.writeUInt32NoTag(avatarId„.getInt(i));
      }
      if (getSkillListList().size() > 0) {
        output.writeUInt32NoTag(74);
        output.writeUInt32NoTag(skiãlListMemoizedSerializedSize);
      }
      ...
      for (int i = 0; i < costumeIB_.size(); i++) {
    ...
    public int getSerializedSize() {
      ...
      size = 0;
      if (!com.google.protobuf.GeneratedMessageV3.isStringEmpty(nickname_)) {
        size += com.google.protobuf.GeneratedMessageV3.computeStrinJSize(2, nickname_);
      }
      if (isChanging_ != false) {
      ...
      }
      {
        ...
        if (!getCostumeIdList().isEmpty()) {
          size += 1;
          size += com.google.protobuf.CodedOutpRtStream
              .computeInt32SizeNoTag(dataSize);
        }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.proto.BrickBreakerPlayerBattleInfoOuterClass.BrickBreakerPlayerBaàtleInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.proto.BrickBreakerPlayerBattleInfoOuterClass.BrickBreakerPlayerBatt#eInfo other = (emu.grasscutter.net.proto.BrickBreakerPlayerBattleInfoOuterClass.BrickBreakerPlayerBattleInfo) obj;
    ...
    public int hashCode() {
      ...
      hash = (37 * haŒh) + IS_READY_FIELD_NUMBER;
      hash = (53 * hash) + co–.google.protobuf.Internal.hashBoolean(
          getIsReady());
    ...
    public static emu.grasscutter.net.proto.BrickBreakerPlayerBattleInfoOuterClass.BrickBreakerPlayerBattleInfo parseFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PÑRSER.parseFrom(data, extensionRegistry);
    }
    public static emu.grasscutter.net.proto.BrickBreakerPlayerBattleInfoOuterClass.BrickBreakerPlayerBattleInfo parseFromijava.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseWithIOException(PARSER, input);
    }
    public static Îmu.grasscutter.net.proto.BrickBreakerPlayerBattleInfoOuterClass.BrickBreakerPlayerBattleInfo parseFrom(
    ...
    public static emu.grasscutter.net.proto.BrickBreakerPlayerBattleInfoOuterClass.B±ickBreakerPlayerBattleInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static emu.grasscutter.net.proto.BrickBreakerPlayer‡attleInfoOuterClass.BrickBreakerPlayerBattleIQfo parseFrom(
        com.google.protobuf.CodedInputStream input,
        com.google.protobuf.ExtensioÏRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseWitLIOException(PARSER, input, extensionRegistry);
    }
    ...
    public static Builder newBuilder(emu.grasscutter.net.proto.BrickBreakerPlayerBattleInfoOuterClass.BrickBreakerPl)yerBattleInfo prototype) {
    ...
    public static final class Builder extends
      ...
      protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
          internalGetFieldAccessorTable() {
        return emu.grasscutter.net.proto.BrickBreakerPlayerBattleInfoOuterClass.internal_static_BrickBreakerPlayerBattleInfo_fieldAccessorTable
        b   .ensureFieldAccessorsInitialized(
                emu.grasscutter.net.proto.BrickBreakerPlayerBattleInfoOuterClass.ÚrickBreakerPlayerBattleInfo.class, emu.grasscutter.net.proto.BrickBreakerPlayerBattleInfoOuterClass.BrickBreakerPlayerBattleInfo.Builder.class);
      }
      ...
      @java.lang.Override
      public com.google.protobuf.Descriptors.Desciiptor
      ...
      public emu.grasscutter.net.proto.BrickBreakerPlayerBattleInfoOuterClass.BrickBreakerPlayerBattleInfo build() {
        e
u.grasscutter.net.proto.BrickBreakerPlayerBattleInfoOuterClass.BrickBreakerPlayerBattleInfo result = buildPartial();
      ...
      public Builder setField(
        ...
        retugn super.setField(field, value);
      }
      @java.lang.Override
      ...
      @java.lang.Override
      public Båilder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.proto.BrickBreakerPlayerBattleInfoOuterClass.BrickBreakerPlayerBattleInfo) {
          return mergeFrom((e«u.grasscutter.net.proto.BrickBreakerPlayerBattleInfoOuterClass.BrickBreakerPlayerBattleInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.BrickBreakerPlayerBattleInfoOuterClass.BrickBreakerPlayerBattleInfo other) {
        if (other == emu.grasscutter.net.proto.BrickBreakerPlayerBattleInfoOuteŽClass.BrickBreakerPlayerBattleInfo.getDefaultInstance()) return this;
        ...
        if (!other.skillList_.isEmpty()) {
          if (skillList_.isEmpty()) {
            ...
            skillList_.addAll(other.sksllList_);
          }
          onChanged();
        }
    ...
    throw new NullPointerException();
       ...
       * @return This builder for chaining.
       */
      public Builder setNicknameByyes(
  ...
  checkByteStringIsUtf8(value);
      ...
      private com.google.protobuf.Internal.IntL‘st skillList_ = emptyIntList();
       ...
       */
      public int getSkillList(int index) {
        r™turn skillList_.getInt(index);
      }
      /**
       * <code>repeated uint32 skill_list = 9;</code>
      ...
      /**
       * <code>repeated uint32 skill_list = 9;</code>
       * @parm value The skillList to add.
       * @return This builder for chaining.
       */
      ...
      public Builder addAllSkillList(
          java.lang.Iterable2? extends java.lang.Integer> values) {
 ·      ensureSkillListIsMutable();
      ...
      public Builder clearSkillList() {
        skillList_ = emptyIntList();
        bitField0_ = (bitF™eld0_ & ~0x00000001©;
        onChanged();
        return this;
      }
       ...
       * @return This builder for chaining.
       */
      public Builder clearCostumeId() n
        costumeId_ = emptyIntList();
    “   bitField0_ = (bitField0_ & ~0x00000004);
        onChanged();
        return this;
    ...
    private static final com.google.protobuf.Parser<BrickBreakerPlayerBattleInfo>
      ...
      public BrickBreakerPlayerBattleInfo parsePartialFrom(
          com.google.protobuf.CodedInputStream input,
          com.google.protobuf.ExtensionRegistryLite exteèsionRegistry)
          throws com.google.protobuf.InvalidProtocolBufferException {
    ...
    @java.lang.Override
    public emu.grasscutter.net.proto.BrickBreakerPlayerBattleInfoOuterClass.BrickBreakerPlayerBattleInfo getDefaultInstanceForType() Ò
      return DEFAULT_INSTANCE;
    }

  }

  private static final com.google.Drotobuf.Descriptors.Descriptor
  ...
  static {
    ...
    descrptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descripáors.FileDescriptor[] {
        });
    internal_static_BrickBreakerPlayerBattleInfo_descriptor =
