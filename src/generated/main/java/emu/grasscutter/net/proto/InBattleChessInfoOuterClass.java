...
public final class InBattleChessInfoOuterClass {
  ...
  public interface InBattleChessInfoOrBuilder extends
    ...
    emu.grasscutter.net.proto.ChessPlayerInfoOuterClass.ChessPlayerInfo getAbhkjjjcfcdOrDefault(
        int key,
    ...
    emu.grasscutter.net.proto.ChessPlayerInfoOuterClass.ChessPlayerInfo getAbhkjjjcfcdOrThrow(
        int key);
     ...
     */
    emu.grasscutter.net.proto.ChessMysteryInfoOuterClass.ChessMysteryInfo getDcfcppdjgod();
    /**
     * <code>.ChessMysteryInfo dcfcppdjgod = 10;</code>
     */
    emu.grasscutter.net.proto.ChessMysteryInfoOuterClass.ChessMysteryInfoOrBuilder getDcfcppdjgodOrBuilder();
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 82: {
              ...
              dcfcppdjgod_ = input.readMessage(emu.grasscutter.net.proto.ChessMysteryInfoOuterClass.ChessMysteryInfo.parser(), extensionRegistry);
              if (subBuilder != null) {
      ...
      static final com.google.protobuf.MapEntry<
          java.lang.Integer, emu.grasscutter.net.proto.ChessPlayerInfoOuterClass.ChessPlayerInfo> defaultEntry =
              ...
              .<java.lang.Integer, emu.grasscutter.net.proto.ChessPlayerInfoOuterClass.ChessPlayerInfo>newDefaultInstance(
                  emu.grasscutter.net.proto.InBattleChessInfoOuterClass.internal_static_InBattleChessInfo_AbhkjjjcfcdEntry_descriptor, 
    ...
    private com.google.protobuf.MapField<
        java.lang.Integer, emu.grasscutter.net.proto.ChessPlayerInfoOuterClass.ChessPlayerInfo> abhkjjjcfcd_;
    ...
    @java.lang.Override
    @java.lang.Deprecated
    public java.util.Map<java.lang.Integer, emu.grasscutter.net.proto.ChessPlayerInfoOuterClass.ChessPlayerInfo> getAbhkjjjcfcd() {
    ...
    public java.util.Map<java.lang.Integer, emu.grasscutter.net.proto.ChessPlayerInfoOuterClass.ChessPlayerInfo> getAbhkjjjcfcdMap() {
    ...
    public emu.grasscutter.net.proto.ChessPlayerInfoOuterClass.ChessPlayerInfo getAbhkjjjcfcdOrDefault(
        int key,
        emu.grasscutter.net.proto.ChessPlayerInfoOuterClass.ChessPlayerInfo defaultValue) {
    ...
    public emu.grasscutter.net.proto.ChessPlayerInfoOuterClass.ChessPlayerInfo getAbhkjjjcfcdOrThrow(
        int key) {
    ...
    private emu.grasscutter.net.proto.ChessMysteryInfoOuterClass.ChessMysteryInfo dcfcppdjgod_;
    /**
     * <code>.ChessMysteryInfo dcfcppdjgod = 10;</code>
     * @return Whether the dcfcppdjgod field is set.
     */
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.proto.ChessMysteryInfoOuterClass.ChessMysteryInfo getDcfcppdjgod() {
      return dcfcppdjgod_ == null ? emu.grasscutter.net.proto.ChessMysteryInfoOuterClass.ChessMysteryInfo.getDefaultInstance() : dcfcppdjgod_;
    }
    /**
     * <code>.ChessMysteryInfo dcfcppdjgod = 10;</code>
     */
    @java.lang.Override
    public emu.grasscutter.net.proto.ChessMysteryInfoOuterClass.ChessMysteryInfoOrBuilder getDcfcppdjgodOrBuilder() {
    ...
    public static final class Builder extends
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.proto.ChessMysteryInfoOuterClass.ChessMysteryInfo, emu.grasscutter.net.proto.ChessMysteryInfoOuterClass.ChessMysteryInfo.Builder, emu.grasscutter.net.proto.ChessMysteryInfoOuterClass.ChessMysteryInfoOrBuilder> dcfcppdjgodBuilder_;
      /**
       * <code>.ChessMysteryInfo dcfcppdjgod = 10;</code>
       * @return Whether the dcfcppdjgod field is set.
       */
       ...
       * <code>.ChessMysteryInfo dcfcppdjgod = 10;</code>
       */
      public Builder setDcfcppdjgod(emu.grasscutter.net.proto.ChessMysteryInfoOuterClass.ChessMysteryInfo value) {
        if (dcfcppdjgodBuilder_ == null) {
          if (value == null) {
       ...
       * <code>.ChessMysteryInfo dcfcppdjgod = 10;</code>
       */
      public Builder mergeDcfcppdjgod(emu.grasscutter.net.proto.ChessMysteryInfoOuterClass.ChessMysteryInfo value) {
        if (dcfcppdjgodBuilder_ == null) {
          if (dcfcppdjgod_ != null) {
            dcfcppdjgod_ =
              emu.grasscutter.net.proto.ChessMysteryInfoOuterClass.ChessMysteryInfo.newBuilder(dcfcppdjgod_).mergeFrom(value).buildPartial();
          } else {
            dcfcppdjgod_ = value;
          }
          onChanged();
       ...
       * <code>.ChessMysteryInfo dcfcppdjgod = 10;</code>
       */
      public emu.grasscutter.net.proto.ChessMysteryInfoOuterClass.ChessMysteryInfo.Builder getDcfcppdjgodBuilder() {
      ...
      public emu.grasscutter.net.proto.ChessMysteryInfoOuterClass.ChessMysteryInfoOrBuilder getDcfcppdjgodOrBuilder() {
        if (dcfcppdjgodBuilder_ != null) {
          ...
          return dcfcppdjgod_ == null ?
              emu.grasscutter.net.proto.ChessMysteryInfoOuterClass.ChessMysteryInfo.getDefaultInstance() : dcfcppdjgod_;
        }
      }
      /**
       * <code>.ChessMysteryInfo dcfcppdjgod = 10;</code>
