...
public final class WorldOwnerDailyTaskNotifyOuterClass {
    ...
    public static final class WorldOwnerDailyTaskNotify extends com.google.protobuf.GeneratedMessageV3
        ...
        public int getSerializedSize() {
            ...
            size = 0;
            if (finishedDailyTaskNum_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(5, finishedDailyTaskNum_);
            }
            if (filterCityId_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(6, filterCityId_);
            }
            for (int i = 0; i < taskList_.size(); i++) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(15, taskList_.get(i));
            }
