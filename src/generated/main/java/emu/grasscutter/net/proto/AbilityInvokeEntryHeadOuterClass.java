...
public final class AbilityInvokeEntryHeadOuterClass {
    ...
    public static final class AbilityInvokeEntryHead extends com.google.protobuf.GeneratedMessageV3
        ...
        public int getSerializedSize() {
            ...
            size = 0;
            if (localId_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeInt32Size(1, localId_);
            }
            if (isServerbuffModifier_ != false) {
                size += com.google.protobuf.CodedOutputStream.computeBoolSize(3, isServerbuffModifier_);
            }
            if (targetId_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(4, targetId_);
            }
            if (instancedAbilityId_ != 0) {
            ...
            if (modifierConfigLocalId_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeInt32Size(12, modifierConfigLocalId_);
            }
