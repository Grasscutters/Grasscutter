...
public final class AvatarEnterSceneInfoOuterClass {
    ...
    public static final class AvatarEnterSceneInfo extends com.google.protobuf.GeneratedMessageV3
        ...
        public int getSerializedSize() {
            ...
            size = 0;
            if (weaponGuid_ != 0L) {
                size += com.google.protobuf.CodedOutputStream.computeUInt64Size(4, weaponGuid_);
            }
            if (weaponAbilityInfo_ != null) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(5, getWeaponAbilityInfo());
            }
            if (avatarAbilityInfo_ != null) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(6, getAvatarAbilityInfo());
            }
            if (avatarGuid_ != 0L) {
                size += com.google.protobuf.CodedOutputStream.computeUInt64Size(7, avatarGuid_);
            }
            if (avatarEntityId_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(12, avatarEntityId_);
            }
            for (int i = 0; i < serverBuffList_.size(); i++) {
                size +=
                        com.google.protobuf.CodedOutputStream.computeMessageSize(13, serverBuffList_.get(i));
            }
            {
                int dataSize = 0;
                for (int i = 0; i < buffIdList_.size(); i++) {
            ...
            if (weaponEntityId_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(15, weaponEntityId_);
            }
    ...
    static {
        java.lang.String[] descriptorData = {
            "\n\032AvatarEnterSceneInfo.proto\032\032AbilitySyn"
                    ...
                    + "\r \003(\0132\013.ServerBuff\022\023\n\013avatar_guid\030\007 \001(\004\022"
                    + "\023\n\013weapon_guid\030\004 \001(\004\0222\n\023avatar_ability_i"
                    + "nfo\030\006 \001(\0132\025.AbilitySyncStateInfo\022\024\n\014buff"
                    + "_id_list\030\016 \003(\r\022\030\n\020weapon_entity_id\030\017 \001(\r"
                    + "\0222\n\023weapon_ability_info\030\005 \001(\0132\025.AbilityS"
                    + "yncStateInfo\022\030\n\020avatar_entity_id\030\014 \001(\rB\033"
