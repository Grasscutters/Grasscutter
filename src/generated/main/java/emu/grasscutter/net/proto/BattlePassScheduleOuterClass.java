...
public final class BattlePassScheduleOuterClass {
    ...
    public interface BattlePassScheduleOrBuilder
        ...
        /**
         * <code>.BattlePassCycle cur_cycle = 13;</code>
         *
        ...
        /**
         * <code>uint32 paid_platform_flags = 15;</code>
         *
        ...
        /**
         * <code>.BattlePassProduct product_info = 7;</code>
         *
    ...
    public static final class BattlePassSchedule extends com.google.protobuf.GeneratedMessageV3
        ...
        public static final int CUR_CYCLE_FIELD_NUMBER = 13;
        ...
        public static final int PAID_PLATFORM_FLAGS_FIELD_NUMBER = 15;
        ...
        public int getSerializedSize() {
            ...
            if (unlockStatus_
                    != emu.grasscutter.net.proto.BattlePassUnlockStatusOuterClass.BattlePassUnlockStatus
                            .BATTLE_PASS_UNLOCK_STATUS_INVALID
                            .getNumber()) {
                size += com.google.protobuf.CodedOutputStream.computeEnumSize(2, unlockStatus_);
            }
            if (endTime_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(3, endTime_);
            }
            if (scheduleId_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(4, scheduleId_);
            }
            if (level_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(5, level_);
            }
            if (point_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(6, point_);
            }
            if (productInfo_ != null) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(7, getProductInfo());
            }
            for (int i = 0; i < rewardTakenList_.size(); i++) {
                size +=
            ...
            if (isViewed_ != false) {
                size += com.google.protobuf.CodedOutputStream.computeBoolSize(11, isViewed_);
            }
            if (isExtraPaidRewardTaken_ != false) {
                size += com.google.protobuf.CodedOutputStream.computeBoolSize(12, isExtraPaidRewardTaken_);
            }
            if (curCycle_ != null) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(13, getCurCycle());
            }
            if (curCyclePoints_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(14, curCyclePoints_);
            }
            if (paidPlatformFlags_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(15, paidPlatformFlags_);
            }
    ...
    static {
        java.lang.String[] descriptorData = {
            "\n\030BattlePassSchedule.proto\032\025BattlePassCy"
                    ...
                    + "r_cycle\030\r \001(\0132\020.BattlePassCycle\022\"\n\032is_ex"
                    + "tra_paid_reward_taken\030\014 \001(\010\022\r\n\005point\030\006 \001"
                    + "(\r\022\r\n\005level\030\005 \001(\r\022\030\n\020cur_cycle_points\030\016 "
                    + "\001(\r\022\021\n\tis_viewed\030\013 \001(\010\022.\n\runlock_status\030"
                    + "\002 \001(\0162\027.BattlePassUnlockStatus\022\023\n\013schedu"
                    + "le_id\030\004 \001(\r\022\022\n\nbegin_time\030\001 \001(\r\022\033\n\023paid_"
                    + "platform_flags\030\017 \001(\r\022(\n\014product_info\030\007 \001"
                    + "(\0132\022.BattlePassProduct\022\020\n\010end_time\030\003 \001(\r"
                    + "\022/\n\021reward_taken_list\030\t \003(\0132\024.BattlePass"
