...
public final class VehicleInfoOuterClass {
    ...
    public interface VehicleInfoOrBuilder
        ...
        /** <code>repeated .VehicleMember member_list = 1;</code> */
        java.util.List<
                        ? extends emu.grasscutter.net.proto.VehicleMemberOuterClass.VehicleMemberOrBuilder>
     ...
     */
    public static final class VehicleInfo extends com.google.protobuf.GeneratedMessageV3
            implements
        ...
        protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
            ...
            return emu.grasscutter.net.proto.VehicleInfoOuterClass
                    .internal_static_VehicleInfo_fieldAccessorTable
                    .ensureFieldAccessorsInitialized(
                            emu.grasscutter.net.proto.VehicleInfoOuterClass.VehicleInfo.class,
                            emu.grasscutter.net.proto.VehicleInfoOuterClass.VehicleInfo.Builder.class);
        }

        public static final int MEMBER_LIST_FIELD_NUMBER = 1;
        private java.util.List<emu.grasscutter.net.proto.VehicleMemberOuterClass.VehicleMember>
                memberList_;
        /** <code>repeated .VehicleMember member_list = 1;</code> */
        @java.lang.Override
        public java.util.List<emu.grasscutter.net.proto.VehicleMemberOuterClass.VehicleMember>
                getMemberListList() {
            return memberList_;
        }
        /** <code>repeated .VehicleMember member_list = 1;</code> */
        ...
        /** <code>repeated .VehicleMember member_list = 1;</code> */
        @java.lang.Override
        public emu.grasscutter.net.proto.VehicleMemberOuterClass.VehicleMember getMemberList(
                int index) {
        ...
        public emu.grasscutter.net.proto.VehicleMemberOuterClass.VehicleMemberOrBuilder
                getMemberListOrBuilder(int index) {
            return memberList_.get(index);
        }
        ...
        public int getSerializedSize() {
            ...
            size = 0;
            for (int i = 0; i < memberList_.size(); i++) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(1, memberList_.get(i));
            }
            if (ownerUid_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(2, ownerUid_);
            }
            if (curStamina_ != 0F) {
                size += com.google.protobuf.CodedOutputStream.computeFloatSize(3, curStamina_);
            }
        ...
        public boolean equals(final java.lang.Object obj) {
            ...
            emu.grasscutter.net.proto.VehicleInfoOuterClass.VehicleInfo other =
                    (emu.grasscutter.net.proto.VehicleInfoOuterClass.VehicleInfo) obj;

            if (!getMemberListList().equals(other.getMemberListList())) return false;
            if (getOwnerUid() != other.getOwnerUid()) return false;
            if (java.lang.Float.floatToIntBits(getCurStamina())
                    != java.lang.Float.floatToIntBits(other.getCurStamina())) return false;
        ...
        public int hashCode() {
            ...
            hash = (53 * hash) + java.lang.Float.floatToIntBits(getCurStamina());
        ...
        public static Builder newBuilder(
                emu.grasscutter.net.proto.VehicleInfoOuterClass.VehicleInfo prototype) {
        ...
        public static final class Builder
            ...
            @java.lang.Override
            public emu.grasscutter.net.proto.VehicleInfoOuterClass.VehicleInfo
            ...
            public emu.grasscutter.net.proto.VehicleInfoOuterClass.VehicleInfo buildPartial() {
                emu.grasscutter.net.proto.VehicleInfoOuterClass.VehicleInfo result =
                        new emu.grasscutter.net.proto.VehicleInfoOuterClass.VehicleInfo(this);
            ...
            private void ensureMemberListIsMutable() {
                if (!((bitField0_ & 0x00000001) != 0)) {
                    memberList_ =
                            new java.util.ArrayList<
                                    emu.grasscutter.net.proto.VehicleMemberOuterClass.VehicleMember>(memberList_);
            ...
            public Builder addAllMemberList(
                    java.lang.Iterable<
                                    ? extends emu.grasscutter.net.proto.VehicleMemberOuterClass.VehicleMember>
                            values) {
                if (memberListBuilder_ == null) {
                    ensureMemberListIsMutable();
                    com.google.protobuf.AbstractMessageLite.Builder.addAll(values, memberList_);
                    onChanged();
                } else {
            ...
            public emu.grasscutter.net.proto.VehicleMemberOuterClass.VehicleMember.Builder
                    getMemberListBuilder(int index) {
            ...
            /** <code>repeated .VehicleMember member_list = 1;</code> */
            public emu.grasscutter.net.proto.VehicleMemberOuterClass.VehicleMember.Builder
                    addMemberListBuilder() {
                return getMemberListFieldBuilder()
                        .addBuilder(
                                emu.grasscutter.net.proto.VehicleMemberOuterClass.VehicleMember
                                        .getDefaultInstance());
            }
            /** <code>repeated .VehicleMember member_list = 1;</code> */
            public emu.grasscutter.net.proto.VehicleMemberOuterClass.VehicleMember.Builder
                    addMemberListBuilder(int index) {
                return getMemberListFieldBuilder()
                        .addBuilder(
                                index,
                                emu.grasscutter.net.proto.VehicleMemberOuterClass.VehicleMember
                ...
                if (memberListBuilder_ == null) {
                    memberListBuilder_ =
                            new com.google.protobuf.RepeatedFieldBuilderV3<
                                    ...
                                    emu.grasscutter.net.proto.VehicleMemberOuterClass.VehicleMember.Builder,
                                    emu.grasscutter.net.proto.VehicleMemberOuterClass.VehicleMemberOrBuilder>(
                                    memberList_, ((bitField0_ & 0x00000001) != 0), getParentForChildren(), isClean());
                    memberList_ = null;
                }
        ...
        private static final emu.grasscutter.net.proto.VehicleInfoOuterClass.VehicleInfo
                DEFAULT_INSTANCE;
        ...
        internal_static_VehicleInfo_fieldAccessorTable =
                new com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
                        ...
                        new java.lang.String[] {
                            "MemberList", "OwnerUid", "CurStamina",
                        });
        emu.grasscutter.net.proto.VehicleMemberOuterClass.getDescriptor();
    }
