...
public final class ShowEquipOuterClass {
    ...
    public interface ShowEquipOrBuilder
            extends
     ...
     */
    public static final class ShowEquip extends com.google.protobuf.GeneratedMessageV3
            implements
                        ...
                        case 18:
                            {
                                ...
                                detail_ =
                                        input.readMessage(
                                                emu.grasscutter.net.proto.ReliquaryOuterClass.Reliquary.parser(),
                                                extensionRegistry);
                                if (subBuilder != null) {
                        ...
                        case 26:
                            {
                                ...
                                if (detailCase_ == 3) {
                                    subBuilder =
                                            ((emu.grasscutter.net.proto.WeaponOuterClass.Weapon) detail_).toBuilder();
                                }
                                detail_ =
                                        input.readMessage(
                                                emu.grasscutter.net.proto.WeaponOuterClass.Weapon.parser(),
                                                extensionRegistry);
                                if (subBuilder != null) {
        ...
        protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
            ...
            return emu.grasscutter.net.proto.ShowEquipOuterClass
                    ...
                    .ensureFieldAccessorsInitialized(
                            emu.grasscutter.net.proto.ShowEquipOuterClass.ShowEquip.class,
                            emu.grasscutter.net.proto.ShowEquipOuterClass.ShowEquip.Builder.class);
        }
        ...
        /** <code>.Reliquary reliquary = 2;</code> */
        @java.lang.Override
        public emu.grasscutter.net.proto.ReliquaryOuterClass.ReliquaryOrBuilder
                getReliquaryOrBuilder() {
            if (detailCase_ == 2) {
                return (emu.grasscutter.net.proto.ReliquaryOuterClass.Reliquary) detail_;
            }
            return emu.grasscutter.net.proto.ReliquaryOuterClass.Reliquary.getDefaultInstance();
        ...
        public int getSerializedSize() {
            ...
            size = 0;
            if (itemId_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(1, itemId_);
            }
            if (detailCase_ == 2) {
                size +=
                        com.google.protobuf.CodedOutputStream.computeMessageSize(
                                2, (emu.grasscutter.net.proto.ReliquaryOuterClass.Reliquary) detail_);
            }
            if (detailCase_ == 3) {
                size +=
                        com.google.protobuf.CodedOutputStream.computeMessageSize(
                                3, (emu.grasscutter.net.proto.WeaponOuterClass.Weapon) detail_);
            }
        ...
        public boolean equals(final java.lang.Object obj) {
            ...
            emu.grasscutter.net.proto.ShowEquipOuterClass.ShowEquip other =
                    (emu.grasscutter.net.proto.ShowEquipOuterClass.ShowEquip) obj;

            if (getItemId() != other.getItemId()) return false;
            if (!getDetailCase().equals(other.getDetailCase())) return false;
            switch (detailCase_) {
                case 2:
                    if (!getReliquary().equals(other.getReliquary())) return false;
                    break;
                case 3:
        ...
        public static Builder newBuilder(
                emu.grasscutter.net.proto.ShowEquipOuterClass.ShowEquip prototype) {
        ...
        public static final class Builder
            ...
            public emu.grasscutter.net.proto.ShowEquipOuterClass.ShowEquip buildPartial() {
                emu.grasscutter.net.proto.ShowEquipOuterClass.ShowEquip result =
                        new emu.grasscutter.net.proto.ShowEquipOuterClass.ShowEquip(this);
            ...
            public Builder mergeFrom(emu.grasscutter.net.proto.ShowEquipOuterClass.ShowEquip other) {
                if (other == emu.grasscutter.net.proto.ShowEquipOuterClass.ShowEquip.getDefaultInstance())
                    return this;
            ...
            public Builder mergeFrom(
                ...
                try {
                    ...
                    parsedMessage =
                            (emu.grasscutter.net.proto.ShowEquipOuterClass.ShowEquip) e.getUnfinishedMessage();
            ...
            private com.google.protobuf.SingleFieldBuilderV3<
                            emu.grasscutter.net.proto.ReliquaryOuterClass.Reliquary,
                            emu.grasscutter.net.proto.ReliquaryOuterClass.Reliquary.Builder,
            ...
            public Builder mergeReliquary(emu.grasscutter.net.proto.ReliquaryOuterClass.Reliquary value) {
                if (reliquaryBuilder_ == null) {
                    if (detailCase_ == 2
                            && detail_
                                    != emu.grasscutter.net.proto.ReliquaryOuterClass.Reliquary.getDefaultInstance()) {
                        detail_ =
                                emu.grasscutter.net.proto.ReliquaryOuterClass.Reliquary.newBuilder(
                                                (emu.grasscutter.net.proto.ReliquaryOuterClass.Reliquary) detail_)
                                        .mergeFrom(value)
                                        .buildPartial();
                    } else {
            ...
            private com.google.protobuf.SingleFieldBuilderV3<
                            ...
                            emu.grasscutter.net.proto.WeaponOuterClass.Weapon.Builder,
            ...
            public Builder mergeWeapon(emu.grasscutter.net.proto.WeaponOuterClass.Weapon value) {
                if (weaponBuilder_ == null) {
                    if (detailCase_ == 3
                            && detail_
                                    != emu.grasscutter.net.proto.WeaponOuterClass.Weapon.getDefaultInstance()) {
                        detail_ =
                                emu.grasscutter.net.proto.WeaponOuterClass.Weapon.newBuilder(
        ...
        private static final com.google.protobuf.Parser<ShowEquip> PARSER =
                new com.google.protobuf.AbstractParser<ShowEquip>() {
                    @java.lang.Override
        ...
        internal_static_ShowEquip_fieldAccessorTable =
                new com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
                        ...
                        new java.lang.String[] {
                            "ItemId", "Reliquary", "Weapon", "Detail",
                        });
        emu.grasscutter.net.proto.ReliquaryOuterClass.getDescriptor();
        emu.grasscutter.net.proto.WeaponOuterClass.getDescriptor();
    }
