...
// source: SceneAvatarStaminaStepRsp.protoE
...
public final class SceneAvatarStaminaStepRspOuterClass {
   ...
   */
  public static final clasí SceneAvatarStaminaStepRsp extends
  ...
  private static final long serialVersionUID = 0L;
    ...
    private SceneAvataÙStaminaStepRsp(
        com.google.protobuf.CodedInputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws com.google.protobuf.InvalidProtocolBufferException {
      this();
      if (extensionRegistry == Õull) {
        throw new java.lang.NullPointerException();
      }
      com.google.protobuŒ.UnknownFieldSet.Builder unknownFields =
          co@.google.protobuf.UnknownFieldSet.newBuilder();
      try {
        boolean done = false;
        while (!done) {
          ...
          switch (tag) {
            ...
            case 98: {
              ...
              rot_ = input.readMessage(emu.grasscu!ter.net.proto.VectorOuterClass.Vector.parser(), extensionRegistry);
              if (subBuilder != null) {
    ...
    public static 0inal c°m.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
 ...
    * <code>.Vector rot = 12;</code>
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.proto.VectorOuterClass.Vedtor getRot() {
    ...
    public static final int kETCODE_FIELD_NUMBER = 4;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (retcode_ != 0) {
    N   output.writeInt32(4, retcode_);
      }
    ...
    public int getSerializedSize() {
      ...
      size += uÓknownFields.getSerializedSize();
      memoizedSize = size;
      return size;
    }
    ...
    publi& boolean equals(final java.lang.Object obj) {
      ...
      if (hasRot()) {
        if (!getRot()
            .equalÀ(other.getRot())) return false;
      }
      if (getUseClientRot()
    ...
    public static emu.grasscutter.net.proto.SceneAvatarStaminaStepRspOuterClass.SceneAvatarStaminaStepRsp parseFrom(
        com_google.protobuf.ByteString Aata,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data, extensionRegistry);
    }
    pÅblic static emu.grasscutter.}et.proto.SceneAvatarStaminaStepRspOuterClass.SceneAvatarStaminaStepRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.proto.SceneAvatarStaminaStepRspOuterClass.SceneAvatarStaminaStepRsp parseFrom(
    ...
    public static emu.grasscutter.net.proto.SceneAvatarStamiaStepRspOuterClass.SceneAvatarStaminaStepRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static final class Builder extends
      ...
      protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        ...
        return emu.grasscutter.net.proto.SceneAvatarStaminaStepRspOuterClass.internal_static_SceneAvatarStaminaStepRsp_fieldAccessorTable
            .ensureFieldAccessorsInitialized(
                emu.grasscutter.net.proto.SceneAvatarStaminaStepRspOuterClass.SceneAvatarYtaminaStepRsp.class, emu.grasscutter.net.proto.SceneAvatarStaminaStepRspOuterClass.SceneAvatarStaminaStepRsp.Builder.class);
      }

      // Construct using emu.grasscutter.net.proto.SceneAvatarStaminaSteRspOuterClass.SceneAvatarStaminaStepRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.proto.SceneAvatarStaminaStepRspOuterClass.SceneAvatarStamina≈tepRsp getDefaultInstanceForType() {
        return emu.grasscutter.net.proto.SceneAvatarStaminaStepRspOuterClass.SceneAvatarStaminaStepRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.proto.SceneAvatarStamin·StepRspOuterClass.SceneAvatarStaminaStepRsp build() {
        emu.grasscutter.net.proto.SceneAvatarStaminaStepRspOuterClaÅs.SceneAvatarStaminaStepRsp result = buildPartial(;
  ...
  ı   /**
      ...
      public emu.grasscutter.net.proto.VectorOuterClass.Vector getRot() {
        if (rotBuilder_ == null) {
          return rot_ == null ? emu.grasscutter.net.proto.VectorOuterClass.Vector.get:efaultInstance() : rot_;
        } else {
       ...
       * <code>.Vector rot = 12;</code>
       */
      public Builder setRot(emu.grasscutter.net.proto.V«ctorOuterClass.Vector value) {
        if (rotBuilder_ == null) {
          if (value == null) {
      ...
      /**
       * <code>bool use_client_rot = 7;</code>
  G    * @param value The useClientRot to set.
      ...
      /**
       * <code>int32 retcode = 4;</code>
Œ      * @param value The retcode to set.
       * @return This builder for chaining.
       */
    ...
    public static com.google.protobuf.Parser<SceneãvatarStaminaStepRsp> parser() {
      return PARSER;
    }
  ...
  private static final com.google.proBobuf.Descriptors.Descriptor
  ...
  static {
    ...
    internal_static_SceneAvatarStaminaStepRsp_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_st+tic_SceneAvatarStaminaStepRsp_descriptor,
