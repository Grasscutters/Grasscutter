...
public final class QueryRegionListHttpRspOuterClass {
    ...
    public interface QueryRegionListHttpRspOrBuilder
            extends
        ...
        /** <code>repeated .RegionSimpleInfo region_list = 2;</code> */
        emu.grasscutter.net.proto.RegionSimpleInfoOuterClass.RegionSimpleInfoOrBuilder
                getRegionListOrBuilder(int index);
     ...
     */
    public static final class QueryRegionListHttpRsp extends com.google.protobuf.GeneratedMessageV3
            implements
        ...
        public static final com.google.protobuf.Descriptors.Descriptor getDescriptor() {
            return emu.grasscutter.net.proto.QueryRegionListHttpRspOuterClass
        ...
        private java.util.List<emu.grasscutter.net.proto.RegionSimpleInfoOuterClass.RegionSimpleInfo>
                regionList_;
        /** <code>repeated .RegionSimpleInfo region_list = 2;</code> */
        @java.lang.Override
        public java.util.List<emu.grasscutter.net.proto.RegionSimpleInfoOuterClass.RegionSimpleInfo>
                getRegionListList() {
            return regionList_;
        }
        /** <code>repeated .RegionSimpleInfo region_list = 2;</code> */
        ...
        /** <code>repeated .RegionSimpleInfo region_list = 2;</code> */
        @java.lang.Override
        public emu.grasscutter.net.proto.RegionSimpleInfoOuterClass.RegionSimpleInfo getRegionList(
                int index) {
            return regionList_.get(index);
        }
        /** <code>repeated .RegionSimpleInfo region_list = 2;</code> */
        @java.lang.Override
        public emu.grasscutter.net.proto.RegionSimpleInfoOuterClass.RegionSimpleInfoOrBuilder
                getRegionListOrBuilder(int index) {
            return regionList_.get(index);
        }
        ...
        public int getSerializedSize() {
            ...
            for (int i = 0; i < regionList_.size(); i++) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(2, regionList_.get(i));
            }
            if (!clientSecretKey_.isEmpty()) {
                size += com.google.protobuf.CodedOutputStream.computeBytesSize(5, clientSecretKey_);
            }
            if (!clientCustomConfigEncrypted_.isEmpty()) {
                size +=
                        com.google.protobuf.CodedOutputStream.computeBytesSize(6, clientCustomConfigEncrypted_);
            }
            if (enableLoginPc_ != false) {
                size += com.google.protobuf.CodedOutputStream.computeBoolSize(7, enableLoginPc_);
            }
        ...
        public boolean equals(final java.lang.Object obj) {
            ...
            emu.grasscutter.net.proto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp other =
                    (emu.grasscutter.net.proto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp) obj;

            if (getRetcode() != other.getRetcode()) return false;
            if (!getRegionListList().equals(other.getRegionListList())) return false;
            if (!getClientSecretKey().equals(other.getClientSecretKey())) return false;
            if (!getClientCustomConfigEncrypted().equals(other.getClientCustomConfigEncrypted()))
                return false;
            if (getEnableLoginPc() != other.getEnableLoginPc()) return false;
        ...
        public int hashCode() {
            ...
            hash = (53 * hash) + com.google.protobuf.Internal.hashBoolean(getEnableLoginPc());
            hash = (29 * hash) + unknownFields.hashCode();
            memoizedHashCode = hash;
            return hash;
        }

        public static emu.grasscutter.net.proto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp
        ...
        public static final class Builder
            ...
            // Construct using
            // emu.grasscutter.net.proto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp.newBuilder()
            private Builder() {
            ...
            @java.lang.Override
            public emu.grasscutter.net.proto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp
                    getDefaultInstanceForType() {
                return emu.grasscutter.net.proto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp
                        .getDefaultInstance();
            }
            ...
            public emu.grasscutter.net.proto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp
                    build() {
                emu.grasscutter.net.proto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp result =
                        buildPartial();
            ...
            public emu.grasscutter.net.proto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp
                    buildPartial() {
                emu.grasscutter.net.proto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp result =
                        new emu.grasscutter.net.proto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp(
                                this);
            ...
            private com.google.protobuf.RepeatedFieldBuilderV3<
                            emu.grasscutter.net.proto.RegionSimpleInfoOuterClass.RegionSimpleInfo,
                            emu.grasscutter.net.proto.RegionSimpleInfoOuterClass.RegionSimpleInfo.Builder,
                            emu.grasscutter.net.proto.RegionSimpleInfoOuterClass.RegionSimpleInfoOrBuilder>
                    regionListBuilder_;
            ...
            public Builder addRegionList(
                    emu.grasscutter.net.proto.RegionSimpleInfoOuterClass.RegionSimpleInfo value) {
                if (regionListBuilder_ == null) {
                    if (value == null) {
                        throw new NullPointerException();
                    }
            ...
            public Builder addAllRegionList(
                    java.lang.Iterable<
                                    ? extends emu.grasscutter.net.proto.RegionSimpleInfoOuterClass.RegionSimpleInfo>
                            values) {
                if (regionListBuilder_ == null) {
                    ensureRegionListIsMutable();
                    com.google.protobuf.AbstractMessageLite.Builder.addAll(values, regionList_);
                    onChanged();
                } else {
            ...
            /** <code>repeated .RegionSimpleInfo region_list = 2;</code> */
            public emu.grasscutter.net.proto.RegionSimpleInfoOuterClass.RegionSimpleInfo.Builder
                    getRegionListBuilder(int index) {
            ...
            /** <code>repeated .RegionSimpleInfo region_list = 2;</code> */
            public emu.grasscutter.net.proto.RegionSimpleInfoOuterClass.RegionSimpleInfo.Builder
                    addRegionListBuilder() {
                return getRegionListFieldBuilder()
                        .addBuilder(
                                emu.grasscutter.net.proto.RegionSimpleInfoOuterClass.RegionSimpleInfo
                                        .getDefaultInstance());
            }
            /** <code>repeated .RegionSimpleInfo region_list = 2;</code> */
            public emu.grasscutter.net.proto.RegionSimpleInfoOuterClass.RegionSimpleInfo.Builder
                    addRegionListBuilder(int index) {
                return getRegionListFieldBuilder()
                        .addBuilder(
                                index,
                                emu.grasscutter.net.proto.RegionSimpleInfoOuterClass.RegionSimpleInfo
                ...
                if (regionListBuilder_ == null) {
                    regionListBuilder_ =
                            new com.google.protobuf.RepeatedFieldBuilderV3<
                                    ...
                                    emu.grasscutter.net.proto.RegionSimpleInfoOuterClass.RegionSimpleInfo.Builder,
                                    emu.grasscutter.net.proto.RegionSimpleInfoOuterClass.RegionSimpleInfoOrBuilder>(
                                    regionList_, ((bitField0_ & 0x00000001) != 0), getParentForChildren(), isClean());
                    regionList_ = null;
                }
        ...
        private static final emu.grasscutter.net.proto.QueryRegionListHttpRspOuterClass
        ...
        private static final com.google.protobuf.Parser<QueryRegionListHttpRsp> PARSER =
                new com.google.protobuf.AbstractParser<QueryRegionListHttpRsp>() {
                    @java.lang.Override
