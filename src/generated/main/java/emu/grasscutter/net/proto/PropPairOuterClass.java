...
public final class PropPairOuterClass {
    ...
    public interface PropPairOrBuilder
            extends
     ...
     */
    public static final class PropPair extends com.google.protobuf.GeneratedMessageV3
            implements
        ...
        protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
            ...
            return emu.grasscutter.net.proto.PropPairOuterClass
                    .internal_static_PropPair_fieldAccessorTable
                    .ensureFieldAccessorsInitialized(
                            emu.grasscutter.net.proto.PropPairOuterClass.PropPair.class,
                            emu.grasscutter.net.proto.PropPairOuterClass.PropPair.Builder.class);
        }
        ...
        /** <code>.PropValue prop_value = 2;</code> */
        @java.lang.Override
        public emu.grasscutter.net.proto.PropValueOuterClass.PropValueOrBuilder
        ...
        public int getSerializedSize() {
            ...
            if (propValue_ != null) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(2, getPropValue());
            }
        ...
        public boolean equals(final java.lang.Object obj) {
            ...
            emu.grasscutter.net.proto.PropPairOuterClass.PropPair other =
                    (emu.grasscutter.net.proto.PropPairOuterClass.PropPair) obj;

            if (getType() != other.getType()) return false;
            if (hasPropValue() != other.hasPropValue()) return false;
            if (hasPropValue()) {
                if (!getPropValue().equals(other.getPropValue())) return false;
            }
        ...
        public static Builder newBuilder(
                emu.grasscutter.net.proto.PropPairOuterClass.PropPair prototype) {
        ...
        public static final class Builder
            ...
            public emu.grasscutter.net.proto.PropPairOuterClass.PropPair buildPartial() {
                emu.grasscutter.net.proto.PropPairOuterClass.PropPair result =
                        new emu.grasscutter.net.proto.PropPairOuterClass.PropPair(this);
                result.type_ = type_;
                if (propValueBuilder_ == null) {
            ...
            public Builder mergeFrom(emu.grasscutter.net.proto.PropPairOuterClass.PropPair other) {
                if (other == emu.grasscutter.net.proto.PropPairOuterClass.PropPair.getDefaultInstance())
                    return this;
                if (other.getType() != 0) {
            ...
            public Builder mergeFrom(
                ...
                try {
                    ...
                    parsedMessage =
                            (emu.grasscutter.net.proto.PropPairOuterClass.PropPair) e.getUnfinishedMessage();
            ...
            public Builder mergePropValue(emu.grasscutter.net.proto.PropValueOuterClass.PropValue value) {
                if (propValueBuilder_ == null) {
                    if (propValue_ != null) {
                        propValue_ =
                                emu.grasscutter.net.proto.PropValueOuterClass.PropValue.newBuilder(propValue_)
                                        .mergeFrom(value)
                                        .buildPartial();
                    } else {
                        propValue_ = value;
                ...
                if (propValueBuilder_ == null) {
                    propValueBuilder_ =
                            new com.google.protobuf.SingleFieldBuilderV3<
                                    ...
                                    emu.grasscutter.net.proto.PropValueOuterClass.PropValue.Builder,
                                    emu.grasscutter.net.proto.PropValueOuterClass.PropValueOrBuilder>(
                                    getPropValue(), getParentForChildren(), isClean());
                    propValue_ = null;
                }
        ...
        private static final com.google.protobuf.Parser<PropPair> PARSER =
                new com.google.protobuf.AbstractParser<PropPair>() {
                    @java.lang.Override
