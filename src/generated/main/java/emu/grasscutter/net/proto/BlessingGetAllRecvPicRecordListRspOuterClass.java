...
public final class BlessingGetAllRecvPicRecordListRspOuterClass {
    ...
    public interface BlessingGetAllRecvPicRecordListRspOrBuilder
            extends
            // @@protoc_insertion_point(interface_extends:BlessingGetAllRecvPicRecordListRsp)
            com.google.protobuf.MessageOrBuilder {

        /** <code>repeated .BlessingRecvPicRecord recv_pic_record_list = 11;</code> */
        ...
        emu.grasscutter.net.proto.BlessingRecvPicRecordOuterClass.BlessingRecvPicRecord
                getRecvPicRecordList(int index);
        /** <code>repeated .BlessingRecvPicRecord recv_pic_record_list = 11;</code> */
        ...
        emu.grasscutter.net.proto.BlessingRecvPicRecordOuterClass.BlessingRecvPicRecordOrBuilder
                getRecvPicRecordListOrBuilder(int index);
     ...
     */
    public static final class BlessingGetAllRecvPicRecordListRsp
            ...
            return emu.grasscutter.net.proto.BlessingGetAllRecvPicRecordListRspOuterClass
                    ...
                    .ensureFieldAccessorsInitialized(
                            emu.grasscutter.net.proto.BlessingGetAllRecvPicRecordListRspOuterClass
                                    .BlessingGetAllRecvPicRecordListRsp.class,
                            emu.grasscutter.net.proto.BlessingGetAllRecvPicRecordListRspOuterClass
                                    .BlessingGetAllRecvPicRecordListRsp.Builder.class);
        }

        public static final int RECV_PIC_RECORD_LIST_FIELD_NUMBER = 11;
        ...
        /** <code>repeated .BlessingRecvPicRecord recv_pic_record_list = 11;</code> */
        @java.lang.Override
        public emu.grasscutter.net.proto.BlessingRecvPicRecordOuterClass.BlessingRecvPicRecordOrBuilder
                getRecvPicRecordListOrBuilder(int index) {
            return recvPicRecordList_.get(index);
        }
        ...
        public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
            ...
            for (int i = 0; i < recvPicRecordList_.size(); i++) {
                output.writeMessage(11, recvPicRecordList_.get(i));
            }
        ...
        public int getSerializedSize() {
            ...
            for (int i = 0; i < recvPicRecordList_.size(); i++) {
                size +=
                        com.google.protobuf.CodedOutputStream.computeMessageSize(11, recvPicRecordList_.get(i));
            }
        ...
        public boolean equals(final java.lang.Object obj) {
            ...
            if (!getRecvPicRecordListList().equals(other.getRecvPicRecordListList())) return false;
        ...
        public static emu.grasscutter.net.proto.BlessingGetAllRecvPicRecordListRspOuterClass
                        .BlessingGetAllRecvPicRecordListRsp
        ...
        public static final class Builder
            ...
            // Construct using
            // emu.grasscutter.net.proto.BlessingGetAllRecvPicRecordListRspOuterClass.BlessingGetAllRecvPicRecordListRsp.newBuilder()
            private Builder() {
            ...
            @java.lang.Override
            public emu.grasscutter.net.proto.BlessingGetAllRecvPicRecordListRspOuterClass
                            .BlessingGetAllRecvPicRecordListRsp
            ...
            public emu.grasscutter.net.proto.BlessingGetAllRecvPicRecordListRspOuterClass
                ...
                emu.grasscutter.net.proto.BlessingGetAllRecvPicRecordListRspOuterClass
                                .BlessingGetAllRecvPicRecordListRsp
                        result =
                                new emu.grasscutter.net.proto.BlessingGetAllRecvPicRecordListRspOuterClass
                                        .BlessingGetAllRecvPicRecordListRsp(this);
            ...
            public Builder mergeFrom(
                ...
                if (other
                        == emu.grasscutter.net.proto.BlessingGetAllRecvPicRecordListRspOuterClass
                                .BlessingGetAllRecvPicRecordListRsp.getDefaultInstance()) return this;
                if (recvPicRecordListBuilder_ == null) {
            ...
            public Builder setRecvPicRecordList(
                    int index,
                    emu.grasscutter.net.proto.BlessingRecvPicRecordOuterClass.BlessingRecvPicRecord value) {
                if (recvPicRecordListBuilder_ == null) {
                    if (value == null) {
            ...
            public Builder setRecvPicRecordList(
                    int index,
                    emu.grasscutter.net.proto.BlessingRecvPicRecordOuterClass.BlessingRecvPicRecord.Builder
                            builderForValue) {
                if (recvPicRecordListBuilder_ == null) {
                    ensureRecvPicRecordListIsMutable();
            ...
            public Builder addAllRecvPicRecordList(
                ...
                if (recvPicRecordListBuilder_ == null) {
                    ensureRecvPicRecordListIsMutable();
                    com.google.protobuf.AbstractMessageLite.Builder.addAll(values, recvPicRecordList_);
                    onChanged();
                } else {
            ...
            /** <code>repeated .BlessingRecvPicRecord recv_pic_record_list = 11;</code> */
            public emu.grasscutter.net.proto.BlessingRecvPicRecordOuterClass.BlessingRecvPicRecord.Builder
                    getRecvPicRecordListBuilder(int index) {
                return getRecvPicRecordListFieldBuilder().getBuilder(index);
            }
            /** <code>repeated .BlessingRecvPicRecord recv_pic_record_list = 11;</code> */
            public emu.grasscutter.net.proto.BlessingRecvPicRecordOuterClass
                            .BlessingRecvPicRecordOrBuilder
                    getRecvPicRecordListOrBuilder(int index) {
                if (recvPicRecordListBuilder_ == null) {
                    return recvPicRecordList_.get(index);
            ...
            /** <code>repeated .BlessingRecvPicRecord recv_pic_record_list = 11;</code> */
            public emu.grasscutter.net.proto.BlessingRecvPicRecordOuterClass.BlessingRecvPicRecord.Builder
                    addRecvPicRecordListBuilder() {
                return getRecvPicRecordListFieldBuilder()
                        .addBuilder(
                                emu.grasscutter.net.proto.BlessingRecvPicRecordOuterClass.BlessingRecvPicRecord
                                        .getDefaultInstance());
            }
            /** <code>repeated .BlessingRecvPicRecord recv_pic_record_list = 11;</code> */
            public emu.grasscutter.net.proto.BlessingRecvPicRecordOuterClass.BlessingRecvPicRecord.Builder
                    addRecvPicRecordListBuilder(int index) {
                return getRecvPicRecordListFieldBuilder()
                        .addBuilder(
                                index,
                                emu.grasscutter.net.proto.BlessingRecvPicRecordOuterClass.BlessingRecvPicRecord
        ...
        private static final emu.grasscutter.net.proto.BlessingGetAllRecvPicRecordListRspOuterClass
                        .BlessingGetAllRecvPicRecordListRsp
                DEFAULT_INSTANCE;
        ...
        private static final com.google.protobuf.Parser<BlessingGetAllRecvPicRecordListRsp> PARSER =
                new com.google.protobuf.AbstractParser<BlessingGetAllRecvPicRecordListRsp>() {
                    @java.lang.Override
    ...
    static {
        java.lang.String[] descriptorData = {
            "\n(BlessingGetAllRecvPicRecordListRsp.pro"
                    ...
                    + "c_record_list\030\013 \003(\0132\026.BlessingRecvPicRec"
