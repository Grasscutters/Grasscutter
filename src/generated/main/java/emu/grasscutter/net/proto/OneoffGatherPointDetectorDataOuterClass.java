...
public final class OneoffGatherPointDetectorDataOuterClass {
    ...
    public static final class OneoffGatherPointDetectorData
        ...
        public int getSerializedSize() {
            ...
            if (isHintValid_ != false) {
                size += com.google.protobuf.CodedOutputStream.computeBoolSize(4, isHintValid_);
            }
            if (hintRadius_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(8, hintRadius_);
            }
            if (isAllCollected_ != false) {
                size += com.google.protobuf.CodedOutputStream.computeBoolSize(9, isAllCollected_);
            }
            if (groupId_ != 0) {
