...
public final class OneoffGatherPointDetectorDataOuterClass {
    ...
    public static final class OneoffGatherPointDetectorData
        ...
        public int getSerializedSize() {
            ...
            size = 0;
            if (hintRadius_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(1, hintRadius_);
            }
            if (hintCenterPos_ != null) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(4, getHintCenterPos());
            }
            if (isAllCollected_ != false) {
                size += com.google.protobuf.CodedOutputStream.computeBoolSize(5, isAllCollected_);
            }
            if (groupId_ != 0) {
            ...
            if (isHintValid_ != false) {
                size += com.google.protobuf.CodedOutputStream.computeBoolSize(11, isHintValid_);
            }
            if (materialId_ != 0) {
