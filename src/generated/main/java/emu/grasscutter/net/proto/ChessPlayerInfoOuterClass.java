...
public final class ChessPlayerInfoOuterClass {
    ...
    public interface ChessPlayerInfoOrBuilder
            extends
        ...
        emu.grasscutter.net.proto.ChessNormalCardInfoOuterClass.ChessNormalCardInfo
                getCandidateCardInfoList(int index);
        /** <code>repeated .ChessNormalCardInfo candidate_card_info_list = 13;</code> */
        int getCandidateCardInfoListCount();
        /** <code>repeated .ChessNormalCardInfo candidate_card_info_list = 13;</code> */
        java.util.List<
                        ? extends
                                emu.grasscutter.net.proto.ChessNormalCardInfoOuterClass
        ...
        emu.grasscutter.net.proto.ChessNormalCardInfoOuterClass.ChessNormalCardInfoOrBuilder
                getCandidateCardInfoListOrBuilder(int index);
     ...
     */
    public static final class ChessPlayerInfo extends com.google.protobuf.GeneratedMessageV3
            implements
        ...
        public static final com.google.protobuf.Descriptors.Descriptor getDescriptor() {
            return emu.grasscutter.net.proto.ChessPlayerInfoOuterClass
        ...
        protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
            ...
            return emu.grasscutter.net.proto.ChessPlayerInfoOuterClass
                    ...
                    .ensureFieldAccessorsInitialized(
                            emu.grasscutter.net.proto.ChessPlayerInfoOuterClass.ChessPlayerInfo.class,
                            emu.grasscutter.net.proto.ChessPlayerInfoOuterClass.ChessPlayerInfo.Builder.class);
        }
        ...
        /** <code>repeated .ChessNormalCardInfo candidate_card_info_list = 13;</code> */
        @java.lang.Override
        public emu.grasscutter.net.proto.ChessNormalCardInfoOuterClass.ChessNormalCardInfo
                getCandidateCardInfoList(int index) {
            return candidateCardInfoList_.get(index);
        }
        /** <code>repeated .ChessNormalCardInfo candidate_card_info_list = 13;</code> */
        @java.lang.Override
        public emu.grasscutter.net.proto.ChessNormalCardInfoOuterClass.ChessNormalCardInfoOrBuilder
                getCandidateCardInfoListOrBuilder(int index) {
            return candidateCardInfoList_.get(index);
        }
        ...
        public int getSerializedSize() {
            ...
            size = 0;
            if (gJDGAIKBFCC_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(2, gJDGAIKBFCC_);
            }
            if (fDJKOOOOHEL_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(4, fDJKOOOOHEL_);
            }
            if (dHOCBFFKAEN_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(5, dHOCBFFKAEN_);
            }
            if (nKJJHNGOBMK_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(6, nKJJHNGOBMK_);
            }
            if (uid_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(11, uid_);
            }
            if (mJEJBIPNFDL_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(12, mJEJBIPNFDL_);
            }
            for (int i = 0; i < candidateCardInfoList_.size(); i++) {
                size +=
                        com.google.protobuf.CodedOutputStream.computeMessageSize(
                                13, candidateCardInfoList_.get(i));
            }
        ...
        public boolean equals(final java.lang.Object obj) {
            ...
            emu.grasscutter.net.proto.ChessPlayerInfoOuterClass.ChessPlayerInfo other =
                    (emu.grasscutter.net.proto.ChessPlayerInfoOuterClass.ChessPlayerInfo) obj;

            if (getUid() != other.getUid()) return false;
            if (getGJDGAIKBFCC() != other.getGJDGAIKBFCC()) return false;
            if (getFDJKOOOOHEL() != other.getFDJKOOOOHEL()) return false;
            if (getMJEJBIPNFDL() != other.getMJEJBIPNFDL()) return false;
            if (getDHOCBFFKAEN() != other.getDHOCBFFKAEN()) return false;
            if (!getCandidateCardInfoListList().equals(other.getCandidateCardInfoListList()))
                return false;
            if (getNKJJHNGOBMK() != other.getNKJJHNGOBMK()) return false;
        ...
        public static emu.grasscutter.net.proto.ChessPlayerInfoOuterClass.ChessPlayerInfo
        ...
        public static Builder newBuilder(
                emu.grasscutter.net.proto.ChessPlayerInfoOuterClass.ChessPlayerInfo prototype) {
        ...
        public static final class Builder
            ...
            // Construct using
            // emu.grasscutter.net.proto.ChessPlayerInfoOuterClass.ChessPlayerInfo.newBuilder()
            private Builder() {
            ...
            public emu.grasscutter.net.proto.ChessPlayerInfoOuterClass.ChessPlayerInfo
                ...
                return emu.grasscutter.net.proto.ChessPlayerInfoOuterClass.ChessPlayerInfo
                        .getDefaultInstance();
            }
            ...
            public emu.grasscutter.net.proto.ChessPlayerInfoOuterClass.ChessPlayerInfo buildPartial() {
                emu.grasscutter.net.proto.ChessPlayerInfoOuterClass.ChessPlayerInfo result =
                        new emu.grasscutter.net.proto.ChessPlayerInfoOuterClass.ChessPlayerInfo(this);
            ...
            private com.google.protobuf.RepeatedFieldBuilderV3<
                            emu.grasscutter.net.proto.ChessNormalCardInfoOuterClass.ChessNormalCardInfo,
                            emu.grasscutter.net.proto.ChessNormalCardInfoOuterClass.ChessNormalCardInfo.Builder,
                            emu.grasscutter.net.proto.ChessNormalCardInfoOuterClass.ChessNormalCardInfoOrBuilder>
                    candidateCardInfoListBuilder_;
            ...
            public Builder setCandidateCardInfoList(
                    int index,
                    emu.grasscutter.net.proto.ChessNormalCardInfoOuterClass.ChessNormalCardInfo value) {
                if (candidateCardInfoListBuilder_ == null) {
                    if (value == null) {
            ...
            public Builder addAllCandidateCardInfoList(
                ...
                if (candidateCardInfoListBuilder_ == null) {
                    ensureCandidateCardInfoListIsMutable();
                    com.google.protobuf.AbstractMessageLite.Builder.addAll(values, candidateCardInfoList_);
                    onChanged();
                } else {
            ...
            /** <code>repeated .ChessNormalCardInfo candidate_card_info_list = 13;</code> */
            public emu.grasscutter.net.proto.ChessNormalCardInfoOuterClass.ChessNormalCardInfo.Builder
                    getCandidateCardInfoListBuilder(int index) {
            ...
            /** <code>repeated .ChessNormalCardInfo candidate_card_info_list = 13;</code> */
            public emu.grasscutter.net.proto.ChessNormalCardInfoOuterClass.ChessNormalCardInfo.Builder
                    addCandidateCardInfoListBuilder() {
                return getCandidateCardInfoListFieldBuilder()
                        .addBuilder(
                                emu.grasscutter.net.proto.ChessNormalCardInfoOuterClass.ChessNormalCardInfo
                                        .getDefaultInstance());
            }
            /** <code>repeated .ChessNormalCardInfo candidate_card_info_list = 13;</code> */
            public emu.grasscutter.net.proto.ChessNormalCardInfoOuterClass.ChessNormalCardInfo.Builder
                    addCandidateCardInfoListBuilder(int index) {
                return getCandidateCardInfoListFieldBuilder()
                        .addBuilder(
                                index,
                                emu.grasscutter.net.proto.ChessNormalCardInfoOuterClass.ChessNormalCardInfo
        ...
        private static final emu.grasscutter.net.proto.ChessPlayerInfoOuterClass.ChessPlayerInfo
                DEFAULT_INSTANCE;
        ...
        private static final com.google.protobuf.Parser<ChessPlayerInfo> PARSER =
                new com.google.protobuf.AbstractParser<ChessPlayerInfo>() {
                    @java.lang.Override
    ...
    static {
        ...
        internal_static_ChessPlayerInfo_descriptor = getDescriptor().getMessageTypes().get(0);
        internal_static_ChessPlayerInfo_fieldAccessorTable =
