...
public final class ParentQuestOuterClass {
    ...
    public interface ParentQuestOrBuilder
        ...
        /** <code>repeated .ChildQuest child_quest_list = 5;</code> */
        ...
        /**
         * <code>.ParentQuestRandomInfo random_info = 1;</code>
         *
    ...
    public static final class ParentQuest extends com.google.protobuf.GeneratedMessageV3
        ...
        public static final int CHILD_QUEST_LIST_FIELD_NUMBER = 5;
        ...
        public int getSerializedSize() {
            ...
            size = 0;
            if (randomInfo_ != null) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(1, getRandomInfo());
            }
            if (isFinished_ != false) {
                size += com.google.protobuf.CodedOutputStream.computeBoolSize(2, isFinished_);
            }
            for (int i = 0; i < childQuestList_.size(); i++) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(5, childQuestList_.get(i));
            }
            for (int i = 0; i < inferencePageList_.size(); i++) {
                size +=
                        com.google.protobuf.CodedOutputStream.computeMessageSize(7, inferencePageList_.get(i));
            }
            if (parentQuestId_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(8, parentQuestId_);
            }
            if (acceptTime_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(9, acceptTime_);
            }
            if (isRandom_ != false) {
            ...
            for (java.util.Map.Entry<java.lang.Integer, java.lang.Integer> entry :
                ...
                com.google.protobuf.MapEntry<java.lang.Integer, java.lang.Integer> timeVarMap__ =
                        TimeVarMapDefaultEntryHolder.defaultEntry
                                ...
                                .build();
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(13, timeVarMap__);
            }
            if (videoKey_ != 0L) {
                size += com.google.protobuf.CodedOutputStream.computeUInt64Size(14, videoKey_);
            }
            {
                int dataSize = 0;
                for (int i = 0; i < questVar_.size(); i++) {
