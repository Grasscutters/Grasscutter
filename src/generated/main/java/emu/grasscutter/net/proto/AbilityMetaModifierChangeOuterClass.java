...
public final class AbilityMetaModifierChangeOuterClass {
    ...
    public interface AbilityMetaModifierChangeOrBuilder
        ...
        /**
         * <code>uint32 apply_entity_id = 2;</code>
         *
        ...
        /**
         * <code>bool is_mute_remote = 15;</code>
         *
    ...
    public static final class AbilityMetaModifierChange extends com.google.protobuf.GeneratedMessageV3
        ...
        public int getSerializedSize() {
            ...
            size = 0;
            if (parentAbilityName_ != null) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(1, getParentAbilityName());
            }
            if (applyEntityId_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(2, applyEntityId_);
            }
            if (attachedInstancedModifier_ != null) {
                size +=
                        com.google.protobuf.CodedOutputStream.computeMessageSize(
                                3, getAttachedInstancedModifier());
            }
            if (action_
                    != emu.grasscutter.net.proto.ModifierActionOuterClass.ModifierAction.MODIFIER_ACTION_ADDED
                            .getNumber()) {
            ...
            if (modifierLocalId_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeInt32Size(5, modifierLocalId_);
            }
            if (serverBuffUid_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(7, serverBuffUid_);
            }
            if (jGGDMDGLJOP_ != false) {
                size += com.google.protobuf.CodedOutputStream.computeBoolSize(8, jGGDMDGLJOP_);
            }
            if (parentAbilityOverride_ != null) {
                size +=
                        com.google.protobuf.CodedOutputStream.computeMessageSize(
                                10, getParentAbilityOverride());
            }
            if (dLOLFHNNEKI_ != false) {
                size += com.google.protobuf.CodedOutputStream.computeBoolSize(12, dLOLFHNNEKI_);
            }
            for (int i = 0; i < properties_.size(); i++) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(14, properties_.get(i));
            }
            if (isMuteRemote_ != false) {
                size += com.google.protobuf.CodedOutputStream.computeBoolSize(15, isMuteRemote_);
            }
        ...
        public boolean equals(final java.lang.Object obj) {
            ...
            if (getJGGDMDGLJOP() != other.getJGGDMDGLJOP()) return false;
        ...
        public int hashCode() {
            ...
            hash = (53 * hash) + com.google.protobuf.Internal.hashBoolean(getJGGDMDGLJOP());
            if (hasParentAbilityName()) {
        ...
        public static final class Builder
            ...
            public emu.grasscutter.net.proto.AbilityMetaModifierChangeOuterClass.AbilityMetaModifierChange
                ...
                result.jGGDMDGLJOP_ = jGGDMDGLJOP_;
                if (parentAbilityNameBuilder_ == null) {
            ...
            public Builder mergeFrom(
                ...
                if (other.getJGGDMDGLJOP() != false) {
                    setJGGDMDGLJOP(other.getJGGDMDGLJOP());
                }
