...
public final class BlossomBriefInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public int getSerializedSize() {
      ...
      if (monsterLevel_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(2, monsterLevel_);
      }
      if (pos_ != null) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (isGuideOpened_ != false) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(10, isGuideOpened_);
      }
      if (resin_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(13, resin_);
      }
      if (circleCampId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
  ...
  static {
    ...
    internal_static_BlossomBriefInfo_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_BlossomBriefInfo_descriptor,
        new java.lang.String[] { "IsGuideOpened", "Resin", "Pos", "RefreshId", "SceneId", "RewardId", "MonsterLevel", "CircleCampId", "CityId", "State", });
    emu.grasscutter.net.proto.VectorOuterClass.getDescriptor();
  }
