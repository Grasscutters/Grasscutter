...
public final class MonsterAIConfigHashNotifyOuterClass {
    ...
    public static final class MonsterAIConfigHashNotify extends com.google.protobuf.GeneratedMessageV3
        ...
        public int getSerializedSize() {
            ...
            size = 0;
            if (jobId_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(3, jobId_);
            }
            if (hashValue_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeInt32Size(6, hashValue_);
            }
            if (entityId_ != 0) {
