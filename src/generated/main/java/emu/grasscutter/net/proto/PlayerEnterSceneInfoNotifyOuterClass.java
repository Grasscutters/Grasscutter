...
public final class PlayerEnterSceneInfoNotifyOuterClass {
    ...
    public static final class PlayerEnterSceneInfoNotify
        ...
        public int getSerializedSize() {
            ...
            size = 0;
            if (teamEnterInfo_ != null) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(3, getTeamEnterInfo());
            }
            for (int i = 0; i < avatarEnterInfo_.size(); i++) {
                size +=
                        com.google.protobuf.CodedOutputStream.computeMessageSize(5, avatarEnterInfo_.get(i));
            }
            if (enterSceneToken_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(12, enterSceneToken_);
            }
            if (curAvatarEntityId_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(14, curAvatarEntityId_);
            }
            if (mpLevelEntityInfo_ != null) {
                size +=
                        com.google.protobuf.CodedOutputStream.computeMessageSize(15, getMpLevelEntityInfo());
            }
    ...
    static {
        java.lang.String[] descriptorData = {
            "\n PlayerEnterSceneInfoNotify.proto\032\030Team"
                    ...
                    + "proto\032\032AvatarEnterSceneInfo.proto\"\347\001\n\032Pl"
                    ...
                    + "r_entity_id\030\016 \001(\r\0220\n\021avatar_enter_info\030\005"
                    + " \003(\0132\025.AvatarEnterSceneInfoB\033\n\031emu.grass"
