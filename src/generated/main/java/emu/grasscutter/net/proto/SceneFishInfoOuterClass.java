...
public final class SceneFishInfoOuterClass {
    ...
    public interface SceneFishInfoOrBuilder
            extends
     ...
     */
    public static final class SceneFishInfo extends com.google.protobuf.GeneratedMessageV3
            implements
        ...
        public static final com.google.protobuf.Descriptors.Descriptor getDescriptor() {
            return emu.grasscutter.net.proto.SceneFishInfoOuterClass
        ...
        protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
            ...
            return emu.grasscutter.net.proto.SceneFishInfoOuterClass
                    ...
                    .ensureFieldAccessorsInitialized(
                            emu.grasscutter.net.proto.SceneFishInfoOuterClass.SceneFishInfo.class,
                            emu.grasscutter.net.proto.SceneFishInfoOuterClass.SceneFishInfo.Builder.class);
        }
        ...
        public int getSerializedSize() {
            ...
            size = 0;
            if (fishId_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(1, fishId_);
            }
            if (fishPoolEntityId_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(2, fishPoolEntityId_);
            }
            if (fishPoolPos_ != null) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(3, getFishPoolPos());
            }
            if (fishPoolGadgetId_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(4, fishPoolGadgetId_);
            }
            if (lastShockTime_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(5, lastShockTime_);
            }
        ...
        public boolean equals(final java.lang.Object obj) {
            ...
            emu.grasscutter.net.proto.SceneFishInfoOuterClass.SceneFishInfo other =
                    (emu.grasscutter.net.proto.SceneFishInfoOuterClass.SceneFishInfo) obj;

            if (getFishId() != other.getFishId()) return false;
            if (getFishPoolEntityId() != other.getFishPoolEntityId()) return false;
            if (hasFishPoolPos() != other.hasFishPoolPos()) return false;
            if (hasFishPoolPos()) {
                if (!getFishPoolPos().equals(other.getFishPoolPos())) return false;
            }
            if (getFishPoolGadgetId() != other.getFishPoolGadgetId()) return false;
            if (getLastShockTime() != other.getLastShockTime()) return false;
        ...
        public static emu.grasscutter.net.proto.SceneFishInfoOuterClass.SceneFishInfo
        ...
        public static Builder newBuilder(
                emu.grasscutter.net.proto.SceneFishInfoOuterClass.SceneFishInfo prototype) {
        ...
        public static final class Builder
            ...
            @java.lang.Override
            public emu.grasscutter.net.proto.SceneFishInfoOuterClass.SceneFishInfo
            ...
            public emu.grasscutter.net.proto.SceneFishInfoOuterClass.SceneFishInfo buildPartial() {
                emu.grasscutter.net.proto.SceneFishInfoOuterClass.SceneFishInfo result =
                        new emu.grasscutter.net.proto.SceneFishInfoOuterClass.SceneFishInfo(this);
            ...
            public Builder mergeFrom(
                    emu.grasscutter.net.proto.SceneFishInfoOuterClass.SceneFishInfo other) {
                if (other
                        == emu.grasscutter.net.proto.SceneFishInfoOuterClass.SceneFishInfo.getDefaultInstance())
                    return this;
            ...
            public Builder mergeFishPoolPos(emu.grasscutter.net.proto.VectorOuterClass.Vector value) {
                if (fishPoolPosBuilder_ == null) {
                    if (fishPoolPos_ != null) {
                        fishPoolPos_ =
                                emu.grasscutter.net.proto.VectorOuterClass.Vector.newBuilder(fishPoolPos_)
                                        .mergeFrom(value)
                                        .buildPartial();
                    } else {
                        fishPoolPos_ = value;
                ...
                if (fishPoolPosBuilder_ == null) {
                    fishPoolPosBuilder_ =
                            new com.google.protobuf.SingleFieldBuilderV3<
                                    ...
                                    emu.grasscutter.net.proto.VectorOuterClass.Vector.Builder,
                                    emu.grasscutter.net.proto.VectorOuterClass.VectorOrBuilder>(
                                    getFishPoolPos(), getParentForChildren(), isClean());
                    fishPoolPos_ = null;
                }
        ...
        private static final emu.grasscutter.net.proto.SceneFishInfoOuterClass.SceneFishInfo
                DEFAULT_INSTANCE;
        ...
        private static final com.google.protobuf.Parser<SceneFishInfo> PARSER =
                new com.google.protobuf.AbstractParser<SceneFishInfo>() {
                    @java.lang.Override
        ...
        internal_static_SceneFishInfo_fieldAccessorTable =
                new com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
                        ...
                        new java.lang.String[] {
                            "FishId", "FishPoolEntityId", "FishPoolPos", "FishPoolGadgetId", "LastShockTime",
                        });
        emu.grasscutter.net.proto.VectorOuterClass.getDescriptor();
    }
