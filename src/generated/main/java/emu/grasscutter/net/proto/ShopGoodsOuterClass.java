...
public final class ShopGoodsOuterClass {
    ...
    public interface ShopGoodsOrBuilder
         ...
         * </pre>
         *
         * <code>uint32 buyLimit = 1201;</code>
         *
         * @return The buyLimit.
         */
        int getBuyLimit();
         ...
         * </pre>
         *
         * <code>uint32 secondary_sheet_id = 1493;</code>
         *
        ...
        /**
         * <code>uint32 IAKCJHEJHOG = 15;</code>
         *
         * @return The iAKCJHEJHOG.
         */
        int getIAKCJHEJHOG();
        ...
        /**
         * <code>uint32 GNENHCFPFCP = 688;</code>
         *
         * @return The gNENHCFPFCP.
         */
        int getGNENHCFPFCP();
         ...
         * </pre>
         *
         * <code>uint32 disableType = 617;</code>
         *
    ...
    public static final class ShopGoods extends com.google.protobuf.GeneratedMessageV3
        ...
        public static final int BUYLIMIT_FIELD_NUMBER = 1201;
        ...
        public static final int SECONDARY_SHEET_ID_FIELD_NUMBER = 1493;
        ...
        public static final int IAKCJHEJHOG_FIELD_NUMBER = 15;
        private int iAKCJHEJHOG_;
        /**
         * <code>uint32 IAKCJHEJHOG = 15;</code>
         *
         * @return The iAKCJHEJHOG.
        ...
        public static final int GNENHCFPFCP_FIELD_NUMBER = 688;
        private int gNENHCFPFCP_;
        /**
         * <code>uint32 GNENHCFPFCP = 688;</code>
         *
         * @return The gNENHCFPFCP.
        ...
        public static final int DISABLETYPE_FIELD_NUMBER = 617;
        ...
        public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
            ...
            if (iAKCJHEJHOG_ != 0) {
                output.writeUInt32(15, iAKCJHEJHOG_);
            }
            if (disableType_ != 0) {
                output.writeUInt32(617, disableType_);
            }
            if (gNENHCFPFCP_ != 0) {
                output.writeUInt32(688, gNENHCFPFCP_);
            }
            if (eOMGIGFFCLI_ != 0) {
                output.writeUInt32(736, eOMGIGFFCLI_);
            }
            if (buyLimit_ != 0) {
                output.writeUInt32(1201, buyLimit_);
            }
            if (secondarySheetId_ != 0) {
                output.writeUInt32(1493, secondarySheetId_);
            }
        ...
        public int getSerializedSize() {
            ...
            size = 0;
            if (goodsId_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(1, goodsId_);
            }
            if (mcoin_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(2, mcoin_);
            }
            if (boughtNum_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(3, boughtNum_);
            }
            if (endTime_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(4, endTime_);
            }
            if (nextRefreshTime_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(5, nextRefreshTime_);
            }
            {
                int dataSize = 0;
                for (int i = 0; i < preGoodsIdList_.size(); i++) {
            ...
            if (goodsItem_ != null) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(7, getGoodsItem());
            }
            if (minLevel_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(8, minLevel_);
            }
            if (maxLevel_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(9, maxLevel_);
            }
            if (bKONLAFGBFC_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(10, bKONLAFGBFC_);
            }
            if (scoin_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(11, scoin_);
            }
            if (hcoin_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(12, hcoin_);
            }
            for (int i = 0; i < costItemList_.size(); i++) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(13, costItemList_.get(i));
            }
            if (beginTime_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(14, beginTime_);
            }
            if (iAKCJHEJHOG_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(15, iAKCJHEJHOG_);
            }
            if (disableType_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(617, disableType_);
            }
            if (gNENHCFPFCP_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(688, gNENHCFPFCP_);
            }
            if (eOMGIGFFCLI_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(736, eOMGIGFFCLI_);
            }
            if (buyLimit_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(1201, buyLimit_);
            }
            if (secondarySheetId_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(1493, secondarySheetId_);
            }
        ...
        public boolean equals(final java.lang.Object obj) {
            ...
            if (getEOMGIGFFCLI() != other.getEOMGIGFFCLI()) return false;
            ...
            if (getIAKCJHEJHOG() != other.getIAKCJHEJHOG()) return false;
            if (getMcoin() != other.getMcoin()) return false;
            if (getBoughtNum() != other.getBoughtNum()) return false;
            if (getGNENHCFPFCP() != other.getGNENHCFPFCP()) return false;
            if (getBKONLAFGBFC() != other.getBKONLAFGBFC()) return false;
        ...
        public int hashCode() {
            ...
            hash = (37 * hash) + IAKCJHEJHOG_FIELD_NUMBER;
            hash = (53 * hash) + getIAKCJHEJHOG();
            hash = (37 * hash) + MCOIN_FIELD_NUMBER;
            hash = (53 * hash) + getMcoin();
            hash = (37 * hash) + BOUGHTNUM_FIELD_NUMBER;
            hash = (53 * hash) + getBoughtNum();
            hash = (37 * hash) + GNENHCFPFCP_FIELD_NUMBER;
            hash = (53 * hash) + getGNENHCFPFCP();
        ...
        public static final class Builder
            ...
            public emu.grasscutter.net.proto.ShopGoodsOuterClass.ShopGoods buildPartial() {
                ...
                result.iAKCJHEJHOG_ = iAKCJHEJHOG_;
                result.mcoin_ = mcoin_;
                result.boughtNum_ = boughtNum_;
                result.gNENHCFPFCP_ = gNENHCFPFCP_;
            ...
            public Builder mergeFrom(emu.grasscutter.net.proto.ShopGoodsOuterClass.ShopGoods other) {
                ...
                if (other.getIAKCJHEJHOG() != 0) {
                    setIAKCJHEJHOG(other.getIAKCJHEJHOG());
                }
                if (other.getMcoin() != 0) {
                ...
                if (other.getGNENHCFPFCP() != 0) {
                    setGNENHCFPFCP(other.getGNENHCFPFCP());
                }
             ...
             * <code>uint32 IAKCJHEJHOG = 15;</code>
             *
             * @param value The iAKCJHEJHOG to set.
             * @return This builder for chaining.
             */
            public Builder setIAKCJHEJHOG(int value) {
             ...
             * @return This builder for chaining.
             */
            public Builder clearIAKCJHEJHOG() {
             ...
             * <code>uint32 GNENHCFPFCP = 688;</code>
             *
             * @param value The gNENHCFPFCP to set.
             * @return This builder for chaining.
             */
            public Builder setGNENHCFPFCP(int value) {
             ...
             * @return This builder for chaining.
             */
            public Builder clearGNENHCFPFCP() {
    ...
    static {
        java.lang.String[] descriptorData = {
            "\n\017ShopGoods.proto\032\017ItemParam.proto\"\262\003\n\tS"
                    ...
                    + "coin\030\013 \001(\r\022\033\n\022secondary_sheet_id\030\325\013 \001(\r\022"
                    ...
                    + "\n\tboughtNum\030\003 \001(\r\022\024\n\013GNENHCFPFCP\030\260\005 \001(\r\022"
                    ...
                    + "\030\010 \001(\r\022\027\n\017nextRefreshTime\030\005 \001(\rB!\n\031emu.g"
