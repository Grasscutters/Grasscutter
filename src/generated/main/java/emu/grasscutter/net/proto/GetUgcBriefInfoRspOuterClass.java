...
public final class GetUgcBriefInfoRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 66: {
              ...
              if (briefCase_ == 8) {
                subBuilder = ((emu.grasscutter.net.proto.MusicBriefInfoOuterClass.MusicBriefInfo) brief_).toBuilder();
              }
              brief_ =
                  input.readMessage(emu.grasscutter.net.proto.MusicBriefInfoOuterClass.MusicBriefInfo.parser(), extensionRegistry);
              if (subBuilder != null) {
                subBuilder.mergeFrom((emu.grasscutter.net.proto.MusicBriefInfoOuterClass.MusicBriefInfo) brief_);
    ...
    public emu.grasscutter.net.proto.MusicBriefInfoOuterClass.MusicBriefInfo getMusicBriefInfo() {
      if (briefCase_ == 8) {
         return (emu.grasscutter.net.proto.MusicBriefInfoOuterClass.MusicBriefInfo) brief_;
      }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (briefCase_ == 8) {
        output.writeMessage(8, (emu.grasscutter.net.proto.MusicBriefInfoOuterClass.MusicBriefInfo) brief_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (briefCase_ == 8) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(8, (emu.grasscutter.net.proto.MusicBriefInfoOuterClass.MusicBriefInfo) brief_);
      }
      if (ugcType_ != emu.grasscutter.net.proto.UgcTypeOuterClass.UgcType.UGC_TYPE_NONE.getNumber()) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public static final class Builder extends
      ...
      public Builder mergeMusicBriefInfo(emu.grasscutter.net.proto.MusicBriefInfoOuterClass.MusicBriefInfo value) {
        if (musicBriefInfoBuilder_ == null) {
          if (briefCase_ == 8 &&
              brief_ != emu.grasscutter.net.proto.MusicBriefInfoOuterClass.MusicBriefInfo.getDefaultInstance()) {
            brief_ = emu.grasscutter.net.proto.MusicBriefInfoOuterClass.MusicBriefInfo.newBuilder((emu.grasscutter.net.proto.MusicBriefInfoOuterClass.MusicBriefInfo) brief_)
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
        ...
        if (musicBriefInfoBuilder_ == null) {
          ...
          musicBriefInfoBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<
              emu.grasscutter.net.proto.MusicBriefInfoOuterClass.MusicBriefInfo, emu.grasscutter.net.proto.MusicBriefInfoOuterClass.MusicBriefInfo.Builder, emu.grasscutter.net.proto.MusicBriefInfoOuterClass.MusicBriefInfoOrBuilder>(
                  (emu.grasscutter.net.proto.MusicBriefInfoOuterClass.MusicBriefInfo) brief_,
  ...
  static {
    ...
    internal_static_GetUgcBriefInfoRsp_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_GetUgcBriefInfoRsp_descriptor,
        new java.lang.String[] { "UgcGuid", "UgcType", "Retcode", "MusicBriefInfo", "Brief", });
    emu.grasscutter.net.proto.UgcTypeOuterClass.getDescriptor();
    emu.grasscutter.net.proto.MusicBriefInfoOuterClass.getDescriptor();
  }
