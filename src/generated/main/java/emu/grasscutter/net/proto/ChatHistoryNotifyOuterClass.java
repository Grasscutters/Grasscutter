...
public final class ChatHistoryNotifyOuterClass {
    ...
    public interface ChatHistoryNotifyOrBuilder
            extends
            // @@protoc_insertion_point(interface_extends:ChatHistoryNotify)
            com.google.protobuf.MessageOrBuilder {

        /** <code>repeated .ChatInfo chat_info = 12;</code> */
        java.util.List<emu.grasscutter.net.proto.ChatInfoOuterClass.ChatInfo> getChatInfoList();
        /** <code>repeated .ChatInfo chat_info = 12;</code> */
        ...
        /** <code>repeated .ChatInfo chat_info = 12;</code> */
        emu.grasscutter.net.proto.ChatInfoOuterClass.ChatInfoOrBuilder getChatInfoOrBuilder(int index);
     ...
     */
    public static final class ChatHistoryNotify extends com.google.protobuf.GeneratedMessageV3
            implements
        ...
        public static final com.google.protobuf.Descriptors.Descriptor getDescriptor() {
            return emu.grasscutter.net.proto.ChatHistoryNotifyOuterClass
        ...
        protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
            ...
            return emu.grasscutter.net.proto.ChatHistoryNotifyOuterClass
                    ...
                    .ensureFieldAccessorsInitialized(
                            emu.grasscutter.net.proto.ChatHistoryNotifyOuterClass.ChatHistoryNotify.class,
                            emu.grasscutter.net.proto.ChatHistoryNotifyOuterClass.ChatHistoryNotify.Builder
                                    .class);
        }
        ...
        public int getSerializedSize() {
            ...
            size = 0;
            if (channelId_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(9, channelId_);
            }
            for (int i = 0; i < chatInfo_.size(); i++) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(12, chatInfo_.get(i));
            }
        ...
        public boolean equals(final java.lang.Object obj) {
            ...
            if (!(obj
                    instanceof emu.grasscutter.net.proto.ChatHistoryNotifyOuterClass.ChatHistoryNotify)) {
                return super.equals(obj);
            }
            emu.grasscutter.net.proto.ChatHistoryNotifyOuterClass.ChatHistoryNotify other =
                    (emu.grasscutter.net.proto.ChatHistoryNotifyOuterClass.ChatHistoryNotify) obj;

            if (!getChatInfoList().equals(other.getChatInfoList())) return false;
        ...
        public static emu.grasscutter.net.proto.ChatHistoryNotifyOuterClass.ChatHistoryNotify
        ...
        public static Builder newBuilder(
                emu.grasscutter.net.proto.ChatHistoryNotifyOuterClass.ChatHistoryNotify prototype) {
        ...
        public static final class Builder
            ...
            // Construct using
            // emu.grasscutter.net.proto.ChatHistoryNotifyOuterClass.ChatHistoryNotify.newBuilder()
            private Builder() {
            ...
            @java.lang.Override
            public emu.grasscutter.net.proto.ChatHistoryNotifyOuterClass.ChatHistoryNotify
                    getDefaultInstanceForType() {
                return emu.grasscutter.net.proto.ChatHistoryNotifyOuterClass.ChatHistoryNotify
                        .getDefaultInstance();
            }

            @java.lang.Override
            public emu.grasscutter.net.proto.ChatHistoryNotifyOuterClass.ChatHistoryNotify build() {
                emu.grasscutter.net.proto.ChatHistoryNotifyOuterClass.ChatHistoryNotify result =
                        buildPartial();
            ...
            public emu.grasscutter.net.proto.ChatHistoryNotifyOuterClass.ChatHistoryNotify
                    buildPartial() {
                emu.grasscutter.net.proto.ChatHistoryNotifyOuterClass.ChatHistoryNotify result =
                        new emu.grasscutter.net.proto.ChatHistoryNotifyOuterClass.ChatHistoryNotify(this);
            ...
            public Builder mergeFrom(
                    emu.grasscutter.net.proto.ChatHistoryNotifyOuterClass.ChatHistoryNotify other) {
                if (other
                        == emu.grasscutter.net.proto.ChatHistoryNotifyOuterClass.ChatHistoryNotify
            ...
            public Builder mergeFrom(
                    ...
                    com.google.protobuf.ExtensionRegistryLite extensionRegistry)
                    throws java.io.IOException {
                emu.grasscutter.net.proto.ChatHistoryNotifyOuterClass.ChatHistoryNotify parsedMessage =
                        null;
                try {
            ...
            private void ensureChatInfoIsMutable() {
                if (!((bitField0_ & 0x00000001) != 0)) {
                    chatInfo_ =
                            new java.util.ArrayList<emu.grasscutter.net.proto.ChatInfoOuterClass.ChatInfo>(
                                    chatInfo_);
            ...
            /** <code>repeated .ChatInfo chat_info = 12;</code> */
            public java.util.List<emu.grasscutter.net.proto.ChatInfoOuterClass.ChatInfo>
                    getChatInfoList() {
                if (chatInfoBuilder_ == null) {
            ...
            public Builder addAllChatInfo(
                    java.lang.Iterable<? extends emu.grasscutter.net.proto.ChatInfoOuterClass.ChatInfo>
                            values) {
                if (chatInfoBuilder_ == null) {
                    ensureChatInfoIsMutable();
                    com.google.protobuf.AbstractMessageLite.Builder.addAll(values, chatInfo_);
                    onChanged();
                } else {
            ...
            public java.util.List<
                            ? extends emu.grasscutter.net.proto.ChatInfoOuterClass.ChatInfoOrBuilder>
                    getChatInfoOrBuilderList() {
                if (chatInfoBuilder_ != null) {
            ...
            public emu.grasscutter.net.proto.ChatInfoOuterClass.ChatInfo.Builder addChatInfoBuilder() {
                return getChatInfoFieldBuilder()
                        .addBuilder(emu.grasscutter.net.proto.ChatInfoOuterClass.ChatInfo.getDefaultInstance());
            }
            /** <code>repeated .ChatInfo chat_info = 12;</code> */
            public emu.grasscutter.net.proto.ChatInfoOuterClass.ChatInfo.Builder addChatInfoBuilder(
                    int index) {
                ...
                if (chatInfoBuilder_ == null) {
                    chatInfoBuilder_ =
                            new com.google.protobuf.RepeatedFieldBuilderV3<
                                    ...
                                    emu.grasscutter.net.proto.ChatInfoOuterClass.ChatInfo.Builder,
                                    emu.grasscutter.net.proto.ChatInfoOuterClass.ChatInfoOrBuilder>(
                                    chatInfo_, ((bitField0_ & 0x00000001) != 0), getParentForChildren(), isClean());
                    chatInfo_ = null;
                }
        ...
        private static final emu.grasscutter.net.proto.ChatHistoryNotifyOuterClass.ChatHistoryNotify
                DEFAULT_INSTANCE;

        static {
            DEFAULT_INSTANCE =
                    new emu.grasscutter.net.proto.ChatHistoryNotifyOuterClass.ChatHistoryNotify();
        }
        ...
        private static final com.google.protobuf.Parser<ChatHistoryNotify> PARSER =
                new com.google.protobuf.AbstractParser<ChatHistoryNotify>() {
                    @java.lang.Override
    ...
    static {
        ...
        internal_static_ChatHistoryNotify_descriptor = getDescriptor().getMessageTypes().get(0);
        internal_static_ChatHistoryNotify_fieldAccessorTable =
