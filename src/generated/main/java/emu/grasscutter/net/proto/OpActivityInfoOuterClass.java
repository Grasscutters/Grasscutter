...
public final class OpActivityInfoOuterClass {
    ...
    public interface OpActivityInfoOrBuilder
            extends
        ...
        emu.grasscutter.net.proto.BonusOpActivityInfoOuterClass.BonusOpActivityInfoOrBuilder
                getBonusInfoOrBuilder();

        public emu.grasscutter.net.proto.OpActivityInfoOuterClass.OpActivityInfo.DetailCase
                getDetailCase();
    }
    /**
     *
     ...
     */
    public static final class OpActivityInfo extends com.google.protobuf.GeneratedMessageV3
            implements
            ...
            try {
                ...
                while (!done) {
                    ...
                    switch (tag) {
                        ...
                        case 74:
                            {
                                emu.grasscutter.net.proto.BonusOpActivityInfoOuterClass.BonusOpActivityInfo.Builder
                                        subBuilder = null;
                                if (detailCase_ == 9) {
                                    subBuilder =
                                            ((emu.grasscutter.net.proto.BonusOpActivityInfoOuterClass.BonusOpActivityInfo)
                                                            detail_)
                                                    .toBuilder();
                                }
                                detail_ =
        ...
        public static final com.google.protobuf.Descriptors.Descriptor getDescriptor() {
            return emu.grasscutter.net.proto.OpActivityInfoOuterClass
        ...
        protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
            ...
            return emu.grasscutter.net.proto.OpActivityInfoOuterClass
                    ...
                    .ensureFieldAccessorsInitialized(
                            emu.grasscutter.net.proto.OpActivityInfoOuterClass.OpActivityInfo.class,
                            emu.grasscutter.net.proto.OpActivityInfoOuterClass.OpActivityInfo.Builder.class);
        }
         ...
         */
        @java.lang.Override
        public emu.grasscutter.net.proto.BonusOpActivityInfoOuterClass.BonusOpActivityInfo
                getBonusInfo() {
            if (detailCase_ == 9) {
                return (emu.grasscutter.net.proto.BonusOpActivityInfoOuterClass.BonusOpActivityInfo)
                        detail_;
            }
            return emu.grasscutter.net.proto.BonusOpActivityInfoOuterClass.BonusOpActivityInfo
                    .getDefaultInstance();
        ...
        /** <code>.BonusOpActivityInfo bonus_info = 9;</code> */
        @java.lang.Override
        public emu.grasscutter.net.proto.BonusOpActivityInfoOuterClass.BonusOpActivityInfoOrBuilder
                getBonusInfoOrBuilder() {
            if (detailCase_ == 9) {
                return (emu.grasscutter.net.proto.BonusOpActivityInfoOuterClass.BonusOpActivityInfo)
                        detail_;
        ...
        public int getSerializedSize() {
            ...
            size = 0;
            if (scheduleId_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(6, scheduleId_);
            }
            if (beginTime_ != 0) {
                size += com.google.protobuf.CodedOutputStream.computeUInt32Size(7, beginTime_);
            }
            if (activityId_ != 0) {
            ...
            if (isHasChange_ != false) {
                size += com.google.protobuf.CodedOutputStream.computeBoolSize(15, isHasChange_);
            }
        ...
        public boolean equals(final java.lang.Object obj) {
            ...
            emu.grasscutter.net.proto.OpActivityInfoOuterClass.OpActivityInfo other =
                    (emu.grasscutter.net.proto.OpActivityInfoOuterClass.OpActivityInfo) obj;
            ...
            if (getIsHasChange() != other.getIsHasChange()) return false;
            if (!getDetailCase().equals(other.getDetailCase())) return false;
            switch (detailCase_) {
                case 9:
                    if (!getBonusInfo().equals(other.getBonusInfo())) return false;
                    break;
                case 0:
                default:
            }
        ...
        public int hashCode() {
            ...
            hash = (53 * hash) + com.google.protobuf.Internal.hashBoolean(getIsHasChange());
            switch (detailCase_) {
                case 9:
        ...
        public static emu.grasscutter.net.proto.OpActivityInfoOuterClass.OpActivityInfo
        ...
        public static Builder newBuilder(
                emu.grasscutter.net.proto.OpActivityInfoOuterClass.OpActivityInfo prototype) {
        ...
        public static final class Builder
            ...
            // Construct using
            // emu.grasscutter.net.proto.OpActivityInfoOuterClass.OpActivityInfo.newBuilder()
            private Builder() {
            ...
            public emu.grasscutter.net.proto.OpActivityInfoOuterClass.OpActivityInfo
                ...
                return emu.grasscutter.net.proto.OpActivityInfoOuterClass.OpActivityInfo
                        .getDefaultInstance();
            }
            ...
            public emu.grasscutter.net.proto.OpActivityInfoOuterClass.OpActivityInfo buildPartial() {
                emu.grasscutter.net.proto.OpActivityInfoOuterClass.OpActivityInfo result =
                        new emu.grasscutter.net.proto.OpActivityInfoOuterClass.OpActivityInfo(this);
            ...
            public Builder setBonusInfo(
                    emu.grasscutter.net.proto.BonusOpActivityInfoOuterClass.BonusOpActivityInfo value) {
                if (bonusInfoBuilder_ == null) {
                    if (value == null) {
                ...
                if (bonusInfoBuilder_ == null) {
                    if (detailCase_ == 9
                        ...
                        detail_ =
                                emu.grasscutter.net.proto.BonusOpActivityInfoOuterClass.BonusOpActivityInfo
                                        .newBuilder(
                                                (emu.grasscutter.net.proto.BonusOpActivityInfoOuterClass
                                                                .BonusOpActivityInfo)
                                                        detail_)
                                        .mergeFrom(value)
                                        .buildPartial();
            ...
            /** <code>.BonusOpActivityInfo bonus_info = 9;</code> */
            public emu.grasscutter.net.proto.BonusOpActivityInfoOuterClass.BonusOpActivityInfo.Builder
                    getBonusInfoBuilder() {
        ...
        private static final emu.grasscutter.net.proto.OpActivityInfoOuterClass.OpActivityInfo
                DEFAULT_INSTANCE;
        ...
        private static final com.google.protobuf.Parser<OpActivityInfo> PARSER =
                new com.google.protobuf.AbstractParser<OpActivityInfo>() {
                    @java.lang.Override
    ...
    static {
        ...
        internal_static_OpActivityInfo_descriptor = getDescriptor().getMessageTypes().get(0);
        internal_static_OpActivityInfo_fieldAccessorTable =
